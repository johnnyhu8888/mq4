...
//trade=1;
 ...
 //**************************   oders modify  ***************************************************************88
          ...
          if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8801 || OrderMagicNumber( )==8802) &&
                  high_05_buffer[0]-OrderOpenPrice()>=0.00160 && high_05_buffer[0]-OrderOpenPrice()<=0.00170) 
           ...
           if    (OrderType()==OP_SELL &&  (OrderMagicNumber( )==4401 || OrderMagicNumber( )==4402) &&
                  low_05_buffer[0]-OrderOpenPrice()<=-0.00160 && low_05_buffer[0]-OrderOpenPrice()>=-0.00170) 
