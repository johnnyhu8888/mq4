...
if    (OrdersTotal()<=6 || (OrdersTotal()<3 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket()))) 
 {
   ...
   if  (OrdersTotal()<=1)
     ...
     if   (k1_15_buffer[1]<=40 &&   k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && 
           d1_15_buffer[1]<=40 &&   d2_15_buffer[1]<=25 && d3_15_buffer[1]<=25 && 
