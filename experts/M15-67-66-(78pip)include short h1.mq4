...
int  buyorder01,buyorder02,buyorder03,buyorder04,buyorder05;
int  sellorder01,sellorder02,sellorder03,sellorder04,sellorder05;
int orderno; 
...
if    (OrdersTotal()>1 && OrdersTotal()<3)
      orderno=3; 
if    (OrdersTotal()>2 && OrdersTotal()<4)
      orderno=4;                       
//+++++++++++++++++++++++++++++++++++++++++++   BUY   1   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          
  if (OrdersTotal()<=orderno)   
             ...
             (macdmainline_60_buffer[1]<=0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.0003 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14)) 
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B1",8801,0,Red );
              ...
              (macdmainline_60_buffer[1]<=0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.0003 && 
               ...
               if  ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14)) 
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B2",8802,0,Yellow );
             ...
             (macdmainline_60_buffer[1]<=0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.0003 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  //(m15-66) h4 [1]macd 值介於0.00100 與-0.00100間  不交易                                
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B3",8803,0,Blue );
        ...
        if  (((close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[4]-open_15_buffer[4]>=0.0006  && 
             ...
             (macdmainline_60_buffer[1]<=0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.0003 && 
              ...
              if   ((k1_240_buffer[1]>=65 && k2_240_buffer[1]>=65 && k3_240_buffer[1]>=65) ||                   
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B4",8804,0,Brown );
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  (macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14)) 
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B5",8805,0,Purple );
             ...
             (close_60_buffer[2]-open_60_buffer[2]>=0.0001  && close_60_buffer[1]-open_60_buffer[1]>=-0.0006 && 
              ...
              if ((close_60_buffer[2]-open_60_buffer[2]<=-0.0100 || close_60_buffer[1]-open_60_buffer[1]<=-0.0100 ||
                  ...
                  (macdmainline_60_buffer[1]>=-0.00099 && macdmainline_60_buffer[1]<=0.00099 &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B6",8806,0,Gold );
             ...
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001   && low_240_buffer[1]-open_240_buffer[1]<=-0.0100)) &&
              ...
              macdmainline_240_buffer[1]>=0.00450 && macdsignalline_240_buffer[1]>=0.00050))  
               ...
               if    (k1_240_buffer[1]-d1_240_buffer[1]<=-12 &&  (k2_240_buffer[1]-d2_240_buffer[1]<=-5 || k3_240_buffer[1]-d3_240_buffer[1]<=-5) &&
                      ...
                      OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B7",8807,0,OrangeRed );
             ...
             ((close_240_buffer[2]-ma360_240_buffer[2]>=-0.0005  && close_240_buffer[2]-ma360_240_buffer[2]<=0.0020) ||
              ...
              (close_240_buffer[4]-ma360_240_buffer[4]>=-0.0005  && close_240_buffer[4]-ma360_240_buffer[4]<=0.0020))))
               ...
               if    (k1_240_buffer[1]-d1_240_buffer[1]<=-12 &&  (k2_240_buffer[1]-d2_240_buffer[1]<=-5 || k3_240_buffer[1]-d3_240_buffer[1]<=-5) &&
                      ...
                      OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B8",8808,0,OrangeRed );
                  ...
                  if    ((k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                   ...
                   // (m15-64)  kd1,kd2,kd3<=-15
                      ...
                      (ma360_240_buffer[1]-ma360_240_buffer[6]<=-0.0001 && ma05_240_buffer[1]-ma05_240_buffer[2]<=0.0015 &&
                       ...
                       OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B9",8809,0,OrangeRed );
           ...
           (close_60_buffer[1]-open_60_buffer[1]>=0.0030 && close_60_buffer[1]-close_60_buffer[2]>=0  &&
            ...
            if    ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14)) 
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B10",8810,0,Gold );
              ...
              (close_60_buffer[1]-open_60_buffer[1]>=0.0015 && close_60_buffer[5]-open_60_buffer[5]>=0.0007  && 
               ...
               if  ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14)) 
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B11",8811,0,Gold );
               ...
               if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-25  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-25) ||
                  ...
                  (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])<=-0.00070) ||    
                   ...
                   (OrderType()==OP_BUY && TimeCurrent()-OrderCloseTime()<=2000))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B12",8812,0,Maroon );
   //+++++++++++++++++++++++++++++++++++++++++++   BUY   13   ++++++++++++++++++++++++++++++++++++++++++++++++++          
               ...
               if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-25  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-25) ||
                  ...
                  (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])<=-0.00070) ||    
                   ...
                   (OrderType()==OP_BUY && TimeCurrent()-OrderCloseTime()<=2000))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B13",8813,0,DeepPink );
        ...
        if    (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 &&
             ...
             ((k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) || (ma180_60_buffer[1]-ma180_60_buffer[2]>=0.0001 &&
               ...
               if   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.0011 && ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.0008 &&
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B14",8814,0,LimeGreen );
    ...
    //+++++++++++++++++++++++++++++++++++++++++++   BUY   15   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if     (close_240_buffer[1]-open_240_buffer[1]>=0.0010  && low_240_buffer[1]-open_240_buffer[1]<=-0.0030 &&
             ...
             ((ma45_240_buffer[1]-ma45_240_buffer[2]>=0.0008 &&  ma90_240_buffer[1]-ma90_240_buffer[2]>=0.0002) ||
              ...
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-78*Point,Ask+2000*Point,"My order #B15",8815,0,FireBrick );
        ...
        //      close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k2_60_buffer[1]-d2_60_buffer[1]>=19  &&  k3_60_buffer[1]-d3_60_buffer[1]>=19) ||
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S1",4401,0,Green );
               ...
               if ((k2_240_buffer[1]<=53 && k3_240_buffer[1]<=53 &&   
                   ...
                   (k1_240_buffer[1]>=86 && k2_240_buffer[1]>=86  &&  k3_240_buffer[1]>=86)) 
                    return;
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S2",4402,0,White );
              ...
              (macdmainline_60_buffer[1]>=-0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]<=-0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]<=-0.0003 && 
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  //(m15-64) h4 [1]macd 負值<=-0.00050 [1]收盤為正值並>=25點,[2]macd 負值<=-0.00030 [2]收盤為正值並>=60點                                
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S3",4403,0,Lime );
              ...
              (macdmainline_60_buffer[1]>=-0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]<=-0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]<=-0.0003 && 
               ...
               if  ((k1_240_buffer[1]<=35 && k2_240_buffer[1]<=35 && k3_240_buffer[1]<=35) ||                   
                   ...
                   (k1_240_buffer[1]>=86 && k2_240_buffer[1]>=86  &&  k3_240_buffer[1]>=86)) 
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S4",4404,0,Gray );
               ...
               (macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                macdmainline_30_buffer[1]>=-0.00080 && macdmainline_30_buffer[1]<=0.00080) ||
                   ...
                   (k1_240_buffer[1]>=86 && k2_240_buffer[1]>=86  &&  k3_240_buffer[1]>=86)) 
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S5",4405,0,Aqua );
               ...
               (macdmainline_60_buffer[1]>=-0.00099 && macdmainline_60_buffer[1]<=0.00099 &&
                macdmainline_30_buffer[1]>=-0.00080 && macdmainline_30_buffer[1]<=0.00080) ||
                   ...
                   (k1_240_buffer[1]>=86 && k2_240_buffer[1]>=86  &&  k3_240_buffer[1]>=86)) 
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S6",4406,0,Teal );
           ...
           (close_240_buffer[1]-open_240_buffer[1]>=0.0001   && high_240_buffer[1]-close_240_buffer[1]>=0.0100)) &&
             ...
             macdmainline_240_buffer[1]<=-0.00450 && macdsignalline_240_buffer[1]<=-0.00050))  
               ...
               if    (k1_240_buffer[1]-d1_240_buffer[1]>=12 &&  (k2_240_buffer[1]-d2_240_buffer[1]>=5 || k3_240_buffer[1]-d3_240_buffer[1]>=5) &&
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S7",4407,0,Olive );
             ...
             ((close_240_buffer[2]-ma360_240_buffer[2]<=0.0005  && close_240_buffer[2]-ma360_240_buffer[2]>=-0.0020) ||
              ...
              (close_240_buffer[4]-ma360_240_buffer[4]<=0.0005  && close_240_buffer[4]-ma360_240_buffer[4]>=-0.0020))))
               ...
               if    (k1_240_buffer[1]-d1_240_buffer[1]>=12 &&  (k2_240_buffer[1]-d2_240_buffer[1]>=5 || k3_240_buffer[1]-d3_240_buffer[1]>=5) &&
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S8",4408,0,Olive );
             ...
             (((close_240_buffer[4]-open_240_buffer[4])+(close_240_buffer[3]-open_240_buffer[3])+ 
               ...
               if    ((k1_240_buffer[1]>=85 && k2_240_buffer[1]>=90  &&  k3_240_buffer[1]>=90) ||
                     ...
                     (k1_240_buffer[1]-d1_240_buffer[1]>=15 && k2_240_buffer[1]-d2_240_buffer[1]>=15 && k3_240_buffer[1]-d3_240_buffer[1]>=15) || 
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S9",4409,0,Olive );
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   SELL   10   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if   ((((close_60_buffer[1]-open_60_buffer[1]<=-0.0100 && close_60_buffer[1]-close_60_buffer[2]<=0.0001  &&
           ...
           (close_60_buffer[1]-open_60_buffer[1]<=-0.0030 && close_60_buffer[1]-close_60_buffer[2]<=0  &&
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S10",4410,0,Teal );
              ...
              (close_60_buffer[1]-open_60_buffer[1]<=-0.0015 && close_60_buffer[5]-open_60_buffer[5]<=-0.0007  && 
               ...
               if ((k2_240_buffer[1]<=53 && k3_240_buffer[1]<=53 &&   
                   ...
                   (k1_240_buffer[1]>=86 && k2_240_buffer[1]>=86  &&  k3_240_buffer[1]>=86)) 
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S11",4411,0,Teal );
  //+++++++++++++++++++++++++++++++++++++++++++   SELL   12   ++++++++++++++++++++++++++++++++++++++++++++++++++          
              ...
              if  ((k2_60_buffer[1]-d2_60_buffer[1]>=25  &&  k3_60_buffer[1]-d3_60_buffer[1]>=25) ||
                 ...
                 (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])>=0.00070) ||    
                   ...
                   (OrderType()==OP_SELL && TimeCurrent()-OrderCloseTime()<=2000))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S12",4412,0,ForestGreen );
              ...
              if  ((k2_60_buffer[1]-d2_60_buffer[1]>=25  &&  k3_60_buffer[1]-d3_60_buffer[1]>=25) ||
                 ...
                 (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])>=0.00070) ||    
                   ...
                   (OrderType()==OP_SELL && TimeCurrent()-OrderCloseTime()<=2000))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S13",4413,0,MidnightBlue );
        ...
        if    (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 &&
             ...
             ((k1_60_buffer[1]>=70 && k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70) || (ma180_60_buffer[1]-ma180_60_buffer[2]<=-0.0001 &&
               ...
               if   (ma45_240_buffer[1]-ma45_240_buffer[2]>=0.0011 && ma90_240_buffer[1]-ma90_240_buffer[2]>=0.0008 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+78*Point,Bid-2000*Point,"My order #S14",4414,0,DimGray );
...
//+++++++++++++++++++++++++++++++++++++++++++CLOSE   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++SHORT   BUY   1   ++++++++++++++++++++++++++++++++++++++++++++++++++          
    if (OrdersTotal()<=orderno)   
     {
                                 //(H1-01)  W 底或ma05 持平一段之後向下後  收紅  下買單
               //ma45,ma90,平或斜上   ma180斜上   
        if    (ma45_60_buffer[1]-ma45_60_buffer[2]>-0.0001 && ma90_60_buffer[1]-ma90_60_buffer[2]>-0.0001 &&
               ma180_60_buffer[1]-ma180_60_buffer[2]>0 &&    
               //ma45 ma90間距開口微上
              (ma90_60_buffer[1]-ma45_60_buffer[1])-(ma90_60_buffer[2]-ma45_60_buffer[2])>0 && 
                  // [1]為正或[1]下影大於20點          [2]為負  
              (close_60_buffer[1]-open_60_buffer[1]>=0.0001  ||
              (close_60_buffer[1]-open_60_buffer[1]<=-0.0001  && low_240_buffer[1]-close_240_buffer[1]<=-0.0020)) &&
               close_60_buffer[2]-open_60_buffer[2]<=-0.0001 &&
               //   [8],[9],[10],[11],[12],[13]的任一個收盤價在[1]收盤價之下  或  ma05[8]~~[13]在0.0006,-0.0006間          
             ((close_240_buffer[8]-close_240_buffer[1]<=-0.0001 || close_240_buffer[9]-close_240_buffer[1]<=-0.0001 ||
               close_240_buffer[10]-close_240_buffer[1]<=-0.0001 || close_240_buffer[11]-close_240_buffer[1]<=-0.0001 ||
               close_240_buffer[12]-close_240_buffer[1]<=-0.0001 || close_240_buffer[13]-close_240_buffer[1]<=-0.0001) ||
              (ma05_60_buffer[8]-ma05_60_buffer[13]>=-0.0006 && ma05_60_buffer[8]-ma05_60_buffer[13]<=0.0006)))                  
               buyorder01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+100*Point,"My order #SB01",801,0,Red );
       }
 //+++++++++++++++++++++++++++++++++++++++++++SHORT   SELL   1   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     if (OrdersTotal()<=orderno)   
      {
                                 //(H1-01)  M 頭或ma05 持平一段之後向上後  收黑  下賣單
               //ma45,ma90,平或斜下   ma180斜下   
        if    (ma45_60_buffer[1]-ma45_60_buffer[2]<0.0001 && ma90_60_buffer[1]-ma90_60_buffer[2]<0.0001 &&
               ma180_60_buffer[1]-ma180_60_buffer[2]<0 &&    
               //ma45 ma90間距開口微下
              (ma90_60_buffer[1]-ma45_60_buffer[1])-(ma90_60_buffer[2]-ma45_60_buffer[2])<0 && 
                  // [1]為負或[1]上影大於20點          [2]為正  
              (close_60_buffer[1]-open_60_buffer[1]<=-0.0001  ||
              (close_60_buffer[1]-open_60_buffer[1]>=0.0001  && high_60_buffer[1]-open_60_buffer[1]>=0.0020))  &&
               close_60_buffer[2]-open_60_buffer[2]>=0.0001 &&
               //   [8],[9],[10],[11],[12],[13]的任一個收盤價在[1]收盤價之上  或  ma05[8]~~[13]在0.0006,-0.0006間          
             ((close_240_buffer[8]-close_240_buffer[1]>=0.0001 || close_240_buffer[9]-close_240_buffer[1]>=0.0001 ||
               close_240_buffer[10]-close_240_buffer[1]>=0.0001 || close_240_buffer[11]-close_240_buffer[1]>=0.0001 ||
               close_240_buffer[12]-close_240_buffer[1]>=0.0001 || close_240_buffer[13]-close_240_buffer[1]>=0.0001) ||
              (ma05_60_buffer[8]-ma05_60_buffer[13]<=0.0006 && ma05_60_buffer[8]-ma05_60_buffer[13]>=-0.0006)))                  
               sellorder01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-100*Point,"My order #SS1",401,0,MediumSeaGreen );
...
//+++++++++++++++++++++++++++++++++++++++++++SHORT  CLOSE  buy  1   ++++++++++++++++++++++++++++++++++++++++++++++++++          
    ...
    if  (OrderType()==OP_SELL &&  (OrderTicket()==sellorder01 || OrderTicket()==sellorder02 ||
         OrderTicket()==sellorder03 || OrderTicket()==sellorder04 || OrderTicket()==sellorder05))
       {  
                        //(H1-01)  M 頭或ma05 持平一段之後向上後  收黑  下賣單
               //ma45,ma90,平或斜下   ma180斜下   
        if    (ma45_60_buffer[1]-ma45_60_buffer[2]<0.0001 && ma90_60_buffer[1]-ma90_60_buffer[2]<0.0001 &&
   ...
   if  (OrderType()==OP_BUY &&  (OrderTicket()==buyorder01 || OrderTicket()==buyorder02 ||
         OrderTicket()==buyorder03 || OrderTicket()==buyorder04 || OrderTicket()==buyorder05))
       {  
//+++++++++++++++++++++++++++++++++++++++++++SHORT  CLOSE  sell   1   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                          //(H1-01)  W 底或ma05 持平一段之後向下後  收紅  下買單
               //ma45,ma90,平或斜上   ma180斜上   
