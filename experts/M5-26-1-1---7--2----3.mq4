...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
     {              
                                     //[macd]-[signal]>=-0.0028 ma45 ma90 持平微向上 間隔<=0.0008  k1<=20 靠近<=0.00003 或超過buy
       if ((ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && 
                                  //ma45在ma90上須超過0.0015 ma45-ma90[1]要比 ma45-ma90[6]>=0.0001 才做賣單
           ma45_05_buffer[1]-ma90_05_buffer[1]>=0.0015 &&                                   
          (ma45_05_buffer[1]-ma90_05_buffer[1])-(ma45_05_buffer[6]-ma90_05_buffer[6])>=0.0001 &&             
 ...
 //*** Buy  2  ***************************************************************************************** 
       ...
       if ((ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]>=-0.0012 &&
           k1_15_buffer[1]<=40 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && k1_15_buffer[1]-d1_15_buffer[1]>=1 &&
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
                                     // [macd]-[signal]<=0.0028 ma45 ma90 持平微向下 間隔>=-0.0008  k1>=80 靠近>=-0.00003 或超過sell
       if ((ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
                                              //ma45在ma90下須超過0.0015 ma45-ma90[1]要比 ma45-ma90[6]<=-0.0001 才做賣單
           ma45_05_buffer[1]-ma90_05_buffer[1]<=-0.0015 &&                                   
           (ma45_05_buffer[1]-ma90_05_buffer[1])-(ma45_05_buffer[6]-ma90_05_buffer[6])<=-0.0001 &&             
 ...
 //***  sell 2  ********************************************************************************** 
                                ...
                                //已呈現反轉型態  不考慮其他離開條件
         if ((ma05_15_buffer[1]-ma12_15_buffer[1]>=0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]<=0.0012 &&
              k1_15_buffer[1]>=60 && k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00015) &&
              (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]<=-0.0003) ||
              (close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[1]-open_15_buffer[1]<=0))
            {
...
//***  CLOSE Buy    ********************************************************************************** 
 //***  CLOSE Buy    ********************************************************************************** 
      ...
      if  (OrderType()==OP_BUY)
       {  
                                                       // mma05 ma12 間距<=-0.0001 [1]<[2]  [2]<=0.0003 [1]收>=0 
          if (((ma05_05_buffer[1]-ma12_05_buffer[1])-(ma05_05_buffer[2]-ma12_05_buffer[2]) <=-0.0001 )&& 
              ...
              if (((ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]>=0.0001 &&
                  ma05_30_buffer[1]-ma05_30_buffer[2]>=0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=0.0001 )) ||
                                                           ...
                                                           //不結束以此條件所做成的買單 在此排除close 以免造成多筆連續的close單
                  ((ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]>=-0.0012 &&
                    k1_15_buffer[1]<=40 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && k1_15_buffer[1]-d1_15_buffer[1]>=1 &&
          ...
          if (((ma05_05_buffer[1]-ma12_05_buffer[1])-(ma05_05_buffer[2]-ma12_05_buffer[2]) >=0.0001)&& 
              ...
              if (((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                  ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-0.0001 )) ||
                                                      ...
                                                      //不結束以此條件所做成的賣單 在此排除close 以免造成多筆連續的close單
                 ((ma05_15_buffer[1]-ma12_15_buffer[1]>=0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]<=0.0012 &&
                  k1_15_buffer[1]>=60 && k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
                  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020) &&
                  (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]<=-0.0003) ||
