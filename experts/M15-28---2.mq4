...
//***  CLOSE Buy    ********************************************************************************** 
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    3     +++++++++++++++++++++
                                              ...
                                              //k1 Ω禴瞏 kd1碩ユ 
               (k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 &&
               ...
               if (TimeCurrent()-OrderCloseTime()<=0 && OrdersTotal()<=1)
...
//***  CLOSE Sell    ********************************************************************************** 
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    1     +++++++++++++++++++++
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    2     +++++++++++++++++++++
                                                   ...
                                                   //m15 ma45  ma90 弊L禴ソ狠篈 
              ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001) || 
               (ma90_15_buffer[1]-ma90_15_buffer[2]<=0 && ma180_15_buffer[1]-ma180_15_buffer[2]<=-0.0001) &&                                  //禴ソ狠ど璶Ωど筁玡3bar
              close_15_buffer[1]-close_15_buffer[2]>=0.0001  &&  close_15_buffer[1]-close_15_buffer[3]>=0.0001 &&
              close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
                                             //ノm15 m30 macd 北恨禦芥翴 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 &&
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    3     +++++++++++++++++++++
               ...
               (k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  &&
                                                   //m15 ma45  ma90 弊L禴ソ狠篈 
               (ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0) || 
               (ma90_15_buffer[1]-ma90_15_buffer[2]>=0 && ma180_15_buffer[1]-ma180_15_buffer[2]>=0) &&                                  //禴ソ狠ど璶Ωど筁玡3bar
                                            //ノm15 m30 macd 北恨禦芥翴 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 &&
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00050 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00010))
