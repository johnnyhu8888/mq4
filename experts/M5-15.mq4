...
//*** Buy  1  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     {              
     //    m5 ど臱墩い,Μ┪紇絬>10翴,kd郎,kd1ユ,k2┪k3ど  BUY

     if (((ma45_15_buffer[1]-ma45_15_buffer[2]>=0.00010 && ma45_05_buffer[1]-ma45_05_buffer[2]>=0.00010) ||
          (ma90_15_buffer[1]-ma90_15_buffer[2]>=0.00010 && ma90_05_buffer[1]-ma90_05_buffer[2]>=0.00010)) &&

          (close_05_buffer[1]-open_05_buffer[1]<=-0.00010 || (close_05_buffer[1]-open_05_buffer[1]>=-0.00010 && low_05_buffer[1]-close_05_buffer[1]>=0.00100 )) && 

         ((k1_05_buffer[1]-d1_05_buffer[1]>=1 &&  (k2_05_buffer[1]-d2_05_buffer[2]>=1 || k3_05_buffer[1]-d3_05_buffer[2]>=1) &&
           k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=40 && k3_05_buffer[1]<=40)  ||

          (k1_05_buffer[1]-d1_05_buffer[1]>=1 &&  
           k1_05_buffer[1]<=25 &&   k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) )) 

            shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+450*Point,"My order #1",8801,0,Yellow );
     }           
...
//*** Buy  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     {              
     //    m15 ど臱墩い,Μ┪紇絬>10翴,kd郎,kd1ユ,k2┪k3ど  BUY

     if (((ma45_30_buffer[1]-ma45_30_buffer[2]>=0.00010 && ma45_15_buffer[1]-ma45_15_buffer[2]>=0.00010) ||
          (ma90_30_buffer[1]-ma90_30_buffer[2]>=0.00010 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.00010)) &&

          (close_15_buffer[1]-open_15_buffer[1]<=-0.00010 || (close_15_buffer[1]-open_15_buffer[1]>=-0.00010 && low_15_buffer[1]-close_15_buffer[1]>=0.00100 )) && 

         ((k1_15_buffer[1]-d1_15_buffer[1]>=1 &&  (k2_15_buffer[1]-d2_15_buffer[2]>=1 || k3_15_buffer[1]-d3_15_buffer[2]>=1) &&
           k1_15_buffer[1]<=50 &&   k2_15_buffer[1]<=40 && k3_15_buffer[1]<=40)  ||

          (k1_15_buffer[1]-d1_15_buffer[1]>=1 &&  
           k1_15_buffer[1]<=25 &&   k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30) )) 

           shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+600*Point,"My order #2",8802,0,Yellow );
     }           
//*** Buy  3  ***************************************************************************************** 
                                                                          
   if (OrdersTotal()<=1)   
     {              
     //    m30 ど臱墩い,Μ┪紇絬>10翴,kd郎,kd1ユ,k2┪k3ど  BUY

     if (((ma45_60_buffer[1]-ma45_60_buffer[2]>=0.00010 && ma45_30_buffer[1]-ma45_30_buffer[2]>=0.00010) ||
          (ma90_60_buffer[1]-ma90_60_buffer[2]>=0.00010 && ma90_30_buffer[1]-ma90_30_buffer[2]>=0.00010)) &&

          (close_30_buffer[1]-open_30_buffer[1]<=-0.00010 || (close_30_buffer[1]-open_30_buffer[1]>=-0.00010 && low_30_buffer[1]-close_30_buffer[1]>=0.00100 )) && 

         ((k1_30_buffer[1]-d1_30_buffer[1]>=1 &&  (k2_30_buffer[1]-d2_30_buffer[2]>=1 || k3_30_buffer[1]-d3_30_buffer[2]>=1) &&
           k1_30_buffer[1]<=50 &&   k2_30_buffer[1]<=40 && k3_30_buffer[1]<=40)  ||

          (k1_30_buffer[1]-d1_30_buffer[1]>=1 &&  
           k1_30_buffer[1]<=25 &&   k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30) )) 

           shortbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-250*Point,Ask+750*Point,"My order #3",8803,0,Yellow );
     }           
//*** Buy  4  ***************************************************************************************** 
   ...
   if   (((ma45_240_buffer[1]-ma45_240_buffer[2]>=0.00010 && ma45_60_buffer[1]-ma45_60_buffer[2]>=0.00010) ||
          (ma90_240_buffer[1]-ma90_240_buffer[2]>=0.00010 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.00010)) &&

          (close_60_buffer[1]-open_60_buffer[1]<=-0.00010 || (close_60_buffer[1]-open_60_buffer[1]>=-0.00010 && low_60_buffer[1]-close_60_buffer[1]>=0.00100 )) && 

         ((k1_60_buffer[1]-d1_60_buffer[1]>=1 &&  (k2_60_buffer[1]-d2_60_buffer[2]>=1 || k3_60_buffer[1]-d3_60_buffer[2]>=1) &&
           k1_60_buffer[1]<=50 &&   k2_60_buffer[1]<=40 && k3_60_buffer[1]<=40)  ||

          (k1_60_buffer[1]-d1_60_buffer[1]>=1 &&  
           k1_60_buffer[1]<=25 &&   k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) )) 

           shortbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+900*Point,"My order #4",8804,0,Yellow );
     }           
//*** Sell  1  ********************************************************************************************************************** 
           
    if (OrdersTotal()<=1)   
     {              
      // m5臱墩い,どΜ堵┪紇絬>10翴,kd蔼郎,kd1ユ,k2┪k3禴    SELL
        ...
        if (((ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.00010 && ma45_05_buffer[1]-ma45_05_buffer[2]<=-0.00010) ||
            ...
            ((k1_05_buffer[1]-d1_05_buffer[1]<=-1 &&  (k2_05_buffer[1]-d2_05_buffer[2]<=-1 || k3_05_buffer[1]-d3_05_buffer[2]<=-1) &&
              k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=60 && k3_05_buffer[1]>=60)  ||

             (k1_05_buffer[1]-d1_05_buffer[1]<=-1 &&  
              k1_05_buffer[1]>=75 &&   k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) )) 
       
              shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-450*Point,"My order #S1",4401,0,Green);
     }        
//*** Sell  2  ********************************************************************************************************************** 
           
    if (OrdersTotal()<=1)   
     {              
      // m15臱墩い,どΜ堵┪紇絬>10翴,kd蔼郎,kd1ユ,k2┪k3禴    SELL
        ...
        if (((ma45_30_buffer[1]-ma45_30_buffer[2]<=-0.00010 && ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.00010) ||
            ...
            ((k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&  (k2_15_buffer[1]-d2_15_buffer[2]<=-1 || k3_15_buffer[1]-d3_15_buffer[2]<=-1) &&
              k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=60 && k3_15_buffer[1]>=60)  ||

             (k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&  
              k1_15_buffer[1]>=75 &&   k2_15_buffer[1]>=70 && k3_15_buffer[1]>=70) )) 
         
              shortsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-600*Point,"My order #S2",4402,0,Green);
     }        
//*** Sell  3  ********************************************************************************************************************** 
           
    if (OrdersTotal()<=1)   
     {              
      // m30臱墩い,どΜ堵┪紇絬>10翴,kd蔼郎,kd1ユ,k2┪k3禴    SELL
        ...
        if (((ma45_60_buffer[1]-ma45_60_buffer[2]<=-0.00010 && ma45_30_buffer[1]-ma45_30_buffer[2]<=-0.00010) ||
            ...
            ((k1_30_buffer[1]-d1_30_buffer[1]<=-1 &&  (k2_30_buffer[1]-d2_30_buffer[2]<=-1 || k3_30_buffer[1]-d3_30_buffer[2]<=-1) &&
              k1_30_buffer[1]>=50 &&   k2_30_buffer[1]>=60 && k3_30_buffer[1]>=60)  ||

             (k1_30_buffer[1]-d1_30_buffer[1]<=-1 &&  
              k1_30_buffer[1]>=75 &&   k2_30_buffer[1]>=70 && k3_30_buffer[1]>=70) )) 
        
              shortsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-750*Point,"My order #S3",4403,0,Green);
     }        
...
//*** Sell  4  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
      // m60臱墩い,どΜ堵┪紇絬>10翴,kd蔼郎,kd1ユ,k2┪k3禴    SELL
      ...
      if   (((ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00010 && ma45_60_buffer[1]-ma45_60_buffer[2]<=-0.00010) ||
            ...
            ((k1_60_buffer[1]-d1_60_buffer[1]<=-1 &&  (k2_60_buffer[1]-d2_60_buffer[2]<=-1 || k3_60_buffer[1]-d3_60_buffer[2]<=-1) &&
              k1_60_buffer[1]>=50 &&   k2_60_buffer[1]>=60 && k3_60_buffer[1]>=60)  ||

             (k1_60_buffer[1]-d1_60_buffer[1]<=-1 &&  
              k1_60_buffer[1]>=75 &&   k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70) )) 
         
              shortsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-900*Point,"My order #S4",4404,0,Green);
     }        
