...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
       ...
       if ((ma05_05_buffer[1]-ma12_05_buffer[1]<=0 && ma05_05_buffer[1]-ma12_05_buffer[1]>=-0.0013 &&
         ...
         if  ((TimeCurrent()-OrderOpenTime()<=4000  && close_05_buffer[1]-open_05_buffer[1]>=0.0005) ||
      
             (TimeCurrent()-OrderOpenTime()<=1500  && close_05_buffer[1]-open_05_buffer[1]>=0.0005 && close_05_buffer[2]-open_05_buffer[2]>=0.0005 )  ||
              
                                                                               //時間區間必須用  ||   不可用 &&                                                                //時間區間必須用  ||   不可用 && 
             (TimeCurrent()-OrderOpenTime()>=1900 || TimeCurrent()-OrderOpenTime()<=4000  &&
