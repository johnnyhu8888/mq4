...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
   {              
                                           ...
                                           //  FOR BUY  ma90  キ稬 籔ma180丁筳<=0.0010  k1k2k3<=30 綼<=0.00006 ┪禬筁 [macd]-[signal]>=-0.00028
             if (ma90_05_buffer[1]-ma90_05_buffer[6]>=0 && 
                 ma90_05_buffer[1]-ma90_05_buffer[40]>=0 && ma90_05_buffer[1]-ma90_05_buffer[40]<=0.0015 &&
                 ma90_05_buffer[1]-ma180_05_buffer[1]<=0.0010 &&
                 close_05_buffer[1]-ma90_05_buffer[1]<=0.0006 && close_05_buffer[1]-open_05_buffer[1]<=-0.0003 &&
              ...
              { 
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+200*Point,"My order #B2",8802,0,Yellow );
                                           ...
                                           //  FOR BUY  ma180  キ稬 籔ma360丁筳<=0.0040  k1k2k3<=30 綼<=0.00006 ┪禬筁 [macd]-[signal]>=-0.00028
             if (ma180_05_buffer[1]-ma180_05_buffer[6]>=0 && 
                 ma180_05_buffer[1]-ma180_05_buffer[40]>=0 && ma180_05_buffer[1]-ma180_05_buffer[40]<=0.0015 &&
                 ma180_05_buffer[1]-ma360_05_buffer[1]<=0.0040 &&
                 close_05_buffer[1]-ma180_05_buffer[1]<=0.0006 &&  close_05_buffer[1]-open_05_buffer[1]<=-0.0003 &&
                 k1_05_buffer[1]<=30 && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30 && 
                 macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00028) 
              { 
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+200*Point,"My order #B3",8803,0,Blue );
              } 
       
                                       // m15 or m30k2k3>=65 耞よΑ  m15 m30 kd2 kd3┕秨 ぃ禦
            if  ((k2_15_buffer[1]>=35 && k3_15_buffer[1]>=35) || (k2_30_buffer[1]>=35 && k3_30_buffer[1]>=35) &&
                  k2_15_buffer[1]-d2_15_buffer[1]<=-5 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-5 &&
                  k2_30_buffer[1]-d2_30_buffer[1]<=-5 &&  k3_30_buffer[1]-d3_30_buffer[1]<=-5)
             {    
                 ...
                 if (k1_15_buffer[0]-k1_15_buffer[1]<=-1 && k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=-1 &&
                  ...
                  {
                      OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+200*Point,"My order #B4",8804,0,Brown );
                  }
             }    
            ...
            if ((k2_15_buffer[1]<=35 && k3_15_buffer[1]<=35) || (k2_30_buffer[1]<=35 && k3_30_buffer[1]<=35) &&
             ...
             {
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+200*Point,"My order #B5",8805,0,Purple );
             }  
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
                                             ...
                                             //  FOR SELL  ma45  キ稬 籔ma45丁筳>=-0.0008  k1k2k3>=70 綼>=-0.00003 ┪禬筁 [macd]-[signal]<=0.00028
               if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&
                   ...
                   close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && close_05_buffer[1]-open_05_buffer[1]>=0.0003 &&
                ...
                { 
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-200*Point,"My order #S1",4401,0,Green );
                    ...
                    //  FOR SELL  ma90  キ稬 籔ma180丁筳>=-0.0010  k1k2k3>=70 綼>=-0.00006 ┪禬筁 [macd]-[signal]>=0.00028
               if (ma90_05_buffer[1]-ma90_05_buffer[6]<=0 && 
                   ma90_05_buffer[1]-ma90_05_buffer[40]<=0 && ma90_05_buffer[1]-ma90_05_buffer[40]>=-0.0015 &&
                   ma90_05_buffer[1]-ma180_05_buffer[1]>=-0.0010 &&
                   close_05_buffer[1]-ma180_05_buffer[1]>=-0.0006 && close_05_buffer[1]-open_05_buffer[1]>=0.0003 &&
                   ...
                   macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00028) 
                { 
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-200*Point,"My order #S2",4402,0,White );
                } 
           
                                             //  FOR SELL  ma180  キ稬 籔ma360丁筳>=-0.0040  k1k2k3>=70 綼>=-0.00006 ┪禬筁 [macd]-[signal]<=0.00028
               if (ma180_05_buffer[1]-ma180_05_buffer[6]<=0 && 
                   ma180_05_buffer[1]-ma180_05_buffer[40]<=0 && ma180_05_buffer[1]-ma180_05_buffer[40]>=-0.0015 &&
                   ma180_05_buffer[1]-ma360_05_buffer[1]>=-0.0040 &&
                   close_05_buffer[1]-ma180_05_buffer[1]>=-0.0006 &&  close_05_buffer[1]-open_05_buffer[1]>=0.0003 &&
                   ...
                   macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00028) 
                { 
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-200*Point,"My order #S3",4403,0,Lime );
                } 
               ...
               if  ((k2_15_buffer[1]>=35 && k3_15_buffer[1]>=35) || (k2_30_buffer[1]>=35 && k3_30_buffer[1]>=35) &&
                ...
                {    
                    ...
                    if (k1_15_buffer[0]-k1_15_buffer[1]<=-1 && k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=-1 &&
                     ...
                     { 
                          OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-200*Point,"My order #S4",4404,0,Gray );
                     } 
                }
                                    // m15 or m30k2k3<=35 耞よΑ     m15m30 ma05 ma08 ma12 
               if ((k2_15_buffer[1]<=35 && k3_15_buffer[1]<=35) || (k2_30_buffer[1]<=35 && k3_30_buffer[1]<=35) &&
                ...
                { 
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-200*Point,"My order #S5",4405,0,Aqua );
                } 
 ...
 //***  CLOSE Buy    ********************************************************************************** 
   ...
   if  (OrderType()==OP_BUY)
       {  
           ...
           {
               if (close_15_buffer[1]-open_05_buffer[1]>=0.0003 && close_15_buffer[2]-open_05_buffer[2]<=-0.0003)
           ...
           {    
               ...
               if ((k2_15_buffer[1]<=35 && k3_15_buffer[1]<=35) || (k2_30_buffer[1]<=35 && k3_30_buffer[1]<=35) &&
                   ...
                   return;
                                          ...
                                          //  FOR BUY  ma45  キ稬 籔ma90丁筳<=0.0008  k1k2k3<=30 綼<=0.00003 ┪禬筁 [macd]-[signal]>=-0.00028
             if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && 
                 ma45_05_buffer[1]-ma45_05_buffer[40]>=0 && ma45_05_buffer[1]-ma45_05_buffer[40]<=0.0015 &&
                 ma45_05_buffer[1]-ma90_05_buffer[1]<=0.0008 &&
                 close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 &&  close_05_buffer[1]-open_05_buffer[1]<=-0.0003 &&
                 ...
                 macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00028) 
              { 
                  OrderClose(OrderTicket(),lots,Ask,1,Green); 
              } 
            ...
            if ((k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 &&  k1_30_buffer[1]-k1_30_buffer[2]>=1) ||
...

             {
                 if (close_15_buffer[1]-open_05_buffer[1]<=-0.0003 && close_15_buffer[2]-open_05_buffer[2]>=0.0003 )
                    ...
                    OrderClose(OrderTicket(),lots,Ask,1,Gray); 
