...
//trade=1;
 ...
 //*** long Buy  1  ***************************************************************************************** 
                    //⊿虫┪Τㄢ眎祏虫虫
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
 ...
 {  
     if  ((k1_15_buffer[1]<=50 &&   k2_15_buffer[1]<=50 && k3_15_buffer[1]<=50 && 
           d1_15_buffer[1]<=50 &&   d2_15_buffer[1]<=50 && d3_15_buffer[1]<=50) && 
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]>=0) ||
          ...
          (k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0))) 
           if    (k1_05_buffer[1]-d1_05_buffer[1]>=3  && k1_05_buffer[1]<=40)                               
           ...
           if    (((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.00010 && ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.00010 && close_15_buffer[1]-ma05_15_buffer[1]<=-0.00010) ||	
                  ...
                  ((ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]<=-0.00010 && close_30_buffer[1]-ma05_30_buffer[1]<=-0.00010) ||	
                   (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0))) 	
                    ...
                    longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2500*Point,"My order #LB1",8801,0,Yellow );
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
       longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
       longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
       longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
       longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
 ...
 {      
     if  ((k1_30_buffer[1]<=45 &&   k2_30_buffer[1]<=45 && k3_30_buffer[1]<=45 && 
           d1_30_buffer[1]<=45 &&   d2_30_buffer[1]<=45 && d3_30_buffer[1]<=45) && 
           ...
           if       (((ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]<=-0.00010 && close_30_buffer[1]-ma05_30_buffer[1]<=-0.00010) ||	
                     ...
                     ((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
                      (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0))) 	
                       ...
                       longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2800*Point,"My order #LB2",8802,0,Yellow );
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy04==OrderTicket() ||
       longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
       longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
       longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
       longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
 ...
 {         
     if  ((k1_60_buffer[1]<=30 &&   k2_60_buffer[1]<=25 && k3_60_buffer[1]<=25 && 
           d1_60_buffer[1]<=30 &&   d2_60_buffer[1]<=25 && d3_60_buffer[1]<=25) && 
         ...
         ((d3_60_buffer[1]-d3_60_buffer[2]>=0) ||
          ...
          (k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0))) 
           if    (k1_15_buffer[1]-d1_15_buffer[1]>=3  && k1_15_buffer[1]<=40)                               
           ...
           if       (((ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.00010 && ma05_60_buffer[1]-ma12_60_buffer[1]<=-0.00010 && close_60_buffer[1]-ma05_60_buffer[1]<=-0.00010) ||	
                     ...
                     ((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
                      ...
                      (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0 && 
                       ...
                       longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+3000*Point,"My order #LB3",8803,0,Yellow );
     }
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() ||
       longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
       longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
       longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
       longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
 ...
 {      
     if  ((k1_240_buffer[1]<=25 &&   k2_240_buffer[1]<=25 && k3_240_buffer[1]<=25 && 
         ...
         ((d3_240_buffer[1]-d3_240_buffer[2]>=0) ||
          ...
          (k2_240_buffer[1]-k2_240_buffer[2]>=0 && k3_240_buffer[1]-k3_240_buffer[2]>=0))) 
           if    (k1_30_buffer[1]-d1_30_buffer[1]>=3 && k1_30_buffer[1]<=40)                               

                    //Τ2眎buy4虫,ぃ禦             
 //              if   ((OrdersTotal()<=1 && longbuy04==OrderTicket()) || 
            ...
            if      (((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
                      ...
                      (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0 && 
                       ...
                       longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #LB4",8804,0,Yellow );
   } 
 //*** long Sell  1  ********************************************************************************************************************** 
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
       longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
       longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
       longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
       longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
       ...
       longsell02==OrderTicket() || longsell03==OrderTicket() || longsell04==OrderTicket() ||
       longsell05==OrderTicket() || longsell06==OrderTicket() || longsell07==OrderTicket() || longsell08==OrderTicket() ||
       longsell09==OrderTicket() || longsell10==OrderTicket() || longsell11==OrderTicket() || longsell12==OrderTicket() ||
       longsell13==OrderTicket() || longsell14==OrderTicket() || longsell15==OrderTicket() || longsell16==OrderTicket() ||
       longsell17==OrderTicket() || longsell18==OrderTicket() || longsell19==OrderTicket() || longsell20==OrderTicket() ||
 ...
 {      
    if  ((k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50 && 
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]<=0) ||
          (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0) || 
          (k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0))) 
          if    (k1_05_buffer[1]-d1_05_buffer[1]<=-3 && k1_05_buffer[1]>=60)                               
           ...
           if     (((ma05_15_buffer[1]-ma05_15_buffer[2]>=0.00010 && ma05_15_buffer[1]-ma12_15_buffer[1]>=0.00010 && close_15_buffer[1]-ma05_15_buffer[1]>=0.00010) ||
                   ...
                   ((ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]>=0.00010 && close_30_buffer[1]-ma05_30_buffer[1]>=0.00010) ||
                    (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0)))
                     ...
                     longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2500*Point,"My order #LS1",4401,0,Green);
    }
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       longsell01==OrderTicket() || longsell03==OrderTicket() || longsell04==OrderTicket() ||
       longsell05==OrderTicket() || longsell06==OrderTicket() || longsell07==OrderTicket() || longsell08==OrderTicket() ||
       longsell09==OrderTicket() || longsell10==OrderTicket() || longsell11==OrderTicket() || longsell12==OrderTicket() ||
       longsell13==OrderTicket() || longsell14==OrderTicket() || longsell15==OrderTicket() || longsell16==OrderTicket() ||
       longsell17==OrderTicket() || longsell18==OrderTicket() || longsell19==OrderTicket() || longsell20==OrderTicket() ||
 ...
 { 
     if  ((k1_30_buffer[1]>=55 &&   k2_30_buffer[1]>=55 && k3_30_buffer[1]>=55 && 
           d1_30_buffer[1]>=55 &&   d2_30_buffer[1]>=55 && d3_30_buffer[1]>=55) && 
           ...
           if     (((ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]>=0.00010 && close_30_buffer[1]-ma05_30_buffer[1]>=0.00010) ||
                   ...
                   ((ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00010 && ma05_60_buffer[1]-ma12_60_buffer[1]>=0.00010 && close_60_buffer[1]-ma05_60_buffer[1]>=0.00010) ||
                    (k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0)))
                     ...
                     longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2800*Point,"My order #LS2",4402,0,Green);
   }
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       longsell01==OrderTicket() || longsell02==OrderTicket() || longsell04==OrderTicket() ||
       longsell05==OrderTicket() || longsell06==OrderTicket() || longsell07==OrderTicket() || longsell08==OrderTicket() ||
       longsell09==OrderTicket() || longsell10==OrderTicket() || longsell11==OrderTicket() || longsell12==OrderTicket() ||
       longsell13==OrderTicket() || longsell14==OrderTicket() || longsell15==OrderTicket() || longsell16==OrderTicket() ||
       longsell17==OrderTicket() || longsell18==OrderTicket() || longsell19==OrderTicket() || longsell20==OrderTicket() ||
 ...
 { 
     if  ((k1_60_buffer[1]>=70 &&   k2_60_buffer[1]>=75 && k3_60_buffer[1]>=75 && 
           d1_60_buffer[1]>=70 &&   d2_60_buffer[1]>=75 && d3_60_buffer[1]>=75) && 
           
         ((d3_60_buffer[1]-d3_60_buffer[2]<=0) ||
          (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0) || 
          (k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0))) 
           if    (k1_15_buffer[1]-d1_15_buffer[1]<=-3 && k1_15_buffer[1]>=60 )                               
           ...
           if     (((ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00010 && ma05_60_buffer[1]-ma12_60_buffer[1]>=0.00010 && close_60_buffer[1]-ma05_60_buffer[1]>=0.00010) ||
                   ...
                   ((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||
                    ...
                    (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0 && 
                     ...
                     longsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-3000*Point,"My order #LS3",4403,0,Green);
    }    
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       longsell01==OrderTicket() || longsell02==OrderTicket() || longsell03==OrderTicket() ||
       longsell05==OrderTicket() || longsell06==OrderTicket() || longsell07==OrderTicket() || longsell08==OrderTicket() ||
       longsell09==OrderTicket() || longsell10==OrderTicket() || longsell11==OrderTicket() || longsell12==OrderTicket() ||
       longsell13==OrderTicket() || longsell14==OrderTicket() || longsell15==OrderTicket() || longsell16==OrderTicket() ||
       longsell17==OrderTicket() || longsell18==OrderTicket() || longsell19==OrderTicket() || longsell20==OrderTicket() ||
 ...
 {           
     if  ((k1_240_buffer[1]>=75 &&   k2_240_buffer[1]>=75 && k3_240_buffer[1]>=75 && 
           d1_240_buffer[1]>=75 &&   d2_240_buffer[1]>=75 && d3_240_buffer[1]>=75) && 
           
         ((d3_240_buffer[1]-d3_240_buffer[2]<=0) ||
          (k1_240_buffer[1]-k1_240_buffer[2]<=0 && k2_240_buffer[1]-k2_240_buffer[2]<=0) || 
          (k2_240_buffer[1]-k2_240_buffer[2]<=0 && k3_240_buffer[1]-k3_240_buffer[2]<=0))) 
          if    (k1_30_buffer[1]-d1_30_buffer[1]<=-3 && k1_30_buffer[1]>=60 )                               
   
        
                    //Τ2眎sell4虫,ぃ芥             
//            if   ((OrdersTotal()<=1 && longsell04==OrderTicket()) ||          
           ...
           if     (((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||
                    ...
                    (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0 && 
                     ...
                     longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-5000*Point,"My order #LS4",4404,0,Green);
   }        
  }
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  SELL   ++++++++++++++++++++++++++++++++++++++++++++++++++          
...
if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       shortbuy04==OrderTicket() || shortbuy05==OrderTicket() ||shortbuy06==OrderTicket() ||
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
...
//                     (k2_15_buffer[1]-d2_15_buffer[1]<=-15 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-15)) ||	
 ...
 if    (OrdersTotal()<1 || (OrdersTotal()<=5 && (shortbuy01==OrderTicket() ||shortbuy03==OrderTicket() ||
       shortbuy04==OrderTicket() || shortbuy05==OrderTicket() ||shortbuy06==OrderTicket() ||
       shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket() ||
       longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
  ...
  { 
     ...
     if  ((k1_05_buffer[1]>=75 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75 && 
           d1_05_buffer[1]>=75 &&   d2_05_buffer[1]>=75 && d3_05_buffer[1]>=75) && 
         ((d3_05_buffer[1]-d3_05_buffer[2]<=0) ||
          (k1_05_buffer[1]-k1_05_buffer[2]<=0 && k2_05_buffer[1]-k2_05_buffer[2]<=0) || 
          (k2_05_buffer[1]-k2_05_buffer[2]<=0 && k3_05_buffer[1]-k3_05_buffer[2]<=0)) || 
...
//         if (OrderType()==OP_BUY && shortsell01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00120 && high_05_buffer[0]-OrderOpenPrice()<=0.00130) 
//                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+60*Point,OrderTakeProfit(),0,Blue);
//         if   (OrderType()==OP_SELL && shortsell01==OrderTicket() &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00120 && low_05_buffer[0]-OrderOpenPrice()>=-0.00130)
