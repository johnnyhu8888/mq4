...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0) ||
               (ma90_15_buffer[1]-ma90_15_buffer[2]>=0 && ma180_15_buffer[1]-ma180_15_buffer[2]>=0 &&
                                                 //加此條調控ma45往下的狀態
                macdsignalline_15_buffer[1]-macdsignalline_15_buffer[2]>=0.00001) &&                             
                                                    //用m15 m30 macd 控管買賣點 
                macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 && 
                macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00050 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00010 &&
...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                               //   ma45 ma90 或 ma90 ma180 上升狀態   k1 一次上升大 kd1大幅交叉上 
         if   ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  && //k1_15_buffer[1]<=62 &&
                                                   //m15 的ma45  ma90 為斜L下跌末端型態 
               (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0) || 
               (ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && ma180_15_buffer[1]-ma180_15_buffer[2]>=0 &&
                                           //加此條調控ma45往下的狀態
                macdsignalline_15_buffer[1]-macdsignalline_15_buffer[2]>=0.00001) &&                                  //下跌末端上升要一次升過前3bar
                                            //用m15 m30 macd 控管買賣點 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 &&
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00050 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00010))
              if (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]>=0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 &&
                ...
                k1_15_buffer[1]<=18 && k2_15_buffer[1]<=18  &&  k3_15_buffer[1]<=18 && 
                                        //價位在ma180,ma360之間 ma08,ma12在ma180上方
                close_15_buffer[1]-ma180_15_buffer[1]<=-0.0001 && close_15_buffer[1]-ma360_15_buffer[1]>=0.0001 && 
                ma180_15_buffer[1]-ma08_15_buffer[1]<=-0.0001 &&  ma180_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 &&
               ...
               (ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0020 &&
                ...
                (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00120 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020) &&
                                            //k1,k2,k3 <=18
                k1_15_buffer[1]<=18 && k2_15_buffer[1]<=18  &&  k3_15_buffer[1]<=18 && 
                                       //價位在ma360,ma650之間 ma08,ma12在ma360上方
                close_15_buffer[1]-ma360_15_buffer[1]<=-0.0001 && close_15_buffer[1]-ma650_15_buffer[1]>=0.0001 && 
                ma360_15_buffer[1]-ma08_15_buffer[1]<=-0.0001 &&  ma360_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 &&
               ...
               (ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0040 &&
                ...
                if (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                   ...
                   (k1_15_buffer[1]<=8 && k2_15_buffer[1]<=8 &&  k3_15_buffer[1]<=8))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+450*Point,"My order #B4",8804,0,Brown );
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0024) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && low_15_buffer[1]-open_15_buffer[1]<=-0.0024) &&
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                   macdsignalline_30_buffer[1]>=-0.00060 && macdsignalline_30_buffer[1]<=0.00060))
                   return;
                   else                               
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+450*Point,"My order #B5",8805,0,Purple );
             ...
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && low_15_buffer[1]-open_15_buffer[1]>=0.0040) &&
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
                 ...
                 (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+450*Point,"My order #B6",8806,0,Gold );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if    (close_30_buffer[1]-open_30_buffer[1]>=0.0010 && ma05_30_buffer[1]-ma12_30_buffer[1]>=-0.0012 && 
             ...
             (macdsignalline_30_buffer[1]-macdsignalline_30_buffer[2])-(macdsignalline_30_buffer[2]-macdsignalline_30_buffer[3])>=0.00002  && 
              ...
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+450*Point,"My order #B7",8807,0,OrangeRed );
       ...
       if   (ma45_15_buffer[1]-ma90_15_buffer[1]>=0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]>=0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0005 && 
            ...
            (k2_15_buffer[1]-k2_15_buffer[2]>=0  ||  k3_15_buffer[1]-k3_15_buffer[2]>=0)) 
             if (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                 ...
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+450*Point,"My order #B8",8808,0,Tomato );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                               // ma45 ma90 或 ma90 ma180 下跌狀態   k1 一次下跌深 kd1大幅交叉下 
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 && //k1_15_buffer[1]>=38 &&
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]<=-0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0020 &&
                ...
                k1_15_buffer[1]>=82 && k2_15_buffer[1]>=82  &&  k3_15_buffer[1]>=82 &&
                                        //價位在ma180,ma360之間 ma08,ma12在ma180下方
                close_15_buffer[1]-ma180_15_buffer[1]>=0.0001 && close_15_buffer[1]-ma360_15_buffer[1]<=-0.0001 && 
                ma180_15_buffer[1]-ma08_15_buffer[1]>=0.0001 &&  ma180_15_buffer[1]-ma12_15_buffer[1]>=0.0001 &&
                                        //[1]收紅 且>=0.0006  [1]>= ma180,ma360,ma650 0.0006 
                close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[1]-ma180_15_buffer[1]>=0.0006) ||
               ...
               (ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0020 && ma650_15_buffer[1]-ma650_15_buffer[40]<=-0.0020 &&
                ...
                (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00120 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020) &&
                                            //k1,k2,k3 >=82
                k1_15_buffer[1]>=82 && k2_15_buffer[1]>=82  &&  k3_15_buffer[1]>=82 && 
                                        //價位在ma360,ma650之間 ma08,ma12在ma360下方
                close_15_buffer[1]-ma360_15_buffer[1]>=0.0001 && close_15_buffer[1]-ma650_15_buffer[1]<=-0.0001 && 
                ma360_15_buffer[1]-ma08_15_buffer[1]>=0.0001 &&  ma360_15_buffer[1]-ma12_15_buffer[1]>=0.0001 &&
        ...
        //        (ma45_15_buffer[1]-ma45_15_buffer[6]>=-0.0013 && ma90_15_buffer[1]-ma90_15_buffer[6]>=-0.0013) || 
               ...
               if (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                  ...
                  (k1_15_buffer[1]>=92 && k2_15_buffer[1]>=92 &&  k3_15_buffer[1]>=92))
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-450*Point,"My order #S4",4404,0,Gray );
          ...
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001   && high_15_buffer[1]-close_15_buffer[1]>=0.0024) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
               ...
               OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-450*Point,"My order #S5",4405,0,Aqua );
          ...
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && high_15_buffer[1]-close_15_buffer[1]>=0.0040) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
               ...
               OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-450*Point,"My order #S6",4406,0,Teal );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if    (close_30_buffer[1]-open_30_buffer[1]<=-0.0010 && ma05_30_buffer[1]-ma12_30_buffer[1]<=0.0012 && 
             ...
             (k2_30_buffer[1]-k2_30_buffer[2]<=0 && k3_30_buffer[1]-k3_30_buffer[2]<=0))                                           
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-450*Point,"My order #S7",4407,0,Olive );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if  (ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]<=-0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0005 && 
           ...
           if  (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                ...
                OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-450*Point,"My order #S8",4408,0,SeaGreen );
...
//+++++++++++++++++++++++++++++++++++++++++++CLOSE   BUY   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                         //11000秒內  買單後最高價<50點
          if  (TimeCurrent()-OrderOpenTime()<=11000  &&  high_15_buffer[1]-OrderOpenPrice()<=0.0050 &&
                                         //ma45,ma90,ma180 斜下
               ma45_15_buffer[1]-ma45_15_buffer[6]<=-0.0001 &&  ma90_15_buffer[1]-ma90_15_buffer[6]<=-0.0001 &&
               ma180_15_buffer[1]-ma180_15_buffer[6]<=-0.0001 &&
                                        //bar [1]或[2]有一收黑超過6點 [1]或[2]有一收平黑
               (close_15_buffer[1]-open_15_buffer[1]<=-0.0006 && close_15_buffer[2]-open_15_buffer[2]<=0) ||
               (close_15_buffer[1]-open_15_buffer[1]<=0 && close_15_buffer[2]-open_15_buffer[2]<=-0.0006) ||
                                          //[1]收黑有上影線 高點到收盤超過30點
               (close_15_buffer[1]-open_15_buffer[1]<=-0.0006 && high_15_buffer[2]-close_15_buffer[2]<=-0.0030)) 
...
//+++++++++++++++++++++++++++++++++++++++++++CLOSE   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++CLOSE   SELL   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                         //11000秒內  賣單後最低價>50點
          if  (TimeCurrent()-OrderOpenTime()<=11000  &&  low_15_buffer[1]-OrderOpenPrice()>=-0.0050 &&
                                         //ma45,ma90,ma180 斜上
               ma45_15_buffer[1]-ma45_15_buffer[6]>=0.0001 &&  ma90_15_buffer[1]-ma90_15_buffer[6]>=0.0001 &&
               ma180_15_buffer[1]-ma180_15_buffer[6]>=0.0001 &&
                                        //bar [1]或[2]有一收紅超過6點 [1]或[2]有一收平紅
               (close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[2]-open_15_buffer[2]>=0) ||
               (close_15_buffer[1]-open_15_buffer[1]>=0 && close_15_buffer[2]-open_15_buffer[2]>=0.0006) ||
                                          //[1]收黑有下影線 低點到收盤超過30點
               (close_15_buffer[1]-open_15_buffer[1]>=0.0006 && low_15_buffer[2]-close_15_buffer[2]>=0.0030)) 
...
//***  Ordermodify   ********************************************************************************** 
        ...
        if (OrderType()==OP_BUY && high_15_buffer[0]-OrderOpenPrice()>=0.0201)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-37*Point,OrderTakeProfit(),0,Blue);
       
        if (OrderType()==OP_BUY && high_15_buffer[0]-OrderOpenPrice()>=0.0101  && high_15_buffer[0]-OrderOpenPrice()<=0.0200)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-42*Point,OrderTakeProfit(),0,Blue);
                  
        if (OrderType()==OP_BUY && high_15_buffer[0]-OrderOpenPrice()>=0.0010  && high_15_buffer[0]-OrderOpenPrice()<=0.0100) 
            OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-52*Point,OrderTakeProfit(),0,Blue);

         
                                                 //如有2次以上修改,必須把值大的放在上面,並且要限制值小的範圍 
                                    //用 low[1] 誤差不會太大   須限定收黑否則反向收紅也會更改    
        if (OrderType()==OP_SELL && low_15_buffer[0]-OrderOpenPrice()<=-0.0201)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+37*Point,OrderTakeProfit(),0,Blue);
                   
        if (OrderType()==OP_SELL && low_15_buffer[0]-OrderOpenPrice()<=-0.0101  && low_15_buffer[0]-OrderOpenPrice()>=-0.0200)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+42*Point,OrderTakeProfit(),0,Blue);
        
        if (OrderType()==OP_SELL && low_15_buffer[0]-OrderOpenPrice()<=-0.0010  && low_15_buffer[0]-OrderOpenPrice()>=-0.0100)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+52*Point,OrderTakeProfit(),0,Blue);
