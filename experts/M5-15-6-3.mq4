     ...
     if  (((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0 &&
         ...
         //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
               if    (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      if   ((ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]<=-0.00010 && close_30_buffer[1]-ma05_30_buffer[1]<=-0.00010) ||	
                            (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0))	
                             return;	
                             else	
                      ...
                      if   ((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
...
//*** long Buy  2  ***************************************************************************************** 
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if  (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+2000*Point,"My order #LB3",8803,0,Yellow );
                      longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+2000*Point,"My order #LB4",8804,0,Yellow );
     }  
...
//┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if  (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-2000*Point,"My order #LS3",4403,0,Green);
                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
     }      
         ...
         ((close_05_buffer[1]-close_05_buffer[2]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010 ) ||
          ...
          if ((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0) ||
              (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0) || 
                ...
                (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                 shortbuy04==OrderTicket() || shortbuy05==OrderTicket() || shortbuy06==OrderTicket() ||
                 shortsell01==OrderTicket() || shortsell02==OrderTicket() || shortsell03==OrderTicket() ||
                 shortsell04==OrderTicket() || shortsell05==OrderTicket() || shortsell06==OrderTicket())))   
                 return;
                 else            
                 shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+250*Point,"My order #B1",8801,0,Yellow );
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
         ...
         ((k1_05_buffer[1]-d1_05_buffer[2]<=-3 &&   k1_05_buffer[1]>=70 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75) &&
         ((close_05_buffer[1]-close_05_buffer[2]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[3]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[4]<=-0.00010 ) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  close_05_buffer[2]-open_05_buffer[2]<=-0.00010) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  low_05_buffer[1]-close_05_buffer[2]>=0.00040))))   
          ...
          if ((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
              (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0) || 
               ...
               (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                 ...
                 shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-250*Point,"My order #S1",4401,0,Green);
   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
         ...
         if (OrderType()==OP_BUY &&  TimeCurrent()-OrderOpenTime()<=15000 && (longbuy03==OrderTicket() || longbuy04==OrderTicket()))
                 if ((OrderOpenPrice()-high_60_buffer[0]<=0.00110 && OrderOpenPrice()-high_60_buffer[1]<=0.00110 &&
                      OrderOpenPrice()-high_60_buffer[2]<=0.00110 && OrderOpenPrice()-high_60_buffer[3]<=0.00110) ||
                     (OrderOpenPrice()-high_240_buffer[0]<=0.00110 && OrderOpenPrice()-high_240_buffer[1]<=0.00110 &&
        ...
        if (OrderType()==OP_BUY &&  TimeCurrent()-OrderOpenTime()<=3600 && (longbuy01==OrderTicket() || longbuy02==OrderTicket()))
                 if ((OrderOpenPrice()-high_15_buffer[0]<=0.00110 && OrderOpenPrice()-high_15_buffer[1]<=0.00110 &&
                      OrderOpenPrice()-high_15_buffer[2]<=0.00110 && OrderOpenPrice()-high_15_buffer[3]<=0.00110) ||
                     (OrderOpenPrice()-high_30_buffer[0]<=0.00110 && OrderOpenPrice()-high_30_buffer[1]<=0.00110 &&
         ...
         if   (OrderType()==OP_BUY && TimeCurrent()-OrderOpenTime()<=1000 && shortbuy01==OrderTicket() &&
                      OrderOpenPrice()-high_05_buffer[0]<=0.00060 && OrderOpenPrice()-high_05_buffer[1]<=0.00060 &&
                      OrderOpenPrice()-high_05_buffer[2]<=0.00060 && OrderOpenPrice()-high_05_buffer[3]<=0.00060 )
                      OrderModify(OrderTicket(),Ask,OrderOpenPrice()+50*Point,OrderOpenPrice()+70*Point,0,Blue);
                                                                    
                             
          if (OrderType()==OP_BUY && shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.01300 && high_05_buffer[0]-OrderOpenPrice()<=0.01320 &&  k1_240_buffer[1]-k1_240_buffer[2]>=3 &&  k2_240_buffer[1]-k2_240_buffer[2]>=1 && k3_240_buffer[1]-k3_240_buffer[2]>=0)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+720*Point,OrderOpenPrice()+1800*Point,0,Blue);
         else
            if (OrderType()==OP_BUY && shortbuy01==OrderTicket() &&  high_05_buffer[0]-OrderOpenPrice()>=0.00900 && high_05_buffer[0]-OrderOpenPrice()<=0.00920 && k1_60_buffer[1]-k1_60_buffer[2]>=3 &&  k2_60_buffer[1]-k2_60_buffer[2]>=1 && k3_60_buffer[1]-k3_60_buffer[2]>=0)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+520*Point,OrderOpenPrice()+1000*Point,0,Blue);
         else
            if (OrderType()==OP_BUY && shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00500 && high_05_buffer[0]-OrderOpenPrice()<=0.00520 && k1_30_buffer[1]-k1_30_buffer[2]>=3 &&  k2_30_buffer[1]-k2_30_buffer[2]>=1 && k3_30_buffer[1]-k3_30_buffer[2]>=0)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+320*Point,OrderOpenPrice()+750*Point,0,Blue);
         else
            if (OrderType()==OP_BUY && shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00400 && high_05_buffer[0]-OrderOpenPrice()<=0.00420 && k1_15_buffer[1]-k1_15_buffer[2]>=3 &&  k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=0)
         ...
         if (OrderType()==OP_SELL &&   TimeCurrent()-OrderOpenTime()<=15000 && (longsell03==OrderTicket() || longsell04==OrderTicket()))
                 if ((OrderOpenPrice()-low_60_buffer[0]>=-0.00110 && OrderOpenPrice()-low_60_buffer[1]>=-0.00110 &&
                      OrderOpenPrice()-low_60_buffer[2]>=-0.00110 && OrderOpenPrice()-low_60_buffer[3]>=-0.00110)||
                     (OrderOpenPrice()-low_240_buffer[0]>=-0.00110 && OrderOpenPrice()-low_240_buffer[1]>=-0.00110 &&
         ...
         if (OrderType()==OP_SELL &&  TimeCurrent()-OrderOpenTime()<=3600 && (longsell01==OrderTicket() || longsell02==OrderTicket()))
                 if ((OrderOpenPrice()-low_15_buffer[0]>=-0.00110 && OrderOpenPrice()-low_15_buffer[1]>=-0.00110 &&
                      OrderOpenPrice()-low_15_buffer[2]>=-0.00110 && OrderOpenPrice()-low_15_buffer[3]>=-0.00110)||
                     (OrderOpenPrice()-low_30_buffer[0]>=-0.00110 && OrderOpenPrice()-low_30_buffer[1]>=-0.00110 &&
         ...
         if   (OrderType()==OP_SELL && TimeCurrent()-OrderOpenTime()<=1000 && shortsell01==OrderTicket() &&
                      OrderOpenPrice()-low_05_buffer[0]<=0.00060 && OrderOpenPrice()-low_05_buffer[1]<=0.00060 &&
                      OrderOpenPrice()-low_05_buffer[2]<=0.00060 && OrderOpenPrice()-low_05_buffer[3]<=0.00060 )
                      OrderModify(OrderTicket(),Bid,OrderOpenPrice()-50*Point,OrderOpenPrice()-70*Point,0,Blue);
        
      
         if (OrderType()==OP_SELL &&  shortsell01==OrderTicket() && low_05_buffer[0]-OrderOpenPrice()<=-0.01300 && low_05_buffer[0]-OrderOpenPrice()>=-0.01320 && k1_240_buffer[1]-k1_240_buffer[2]<=-3 &&  k2_240_buffer[1]-k2_240_buffer[2]<=-1 && k3_240_buffer[1]-k3_240_buffer[2]<=0)
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-720*Point,OrderOpenPrice()-1800*Point,0,Blue);
         else       
            if (OrderType()==OP_SELL &&  shortsell01==OrderTicket() && low_05_buffer[0]-OrderOpenPrice()<=-0.00800 && low_05_buffer[0]-OrderOpenPrice()>=-0.00920 && k1_60_buffer[1]-k1_60_buffer[2]<=-3 &&  k2_60_buffer[1]-k2_60_buffer[2]<=-1 && k3_60_buffer[1]-k3_60_buffer[2]<=0)
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-520*Point,OrderOpenPrice()-1000*Point,0,Blue);
         else
            if (OrderType()==OP_SELL &&  shortsell01==OrderTicket() && low_05_buffer[0]-OrderOpenPrice()<=-0.00500 && low_05_buffer[0]-OrderOpenPrice()>=-0.00520 && k1_30_buffer[1]-k1_30_buffer[2]<=-3 &&  k2_30_buffer[1]-k2_30_buffer[2]<=-1 && k3_30_buffer[1]-k3_30_buffer[2]<=0)
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-320*Point,OrderOpenPrice()-750*Point,0,Blue);
         else
            if (OrderType()==OP_SELL &&  shortsell01==OrderTicket() && low_05_buffer[0]-OrderOpenPrice()<=-0.00400 && low_05_buffer[0]-OrderOpenPrice()>=-0.00420 && k1_15_buffer[1]-k1_15_buffer[2]<=-3 &&  k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=0)
