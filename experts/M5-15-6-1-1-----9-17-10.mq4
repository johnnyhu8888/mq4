...
//           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8807 || OrderMagicNumber( )==8806) &&
           if    (OrderType()==OP_BUY &&// OrderMagicNumber( )==8806 &&
                  high_05_buffer[0]-OrderOpenPrice()>=0.00500 && high_05_buffer[0]-OrderOpenPrice()<=0.00260) 
                             //stoploss=OrderOpenPrice()+40*Point可以賺4點
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+200*Point,OrderTakeProfit(),0,Blue);
...
//           if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4401 || OrderMagicNumber( )==44011) &&
 ...
 //          if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4407 || OrderMagicNumber( )==4406) &&
           if    (OrderType()==OP_SELL && //OrderMagicNumber( )==4406 &&
                  low_05_buffer[0]-OrderOpenPrice()<=-0.00500 && low_05_buffer[0]-OrderOpenPrice()>=-0.00260) 
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-200*Point,OrderTakeProfit(),0,Blue);
                                                 //44011為反向單以安全為原則 
//          if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4407 || OrderMagicNumber( )==4406) &&
          if    (OrderType()==OP_SELL && // OrderMagicNumber( )==4406 &&
...
//***************************************************************************************************8 
 ...
 //*** close Buy  1  ***************************************************************************************** 
  ...
  if    (OrderType()==OP_BUY)
   {
//    if  ( OrdersTotal()>0 && OrderMagicNumber()==4401)     加上此列一次會下3張單
      ...
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                      k2_30_buffer[1]-d2_30_buffer[1]>=20 && k3_30_buffer[1]-d3_30_buffer[1]>=20) ||
                     (d2_60_buffer[1]<=55 && d3_60_buffer[1]<=55 &&
                      k2_60_buffer[1]-d2_60_buffer[1]>=20 && k3_60_buffer[1]-d3_60_buffer[1]>=20) ||
                     (d2_60_buffer[1]<=50 && d3_60_buffer[1]<=50 &&
                    ((k1_60_buffer[1]-d1_60_buffer[1])+(k2_60_buffer[1]-d2_60_buffer[1])+(k3_60_buffer[1]-d3_60_buffer[1]))>50) ||
                     (d2_240_buffer[1]<=55 && d3_240_buffer[1]<=55 &&
                      k2_240_buffer[1]-d2_240_buffer[1]>=20 && k3_240_buffer[1]-d3_240_buffer[1]>=20) || 
                     (d2_240_buffer[1]<=50 && d3_240_buffer[1]<=50 &&
                    ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))>50) ||
                     
                      //ma05 持平狀態 
                 ((ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
                  (ma05_15_buffer[1]-ma05_15_buffer[6]>=0.00080) &&                        //k1,k2,k3  任一持平
                             //k1,k2,k3  任一持平
                 ((k1_15_buffer[1]-k1_15_buffer[6]<=2 && k1_15_buffer[1]-k1_15_buffer[6]>=-2 ||
                   k2_15_buffer[1]-k2_15_buffer[6]<=2 && k2_15_buffer[1]-k2_15_buffer[6]>=-2 ||          
                   k3_15_buffer[1]-k3_15_buffer[6]<=2 && k3_15_buffer[1]-k3_15_buffer[6]>=-2) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
                  (k2_15_buffer[1]-k2_15_buffer[2]<=-1  && k3_15_buffer[1]-k3_15_buffer[2]<=-1 ||
                   d2_15_buffer[1]-d2_15_buffer[2]<=-1  && d3_15_buffer[1]-d3_15_buffer[2]<=-1)) &&
                             //呈下跌狀態
                  (close_15_buffer[1]-close_15_buffer[20]>=0.00200 ||  close_15_buffer[1]-close_15_buffer[40]>=0.00200)) || 
                       //ma05 持平狀態 
                 ((ma05_30_buffer[1]-ma05_30_buffer[6]<=0.00040 && ma05_30_buffer[1]-ma05_30_buffer[6]<=0.00040) || 
                  (ma05_30_buffer[1]-ma05_30_buffer[6]>=0.00100) &&                      
                             //k1,k2,k3  任一持平
                 ((k1_30_buffer[1]-k1_30_buffer[6]<=3 && k1_30_buffer[1]-k1_30_buffer[6]>=-3 ||
                   k2_30_buffer[1]-k2_30_buffer[6]<=3 && k2_30_buffer[1]-k2_30_buffer[6]>=-3 ||          
                   k3_30_buffer[1]-k3_30_buffer[6]<=3 && k3_30_buffer[1]-k3_30_buffer[6]>=-3) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
                  (k2_30_buffer[1]-k2_30_buffer[2]<=-1  && k3_30_buffer[1]-k3_30_buffer[2]<=-1 ||
                   d2_30_buffer[1]-d2_30_buffer[2]<=-1  && d3_30_buffer[1]-d3_30_buffer[2]<=-1)) &&
                             //呈下跌狀態
                  (close_30_buffer[1]-close_30_buffer[20]>=0.00200 ||  close_30_buffer[1]-close_30_buffer[40]>=0.00200)) || 

                       //ma05 持平狀態 
                 ((ma05_60_buffer[1]-ma05_60_buffer[6]<=0.000060 && ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060) || 
                  (ma05_60_buffer[1]-ma05_60_buffer[6]>=0.00150) &&                     
                             //k1,k2,k3  任一持平
                 ((k1_60_buffer[1]-k1_60_buffer[6]<=5 && k1_60_buffer[1]-k1_60_buffer[6]>=-5 ||
                   k2_60_buffer[1]-k2_60_buffer[6]<=5 && k2_60_buffer[1]-k2_60_buffer[6]>=-5 ||          
                   k3_60_buffer[1]-k3_60_buffer[6]<=5 && k3_60_buffer[1]-k3_60_buffer[6]>=-5) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
                  (k2_60_buffer[1]-k2_60_buffer[2]<=-1  && k3_60_buffer[1]-k3_60_buffer[2]<=-1 ||
                   d2_60_buffer[1]-d2_60_buffer[2]<=-1  && d3_60_buffer[1]-d3_60_buffer[2]<=-1)) &&
                             //呈下跌狀態
                  (close_60_buffer[1]-close_60_buffer[20]>=0.00200 ||  close_60_buffer[1]-close_60_buffer[40]>=0.00200)) || 
                  ...
                  (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)) ||
                        ...
                        //macd 差值太大不買賣
                      (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=0.000600) ||
                      (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.000800) ||
                      (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=0.001300) ||
  
                       //m15或m30或m60  k1,k2,k3 同時向上 
                    (k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k1_15_buffer[1]-k1_15_buffer[2]>=0) || 
                    (k1_30_buffer[1]-k1_30_buffer[2]>=0 && k2_30_buffer[1]-k2_30_buffer[2]>=0 && k1_30_buffer[1]-k1_30_buffer[2]>=0) || 
                    (k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k1_60_buffer[1]-k1_60_buffer[2]>=-1) ||
//取消m240         
                        //m60,m240 kd值差全部>10
                 (k2_60_buffer[1]-d2_60_buffer[1]>=10 && k3_60_buffer[1]-d3_60_buffer[2]>=10 &&
                ...
                ((k2_60_buffer[1]-d2_60_buffer[1])+(k3_60_buffer[1]-d3_60_buffer[2])>=35) ||
                 ...
                 (k1_240_buffer[1]-k1_240_buffer[2]>=4 &&  k1_240_buffer[2]-k1_240_buffer[3]<=-4 && k1_240_buffer[1]<=35) ||
                        ...
                        //m240 ma05[1],ma12[1]差距大於28點 ,且往上加大([1]-[2])-([2]-[3])>=0.00080
                 (ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00280 &&
                ((ma05_240_buffer[1]-ma12_240_buffer[1])-(ma05_240_buffer[1]-ma12_240_buffer[1]))-      
                ((ma05_240_buffer[2]-ma12_240_buffer[2])-(ma05_240_buffer[3]-ma12_240_buffer[3]))>=0.00080) ||      
...
//*** close Buy  2  ***************************************************************************************** 
 //   if ( OrdersTotal()>0 && OrderMagicNumber() == 4402 ) 
      ...
      if  ((k1_15_buffer[1]-k1_15_buffer[2]<=-8 &&  k1_15_buffer[1]>=75 &&
            k1_15_buffer[1]-d1_15_buffer[1]<=-5 &&
            close_15_buffer[1]-close_15_buffer[2]<=-0.00010 && close_15_buffer[1]-close_15_buffer[3]<=-0.00010) ||
           (k1_30_buffer[1]-k1_30_buffer[2]<=-8 &&  k1_30_buffer[1]>=75 &&
            k1_30_buffer[1]-d1_30_buffer[1]<=-5 &&
...
//     if ( OrdersTotal()>0 && OrderMagicNumber() == 4403) 
         //     k1大幅轉折
              // k1大幅轉折 kd2,kd3 間距縮小 或k2,k3都向下
     if ((((k1_15_buffer[1]>=55 && k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
           (k1_15_buffer[1]>=55 && k1_15_buffer[1]-k1_15_buffer[2]<=-8 &&  k1_15_buffer[2]-k1_15_buffer[3]>=1)) && 
          ((k2_15_buffer[1]-d2_15_buffer[1]<=6 &&  k3_15_buffer[1]-d3_15_buffer[1]<=6) ||
           (k2_15_buffer[1]-k2_15_buffer[2]<=0  &&  k3_15_buffer[1]-k3_15_buffer[2]<=0))) ||
             // k1,k2,k3都向下 且在80上
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 &&  k2_15_buffer[1]-k2_15_buffer[2]<=-1 &&
            k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&  k1_15_buffer[1]>=80 && k2_15_buffer[1]>=80 &&
            k3_15_buffer[1]>=80) ||
                  //角度折反
           (k1_15_buffer[1]-k1_15_buffer[2]<=-4 &&  k1_15_buffer[2]-k1_15_buffer[3]>=4 && k1_15_buffer[1]>=55) ||
           
                //k1 &&(k2||k3)向下,macd 在合理範圍內,收盤[1]<[2] 
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && (k2_15_buffer[1]-k2_15_buffer[2]<=-1 ||
            k3_15_buffer[1]-k3_15_buffer[2]<=-1) &&  k1_15_buffer[1]>=65 && k2_15_buffer[1]>=75 &&
            k3_15_buffer[1]>=75 && close_15_buffer[1]-close_15_buffer[2]<=-0.00010))  

                      //ma05 持平狀態 
           if   (((ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
                  (ma05_15_buffer[1]-ma05_15_buffer[6]>=0.00080) &&                        //k1,k2,k3  任一持平
                             //k1,k2,k3  任一持平
                 ((k1_15_buffer[1]-k1_15_buffer[6]<=2 && k1_15_buffer[1]-k1_15_buffer[6]>=-2 ||
                   k2_15_buffer[1]-k2_15_buffer[6]<=2 && k2_15_buffer[1]-k2_15_buffer[6]>=-2 ||          
                 ...
                 ((k1_60_buffer[1]-k1_60_buffer[6]<=5 && k1_60_buffer[1]-k1_60_buffer[6]>=-5 ||
                  ...
                  (close_60_buffer[1]-close_60_buffer[20]>=0.00200 ||  close_60_buffer[1]-close_60_buffer[40]>=0.00200)) ||
                       ...
                       //m15或m30或m60 m240 k1,k2,k3 同時向上 
                    (k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k1_15_buffer[1]-k1_15_buffer[2]>=0) || 
                    (k1_30_buffer[1]-k1_30_buffer[2]>=0 && k2_30_buffer[1]-k2_30_buffer[2]>=0 && k1_30_buffer[1]-k1_30_buffer[2]>=0) || 
                    (k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k1_60_buffer[1]-k1_60_buffer[2]>=-1) ||
                    (k1_240_buffer[1]-k1_240_buffer[2]>=0 && k2_240_buffer[1]-k2_240_buffer[2]>=0 && k1_240_buffer[1]-k1_240_buffer[2]>=-1) ||
...
//    if (  OrdersTotal()>0 && OrderMagicNumber() != 4406)     //長短單會一直close   加上此列一次會下3張單
         //     k1大幅轉折
     if ((((k1_60_buffer[1]>=65 && k1_60_buffer[1]-k1_60_buffer[2]<=-6 &&  k1_60_buffer[2]-k1_60_buffer[3]>=3) || 
           (k1_60_buffer[1]>=65 && k1_60_buffer[1]-k1_60_buffer[2]<=-8 &&  k1_60_buffer[2]-k1_60_buffer[3]>=1)) && 
          ((k2_60_buffer[1]-d2_60_buffer[1]<=6 &&  k3_60_buffer[1]-d3_60_buffer[1]<=6) ||
           ...
           (k1_60_buffer[1]-k1_60_buffer[2]<=-1 &&  k2_60_buffer[1]-k2_60_buffer[2]<=-1 &&
            k3_60_buffer[1]-k3_60_buffer[2]<=-1 &&  k1_60_buffer[1]>=80 && k2_60_buffer[1]>=80 &&
            k3_60_buffer[1]>=80) ||
                 //角度折反
           (k1_60_buffer[1]-k1_60_buffer[2]<=-4 &&  k1_60_buffer[2]-k1_60_buffer[3]>=4 && k1_60_buffer[1]>=65) ||
                //k1 &&(k2||k3)向下,macd 在合理範圍內,收盤[1]<[2] 
           (k1_60_buffer[1]-k1_60_buffer[2]<=-1 && (k2_60_buffer[1]-k2_60_buffer[2]<=-1 ||
            k3_60_buffer[1]-k3_60_buffer[2]<=-1) &&  k1_60_buffer[1]>=65 && k2_60_buffer[1]>=75 &&
            k3_60_buffer[1]>=75 && close_60_buffer[1]-close_60_buffer[2]<=-0.00010))  

                      //ma05 持平狀態 
            if  (((ma05_60_buffer[1]-ma05_60_buffer[6]<=0.000060 && ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060) || 
                  (ma05_60_buffer[1]-ma05_60_buffer[6]>=0.00150) &&  
                             //k1,k2,k3  任一持平
                 ((k1_60_buffer[1]-k1_60_buffer[6]<=5 && k1_60_buffer[1]-k1_60_buffer[6]>=-5 ||
                   k2_60_buffer[1]-k2_60_buffer[6]<=5 && k2_60_buffer[1]-k2_60_buffer[6]>=-5 ||          
                  ...
                  (close_60_buffer[1]-close_60_buffer[20]>=0.00200 ||  close_60_buffer[1]-close_60_buffer[40]>=0.00200)) || 
                       ...
                       //ma05 持平狀態 
                 ((ma05_240_buffer[1]-ma05_240_buffer[6]<=0.000100 && ma05_240_buffer[1]-ma05_240_buffer[6]>=-0.00100) || 
                  (ma05_240_buffer[1]-ma05_240_buffer[6]>=0.00300) &&  
                             //k1,k2,k3  任一持平
                 ((k1_240_buffer[1]-k1_240_buffer[6]<=9 && k1_240_buffer[1]-k1_240_buffer[6]>=-9 ||
                   k2_240_buffer[1]-k2_240_buffer[6]<=9 && k2_240_buffer[1]-k2_240_buffer[6]>=-9 ||          
                   k3_240_buffer[1]-k3_240_buffer[6]<=9 && k3_240_buffer[1]-k3_240_buffer[6]>=-9) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
                  (k2_240_buffer[1]-k2_240_buffer[2]<=-1  && k3_240_buffer[1]-k3_240_buffer[2]<=-1 ||
                   d2_240_buffer[1]-d2_240_buffer[2]<=-1  && d3_240_buffer[1]-d3_240_buffer[2]<=-1)) &&
                             //呈下跌狀態
                  (close_240_buffer[1]-close_240_buffer[20]>=0.00200 ||  close_240_buffer[1]-close_240_buffer[40]>=0.00200)) ||
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 4405) 
                           ...
                           //[1][2]收黑,k1在高點且下彎
         if  ((close_240_buffer[1]-open_240_buffer[1]<=-0.00050 && close_240_buffer[2]-open_240_buffer[2]<=-0.00050 &&
               k1_240_buffer[1]-k1_240_buffer[2]<=-1 &&  k1_240_buffer[1]>=85) ||
                            //上影線超過40點,[1]收小紅或黑
              (high_240_buffer[1]-close_240_buffer[1]>=0.00400 && close_240_buffer[1]-open_240_buffer[1]<=0.00030) &&
                                                        //m240 ma05[1],ma12[1]差距大於35點 
               ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00350 &&
                                    //k2或k3之一為下降 
             ((k2_240_buffer[1]-k2_240_buffer[2]<=-1) || (k3_240_buffer[1]-k3_240_buffer[2]<=-1) ||
                         //kd值縮小在8之內
              (k2_240_buffer[1]-d2_240_buffer[2]<=8) || (k3_240_buffer[1]-d3_240_buffer[2]<=8)))
...
//*** close Buy  6  ***************************************************************************************** 
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 4406) 
      return;
                           ...
                           //[1]收黑,k1,k2,k3 在高點且下彎 kd值<=-5 macd 在範圍內
         if   (close_240_buffer[1]-open_240_buffer[1]<=-0.00050 &&  k1_240_buffer[1]-k1_240_buffer[2]<=-1 &&  
               ...
               k1_240_buffer[1]-d1_240_buffer[1]<=-5 )
               OrderClose(OrderTicket(),lots,Bid,1,LimeGreen); 
 ...
 //    if ( OrdersTotal()>0 && OrderMagicNumber() == 8801 )  加上此列一次會下3張單
           ...
           (k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0 &&
            ...
            if  (((ma05_15_buffer[1]-ma05_15_buffer[6]>=-0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
                 ...
                 ((k1_15_buffer[1]-k1_15_buffer[6]>=-2 && k1_15_buffer[1]-k1_15_buffer[6]<=2 ||
                   k2_15_buffer[1]-k2_15_buffer[6]>=-2 && k2_15_buffer[1]-k2_15_buffer[6]<=2 ||          
                   k3_15_buffer[1]-k3_15_buffer[6]>=-2 && k3_15_buffer[1]-k3_15_buffer[6]<=2) ||
                                   //k2,k3 或 d2,d3呈上升狀態,但ma05是持平所以不買賣  
                  (k2_15_buffer[1]-k2_15_buffer[2]>=1  && k3_15_buffer[1]-k3_15_buffer[2]>=1 ||
                   d2_15_buffer[1]-d2_15_buffer[2]>=1  && d3_15_buffer[1]-d3_15_buffer[2]>=1)) &&
                             //呈下跌狀態
                  (close_15_buffer[1]-close_15_buffer[20]<=-0.00200 ||  close_15_buffer[1]-close_15_buffer[40]<=-0.00200)) || 
                     ...
                     //ma05 持平狀態 
                 ((ma05_30_buffer[1]-ma05_30_buffer[6]>=-0.00040 && ma05_30_buffer[1]-ma05_30_buffer[6]<=0.00040) || 
                  (ma05_30_buffer[1]-ma05_30_buffer[6]<=-0.00100) &&                //k1,k2,k3  任一持平
                 ((k1_30_buffer[1]-k1_30_buffer[6]>=-3 && k1_30_buffer[1]-k1_30_buffer[6]<=3 ||
                   k2_30_buffer[1]-k2_30_buffer[6]>=-3 && k2_30_buffer[1]-k2_30_buffer[6]<=3 ||          
                   k3_30_buffer[1]-k3_30_buffer[6]>=-3 && k3_30_buffer[1]-k3_30_buffer[6]<=3) ||
                                   //k2,k3 或 d2,d3呈上升狀態,但ma05是持平所以不買賣  
                  ...
                  (close_30_buffer[1]-close_30_buffer[20]<=-0.00200 ||  close_30_buffer[1]-close_30_buffer[40]<=-0.00200)) || 
                     ...
                     //ma05 持平狀態 
                 ((ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060 && ma05_60_buffer[1]-ma05_60_buffer[6]<=0.00060) || 
                  (ma05_60_buffer[1]-ma05_60_buffer[6]<=-0.00150) &&                              //k1,k2,k3  任一持平
                 ((k1_60_buffer[1]-k1_60_buffer[6]>=-5 && k1_60_buffer[1]-k1_60_buffer[6]<=5 ||
                   k2_60_buffer[1]-k2_60_buffer[6]>=-5 && k2_60_buffer[1]-k2_60_buffer[6]<=5 ||          
                   k3_60_buffer[1]-k3_60_buffer[6]>=-5 && k3_60_buffer[1]-k3_60_buffer[6]<=5) ||
                                   //k2,k3 或 d2,d3呈上升狀態,但ma05是持平所以不買賣  
                  ...
                  (d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                   k2_60_buffer[1]-d2_60_buffer[2]<=-20 && k3_240_buffer[1]-d3_240_buffer[2]<=-20) ||
                  (d2_60_buffer[1]>=50 && d3_60_buffer[1]>=50 &&
                 ((k1_60_buffer[1]-d1_60_buffer[1])+(k2_60_buffer[1]-d2_60_buffer[1])+(k3_60_buffer[1]-d3_60_buffer[1]))<50) ||
                  (d2_240_buffer[1]>=45 && d3_240_buffer[1]>=45 &&
                   k2_240_buffer[1]-d2_240_buffer[1]<=-20 && k3_240_buffer[1]-d3_240_buffer[1]<=-20) || 
                  (d2_240_buffer[1]>=50 && d3_240_buffer[1]>=50 &&
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                                         //macd 差值太大不買賣
                   ...
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.001300) ||
                       ...
                       //m15或m30或m60 m240  k1,k2,k3 同時向下 
                    (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k1_15_buffer[1]-k1_15_buffer[2]<=0) || 
                    (k1_30_buffer[1]-k1_30_buffer[2]<=0 && k2_30_buffer[1]-k2_30_buffer[2]<=0 && k1_30_buffer[1]-k1_30_buffer[2]<=0) || 
                    (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k1_60_buffer[1]-k1_60_buffer[2]<=1) ||
//取消m240               
                ...
                ((k2_60_buffer[1]-d2_60_buffer[1])+(k3_60_buffer[1]-d3_60_buffer[2])<=-35) ||
                 ...
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-4 &&  k1_240_buffer[2]-k1_240_buffer[3]>=4 && k1_240_buffer[1]>=65) ||
                        ...
                        //m240 ma05[1],ma12[1]差距大於28點 ,且往下加大([1]-[2])-([2]-[3])<=-0.00080
                 (ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00280 &&
                ((ma05_240_buffer[1]-ma12_240_buffer[1])-(ma05_240_buffer[1]-ma12_240_buffer[1]))-      
                ((ma05_240_buffer[2]-ma12_240_buffer[2])-(ma05_240_buffer[3]-ma12_240_buffer[3]))<=-0.00080) ||      
...
//      if ( OrdersTotal()>0 && OrderMagicNumber() == 8802 ) 
      ...
      if   ((k1_15_buffer[1]-k1_15_buffer[2]>=6 &&  k1_15_buffer[1]<=25 &&
            k1_15_buffer[1]-d1_15_buffer[1]>=4 &&
            close_15_buffer[1]-close_15_buffer[2]>=0.00010 && close_15_buffer[1]-close_15_buffer[3]>=0.00010) ||
           (k1_30_buffer[1]-k1_30_buffer[2]>=6 &&  k1_30_buffer[1]<=25 &&
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 8803) 
                    ...
                    // k1大幅轉折 kd2,kd3 間距縮小 或k2,k3都向上
     if ((((k1_15_buffer[1]<=45 && k1_15_buffer[1]-k1_15_buffer[2]>=6  &&  k1_15_buffer[2]-k1_15_buffer[3]<=-3) || 
           (k1_15_buffer[1]<=45 && k1_15_buffer[1]-k1_15_buffer[2]>=8  &&  k1_15_buffer[2]-k1_15_buffer[3]<=-1)) && 
          ((k2_15_buffer[1]-d2_15_buffer[1]>=-6 &&  k3_15_buffer[1]-d3_15_buffer[1]>=-6)||
           (k2_15_buffer[1]-k2_15_buffer[2]>=0  &&  k3_15_buffer[1]-k3_15_buffer[2]>=0))) ||
    
                     // k1,k2,k3都向上 且在20下
           (k1_15_buffer[1]-k1_15_buffer[2]>=1 &&  k2_15_buffer[1]-k2_15_buffer[2]>=1 &&
            k3_15_buffer[1]-k3_15_buffer[2]>=1 &&  k1_15_buffer[1]<=20 && k2_15_buffer[1]<=20 &&
            k3_15_buffer[1]<=20) ||
                 //角度折反
           (k1_15_buffer[1]-k1_15_buffer[2]>=4 &&  k1_15_buffer[2]-k1_15_buffer[3]<=-4 && k1_15_buffer[1]<=45) ||
                               //k1 &&(k2||k3)向上,macd 在合理範圍內,收盤[1]>[2]          
           (k1_15_buffer[1]-k1_15_buffer[2]>=1 && (k2_15_buffer[1]-k2_15_buffer[2]>=1 ||
            k3_15_buffer[1]-k3_15_buffer[2]>=1) &&  k1_15_buffer[1]<=35 && k2_15_buffer[1]<=25 &&
            k3_15_buffer[1]<=25 && close_15_buffer[1]-close_15_buffer[2]>=0.00010))  
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 8804) 
                    ...
                    // k1大幅轉折 kd2,kd3 間距縮小 或k2,k3都向上
     if ((((k1_60_buffer[1]<=35 && k1_60_buffer[1]-k1_60_buffer[2]>=6  &&  k1_60_buffer[2]-k1_60_buffer[3]<=-3) || 
           (k1_60_buffer[1]<=35 && k1_60_buffer[1]-k1_60_buffer[2]>=8  &&  k1_60_buffer[2]-k1_60_buffer[3]<=-1)) && 
          ((k2_60_buffer[1]-d2_60_buffer[1]>=-6 &&  k3_60_buffer[1]-d3_60_buffer[1]>=-6)||
           (k2_60_buffer[1]-k2_60_buffer[2]>=0  &&  k3_60_buffer[1]-k3_60_buffer[2]>=0))) ||
    
                     // k1,k2,k3都向上 且在20下
           (k1_60_buffer[1]-k1_60_buffer[2]>=1 &&  k2_60_buffer[1]-k2_60_buffer[2]>=1 &&
            k3_60_buffer[1]-k3_60_buffer[2]>=1 &&  k1_60_buffer[1]<=20 && k2_60_buffer[1]<=20 &&
            k3_60_buffer[1]<=20) ||
                 //角度折反
           (k1_60_buffer[1]-k1_60_buffer[2]>=4 &&  k1_60_buffer[2]-k1_60_buffer[3]<=-4 && k1_60_buffer[1]<=35) ||
                               //k1 &&(k2||k3)向上,macd 在合理範圍內,收盤[1]>[2]          
           (k1_60_buffer[1]-k1_60_buffer[2]>=1 && (k2_60_buffer[1]-k2_60_buffer[2]>=1 ||
            k3_60_buffer[1]-k3_60_buffer[2]>=1) &&  k1_60_buffer[1]<=35 && k2_60_buffer[1]<=25 &&
            k3_60_buffer[1]<=25 && close_60_buffer[1]-close_60_buffer[2]>=0.00010))  
                      //ma05 持平狀態 
            if  (((ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060 && ma05_60_buffer[1]-ma05_60_buffer[6]<=0.00060) || 
                  (ma05_60_buffer[1]-ma05_60_buffer[6]<=-0.00150) && 
                             //k1,k2,k3  任一持平
                 ((k1_60_buffer[1]-k1_60_buffer[6]>=-5 && k1_60_buffer[1]-k1_60_buffer[6]<=5 ||
                   k2_60_buffer[1]-k2_60_buffer[6]>=-5 && k2_60_buffer[1]-k2_60_buffer[6]<=5 ||          
                  ...
                  (close_60_buffer[1]-close_60_buffer[20]<=-0.00200 ||  close_60_buffer[1]-close_60_buffer[40]<=-0.00200)) ||
                     ...
                     //ma05 持平狀態 
                 ((ma05_240_buffer[1]-ma05_240_buffer[6]>=-0.00100 && ma05_240_buffer[1]-ma05_240_buffer[6]<=0.00100) || 
                  (ma05_240_buffer[1]-ma05_240_buffer[6]<=-0.00300) && 
                             //k1,k2,k3  任一持平
                 ((k1_240_buffer[1]-k1_240_buffer[6]>=-9 && k1_240_buffer[1]-k1_240_buffer[6]<=9 ||
                   k2_240_buffer[1]-k2_240_buffer[6]>=-9 && k2_240_buffer[1]-k2_240_buffer[6]<=9 ||          
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 8805) 
                           //[1][2]收紅,k1在低點且上彎
         if  ((close_240_buffer[1]-open_240_buffer[1]>=0.00050 && close_240_buffer[2]-open_240_buffer[2]>=0.00050 &&
               k1_240_buffer[1]-k1_240_buffer[2]>=1 &&  k1_240_buffer[1]<=15) ||
                            //下影線超過40點,[1]收小黑或紅
              (low_240_buffer[1]-close_240_buffer[1]<=-0.00400 && close_240_buffer[1]-open_240_buffer[1]>=-0.00030) &&
                                                        //m240 ma05[1],ma12[1]差距大於35點 
               ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00350 &&
                                    //k2或k3之一為上升
             ((k2_240_buffer[1]-k2_240_buffer[2]>=1) || (k3_240_buffer[1]-k3_240_buffer[2]>=1) ||
...
//取消m240               
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #LB1",8801,0,Yellow );
//*** long Buy  2  ***************************************************************************************** 
   if ( OrdersTotal()>0 && OrderMagicNumber() == 8802 ) 
      return;
      else
      ...
      if   ((k1_15_buffer[1]-k1_15_buffer[2]>=6 &&  k1_15_buffer[1]<=25 &&
           ...
           (k1_30_buffer[1]-k1_30_buffer[2]>=6 &&  k1_30_buffer[1]<=25 &&
            ...
            if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-10 && k3_60_buffer[1]-d3_60_buffer[2]<=-10 &&
             ...
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-250*Point,Ask+3900*Point,"My order #LB2",8802,0,Yellow );
//*** long Buy  3  ***************************************************************************************** 
            ...
            if  (((ma05_15_buffer[1]-ma05_15_buffer[6]>=-0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-280*Point,Ask+3800*Point,"My order #LB3",8803,0,Yellow );
            ...
            if  (((ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060 && ma05_60_buffer[1]-ma05_60_buffer[6]<=0.00060) || 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+3700*Point,"My order #LB4",8804,0,Yellow );
      ...
      return;
         ...
         if  ((close_240_buffer[1]-open_240_buffer[1]>=0.00050 && close_240_buffer[2]-open_240_buffer[2]>=0.00050 &&
             ...
             ((k2_240_buffer[1]-k2_240_buffer[2]>=1) || (k3_240_buffer[1]-k3_240_buffer[2]>=1) ||
                         //kd值縮小在8之內
              (k2_240_buffer[1]-d2_240_buffer[2]>=-8) || (k3_240_buffer[1]-d3_240_buffer[2]>=-8)))
               OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+3700*Point,"My order #LB5",8805,0,Yellow );
 //*** long buy  6  ***************************************************************************************** 
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 8806) 
      return;
         ...
         if   (close_240_buffer[1]-open_240_buffer[1]>=0.00050 &&  k1_240_buffer[1]-k1_240_buffer[2]>=1 &&  
               ...
               k1_240_buffer[1]<=30 &&  k2_240_buffer[1]<=25 &&  k3_240_buffer[1]<=25 &&
               k1_240_buffer[1]-d1_240_buffer[1]>=5 )
               OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+3700*Point,"My order #LB6",8806,0,Yellow );
//***************************************************************************************************************************************
//SELL
//*** long Sell  1  ********************************************************************************************************************** 
...
//取消m240         
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-5000*Point,"My order #LS1",4401,0,Blue);
            ...
            if  ((k2_60_buffer[1]-d2_60_buffer[1]>=10 && k3_60_buffer[1]-d3_60_buffer[2]>=10 &&
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-3900*Point,"My order #S2",4402,0,Green);
     ...
     if ((((k1_15_buffer[1]>=55 && k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
          ...
          ((k2_15_buffer[1]-d2_15_buffer[1]<=6 &&  k3_15_buffer[1]-d3_15_buffer[1]<=6) ||
           ...
           (k1_15_buffer[1]-k1_15_buffer[2]<=-4 &&  k1_15_buffer[2]-k1_15_buffer[3]>=4 && k1_15_buffer[1]>=55) ||
                //k1 &&(k2||k3)向下,macd 在合理範圍內,收盤[1]<[2] 
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && (k2_15_buffer[1]-k2_15_buffer[2]<=-1 ||
            k3_15_buffer[1]-k3_15_buffer[2]<=-1) &&  k1_15_buffer[1]>=65 && k2_15_buffer[1]>=70 &&
            k3_15_buffer[1]>=70 && close_15_buffer[1]-close_15_buffer[2]<=-0.00010))  
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  return;
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+280*Point,Bid-3800*Point,"My order #S3",4403,0,Green);
 //*** long SELL  4  ***************************************************************************************** 
            ...
            if  (((ma05_60_buffer[1]-ma05_60_buffer[6]<=0.000060 && ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060) || 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+290*Point,Bid-3700*Point,"My order #S4",4404,0,Green);
      ...
      return;
         ...
         if  ((close_240_buffer[1]-open_240_buffer[1]<=-0.00050 && close_240_buffer[2]-open_240_buffer[2]<=-0.00050 &&
             ...
             ((k2_240_buffer[1]-k2_240_buffer[2]<=-1) || (k3_240_buffer[1]-k3_240_buffer[2]<=-1) ||
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+290*Point,Bid-3700*Point,"My order #S5",4405,0,Green);
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 4406) 
      return;
         ...
         if   (close_240_buffer[1]-open_240_buffer[1]<=-0.00050 &&  k1_240_buffer[1]-k1_240_buffer[2]<=-1 &&  
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+290*Point,Bid-3700*Point,"My order #S6",4406,0,Green);
