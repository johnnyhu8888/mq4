...
//*** Buy  1  ***************  ma45弊絬,ma05,ma08,ma12は锣,硈Μ2ma05 ***************************************************************** 
     ...
     {              
      ...
      //           if  (k1_01_buffer[1]<25 &&  d1_01_buffer[1]<30  &&  k1_01_buffer[1]-d1_01_buffer[1]<=-2) 
        //          {           
                      ...
                      if  ((close_01_buffer[1]-open_01_buffer[1]>=0.0003 &&  close_01_buffer[2]-open_01_buffer[2]>=0.0003 ) ||
                                                                              //┪1barΜ>=0.0006 2barΜキ堵
                           (close_01_buffer[1]-open_01_buffer[1]>=0.0006 &&  close_01_buffer[2]-open_01_buffer[2]<=0))
                       {          
           //                while (close_05_buffer[1]-open_05_buffer[1]<=-0.0009 || close_05_buffer[0]-open_05_buffer[0]<=-0.0015)
             //              break;
                   //        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-10*Point,Ask+32*Point,"My order #1",8801,0,Yellow );
                          OrderSend(Symbol(),OP_BUYLIMIT,lots,Ask,1,Ask-10*Point,Ask+32*Point,"My order #1",8801,0,Yellow );
...
//*** Sell  1  ***************  ma45弊絬,ma05,ma08,ma12は紆,硈Μ2堵ma05 ***************************************************************** 
            ...
            ma12_01_buffer[1]-ma12_01_buffer[6]>=0.0006)
         {
             ...
             //    if  (k1_01_buffer[1]>75 &&  d1_01_buffer[1]>70  &&  k1_01_buffer[1]-d1_01_buffer[1]>=2) 
               //   {           
                      ...
                      if  ((close_01_buffer[1]-open_01_buffer[1]<=-0.0003 &&  close_01_buffer[2]-open_01_buffer[2]<=-0.0003 )|| 
                                                                              //┪1barΜ堵<=-0.0006 2barΜキ
                           (close_01_buffer[1]-open_01_buffer[1]<=-0.0006 &&  close_01_buffer[2]-open_01_buffer[2]>=0))
                       {          
           //                while (close_05_buffer[1]-open_05_buffer[1]>=0.0009  || close_05_buffer[0]-open_05_buffer[0]>=0.0015)
                                   
            //               break; 
                   //        OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+10*Point,Bid-32*Point,"My order #S1",4401,0,Green );
                            OrderSend(Symbol(),OP_SELLLIMIT,lots,Bid,1,Bid+10*Point,Bid-32*Point,"My order #S1",4401,0,Green );
 ...
 //***  CLOSE Buy  1  ********************************************************************************** 
            ...
            if  ((OrderType()==OP_SELL  &&  close_01_buffer[1]-open_01_buffer[1]<=-0.0006 &&  
                 close_01_buffer[2]-open_01_buffer[2]<=-0.0003 ) || (close_01_buffer[1]-open_01_buffer[1]<=-0.0010))
             {
 ...
 //***  CLOSE Sell  1  ********************************************************************************** 
            ...
            if  ((OrderType()==OP_BUY  &&  close_01_buffer[1]-open_01_buffer[1]>=0.0006 &&  
                 close_01_buffer[2]-open_01_buffer[2]>=0.0003 ) || (close_01_buffer[1]-open_01_buffer[1]>=0.0010))
             {
