  ...
  if (OrdersTotal()<=1)   
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
              ...
              macdmainline_30_buffer[1]<=0.00110   &&                                     //k1 (k2||k3)已上升
                                     //k1 (k2||k3)已上升
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]<=0  && k2_240_buffer[1]-k2_240_buffer[2]<=0  &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-27*Point,Ask+2000*Point,"My order #B2",8802,0,Yellow );
         ...
         if   ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  && close_15_buffer[1]-open_15_buffer[1]>=0.0002 &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]<=0  && k2_240_buffer[1]-k2_240_buffer[2]<=0  &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-26*Point,Ask+2000*Point,"My order #B3",8803,0,Blue );
             ...
             (((ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0040) ||
                ...
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_15_buffer[1]<=8 && k2_15_buffer[1]<=8 &&  k3_15_buffer[1]<=8))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-25*Point,Ask+2000*Point,"My order #B4",8804,0,Brown );
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0080) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && low_15_buffer[1]-open_15_buffer[1]<=-0.0080) &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-22*Point,Ask+2000*Point,"My order #B7",8807,0,OrangeRed );
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   BUY   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                 ...
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-21*Point,Ask+2000*Point,"My order #B8",8808,0,Tomato);
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0) || 
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && k2_240_buffer[1]-k2_240_buffer[2]>=0  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+27*Point,Bid-2000*Point,"My order #S2",4402,0,White );
        ...
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 && close_15_buffer[1]-open_15_buffer[1]<=-0.0002 &&
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && k2_240_buffer[1]-k2_240_buffer[2]>=0  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+26*Point,Bid-2000*Point,"My order #S3",4403,0,Lime );
        ...
        //        (ma45_15_buffer[1]-ma45_15_buffer[6]>=-0.0013 && ma90_15_buffer[1]-ma90_15_buffer[6]>=-0.0013) || 
                ...
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_15_buffer[1]>=92 && k2_15_buffer[1]>=92 &&  k3_15_buffer[1]>=92))
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+25*Point,Bid-2000*Point,"My order #S4",4404,0,Gray );
             ...
             close_240_buffer[1]-open_240_buffer[1]<=-0.0001  && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && k2_240_buffer[1]-k2_240_buffer[2]>=0  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+22*Point,Bid-2000*Point,"My order #S7",4407,0,Olive );
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && 
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && k2_240_buffer[1]-k2_240_buffer[2]>=0  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+22*Point,Bid-2000*Point,"My order #S8",4408,0,SeaGreen );
...
//+++++++++++++++++++++++++++++++++++++++++++CLOSE   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
               ...
               close_15_buffer[1]-close_15_buffer[3]>=0.0001  &&  close_15_buffer[1]-close_15_buffer[4]>=0.0001) 
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                   macdsignalline_30_buffer[1]>=-0.00099 && macdsignalline_30_buffer[1]<=2000) ||
                                        //H4 k1,k2,k3全向下,或 kd2,kd3向下開口大 或 k1,k,2,k3在極低
                  (k2_240_buffer[1]-d2_240_buffer[1]<=-18  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-18) ||
                  (k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                  (k1_240_buffer[1]-k1_240_buffer[2]<=0  && k2_240_buffer[1]-k2_240_buffer[2]<=0  &&
