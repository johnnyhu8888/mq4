...
//trade=1;
 ...
 //**************************   oders modify  ***************************************************************88
                            //任一筆
           if    (OrderType()==OP_BUY &&   // || OrderMagicNumber( )==8802) &&
           ...
           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8805) &&// || OrderMagicNumber( )==8802) &&
...
//                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+30*Point,OrderTakeProfit(),0,Blue);
           ...
           if    (OrderType()==OP_SELL && //(OrderMagicNumber( )==4405)&& // || OrderMagicNumber( )==4402) &&
...
//   if ( OrdersTotal()>0 && OrderMagicNumber() == 4405 ) 
     ...
     if   (((k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50 &&
             k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50 &&
             k1_30_buffer[1]>=50 &&   k2_30_buffer[1]>=50 && k3_30_buffer[1]>=50 &&
             k1_05_buffer[1]-k1_05_buffer[2]<=-2 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=1 &&
             close_05_buffer[1]-open_05_buffer[1]>=0.00010 && close_05_buffer[2]-open_05_buffer[2]<=-0.00010) ||
      
            (k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50 &&
             k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50 &&
             k1_30_buffer[1]>=50 &&   k2_30_buffer[1]>=50 && k3_30_buffer[1]>=50 &&
             k2_05_buffer[1]-d2_05_buffer[1]<=-15 && k3_05_buffer[1]-d3_05_buffer[1]<=-15)) && 
     ...
     if  (((k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
           ...
           (k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0 &&
            ...
            if    (k1_15_buffer[1]-d1_15_buffer[1]>=3 &&   k1_15_buffer[1]<=50)                               
                         ...
                         //m60 m240   k2,k3尚在上面,且開口很大  不做買單
            if   ((d2_30_buffer[1]>=45 && d3_30_buffer[1]>=45 &&
                   k2_30_buffer[1]-d2_30_buffer[1]<=-20 && k3_30_buffer[1]-d3_30_buffer[1]<=-20) ||
                  (d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                   k2_60_buffer[1]-d2_60_buffer[1]<=-20 && k3_60_buffer[1]-d3_60_buffer[1]<=-20) ||
                  (d2_60_buffer[1]>=50 && d3_60_buffer[1]>=50 &&
     ...
     if   (((k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
            ...
            (k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
             ...
             k2_05_buffer[1]-d2_05_buffer[1]>=15 && k3_05_buffer[1]-d3_05_buffer[1]>=15)) && 
                 ...
                 //m60 m240   k2,k3尚在下面,且開口很大 不做賣單
            (d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
             k2_30_buffer[1]-d2_30_buffer[1]>=20 && k3_30_buffer[1]-d3_30_buffer[1]>=20) ||
            (d2_60_buffer[1]<=55 && d3_60_buffer[1]<=55 &&
             k2_60_buffer[1]-d2_60_buffer[1]>=20 && k3_60_buffer[1]-d3_60_buffer[1]>=20) ||
            (d2_60_buffer[1]<=50 && d3_60_buffer[1]<=50 &&
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 8805 ) 
     ...
     if   (((k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
         ...
         (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
          ...
          OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+500*Point,"My order #short",8805,0,Yellow );
...
//*** long Sell  1  ********************************************************************************************************************** 
    ...
    if  ( OrdersTotal()>0 && (OrderMagicNumber()==4401 || OrderMagicNumber()==4411)) 
       return;
       else
 ...
 //                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-1200*Point,"My order #LS11",4411,0,Blue);
     ...
     if   (((k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50 &&
           ...
           ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
             ...
             (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.001000) ||
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-500*Point,"My order #S1",4405,0,Green);
