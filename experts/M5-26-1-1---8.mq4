...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
     {              
       ...
       if ((ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && 
           ...
           (ma45_15_buffer[1]-ma45_15_buffer[6]>=0 && 
           ma45_15_buffer[1]-ma45_15_buffer[40]>=0 && ma45_15_buffer[1]-ma45_15_buffer[40]<=0.0015 &&
           ma90_15_buffer[1]-ma90_15_buffer[6]>=0  &&
           close_15_buffer[1]-ma90_15_buffer[1]<=0.0003 && 
           k1_15_buffer[1]<=20 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00028) ||
           
           
          (ma45_30_buffer[1]-ma45_30_buffer[6]>=0 && 
           ma45_30_buffer[1]-ma45_30_buffer[40]>=0 && ma45_30_buffer[1]-ma45_30_buffer[40]<=0.0015 &&
           ma90_30_buffer[1]-ma90_30_buffer[6]>=0  &&
           close_30_buffer[1]-ma90_30_buffer[1]<=0.0003 && 
           k1_30_buffer[1]<=20 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00028))
       
        { 
                      // m15 m30 k1k2k3[0]-[1]<=-1
            if ((k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                k1_30_buffer[1]-k1_30_buffer[2]<=-1 && k2_30_buffer[1]-k2_30_buffer[2]<=-1 ) ||
                
               (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-0.0001 ))
  ...
  //***  buy 2  ********************************************************************************** 
          ...
          if ((close_05_buffer[2]-open_05_buffer[2]<=-0.0003 && close_05_buffer[1]-open_05_buffer[1]>=0.0007 &&
             ...
             (close_15_buffer[2]-open_15_buffer[2]<=-0.0003 && close_15_buffer[1]-open_15_buffer[1]>=0.0007 &&
              k1_15_buffer[1]<=25 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25) ||
              
              (close_30_buffer[2]-open_30_buffer[2]<=-0.0003 && close_30_buffer[1]-open_30_buffer[1]>=0.0007 &&
  ...
  //***  buy 3  ********************************************************************************** 
                                             ...
                                             // mma05 ma12 丁禯<=-0.0001 [1]<[2]  [2]<=0.0003 [1]Μ>=0 
          if ((ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 && ma05_15_buffer[1]-ma12_15_buffer[2]>=-0.0010 &&
              k1_15_buffer[1]<=25 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && k1_15_buffer[1]-d1_15_buffer[1]>=3 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00020) &&
              (close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[1]-open_15_buffer[1]>=0.0003) ||
              (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]>=0))
           {                                                       // m15 m30 k1k2k3[0]-[1]<=-1
                    if ((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                        ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-0.0001)||
            
                        (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                         k1_30_buffer[1]-k1_30_buffer[2]<=-1 && k2_30_buffer[1]-k2_30_buffer[2]<=-1))
...
//*** Sell  1  ********************************************************************************************************************** 
     ...
     {              
       ...
       if ((ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
          ...
          (ma45_15_buffer[1]-ma45_15_buffer[6]<=0 && 
           ...
           ma90_15_buffer[1]-ma90_15_buffer[6]<=0  &&
           close_15_buffer[1]-ma90_15_buffer[1]>=-0.0003 && 
           k1_15_buffer[1]>=80 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00028) ||
           ...
           ma90_30_buffer[1]-ma90_30_buffer[6]<=0  &&
           close_30_buffer[1]-ma90_30_buffer[1]>=-0.0003 && 
           k1_30_buffer[1]>=80 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00028))
 ...
 //***  sell 2  ********************************************************************************** 
                                                   ...
                                                   //[2]>=0.0003  [1]<=-0.0008
           if ((close_05_buffer[2]-open_05_buffer[2]>=0.0001 && close_05_buffer[1]-open_05_buffer[1]<=-0.0007 &&
  ...
  //***  sell 3  ********************************************************************************** 
        ...
        if   ((ma05_15_buffer[1]-ma12_15_buffer[1]>=0.0001 && ma05_15_buffer[1]-ma12_15_buffer[2]<=0.0010 &&
              k1_15_buffer[1]>=75 && k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && k1_15_buffer[1]-d1_15_buffer[1]<=-3 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00020) &&
              (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]<=-0.0003) ||
              (close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[1]-open_15_buffer[1]<=0))
         {
...
//***  CLOSE Buy    ********************************************************************************** 
 //***  CLOSE Buy    ********************************************************************************** 
      ...
      if  (OrderType()==OP_BUY)
       {  
                                                       // mma05 ma12 丁禯<=-0.0001 [1]<[2]  [2]<=0.0003 [1]Μ>=0 
          if (((ma05_05_buffer[1]-ma12_05_buffer[1])-(ma05_05_buffer[2]-ma12_05_buffer[2]) <=-0.0001 )&& 
              ma05_05_buffer[1]-ma12_05_buffer[1]>=0.0001 &&
              k1_05_buffer[1]>=70 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70 &&
              (close_05_buffer[2]-open_05_buffer[2]>=0.0003  &&  close_05_buffer[1]-open_05_buffer[1]<=0) ||
              (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]<=0))
