   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       ...
       //虫秨4000ずぃ禦芥
 if   (TimeCurrent()-OrderOpenTime()<=4000 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]>=0) ||
          ...
          (k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0))) 
           if    (k1_05_buffer[0]-d1_05_buffer[0]>=3 &&   k1_05_buffer[1]<=50)                               
                    ...
                    //Τ1眎buy1虫,ぃ禦             
               if   ((longbuy01>0 && longbuy01<=2)  ||

                      (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.00050 &&  ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00050)) 	
                       return;	
                       else	
         ...
         ((d3_30_buffer[1]-d3_30_buffer[2]>=0) ||
          ...
          (k2_30_buffer[1]-k2_30_buffer[2]>=0 && k3_30_buffer[1]-k3_30_buffer[2]>=0))) 
           if    (k1_05_buffer[0]-d1_05_buffer[0]>=3 &&   k1_05_buffer[1]<=50)                               
                    ...
                    //Τ2眎buy2虫,ぃ禦             
               if   ((longbuy02>0 && longbuy02<=2)  ||
           
                      (ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00050 &&  ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.00050)) 	
                       return;	
                       else	
         ...
         ((d3_60_buffer[1]-d3_60_buffer[2]>=0) ||
          ...
          (k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0))) 
           if    (k1_15_buffer[0]-d1_15_buffer[0]>=3 &&   k1_15_buffer[1]<=50)                               
                    ...
                    //Τ2眎buy3虫,ぃ禦             
               if   ((longbuy03>0 && longbuy03<=2)  ||
                     (ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.00050 &&  ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00100)) 	
                       return;	
                       else	
     ...
     if   (k1_05_buffer[1]>=70 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>75 && 
         ...
         ((d3_05_buffer[1]-d3_05_buffer[2]<=0) ||
          ...
          (k2_05_buffer[1]-k2_05_buffer[2]<=0 && k3_05_buffer[1]-k3_05_buffer[2]<=0))) 
                    ...
                    //Τ2眎sell1虫,ぃ禦             
               if   (shortsell01>0 && shortsell01<=2) 
...
//              if  ((OrdersTotal()==1 && longsell01==OrderTicket()) ||
             if     (ma05_15_buffer[1]-ma05_15_buffer[2]>=0.00050 &&  ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00050)
                     return;				
                     else				
...
//               if  ((OrdersTotal()==1 && longsell02==OrderTicket()) ||         
            if     (ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00050 &&  ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00050)	
                    return;				
                    else				
...
//              if    ((OrdersTotal()==1 && longsell03==OrderTicket()) ||           
               if    (ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00050 &&  ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00100) 	
                      return;				
                      else				          
