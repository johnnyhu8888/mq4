...
//*** close Buy  2  ***************************************************************************************** 
    ...
    if (  OrdersTotal()>0 && OrderMagicNumber() == 4402 ) 
       //    m5 k1,k2,k3,50,[1]Μ [2]Μ堵 SELL
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-2 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
            k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50) ||
           (k1_30_buffer[0]-k1_30_buffer[1]<=-2 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0 &&
            k1_30_buffer[1]>=50 &&   k2_30_buffer[1]>=50 && k3_30_buffer[1]>=50))) 
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-1 &&   k1_05_buffer[1]>=50)                               
