...
//     {              
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                  ...
                  return;
                   ...
                   longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+760*Point,"My order #3",8803,0,Yellow );
...
//*** long Buy  2  ***************************************************************************************** 
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
            ...
            longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1500*Point,"My order #4",8804,0,Yellow );
...
//┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
              ...
              longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-750*Point,"My order #S3",4403,0,Green);
     }
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if  (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                  ...
                  longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-1500*Point,"My order #S4",4404,0,Green);
     }      
...
//*** Sell  1  ********************************************************************************************************************** 
  ...
  if (OrdersTotal()>0)
   ...
   //         Comment("TTTTTTTTTTTT   ",TimeCurrent()-OrderOpenTime(),"   KKKKKKKKKK  ",OrderOpenPrice()-high_60_buffer[0],
     //       "  EEEEEEE  ",OrderOpenPrice()-high_60_buffer[1], "   RRRRRRRRRRRR  ",OrderOpenPrice()-high_60_buffer[2],
    //         "  SSSSSSSSSS  ",OrderOpenPrice()-high_60_buffer[3], "   MMMMMMMMMM  ",OrderOpenPrice()-high_60_buffer[4]);                                                             
         
                              //秨虫10だず硉,搭ぶ穕ア
         if (OrderType()==OP_BUY &&  TimeCurrent()-OrderOpenTime()<=15000 && (longbuy01==OrderTicket() || longbuy02==OrderTicket()))
                 if ((OrderOpenPrice()-high_60_buffer[0]<=0.00150 && OrderOpenPrice()-high_60_buffer[1]<=0.00150 &&
                      OrderOpenPrice()-high_60_buffer[2]<=0.00150 && OrderOpenPrice()-high_60_buffer[3]<=0.00150) ||
                     (OrderOpenPrice()-high_240_buffer[0]<=0.00150 && OrderOpenPrice()-high_240_buffer[1]<=0.00150 &&
                      OrderOpenPrice()-high_240_buffer[2]<=0.00150 && OrderOpenPrice()-high_240_buffer[3]<=0.00150)) 
 ...
 //        else  
         ...
         if   (OrderType()==OP_BUY && TimeCurrent()-OrderOpenTime()<=1500 && shortbuy01==OrderTicket() &&
...
//                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+140*Point,OrderTakeProfit(),0,Blue);
 //        else
         ...
         if (OrderType()==OP_SELL &&   TimeCurrent()-OrderOpenTime()<=15000 && (longsell01==OrderTicket() || longsell02==OrderTicket()))
                 if ((OrderOpenPrice()-low_60_buffer[0]>=-0.00150 && OrderOpenPrice()-low_60_buffer[1]>=-0.00150 &&
                      OrderOpenPrice()-low_60_buffer[2]>=-0.00150 && OrderOpenPrice()-low_60_buffer[3]>=-0.00150)||
                     (OrderOpenPrice()-low_240_buffer[0]>=-0.00150 && OrderOpenPrice()-low_240_buffer[1]>=-0.00150 &&
                      OrderOpenPrice()-low_240_buffer[2]>=-0.00150 && OrderOpenPrice()-low_240_buffer[3]>=-0.00150))
         ...
         if   (OrderType()==OP_SELL && TimeCurrent()-OrderOpenTime()<=1500 && shortsell01==OrderTicket() &&
                      OrderOpenPrice()-low_05_buffer[0]<=0.00070 && OrderOpenPrice()-low_05_buffer[1]<=0.00070 &&
                      OrderOpenPrice()-low_05_buffer[2]<=0.00070 && OrderOpenPrice()-low_05_buffer[3]<=0.00070 )
