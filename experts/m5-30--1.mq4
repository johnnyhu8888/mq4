...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
       ...
       if ((ma05_05_buffer[1]-ma12_05_buffer[1]<=0 && ma05_05_buffer[1]-ma12_05_buffer[1]>=-0.0013 &&
          ...
          {
                // 虫ノ堵跑 ┮斗璶兵ン逼埃ぃ続祏既は锣   //m15 k1,k2,k3  m30  k1,k2 
                
          if    ((k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0 &&
                k1_30_buffer[1]-k1_30_buffer[2]<=0 && k2_30_buffer[1]-k2_30_buffer[2]<=0) ||
                
                                                        //    m15 05,08,12  m30 05,08
               ...
               (close_15_buffer[1]-open_15_buffer[1]<=-0.0001  &&  close_30_buffer[1]-open_30_buffer[1]<=-0.0001 &&
                ...
                close_30_buffer[2]-open_30_buffer[2]>=0  &&  close_30_buffer[3]-open_30_buffer[3]>=0) ||
                                         ...
                                         //m30  ma45,ma80 ma180℡禴 
                (ma45_30_buffer[1]-ma45_30_buffer[6]<=-0.0008 &&  ma90_30_buffer[1]-ma90_30_buffer[2]<=-0.0003 &&
                 ma180_30_buffer[1]-ma180_30_buffer[6]<=0 && ma45_30_buffer[1]-ma90_30_buffer[1]<=-0.0015 &&
                 ma90_30_buffer[1]-ma180_30_buffer[1]<=-0.0010)) 
                                 OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-80*Point,"My order #S3",4403,0,Lime );

               
        //         return;
                 else  
                   
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+100*Point,"My order #B1",8801,0,Red );

         }         
                                        //瞷は锣篈  
             if  ((ma05_15_buffer[1]-ma12_15_buffer[1]<=0 && ma05_15_buffer[1]-ma12_15_buffer[1]>=-0.0013 &&
                  k1_15_buffer[1]<=36 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && k1_15_buffer[1]-d1_15_buffer[1]>=1 &&
                  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00015) &&
                  (close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[1]-open_15_buffer[1]>=0.0001) ||
                  (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]>=0))
          
                                          //m30 k1,k2,k3  kd2,kd3秨
                  if  ((k1_30_buffer[1]-d1_30_buffer[1]<=-5 && k2_30_buffer[1]-d2_30_buffer[1]<=-10 && 
                       k3_30_buffer[1]-d3_30_buffer[1]<=-10 && 
                       k2_30_buffer[1]>=45 && k3_30_buffer[1]>=45) ||
                     
                      (k1_60_buffer[1]-d1_60_buffer[1]<=-5 && k2_60_buffer[1]-d2_60_buffer[1]<=-10 && 
                       k3_60_buffer[1]-d3_60_buffer[1]<=-10 && 
                      ...
                      (ma45_30_buffer[1]-ma45_30_buffer[6]<=-0.0008 &&  ma90_30_buffer[1]-ma90_30_buffer[2]<=-0.0003 &&
                       ma180_30_buffer[1]-ma180_30_buffer[6]<=0 && ma45_30_buffer[1]-ma90_30_buffer[1]<=-0.0015 &&
                       ma90_30_buffer[1]-ma180_30_buffer[1]<=-0.0010))
                                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-80*Point,"My order #S4",4404,0,Gray );
 
            //           return;
                       else
                       
                       OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+100*Point,"My order #B2",8802,0,Yellow );
     ...
     {                                            
         ...
         if ((ma05_05_buffer[1]-ma12_05_buffer[1]>=0 && ma05_05_buffer[1]-ma12_05_buffer[1]<=0.0013 &&
              ...
              (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]<=0))
            {
                                        ...
                                        // 虫ノ跑堵 ┮斗璶兵ン逼埃ぃ続祏既は锣  //m15 k1,k2,k3  m30  k1,k2 
                  if   ((k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0 &&
                         k1_30_buffer[1]-k1_30_buffer[2]>=0 && k2_30_buffer[1]-k2_30_buffer[2]>=0) ||
                      ...
                      (ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001 &&  ma05_30_buffer[1]-ma05_30_buffer[2]>=0.0001 &&
                       ma05_60_buffer[1]-ma05_60_buffer[2]>=0.0001 &&  k1_15_buffer[1]-k1_15_buffer[2]>=1) ||
                                                      ...
                                                      //m15 ,m30 [1]Μ [2][3]堵  m15 k1  害琿
                      (close_15_buffer[1]-open_15_buffer[1]>=0.0001  &&  close_30_buffer[1]-open_30_buffer[1]>=0.0001 &&
                       close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[3]-open_15_buffer[3]<=0 &&
                       close_30_buffer[2]-open_30_buffer[2]<=0  &&  close_30_buffer[3]-open_30_buffer[3]<=0) ||
                
                                             //m30  ma45,ma80 ma180℡害 
                      (ma45_30_buffer[1]-ma45_30_buffer[6]>=0.0008 &&  ma90_30_buffer[1]-ma90_30_buffer[2]>=0.0003 &&
                       ma180_30_buffer[1]-ma180_30_buffer[6]>=0 && ma45_30_buffer[1]-ma90_30_buffer[1]>=0.0015 &&
                       ma90_30_buffer[1]-ma180_30_buffer[1]>=0.0010)) 
                     
                       OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+80*Point,"My order #B3",8803,0,Blue );
          
               //          return;
                         else  
                        
                       OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-100*Point,"My order #S1",4401,0,Green );

            }  
  
                                             //瞷は锣篈  
             if ((ma05_15_buffer[1]-ma12_15_buffer[1]>=0 && ma05_15_buffer[1]-ma12_15_buffer[1]<=0.0013 &&
                  k1_15_buffer[1]>=64 && k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
                  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00015) &&
                  (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]<=-0.0001) ||
                  (close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[1]-open_15_buffer[1]<=0))
                  ...
                  if  ((k1_30_buffer[1]-d1_30_buffer[1]>=5 && k2_30_buffer[1]-d2_30_buffer[1]>=10 && 
                      ...
                      ((k2_30_buffer[1]-d2_30_buffer[1]>=20 && k3_30_buffer[1]-d3_30_buffer[1]>=20) ||
                       (k2_60_buffer[1]-d2_60_buffer[1]>=20 && k3_60_buffer[1]-d3_60_buffer[1]>=20)) ||
                              ...
                              //m30  ma45,ma80 ma180℡ど 
                      (ma45_30_buffer[1]-ma45_30_buffer[6]>=0.0008 &&  ma90_30_buffer[1]-ma90_30_buffer[2]>=0.0003 &&
                       ma180_30_buffer[1]-ma180_30_buffer[6]>=0 && ma45_30_buffer[1]-ma90_30_buffer[1]>=0.0015 &&
                       ma90_30_buffer[1]-ma180_30_buffer[1]>=0.0010))
                      OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+80*Point,"My order #B4",8804,0,Brown );
            //           return;
                       else
                     
                       OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-100*Point,"My order #S2",4402,0,White );
