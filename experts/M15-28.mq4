  ...
  if (OrdersTotal()<=1)   
     {                                           //m15 ma45  ma90 弊L禴ソ狠篈 
           if (ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && 
              ...
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00065 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00010 &&
                                             //k1 (k2||k3)ど
     ...
     {                                               //m15 ma45  ma90   どソ狠篈
          if (ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
              ...
              close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
                                                 //ノm15 m30 macd 北恨禦芥翴 
               macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010 &&
               macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00065 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010 &&
                                                   //k1 (k2||k3)禴
              k1_15_buffer[1]-k1_15_buffer[2]<=-1  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
              k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0)
     ...
     if   (OrderType()==OP_BUY)       
      {                                             
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0 && 
              close_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 &&
                                                    //ノm15 m30 macd 北恨禦芥翴                                                    
               macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=0.00010 &&
               macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00065 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=0.00010 &&

               k1_15_buffer[1]>=45 && k2_15_buffer[1]>=45 && k3_15_buffer[1]>=45 && 
               k1_15_buffer[1]-k1_15_buffer[2]<=-1  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-1 && 
               k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0)
       
           
               OrderClose(OrderTicket(),lots,Ask,1,Green);    
                                                       //絋﹚close禦虫,ヘ玡礚虫,ぃ兵穦は滦close   
               if (TimeCurrent()-OrderCloseTime()>=100 && OrdersTotal()<=0)
                 
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2",4402,0,Lime );
      ...
      if  (OrderType()==OP_SELL)
       {  
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0 && 
               ...
               k1_15_buffer[1]<=55 && k2_15_buffer[1]<=55 && k3_15_buffer[1]<=55  && 
               k1_15_buffer[1]-k1_15_buffer[2]>=1  &&  k1_15_buffer[1]-d1_15_buffer[1]>=1 && 
               k2_15_buffer[1]-k2_15_buffer[2]>=0  ||  k3_15_buffer[1]-k3_15_buffer[2]>=0)
       
              OrderClose(OrderTicket(),lots,Bid,1,Red); 
                                                       //絋﹚close芥虫,ヘ玡礚虫,ぃ兵穦は滦close  
              if (TimeCurrent()-OrderCloseTime()>=100 && OrdersTotal()<=0)
