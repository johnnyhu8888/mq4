...
//*** close Buy  9  ***************************************************************************************** 
 ...
 // m240 k1,k2或k3下降,且在70上
      if (((k1_240_buffer[1]-k1_240_buffer[2]<=-3 &&  (k2_240_buffer[1]-k2_240_buffer[2]<=-1 || k3_240_buffer[1]-k3_240_buffer[2]<=-1)) ||
...
//用在轉折所以排除條件較少      
 ...
 //K1,k2,k3 在低點 kd1交叉上            
            k1_15_buffer[1]<=30  &&  k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 &&
           (k1_15_buffer[1]-d1_15_buffer[1]>=2  || k1_15_buffer[1]-k1_15_buffer[2]>=4))
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+6900*Point,"My order #B6",8806,0,Aqua);
 ...
 //K1,k2,k3 在低點 kd1交叉上           
            k1_240_buffer[1]<=30  &&  k2_240_buffer[1]<=25 && k3_240_buffer[1]<=25 &&
           (k1_240_buffer[1]-d1_240_buffer[1]>=2 || k1_240_buffer[1]-k1_240_buffer[2]>=4))
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+6900*Point,"My order #B7",8807,0,Aqua);
 ...
 //m30,m60,m240全部在30下且開始上升
            ...
            k1_60_buffer[0]-k1_60_buffer[1]>=-1 && k1_60_buffer[1]<=30 &&
            k1_240_buffer[0]-k1_240_buffer[1]>=-2 && k1_240_buffer[1]<=30)
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+6900*Point,"My order #B8",8808,0,Aqua);
 ...
 //或[1][2][3]或[2][3][4]開或收盤在ma360上下各12點間
           ...
           ((close_240_buffer[4]-ma360_240_buffer[4]>=-0.00120 || close_240_buffer[4]-ma360_240_buffer[4]<=0.00120) ||
            (close_240_buffer[1]-ma360_240_buffer[1]>=-0.00120 || close_240_buffer[1]-ma360_240_buffer[1]<=0.00120))))
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+6900*Point,"My order #B9",8809,0,Aqua);
...
//H1,H4 kd1,2,3值差全部>1
 ...
 //K1,k2,k3 在高點 kd1交叉下            
            k1_240_buffer[1]>=70  &&  k2_240_buffer[1]>=75 && k3_240_buffer[1]>=75 &&
           (k1_240_buffer[1]-d1_240_buffer[1]<=-2 || k1_240_buffer[1]-k1_240_buffer[2]<=-4))
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-6900*Point,"My order #S7",4407,0,Green);
 ...
 //或[1][2][3]或[2][3][4]開或收盤在ma360上下各12點間
           ...
           ((close_240_buffer[4]-ma360_240_buffer[4]<=0.00120 || close_240_buffer[4]-ma360_240_buffer[4]>=-0.00120) ||
            (close_240_buffer[1]-ma360_240_buffer[1]<=0.00120 || close_240_buffer[1]-ma360_240_buffer[1]>=-0.00120))))
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-6900*Point,"My order #S9",4409,0,Green);
