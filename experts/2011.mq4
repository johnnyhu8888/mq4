...
if   (TimeCurrent()-OrderOpenTime()<=5000 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
  ...
  if  (OrdersTotal()<1 || (OrdersTotal()<3 && shortbuy01==OrderTicket() || shortbuy02==OrderTicket() || shortbuy03==OrderTicket() ||
       ...
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket()))
     {
        ...
        if (((ma45_15_buffer[1]-ma45_15_buffer[2]>=0 &&  ma45_15_buffer[1]-ma45_15_buffer[6]<=0) ||
                                                 //雖為下跌但h4 [1]尚為正大於20點
             (ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.00010 && 
                              //h4 收紅 且上影線<=0.00060
              close_240_buffer[1]-open_240_buffer[1]>=0.00200 && high_240_buffer[1]-close_240_buffer[1]<=0.00550 )) && 
              ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.00010&& 
                                                 //下跌末端上升要一次升過前3bar
              close_15_buffer[1]-close_15_buffer[2]>=0.000100  && // close_15_buffer[1]-close_15_buffer[3]>=0.00010 &&
      //        close_15_buffer[1]-close_15_buffer[4]>=0.00010  &&
                                             //用m15 m30 macd 控管買賣點 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.000200 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.000100 &&
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.000500 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.000200 &&
              macdmainline_30_buffer[1]<=0.001100   &&   
                                                         //m60 的45,90,180  皆是斜上
            (macdmainline_60_buffer[1]<=0.002000 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.00030 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.00030 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.000990 && macdmainline_15_buffer[1]<=0.000990 &&
                   macdmainline_30_buffer[1]>=-0.000800 && macdmainline_30_buffer[1]<=0.000800) ||
                   ...
                   (k2_60_buffer[1]-d2_60_buffer[1]<=-19  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-19) ||
                      //(m15-65) [1]收負<=25點 macd差值<=-0.002300
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.00250 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.002300) ||
                   ...
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-10  &&  k2_240_buffer[1]-d2_240_buffer[1]<=-10  && 
                    k3_240_buffer[1]-d3_240_buffer[1]<=-10  &&  k2_240_buffer[0]>=70 && k3_240_buffer[1]>=70) ||
                               //(m15-57) h4  kd1,kd2,kd3<=0   k1,k2,k3>=80 macd>=0.009000   
                   (k1_240_buffer[1]-d1_240_buffer[1]<=0  &&  k2_240_buffer[1]-d2_240_buffer[1]<=0  && 
                    ...
                    macdmainline_240_buffer[1]>=0.009000) ||
                   ...
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.01000  &&  close_240_buffer[2]-open_240_buffer[2]<=-0.00500  && 
                    ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00200  &&
                   (k1_240_buffer[1]>=50 && k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50) || (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.003500))  ||
                           //(m15-57)h4  kd1,kd2,kd3<=-4   ma05  [1]-[2]<=-0.0030
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-4  &&  k2_240_buffer[1]-d2_240_buffer[1]<=-4  && 
                    k3_240_buffer[1]-d3_240_buffer[1]<=-4  &&  ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00300) ||
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00060 && ma08_240_buffer[1]-ma08_240_buffer[2]<=-0.00060 &&
                    ma12_240_buffer[1]-ma12_240_buffer[2]<=-0.00060 && ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00060 &&
                    close_240_buffer[1]-open_240_buffer[1]<=-0.00010) ||
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00150 && ma08_240_buffer[1]-ma08_240_buffer[2]<=-0.00150 &&
                    ma12_240_buffer[1]-ma12_240_buffer[2]<=-0.00150 && ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00020 &&
                    ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00020 &&
                    close_240_buffer[1]-open_240_buffer[1]<=-0.00010) ||
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00040 && ma08_240_buffer[1]-ma08_240_buffer[2]<=-0.00040 &&
                    ma12_240_buffer[1]-ma12_240_buffer[2]<=-0.00040 && ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00020 &&
                    ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00020 && k1_240_buffer[1]-k1_240_buffer[2]<=0 &&
                   ...
                   (k2_240_buffer[1]>=70 && k3_240_buffer[1]>=70  && 
                    ...
                    k3_240_buffer[1]-k3_240_buffer[2]<=0 &&  close_240_buffer[1]-open_240_buffer[1]<=-0.00010) || 
 ...
 //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
                    (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                     ...
                     longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B1",8801,0,Red );
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (k1_60_buffer[1]<=15 && k2_60_buffer[1]<=15 && k3_60_buffer[1]<=15  && 
               ...
               close_60_buffer[1]-open_60_buffer[1]>=0.00200 && close_60_buffer[1]-close_60_buffer[2]>=0.00100 &&
               close_60_buffer[1]-close_60_buffer[3]>=0.00100 && close_60_buffer[1]-close_60_buffer[4]>=0.00100 &&
               close_60_buffer[1]-ma05_60_buffer[1]>=0.00100 && 
              ...
              (macdmainline_60_buffer[1]<=0.002000 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.00030 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.00030 && 
               ...
               if  ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-19  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-19 &&
                    k1_240_buffer[0]-k1_240_buffer[1]<=-2) ||
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-19  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-19 &&
                    macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.003000) ||
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-25  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-25) ||
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-15  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-15 &&
                    k2_240_buffer[0]>=40 && k3_240_buffer[1]>=40) ||
                            //h4  kd1,kd2,kd3<=-10   k2,k3>=70   
                   ...
                   (k1_240_buffer[1]-d1_240_buffer[1]<=0  &&  k2_240_buffer[1]-d2_240_buffer[1]<=0  && 
                    ...
                    macdmainline_240_buffer[1]>=0.009000) ||
                       //(m15-57)h4  kd1+kd2+kd3<=-35 
                   ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1])<=-35) ||
                            // (m15-57) h4  [1]<=-0.01000  [2]<=-0.00500  ma05[1]-[2]<=-0.00200  k1,k2,k3>=50 || macd差值>=-3500
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.01000  &&  close_240_buffer[2]-open_240_buffer[2]<=-0.00500  && 
                    ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00200  &&
                   (k1_240_buffer[1]>=50 && k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50) || (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.003500))  ||
                           //(m15-57)h4  kd1,kd2,kd3<=-4   ma05  [1]-[2]<=-0.00300
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-4  &&  k2_240_buffer[1]-d2_240_buffer[1]<=-4  && 
                    k3_240_buffer[1]-d3_240_buffer[1]<=-4  &&  ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00300) ||
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00060 && ma08_240_buffer[1]-ma08_240_buffer[2]<=-0.00060 &&
                    ma12_240_buffer[1]-ma12_240_buffer[2]<=-0.00060 && ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00060 &&
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B2",8802,0,Yellow );
                             
//+++++++++++++++++++++++++++++++++++++++++++   BUY   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      
                                                      //k1 一次上升大 kd1大幅交叉上 
         if ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  && close_15_buffer[1]-open_15_buffer[1]>=0.00020 &&
                                                   //設限以防過高再買進  
             ...
             (macdmainline_60_buffer[1]<=0.002000 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.00030 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.00030 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.000990 && macdmainline_15_buffer[1]<=0.000990 &&
                  ...
                  (close_240_buffer[1]-open_240_buffer[1]<=-0.00300 &&                          
                   ...
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.00250 &&  close_240_buffer[2]-open_240_buffer[2]<=-0.00600 &&                          
                    macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=0.000500 &&
                    macdmainline_240_buffer[2]-macdsignalline_240_buffer[2]>=0.000300) ||
                           //(m15-66) h4 [1]macd 值介於0.001500 與-0.001500間 且 kd1,kd2,kd3<=-4 不交易                                
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-4 && k2_240_buffer[1]-d2_240_buffer[1]<=-4 &&
                    k3_240_buffer[1]-d3_240_buffer[1]<=-4 &&                       
                    macdmainline_240_buffer[1]>=-0.001500 && macdmainline_240_buffer[1]<=0.001500 &&
                    macdsignalline_240_buffer[1]>=-0.001500 &&  macdsignalline_240_buffer[1]<=0.001500) ||
                  //(m15-66) h4 [1]macd 值介於0.001000 與-0.001000間  不交易                                
                   (macdmainline_240_buffer[1]>=-0.001000 && macdmainline_240_buffer[1]<=0.001000 &&
                    macdsignalline_240_buffer[1]>=-0.001000 &&  macdsignalline_240_buffer[1]<=0.001000) ||
                                  //(m15-66)  macd 差值<=-0.004500  signal[1]-[2]<=-0.001000
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.004500 &&
                    macdsignalline_240_buffer[1]- macdsignalline_240_buffer[2]<=-0.001000) ||
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B3",8803,0,Blue );

//+++++++++++++++++++++++++++++++++++++++++++   BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
    
             //m15 的 [+4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00060  較易發生條件較嚴
        if  (((close_15_buffer[1]-open_15_buffer[1]>=0.00060 && close_15_buffer[4]-open_15_buffer[4]>=0.00060  && 
               close_15_buffer[2]-open_15_buffer[2]<=-0.00060 && close_15_buffer[3]-open_15_buffer[3]<=-0.00060 &&
              ...
              (close_15_buffer[1]-open_15_buffer[1]>=0.00010  && low_15_buffer[1]-close_15_buffer[1]<=-0.00290) ||
              (k2_15_buffer[1]-k2_15_buffer[2]>=2 && k3_15_buffer[1]-k3_15_buffer[2]>=2) ||
              (ma05_15_buffer[1]-ma05_15_buffer[2]>=-0.00060 && 
              (k2_15_buffer[1]-k2_15_buffer[2]>=0 || k3_15_buffer[1]-k3_15_buffer[2]>=0)))) ||
               
                //m15 的 [+5][-4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00060  
              (close_15_buffer[1]-open_15_buffer[1]>=0.00060 && close_15_buffer[5]-open_15_buffer[5]>=0.00060  && 
               close_15_buffer[2]-open_15_buffer[2]<=-0.00060 && close_15_buffer[3]-open_15_buffer[3]<=-0.00060 &&
               close_15_buffer[4]-open_15_buffer[4]<=-0.00060 &&
               k1_15_buffer[1]-k1_15_buffer[2]>=0  && close_15_buffer[1]-close_15_buffer[3]>=0.00010 &&
              (low_15_buffer[1]==M15lowest40bar ||  low_15_buffer[2]==M15lowest40bar) && 
              (ma05_15_buffer[1]-ma05_15_buffer[2]>=-0.00010 || 
              (close_15_buffer[1]-open_15_buffer[1]>=0.00010  && low_15_buffer[1]-close_15_buffer[1]<=-0.00290) ||
              (k2_15_buffer[1]-k2_15_buffer[2]>=2 && k3_15_buffer[1]-k3_15_buffer[2]>=2) ||
              (ma05_15_buffer[1]-ma05_15_buffer[2]>=-0.00060 && 
              (k2_15_buffer[1]-k2_15_buffer[2]>=0 || k3_15_buffer[1]-k3_15_buffer[2]>=0)))) ||
               
                 //m30 的 [+4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00080  較易發生條件較嚴
              (close_30_buffer[1]-open_30_buffer[1]>=0.00080 && close_30_buffer[4]-open_30_buffer[4]>=0.00080  && 
               close_30_buffer[2]-open_30_buffer[2]<=-0.00080 && close_30_buffer[3]-open_30_buffer[3]<=-0.00080 &&
               k1_30_buffer[1]-k1_30_buffer[2]>=0  && close_30_buffer[1]-close_30_buffer[3]>=0.00010 &&
              (low_30_buffer[1]==M30lowest40bar ||  low_30_buffer[2]==M30lowest40bar) && 
              (ma05_30_buffer[1]-ma05_30_buffer[2]>=0 || 
              (close_30_buffer[1]-open_30_buffer[1]>=0.00010  && low_30_buffer[1]-close_30_buffer[1]<=-0.00290) ||
              (k2_30_buffer[1]-k2_30_buffer[2]>=2 && k3_30_buffer[1]-k3_30_buffer[2]>=2) ||
              (ma05_30_buffer[1]-ma05_30_buffer[2]>=-0.00060 && 
              (k2_30_buffer[1]-k2_30_buffer[2]>=0 || k3_30_buffer[1]-k3_30_buffer[2]>=0)))) ||
                  //m30 的 [+5][-4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00080  
              (close_30_buffer[1]-open_30_buffer[1]>=0.00080 && close_30_buffer[5]-open_30_buffer[5]>=0.00080  && 
               close_30_buffer[2]-open_30_buffer[2]<=-0.00080 && close_30_buffer[3]-open_30_buffer[3]<=-0.00080 &&
               close_30_buffer[4]-open_30_buffer[4]<=-0.00080 &&
               k1_30_buffer[1]-k1_30_buffer[2]>=0  && close_30_buffer[1]-close_30_buffer[3]>=0.00010 &&
              (low_30_buffer[1]==M30lowest40bar ||  low_30_buffer[2]==M30lowest40bar) && 
              (ma05_30_buffer[1]-ma05_30_buffer[2]>=-0.00010 || 
              (close_30_buffer[1]-open_30_buffer[1]>=0.00010  && low_30_buffer[1]-close_30_buffer[1]<=-0.00290) ||
              (k2_30_buffer[1]-k2_30_buffer[2]>=2 && k3_30_buffer[1]-k3_30_buffer[2]>=2) ||
              (ma05_30_buffer[1]-ma05_30_buffer[2]>=-0.00060 && 
              (k2_30_buffer[1]-k2_30_buffer[2]>=0 || k3_30_buffer[1]-k3_30_buffer[2]>=0)))) ||
             
                  //m60 的 [+4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00100  較易發生條件較嚴
              (close_60_buffer[1]-open_60_buffer[2]>=-0.00010  &&
               close_60_buffer[1]-open_60_buffer[1]>=0.00100 && close_60_buffer[4]-open_60_buffer[4]>=0.00100  && 
               close_60_buffer[2]-open_60_buffer[2]<=-0.00100 && close_60_buffer[3]-open_60_buffer[3]<=-0.00100 &&
              ...
              (close_60_buffer[1]-open_60_buffer[1]>=0.00010  && low_60_buffer[1]-close_60_buffer[1]<=-0.00290) ||
              (k2_60_buffer[1]-k2_60_buffer[2]>=2 && k3_60_buffer[1]-k3_60_buffer[2]>=2) ||
              (ma05_60_buffer[1]-ma05_60_buffer[2]>=-0.00060 && 
              (k2_60_buffer[1]-k2_60_buffer[2]>=0 || k3_60_buffer[1]-k3_60_buffer[2]>=0)))) ||
                    //m60 的 [+5][-4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00100  
              (close_60_buffer[1]-open_60_buffer[2]>=-0.00010  &&
               close_60_buffer[1]-open_60_buffer[1]>=0.00100 && close_60_buffer[5]-open_60_buffer[5]>=0.00100  && 
               close_60_buffer[2]-open_60_buffer[2]<=-0.00100 && close_60_buffer[3]-open_60_buffer[3]<=-0.00100 &&
               close_60_buffer[4]-open_60_buffer[4]<=-0.00100 &&
               k1_60_buffer[1]-k1_60_buffer[2]>=0  &&
              (low_60_buffer[1]==H1lowest40bar ||  low_60_buffer[2]==H1lowest40bar) && 
              (ma05_60_buffer[1]-ma05_60_buffer[2]>=-0.00010 || 
              (close_60_buffer[1]-open_60_buffer[1]>=0.00010  && low_60_buffer[1]-close_60_buffer[1]<=-0.00290) ||
              (k2_60_buffer[1]-k2_60_buffer[2]>=2 && k3_60_buffer[1]-k3_60_buffer[2]>=2) ||
              (ma05_60_buffer[1]-ma05_60_buffer[2]>=-0.00060 && 
              (k2_60_buffer[1]-k2_60_buffer[2]>=0 || k3_60_buffer[1]-k3_60_buffer[2]>=0))))) &&
              ...
              if   ((k1_240_buffer[1]>=65 && k2_240_buffer[1]>=65 && k3_240_buffer[1]>=65) ||                   
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B4",8804,0,Brown );

//+++++++++++++++++++++++++++++++++++++++++++   BUY   5   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                    
                                     //m15 長下影線 >=24點  [1]>0.0001開-低  [1]<-0.00010收-低
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.00010 && low_15_buffer[1]-close_15_buffer[1]<=-0.00240) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.00010  && low_15_buffer[1]-open_15_buffer[1]<=-0.00240) &&
              ...
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00900 && 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.000100) 
              
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.01000 || close_15_buffer[1]-open_15_buffer[1]<=-0.01000 ||
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=-0.001200 || 
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.000500) ||
                                                 //避開下跌後之反彈
                  (open_15_buffer[3]-open_15_buffer[2]<=0.00030 && open_15_buffer[4]-open_15_buffer[2]<=0.00030) ||    
                  (open_15_buffer[2]-open_15_buffer[1]<=0.00030 && open_15_buffer[3]-open_15_buffer[1]<=0.00030) ||     
                  (macdmainline_15_buffer[1]>=-0.000990 && macdmainline_15_buffer[1]<=0.000990 &&
                   macdmainline_30_buffer[1]>=-0.000800 && macdmainline_30_buffer[1]<=0.000800) ||
                                      //h4  k2,k3 在47上  開口向下  不做買單 
                   (k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                    k2_240_buffer[1]-d2_240_buffer[1]<=0 && k3_240_buffer[1]-d3_240_buffer[1]<=0) || 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy05=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B5",8805,0,Purple );
  
//+++++++++++++++++++++++++++++++++++++++++++   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                 //h1 [1]留下影線 >=24點  [1]>0.0001開-低  [1]<-0.00010收-低
       if  (((close_60_buffer[1]-open_60_buffer[1]<=-0.00010 && close_60_buffer[1]-open_60_buffer[1]>=-0.00060 && 
              low_60_buffer[1]-close_60_buffer[1]<=-0.00240) ||
             (close_60_buffer[1]-open_60_buffer[1]>=0.00010  && close_60_buffer[1]-open_60_buffer[1]>=-0.00060 && 
              low_60_buffer[1]-open_60_buffer[1]<=-0.00240) &&
              ...
              k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0) ||
                                         //[1]收紅 [2]留下影線
             ((close_60_buffer[2]-open_60_buffer[2]<=-0.00010 && close_60_buffer[2]-open_60_buffer[2]>=-0.00060 && 
              low_60_buffer[2]-close_60_buffer[2]<=-0.00240) ||
             (close_60_buffer[2]-open_60_buffer[2]>=0.00010  && close_60_buffer[1]-open_60_buffer[1]>=-0.00060 && 
              low_60_buffer[2]-open_60_buffer[2]<=-0.00240) &&
              ...
              macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.02000 && 
              macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.000100) 
              
              if ((close_60_buffer[2]-open_60_buffer[2]<=-0.01000 || close_60_buffer[1]-open_60_buffer[1]<=-0.01000 ||
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=-0.002000 || 
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.000500) ||
                                                 //避開下跌後之反彈
                  (open_60_buffer[3]-open_60_buffer[2]<=0.00030 && open_60_buffer[4]-open_60_buffer[2]<=0.00030) ||    
                  (open_60_buffer[2]-open_60_buffer[1]<=0.00030 && open_60_buffer[3]-open_60_buffer[1]<=0.00030) ||     
                  (macdmainline_60_buffer[1]>=-0.000990 && macdmainline_60_buffer[1]<=0.000990 &&
                   macdmainline_30_buffer[1]>=-0.000800 && macdmainline_30_buffer[1]<=0.000800) ||
                                       //h4  k2,k3 在47上  開口向下  不做買單 
                   (k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                    k2_240_buffer[1]-d2_240_buffer[1]<=0 && k3_240_buffer[1]-d3_240_buffer[1]<=0) || 
                   ...
                   (k1_240_buffer[1]-d1_240_buffer[1]<=0  &&  k2_240_buffer[1]-d2_240_buffer[1]<=0  && 
                    ...
                    macdmainline_240_buffer[1]>=0.009000) ||
                       //(m15-57)h4  kd1+kd2+kd3<=-35 
                   ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1])<=-35) ||
                            // (m15-57) h4  [1]<=-0.01000  [2]<=-0.00500  ma05[1]-[2]<=-0.00200  k1,k2,k3>=50 || macd差值>=-350
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.01000  &&  close_240_buffer[2]-open_240_buffer[2]<=-0.00500  && 
                    ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00200  &&
                   (k1_240_buffer[1]>=50 && k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50) || (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.003500))  ||
                           //(m15-57)h4  kd1,kd2,kd3<=-4   ma05  [1]-[2]<=-0.00300
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy06=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B6",8806,0,Gold );
 
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                     
                         //(m15-61)  H4     [2]留下影線>80點  [1]>=[2] 
       if  ((((close_240_buffer[2]-open_240_buffer[2]<=-0.00010 && low_240_buffer[2]-close_240_buffer[2]<=-0.00800) ||
              (close_240_buffer[2]-open_240_buffer[2]>=0.00010  && low_240_buffer[2]-open_240_buffer[2]<=-0.00800)) &&
               close_240_buffer[1]-open_240_buffer[1]>=0.00010 &&
                                                          //H4 k1,k2,k3 <=30   || [2]<=-0.0250
             ((k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30  &&  k3_240_buffer[1]<=30) || (close_240_buffer[2]-open_240_buffer[2]<=-0.02500))) ||
          
                //(m15-66)  [2]留下影線>35  k1,k2,k3>=35   ma12-ma05<=-0.00050   close[4]||[5]||[6]||[7]>close[1]&& [2] 含w底性質
          (((close_240_buffer[2]-open_240_buffer[2]<=-0.00010 && low_240_buffer[2]-close_240_buffer[2]<=-0.00350) ||
            (close_240_buffer[2]-open_240_buffer[2]>=0.00010  && low_240_buffer[2]-open_240_buffer[2]<=-0.00350)) &&
           ...
           ((close_240_buffer[1]-open_240_buffer[1]>=0.00300  && ma12_240_buffer[1]-ma05_240_buffer[2]>=0.00050 && 
             k1_240_buffer[1]<=40 && k2_240_buffer[1]<=40  &&  k3_240_buffer[1]<=40) || 
            
                //(m15-66)  k1,k2,k3<=25,k2,k3>=1,d2,d3>=0,kd1,kd2>=2  macd main && signal[1]-[2]>=0.000030
             (k2_240_buffer[1]<=25  &&  k3_240_buffer[1]<=25 && k2_240_buffer[1]-k2_240_buffer[2]>=1 &&
              ...
              macdmainline_240_buffer[1]-macdmainline_240_buffer[2]>=0.000030 && 
              macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]>=0.000030))) ||
        
              
                //(m15-66) H4 [2] 留下影線>70點 [1]>下影線100點 macd差值[1]-[2]>50
            (((close_240_buffer[2]-open_240_buffer[2]<=-0.00010 && low_240_buffer[2]-close_240_buffer[2]<=-0.00700) ||
             (close_240_buffer[2]-open_240_buffer[2]>=0.00010   && low_240_buffer[2]-open_240_buffer[2]<=-0.00700)) &&
             ((close_240_buffer[1]-open_240_buffer[1]<=-0.00010 && low_240_buffer[1]-close_240_buffer[1]<=-0.01000) ||
             (close_240_buffer[1]-open_240_buffer[1]>=0.00010   && low_240_buffer[1]-open_240_buffer[1]<=-0.01000)) &&
              macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=0.003700 && 
              macdmainline_240_buffer[1]>=0.004500 && macdsignalline_240_buffer[1]>=0.000500))  
                        // (m15-67) 
               if    ((k1_240_buffer[1]-d1_240_buffer[1]<=-12 &&  (k2_240_buffer[1]-d2_240_buffer[1]<=-5 || k3_240_buffer[1]-d3_240_buffer[1]<=-5) &&
                     ...
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy07=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B7",8807,0,OrangeRed );
  
  //+++++++++++++++++++++++++++++++++++++++++++   BUY   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
              
                     //(m15-62)   h4 的 ma180斜上 或ma180持平 ma360 斜上   
        if   (((ma180_240_buffer[1]-ma180_240_buffer[2]>=0.00010 ||  (ma180_240_buffer[1]-ma180_240_buffer[2]>=0 &&
               ma360_240_buffer[1]-ma360_240_buffer[2]>=0.00010)) &&
                  // [1]收在ma180上的20點內  
               close_240_buffer[1]-ma180_240_buffer[1]>=0.00010  && close_240_buffer[1]-ma180_240_buffer[1]<=0.00200 &&
                 //h4 [1]下影線超過30點
              ...
              (close_240_buffer[1]-open_240_buffer[1]>=0.00010  && low_240_buffer[1]-open_240_buffer[1]<=-0.00300)) &&
               ...
               macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.001500 &&  macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001000 &&
                   // [2]||[3]||[4]收在ma180上的20點內  
             ((close_240_buffer[2]-ma180_240_buffer[2]>=0.00010  && close_240_buffer[2]-ma180_240_buffer[2]<=0.00200) ||
              (close_240_buffer[3]-ma180_240_buffer[3]>=0.00010  && close_240_buffer[3]-ma180_240_buffer[3]<=0.00200) ||
              (close_240_buffer[4]-ma180_240_buffer[4]>=0.00010  && close_240_buffer[4]-ma180_240_buffer[4]<=0.00200))) ||
              ...
              (ma180_240_buffer[1]-ma180_240_buffer[2]>=-0.00010 && ma360_240_buffer[1]-ma360_240_buffer[2]>=-0.00010 &&
               ma650_240_buffer[1]-ma650_240_buffer[2]>=-0.00010 && 
                  // [1]收在ma360上的20點內  
               close_240_buffer[1]-ma360_240_buffer[1]>=0.00010  && close_240_buffer[1]-ma360_240_buffer[1]<=0.00200 &&
                 //h4 [1]下影線超過30點
              ((close_240_buffer[1]-open_240_buffer[1]<=-0.00010 && low_240_buffer[1]-close_240_buffer[1]<=-0.00300) ||
              (close_240_buffer[1]-open_240_buffer[1]>=0.00010  && low_240_buffer[1]-open_240_buffer[1]<=-0.00300)) &&
                 //kd1>=3      
               k1_240_buffer[1]-d1_240_buffer[1]>=3 &&
                   // [2]||[3]||[4]收在ma360上的20點內  
             ((close_240_buffer[2]-ma360_240_buffer[2]>=-0.00050  && close_240_buffer[2]-ma360_240_buffer[2]<=0.00200) ||
              (close_240_buffer[3]-ma360_240_buffer[3]>=-0.00050  && close_240_buffer[3]-ma360_240_buffer[3]<=0.00200) ||
              (close_240_buffer[4]-ma360_240_buffer[4]>=-0.00050  && close_240_buffer[4]-ma360_240_buffer[4]<=0.00200))))
                            // (m15-67) 
               if   ((k1_240_buffer[1]-d1_240_buffer[1]<=-12 &&  (k2_240_buffer[1]-d2_240_buffer[1]<=-5 || k3_240_buffer[1]-d3_240_buffer[1]<=-5) &&
                      k2_240_buffer[1]>=75 && k3_240_buffer[1]>=75) ||
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy08=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B8",8808,0,OrangeRed );

  //+++++++++++++++++++++++++++++++++++++++++++   BUY   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                 
              //h4 的 case-buy1  [+4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00300 
        if   ((close_240_buffer[1]-open_240_buffer[1]>=0.00300 && close_240_buffer[4]-open_240_buffer[4]>=0.00100  && 
               close_240_buffer[2]-open_240_buffer[2]<=-0.00100 && close_240_buffer[3]-open_240_buffer[3]<=-0.00100 &&
                //(m15-61)  [1]上影線小於15點
               high_240_buffer[1]-close_240_buffer[1]<=0.00150  &&
             ...
             ((k1_240_buffer[1]-d1_240_buffer[1]>=-3  && (k2_240_buffer[1]-d2_240_buffer[1]>=-3 || k3_240_buffer[1]-d3_240_buffer[1]>=-3)) ||
                      // (m15-61)  macd差值>=-0.001500  <=0.001000 
              (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.001500 &&  macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001000))  &&
                //(m15-66)  h4 收盤必須離ma05在20點內  k2,k3必須在35下以免已漲過高 kd2,kd3>=9
             ((ma05_240_buffer[1]- close_240_buffer[1]<=0.00200 && ma05_240_buffer[1]-ma05_240_buffer[2]>=0 &&
          ...
          //       //(m15=58)  h4 收盤必須離ma05在15點內   h1   k1,k2,k3必須在30下以免已漲過高
              (ma05_240_buffer[1]- close_240_buffer[1]<=0.00150 && ma05_240_buffer[1]-ma05_240_buffer[2]>=0 &&
               k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30 && k3_240_buffer[1]<=30))) ||  //  && 
          //    (low_240_buffer[1]==H4lowest40bar ||  low_240_buffer[2]==H4lowest40bar)) ||
            
                   //h4 的 case-buy2  [+5][-4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.00100   [1]>=0.00300  
              (close_240_buffer[1]-open_240_buffer[1]>=0.00300 && close_240_buffer[5]-open_240_buffer[5]>=0.00100  && 
               close_240_buffer[2]-open_240_buffer[2]<=-0.00100 && close_240_buffer[3]-open_240_buffer[3]<=-0.00100 &&
               close_240_buffer[4]-open_240_buffer[4]<=-0.00100 &&
                              //(m15-61)  [1]上影線小於15點
               high_240_buffer[1]-close_240_buffer[1]<=0.00150  &&
      ...
      //        (low_240_buffer[1]==H4lowest40bar ||  low_240_buffer[2]==H4lowest40bar || low_240_buffer[3]==H4lowest40bar )) ||
                        ...
                        //(m15-65) H4 的 [+5][-4][-3][2][+1]   [1]>=0.00150 [2]>=0 [3][4]<=-0.00100 [5]>=-0.00100 
              (close_240_buffer[1]-open_240_buffer[1]>=0.00150 && close_240_buffer[5]-open_240_buffer[5]>=0.00100  && 
                 //(m15-64) [2]不可跌破150點 跌太多不好回頭
               close_240_buffer[2]-open_240_buffer[2]<=0 && close_240_buffer[2]-open_240_buffer[2]>=-0.01500 &&
               close_240_buffer[3]-open_240_buffer[3]<=-0.00100 &&
               close_240_buffer[4]-open_240_buffer[4]<=-0.00100 && 
                 //h4 (m15-65)  [2][3][4]收盤如高於[5]的開盤最多5點內
               open_240_buffer[2]-close_240_buffer[5]>=-0.00050 &&
               open_240_buffer[3]-close_240_buffer[5]>=-0.00050 && 
               open_240_buffer[4]-close_240_buffer[5]>=-0.00050 &&
               close_240_buffer[1]-close_240_buffer[5]>=-0.00050 && 
                    //(m15-62)   [1]下影線不超過5點   k1<=50  k2,k3<=35    kd2,kd3>=4  
               high_240_buffer[1]-close_240_buffer[1]<=0.00050  && k1_240_buffer[1]<=50 && k2_240_buffer[1]<=35 && k3_240_buffer[1]<=35 && 
               k2_240_buffer[1]-d2_240_buffer[1]>=4 && k3_240_buffer[1]-d3_240_buffer[1]>=4) ||
         
                    
                        //(m15-61) H4 的 [+2][+1]   上影線在10點內
              (close_240_buffer[1]-open_240_buffer[1]>=0.00100 && close_240_buffer[2]-open_240_buffer[2]>=0.00100  && 
                     //  [1][2]上影線小於10點
               low_240_buffer[1]-close_240_buffer[1]>=0.00100  &&  low_240_buffer[2]-close_240_buffer[2]>=0.00100  &&             
                    //    kd1,kd2,kd3>=1 
               k1_240_buffer[1]-k1_240_buffer[2]>=1  && k2_240_buffer[1]-k2_240_buffer[2]>=1 && k3_240_buffer[1]-k3_240_buffer[2]>=1 &&
                    //   macd  差值>=-0.001000  <=0.001000
               macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.001000 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001000  &&
               macdmainline_240_buffer[1]<=-0.003500 && 
                      //k1,k2,k3<=15
               k1_240_buffer[1]<=15 && k2_240_buffer[1]<=15 && k3_240_buffer[1]<=15) ||
    
                     //h4  [4][3][2]<=-0.00500 [1]>=0.00100 ma45[1]-[2]>=0.00010
              (close_240_buffer[4]-open_240_buffer[4]<=-0.00500 && close_240_buffer[3]-open_240_buffer[3]<=-0.00500  && 
               close_240_buffer[2]-open_240_buffer[2]<=-0.00500 && close_240_buffer[1]-open_240_buffer[1]>=0.00100 &&
               ma45_240_buffer[1]-ma45_240_buffer[2]>=0.00010) ||
          
                       //(m15-61) h4  [4]+[3]+[2]<=-0.01500 [1]>=0.00300  [1]-[2]>=-0.00100  macd  差值>=-0.001000  <=0.001000
             (((close_240_buffer[4]-open_240_buffer[4])+(close_240_buffer[3]-open_240_buffer[3])+ 
               (close_240_buffer[2]-open_240_buffer[2])<=-0.01500) && close_240_buffer[1]-open_240_buffer[1]>=0.00300 &&
                close_240_buffer[1]-close_240_buffer[2]>=-0.00100 &&
                macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.001000 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001000)) 
                  if    ((k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                      ...
                      (close_240_buffer[1]-open_240_buffer[1]<=-0.01500 || close_240_buffer[2]-open_240_buffer[2]<=-0.01500) ||
                          //(m15-64) [1]||[2]不可跌破110點   kd1[1]||kd1[2]<=-20 
                      (close_240_buffer[1]-open_240_buffer[1]<=-0.01100 && k1_240_buffer[1]-d1_240_buffer[1]<=-20) ||
                      (close_240_buffer[2]-open_240_buffer[2]<=-0.01100 && k1_240_buffer[2]-d1_240_buffer[2]<=-20) ||
                   // (m15-64)  kd1,kd2,kd3<=-15
                      (k1_240_buffer[1]-d1_240_buffer[1]<=-15 && k2_240_buffer[1]-d2_240_buffer[1]<=-15 && k3_240_buffer[1]-d3_240_buffer[1]<=-15) || 
                        //(m15-66)  ma360[1]-[6]<=-0.00010   ma05,ma08,ma12<=0.0015   kd1[1]<=-10  macd signal[1]-[2]<=-0.000020 
                      (ma360_240_buffer[1]-ma360_240_buffer[6]<=-0.00010 && ma05_240_buffer[1]-ma05_240_buffer[2]<=0.00150 &&
                       ma08_240_buffer[1]-ma08_240_buffer[2]<=0.00150 && ma12_240_buffer[1]-ma12_240_buffer[2]<=0.00150 &&
                       k1_240_buffer[1]-d1_240_buffer[1]<=-10 && macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000020) ||
                        (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                         longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                         longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                         longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                         ...
                         longbuy09=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B9",8809,0,OrangeRed );

 //+++++++++++++++++++++++++++++++++++++++++++   BUY   10   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                 
                                    //h1 [1] 實紅超過30,50,70,100點   
                                //100 點 [1]-[2]>=0.00010  [1]-[3]>=0.00010
      if   ((((close_60_buffer[1]-open_60_buffer[1]>=0.01000 && close_60_buffer[1]-close_60_buffer[2]>=0.00010  &&
            close_60_buffer[1]-close_60_buffer[3]>=0.00010 && 
            ...
            k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) ||
                               //75 點 [1]-[2]>=0~~~~[1]-[4]>=0 
           (close_60_buffer[1]-open_60_buffer[1]>=0.00750 && close_60_buffer[1]-close_60_buffer[2]>=0  &&
            close_60_buffer[1]-close_60_buffer[3]>=0 && close_60_buffer[1]-close_60_buffer[4]>=0  &&
                              //kd1,kd2,kd3>=0 k1,k2,k3<=30 
            k1_60_buffer[1]-d1_60_buffer[1]>=0 && k2_60_buffer[1]-d2_60_buffer[1]>=0 && k3_60_buffer[1]-d3_60_buffer[1]>=0 &&
            k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) ||
                              //55 點 [1]-[2][3]>=0,[1]-[6]>=0 
           (close_60_buffer[1]-open_60_buffer[1]>=0.00550 && close_60_buffer[1]-close_60_buffer[2]>=0  &&
            close_60_buffer[1]-close_60_buffer[3]>=0 && close_60_buffer[1]-close_60_buffer[6]>=0  &&
                              //kd1,kd2,kd3>=0 k1,k2,k3<=30 
            k1_60_buffer[1]-d1_60_buffer[1]>=0 && k2_60_buffer[1]-d2_60_buffer[1]>=0 && k3_60_buffer[1]-d3_60_buffer[1]>=0 &&
            k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) ||
                          //30 點 [1]-[2]>=0~~~~~[1]-[8]>=0 
           (close_60_buffer[1]-open_60_buffer[1]>=0.00300 && close_60_buffer[1]-close_60_buffer[2]>=0  &&
            close_60_buffer[1]-close_60_buffer[3]>=0 && close_60_buffer[1]-close_60_buffer[4]>=0  &&
            ...
            if    ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy10=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B10",8810,0,Gold );

 //+++++++++++++++++++++++++++++++++++++++++++   BUY   11   ++++++++++++++++++++++++++++++++++++++++++++++++++          

                      //m30 的 [+4][-3][-2][+1]   [1]>=0.00300 
         if   ((close_30_buffer[1]-open_30_buffer[1]>=0.00300 && close_30_buffer[4]-open_30_buffer[4]>=0.00080  && 
               close_30_buffer[2]-open_30_buffer[2]<=-0.00080 && close_30_buffer[3]-open_30_buffer[3]<=-0.00080 &&
               k2_30_buffer[1]-d2_30_buffer[1]>=12 && k3_30_buffer[1]-d3_30_buffer[1]>=12 &&
               k2_30_buffer[1]<=45 && k3_30_buffer[1]<=45) || 
                       //m30 的 [+5][-4][-3][-2][+1]  [1]>=0.00150  
              (close_30_buffer[1]-open_30_buffer[1]>=0.00150 && close_30_buffer[5]-open_30_buffer[5]>=0.00100  && 
               close_30_buffer[2]-open_30_buffer[2]<=-0.00100 && close_30_buffer[3]-open_30_buffer[3]<=-0.00100 &&
               close_30_buffer[4]-open_30_buffer[4]<=-0.00100 &&
               k2_30_buffer[1]-d2_30_buffer[1]>=10 && k3_30_buffer[1]-d3_30_buffer[1]>=10 &&
               k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30) || 
  
                  //m60 的 [+4][-3][-2][+1]   [1]>=0.00300 
              (close_60_buffer[1]-open_60_buffer[1]>=0.00300 && close_60_buffer[4]-open_60_buffer[4]>=0.00100  && 
               close_60_buffer[2]-open_60_buffer[2]<=-0.00100 && close_60_buffer[3]-open_60_buffer[3]<=-0.00100 &&
               k2_60_buffer[1]-d2_60_buffer[1]>=10 && k3_60_buffer[1]-d3_60_buffer[1]>=10 &&
               k2_60_buffer[1]<=55 && k3_60_buffer[1]<=55) || 
                     //m60 的 [+4][-3][-2][+1]   [1]>=0.00200 
              (close_60_buffer[1]-open_60_buffer[1]>=0.00200 && close_60_buffer[4]-open_60_buffer[4]>=0.00070  && 
               close_60_buffer[2]-open_60_buffer[2]<=-0.00070 && close_60_buffer[3]-open_60_buffer[3]<=-0.00070 &&
               ...
               k2_60_buffer[1]<=20 && k3_60_buffer[1]<=20) || 
                     //m60 的 [+5][-4][-3][-2][+1]  [1]>=0.00150  
              (close_60_buffer[1]-open_60_buffer[1]>=0.00150 && close_60_buffer[5]-open_60_buffer[5]>=0.00070  && 
               close_60_buffer[2]-open_60_buffer[2]<=-0.00070 && close_60_buffer[3]-open_60_buffer[3]<=-0.00070 &&
               close_60_buffer[4]-open_60_buffer[4]<=-0.00070 &&
               ...
               if  ((k2_240_buffer[1]>=47 && k3_240_buffer[1]>=47 && 
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14) || 
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy11=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B11",8811,0,Gold );
 
    //+++++++++++++++++++++++++++++++++++++++++++   BUY   12   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                  //m30 [2]留下影線 >=25點  [1]>0.00010開-低  [1]<-0.00010收-低
       if  (((close_30_buffer[2]-open_30_buffer[2]<=-0.00010 && low_30_buffer[2]-close_30_buffer[2]<=-0.00250) ||
             (close_30_buffer[2]-open_30_buffer[2]>=0.00010  && low_30_buffer[2]-open_30_buffer[2]<=-0.00250) &&
             (low_30_buffer[1]==M15lowest50bar || low_30_buffer[2]==M15lowest50bar) &&
                                  //       [1]收正  [1]-[2]>=0.00010   k1,k2,k3>=0  k1,k2,k3<=30
             (close_30_buffer[1]-open_30_buffer[1]>=0.00010 && close_30_buffer[1]-close_30_buffer[2]>=0.00010 &&
              ...
              k1_30_buffer[1]<=30 && k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30) ||
                                    //    [1]收正  [1]-[2]>=0.00010   k1,(k2||k3)>=0  k1,k2,k3<=30 kd1>=1
             (close_30_buffer[1]-open_30_buffer[1]>=0.00010 && close_30_buffer[1]-close_30_buffer[2]>=0.00010 &&
              k1_30_buffer[1]-k1_30_buffer[2]>=0 && (k2_30_buffer[1]-k2_30_buffer[2]>=0 || k3_30_buffer[1]-k3_30_buffer[2]>=0) &&
              k1_30_buffer[1]-d1_30_buffer[2]>=1 && 
              k1_30_buffer[1]<=20 && k2_30_buffer[1]<=20 && k3_30_buffer[1]<=20)) ||
              
                                     //m30 [1]&&[2]留下影線 >=25點  [1]>0.00010開-低  [1]<-0.00010收-低
            ((close_30_buffer[1]-open_30_buffer[1]<=-0.00010 && close_30_buffer[1]-open_30_buffer[1]>=-0.00100 && 
            low_30_buffer[1]-close_30_buffer[1]<=-0.00250) ||
             (close_30_buffer[1]-open_30_buffer[1]>=0.00010  && low_30_buffer[1]-open_30_buffer[1]<=-0.00250) &&
             (close_30_buffer[2]-open_30_buffer[2]<=-0.00010 && low_30_buffer[2]-close_30_buffer[2]<=-0.00250) ||
             (close_30_buffer[2]-open_30_buffer[2]>=0.00010  && low_30_buffer[2]-open_30_buffer[2]<=-0.00250) &&
              k1_30_buffer[1]<=30 && k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30  &&
             (low_30_buffer[1]==M15lowest50bar || low_30_buffer[2]==M15lowest50bar) &&
                                  //       [1]收正  [1]-[2]>=0.00100   k2,k3>=0  k1,k2,k3<=30
              close_30_buffer[1]-open_30_buffer[1]>=0.00100 && close_30_buffer[1]-close_30_buffer[2]>=0.00010 &&
              k2_30_buffer[1]-k2_30_buffer[2]>=0 && k3_30_buffer[1]-k3_30_buffer[2]>=0 &&
              k1_30_buffer[1]<=30 && k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30) ||
                                    // [1]留下影線 >=40點  [1]>0.00010開-低  k1,k2,k3>=1  ,k1,k2,k3<=20
            ((close_30_buffer[1]-open_30_buffer[1]>=0.00010  && low_30_buffer[1]-open_30_buffer[1]<=-0.00400) &&
              ...
              k1_30_buffer[1]<=20 && k2_30_buffer[1]<=20 && k3_30_buffer[1]<=20))
               ...
               if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-25  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-25) ||
                    ...
                    (k2_60_buffer[1]-d2_60_buffer[1]<=-19  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-19 && 
                     ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00100  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00080) ||
                        //h1 [1]<=-0.0120  h4   ma05,ma08,ma12<=-0.00250
                    (close_60_buffer[1]-open_60_buffer[1]<=-0.01200 && ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00250  &&  
                     ma08_240_buffer[1]-ma08_240_buffer[2]<=-0.00250  &&  ma12_240_buffer[1]-ma12_240_buffer[2]<=-0.00250) ||
                   ...
                   (k2_240_buffer[1]-k2_240_buffer[1]<=-10 || k3_240_buffer[1]-k3_240_buffer[1]<=-10)) ||
                         //(m15-57)h4  [1]跌過140點
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.01400) ||
                     //(m15-59) h4  ma45,ma90,ma180其中任二[1]-[2]<=0    [1]<=-0.01000
                  ((ma45_240_buffer[1]-ma45_240_buffer[2]<=0 || ma90_240_buffer[1]-ma90_240_buffer[2]<=0) &&
                   (ma90_240_buffer[1]-ma90_240_buffer[2]<=0 || ma180_240_buffer[1]-ma180_240_buffer[2]<=0) &&
                    close_240_buffer[1]-open_240_buffer[1]<=-0.01000) ||  
                         //(m15-59) h4 k1||k2||k3 >=65 don't buy
                   (k1_240_buffer[1]>=65 || k2_240_buffer[1]>=65 || k3_240_buffer[1]>=65) ||                   
                      //(m15-57)h4  ma45[1][2]<=-0.00070  ma90[1][2]<=-0.00040  ma45||ma90([1]-[2])-[2]-[3])<=-0.00010 ma45,ma90間距<=0.0400 >=-0.0035
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00070  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00040 &&
                  ((ma45_240_buffer[1]-ma45_240_buffer[2])-(ma45_240_buffer[2]-ma45_240_buffer[3])<=-0.00010  ||
                   (ma90_240_buffer[1]-ma90_240_buffer[2])-(ma90_240_buffer[2]-ma90_240_buffer[3])<=-0.00010) &&
                    //(m15-58)   ma45在ma90 下但間距<=0.0350 >=-0.00100
                    ma45_240_buffer[1]-ma90_240_buffer[1]<=0.03500 && ma45_240_buffer[1]-ma90_240_buffer[1]>=-0.00100) ||
                   ...
                   ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1])<=-40 &&
                     k1_240_buffer[1]-d1_240_buffer[1]<=-12 && k2_240_buffer[1]-d2_240_buffer[1]<=-12 && k3_240_buffer[1]-d3_240_buffer[1]<=-12) ||
                           ...
                           //(m15-61)(m15-57)h4  [1]跌過100點  (ma45<=-0.00150  || [0]<=-0.01500)
                   (close_240_buffer[1]-open_240_buffer[1]<=-0.01000 && (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00150 ||
                    close_240_buffer[0]-open_240_buffer[0]<=-0.01500)) ||
                   ...
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-19  &&  k2_240_buffer[1]-k2_240_buffer[2]<=-2 &&
                    k3_240_buffer[1]-k3_240_buffer[2]<=-2) ||
                       // h4  ma05[1]-ma12[1]<=-0.0160  ma05[2]-ma12[2]<=-0.01200   ma05[1]-ma05[2]<=-0.00300
                   (ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.01600  &&  ma05_240_buffer[2]-ma12_240_buffer[2]<=-0.01200  &&
                    ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00300) ||
                          //(m15-57)h4   ma05[1]-[2]<=-0.00500  ma45[1]-[2]<=-0.00070
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00500  &&  ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00070) ||
                  
                      //(m15-66)  kd2,kd3[1]<=-15 k1[0]-[1]<=-5||kd1[1]<=-5   macd<=-0.003000
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-15  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-15 &&
                  ((k1_240_buffer[0]-k1_240_buffer[1]<=-5) || (k1_240_buffer[1]-d1_240_buffer[1]<=-5)) &&
                    macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.003000) ||    
                    // (m15-16)  kd2,kd3[1]<=-7 k1[0]-[1]<=-7||kd1[1]<=-7      macd[1]<=-0.003500  macd[2]<=-0.002500  (macd[1]-[2]<=-0.000700 || macdmain[1]-[2]<=-0.001500  macdsignal[1]-[2]<=-0.00700 
                  ...
                  ((k1_240_buffer[0]-k1_240_buffer[1]<=-7) || (k1_240_buffer[1]-d1_240_buffer[1]<=-7)) &&
                     macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.003500 &&
                    macdmainline_240_buffer[2]-macdsignalline_240_buffer[2]<=-0.002500 && 
                  (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])<=-0.000700) ||    
                    (macdmainline_240_buffer[1]-macdmainline_240_buffer[2]<=-0.001500 && macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2])<=-0.000700)) ||
                          //ma45  ma90 <=-0.00140
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00140  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00140) ||
                          //(m15-57) h4 ma45  ma90 <=-0.00100   ma45+ma90<=-0.00290
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00100  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00100 &&
                   (ma45_240_buffer[1]-ma45_240_buffer[2])+ (ma90_240_buffer[1]-ma90_240_buffer[2])<=-0.0020) ||

                           //H4 k1,k2,k3全向下,或 h4,m30,m60 kd2,kd3向下開口大 或 k1,k,2,k3在極低
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-19  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-19 &&
                    k1_240_buffer[0]-k1_240_buffer[1]<=-2 &&
                                     //h4 ma45 [1]-[2]<=0 &&  ma45 [1]-[2]>=-0.00140 區間外允許做買單
                    ma45_240_buffer[1]-ma45_240_buffer[2]<=0 && ma45_240_buffer[1]-ma45_240_buffer[2]>=-0.00140) ||
                   (k2_240_buffer[1]-d2_240_buffer[1]<=-19  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-19 &&
                    macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.003000 &&
                                     //h4 ma45 [1]-[2]<=0 &&  ma45 [1]-[2]>=-0.00140 區間外允許做買單
                    ma45_240_buffer[1]-ma45_240_buffer[2]<=0 && ma45_240_buffer[1]-ma45_240_buffer[2]>=-0.00140) ||
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14 &&
                    ...
                    ma45_240_buffer[1]-ma45_240_buffer[2]<=0 && ma45_240_buffer[1]-ma45_240_buffer[2]>=-0.00140) ||
                      ...
                      longbuy12=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B12",8812,0,Maroon );

   //+++++++++++++++++++++++++++++++++++++++++++   BUY   13   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                  //h1 留下影線[2] >=25點  [1]>0.0001開-低  [1]<-0.0001收-低
       if  (((close_60_buffer[2]-open_60_buffer[2]<=-0.00010 && low_60_buffer[2]-close_60_buffer[2]<=-0.00250) ||
             (close_60_buffer[2]-open_60_buffer[2]>=0.00010  && low_60_buffer[2]-open_60_buffer[2]<=-0.00250) &&
             (low_60_buffer[1]==M15lowest70bar || low_60_buffer[2]==M15lowest70bar) &&
                                  //       [1]收正  [1]-[2]>=0.00010   k1,k2,k3>=0  k1,k2,k3<=30
             (close_60_buffer[1]-open_60_buffer[1]>=0.00100 && close_60_buffer[1]-close_60_buffer[2]>=0.00010 &&
              k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0 &&
              k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) ||
                                       //    [1]收正  [1]-[2]>=0.00010   k1,(k2||k3)>=0  k1,k2,k3<=30 kd1>=1
             (close_60_buffer[1]-open_60_buffer[1]>=0.00010 && close_60_buffer[1]-close_60_buffer[2]>=0.00010 &&
              k1_60_buffer[1]-k1_60_buffer[2]>=0 && (k2_60_buffer[1]-k2_60_buffer[2]>=0 || k3_60_buffer[1]-k3_60_buffer[2]>=0) &&
              k1_60_buffer[1]-d1_60_buffer[2]>=1 && 
              k1_60_buffer[1]<=20 && k2_60_buffer[1]<=20 && k3_60_buffer[1]<=20)) ||
            
                                     //m60 [1],[2]留下影線 >=24點  [1]>0.00010開-低  [1]<-0.00010收-低  [1]>=-0.00100  <=-0.00010
            ((close_60_buffer[1]-open_60_buffer[1]<=-0.00010 && close_60_buffer[1]-open_60_buffer[1]>=-0.00100 && 
              low_60_buffer[1]-close_60_buffer[1]<=-0.00240) ||
             (close_60_buffer[1]-open_60_buffer[1]>=0.00010  && low_60_buffer[1]-open_60_buffer[1]<=-0.00240) &&
             (close_60_buffer[2]-open_60_buffer[2]<=-0.00010 && low_60_buffer[2]-close_60_buffer[2]<=-0.00240) ||
             (close_60_buffer[2]-open_60_buffer[2]>=0.00010  && low_60_buffer[2]-open_60_buffer[2]<=-0.00240) &&
              k1_60_buffer[1]<=20 && k2_60_buffer[1]<=20 && k3_60_buffer[1]<=20 &&
             (low_60_buffer[1]==M15lowest70bar || low_60_buffer[2]==M15lowest70bar)) ||
                                    // [1]留下影線 >=40點  [1]>0.00010開-低  k1,k2,k3>=1  ,k1,k2,k3<=20
            ((close_60_buffer[1]-open_60_buffer[1]>=0.00010  && low_60_buffer[1]-open_60_buffer[1]<=-0.00400) &&
               ...
               if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-25  &&  k3_60_buffer[1]-d3_60_buffer[1]<=-25) ||
                  ...
                  ((ma45_240_buffer[1]-ma45_240_buffer[2]<=0 || ma90_240_buffer[1]-ma90_240_buffer[2]<=0) &&
                   (ma90_240_buffer[1]-ma90_240_buffer[2]<=0 || ma180_240_buffer[1]-ma180_240_buffer[2]<=0) &&
                    close_240_buffer[1]-open_240_buffer[1]<=-0.01000) ||  
                         //(m15-59) h4 k1||k2||k3 >=65 don't buy
                   (k1_240_buffer[1]>=65 || k2_240_buffer[1]>=65 || k3_240_buffer[1]>=65) ||                   
                      //(m15-57)h4  ma45[1][2]<=-0.00070  ma90[1][2]<=-0.00040  ma45||ma90([1]-[2])-[2]-[3])<=-0.00010 ma45,ma90間距<=0.0400 >=-0.00350
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00070  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00040 &&
                  ((ma45_240_buffer[1]-ma45_240_buffer[2])-(ma45_240_buffer[2]-ma45_240_buffer[3])<=-0.00010  ||
                   (ma90_240_buffer[1]-ma90_240_buffer[2])-(ma90_240_buffer[2]-ma90_240_buffer[3])<=-0.00010) &&
                    //(m15-58)   ma45在ma90 下但間距<=0.0350 >=-0.00100
                   ...
                   (k1_240_buffer[1]-d1_240_buffer[1]<=-19  &&  k2_240_buffer[1]-k2_240_buffer[2]<=-2 &&
                    k3_240_buffer[1]-k3_240_buffer[2]<=-2) ||
                       // h4  ma05[1]-ma12[1]<=-0.01600  ma05[2]-ma12[2]<=-0.01200   ma05[1]-ma05[2]<=-0.00300
                   (ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.01600  &&  ma05_240_buffer[2]-ma12_240_buffer[2]<=-0.01200  &&
                    ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00300) ||
                          //(m15-57)h4   ma05[1]-[2]<=-0.00500  ma45[1]-[2]<=-0.00070
                   (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00500  &&  ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00070) ||
                  ...
                  (((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])<=-0.000700) ||    
                    (macdmainline_240_buffer[1]-macdmainline_240_buffer[2]<=-0.001500 && macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2])<=-0.000700)) ||
                          //ma45  ma90 <=-0.0014
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00140  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00140) ||
                          //(m15-57) h4 ma45  ma90 <=-0.0010   ma45+ma90<=-0.00290
                   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.00100  &&  ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.00100 &&
                   (ma45_240_buffer[1]-ma45_240_buffer[2])+ (ma90_240_buffer[1]-ma90_240_buffer[2])<=-0.00290) ||
                   ...
                   (k1_240_buffer[1]<=14 && k2_240_buffer[1]<=14  &&  k3_240_buffer[1]<=14 &&
                    ...
                    ma45_240_buffer[1]-ma45_240_buffer[2]<=0 && ma45_240_buffer[1]-ma45_240_buffer[2]>=-0.00140) ||
                     (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy13=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-780*Point,Ask+20000*Point,"My order #B13",8813,0,DeepPink );
           ...
           ((close_240_buffer[4]-open_240_buffer[1]>=0 || close_240_buffer[5]-open_240_buffer[1]>=0 ||
            ...
            ((close_240_buffer[1]-open_240_buffer[1]<=-0.0030  && ma12_240_buffer[1]-ma05_240_buffer[2]<=-0.0005 && 
              k1_240_buffer[1]>=60 && k2_240_buffer[1]>=60  &&  k3_240_buffer[1]>=60) || 
                ...
                //(m15-66)  case-sell3  k1,k2,k3>=75,k2,k3<=-1,d2,d3<=0,kd1,kd2<=-2 macd main && signal[1]-[2]<=-0.00003
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   SHORT BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if      (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00070 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00030 &&
               ...
               close_15_buffer[1]-close_15_buffer[3]>=0.0001 && close_15_buffer[1]-close_15_buffer[3]>=0.0001 &&
                 //h4 ma45 為斜上狀態
               ma45_240_buffer[1]-ma45_240_buffer[1]>=0.0005) 
                  if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
...
//***  Ordermodify   ********************************************************************************** 
  ...
  //          OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-50*Point,OrderTakeProfit(),0,Blue);
       if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket()) && 
          high_15_buffer[0]-OrderOpenPrice()>=0.0025 && high_15_buffer[0]-OrderOpenPrice()<=0.0059)
   ...
   //         OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+50*Point,OrderTakeProfit(),0,Blue);
      ...
      if (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0025 && low_15_buffer[0]-OrderOpenPrice()>=-0.0059)
                                  //stoploss=OrderOpenPrice()-7*Point可以賺5點
            OrderModify(OrderTicket(),Bid,OrderOpenPrice()-7*Point,OrderTakeProfit(),0,Blue);
      if (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0060)
                                  //stoploss=OrderOpenPrice()-27*Point可以賺5點
