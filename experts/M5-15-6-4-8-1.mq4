...
if    (OrdersTotal()<=1 || (OrdersTotal()<=3 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket()))) 
 {
    ...
    if (OrdersTotal()<=3)   
     ...
     if   (k1_15_buffer[1]<=25 &&   k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && 
           d1_15_buffer[1]<=25 &&   d2_15_buffer[1]<=25 && d3_15_buffer[1]<=25 && 
           
           k1_15_buffer[1]-d1_15_buffer[1]>=-3 &&  k2_15_buffer[1]-d2_15_buffer[1]>=-3 && 
           
         ((d3_15_buffer[1]-d3_05_buffer[2]>=0) ||
          ...
          longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+900*Point,"My order #LB1",8801,0,Yellow );
...
//*** long Buy  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=3)   
     {              
         //    m5 k1,k2,k3ど,50,[1]Μ堵  BUY

     if   (k1_30_buffer[1]<=25 &&   k2_30_buffer[1]<=25 && k3_30_buffer[1]<=25 && 
           d1_30_buffer[1]<=25 &&   d2_30_buffer[1]<=25 && d3_30_buffer[1]<=25 && 
           
           k1_30_buffer[1]-d1_30_buffer[1]>=-3 &&  k2_30_buffer[1]-d2_30_buffer[1]>=-3 && 
           
         ((d3_30_buffer[1]-d3_05_buffer[2]>=0) ||
 ...
 //*** long Buy  3  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=3)   
     ...
     if   (k1_60_buffer[1]<=25 &&   k2_60_buffer[1]<=25 && k3_60_buffer[1]<=25 && 
           d1_60_buffer[1]<=25 &&   d2_60_buffer[1]<=25 && d3_60_buffer[1]<=25 && 
           
           k1_60_buffer[1]-d1_60_buffer[1]>=-3 &&  k2_60_buffer[1]-d2_60_buffer[1]>=-3 && 
           
         ((d3_60_buffer[1]-d3_05_buffer[2]>=0) ||
          ...
          (k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0))) 
                       ...
                       longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+25000*Point,"My order #LB3",8803,0,Yellow );
 //                     longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2000*Point,"My order #LB4",8804,0,Yellow );
     }  
 ...
 //*** long Buy  4  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=3)   
     ...
     if   (k1_240_buffer[1]<=25 &&   k2_240_buffer[1]<=25 && k3_240_buffer[1]<=25 && 
           d1_240_buffer[1]<=25 &&   d2_240_buffer[1]<=25 && d3_240_buffer[1]<=25 && 
           
           k1_240_buffer[1]-d1_240_buffer[1]>=-3 &&  k2_240_buffer[1]-d2_240_buffer[1]>=-3 && 
           
         ((d3_240_buffer[1]-d3_05_buffer[2]>=0) ||
          ...
          (k2_240_buffer[1]-k2_240_buffer[2]>=0 && k3_240_buffer[1]-k3_240_buffer[2]>=0))) 
           ...
           longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+25000*Point,"My order #LB4",8804,0,Yellow );
 //                     longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2000*Point,"My order #LB4",8804,0,Yellow );
     }  
     ...
     {              
      ...
      if  (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
           ...
           (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0 &&
            ...
            if  (k1_05_buffer[0]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
     
      
//┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
            if   ((OrdersTotal()<=1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                   ...
                   ((ma05_15_buffer[1]-ma05_15_buffer[2]>=0.00010 && ma05_15_buffer[1]-ma12_15_buffer[1]>=0.00010 && close_15_buffer[1]-ma05_15_buffer[1]>=0.00010) ||
                    (k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
                    (k2_15_buffer[1]-d2_15_buffer[1]>=15 &&  k3_15_buffer[1]-d3_15_buffer[1]>=15)) ||
       
                   ((ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00010 && ma05_30_buffer[1]-ma12_30_buffer[1]>=0.00010 && close_30_buffer[1]-ma05_30_buffer[1]>=0.00010) ||
                    (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0) ||
                    (k2_30_buffer[1]-d2_30_buffer[1]>=15 &&  k3_30_buffer[1]-d3_30_buffer[1]>=15)) ||

                   ((ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00010 && ma05_60_buffer[1]-ma12_60_buffer[1]>=0.00010 && close_60_buffer[1]-ma05_60_buffer[1]>=0.00010) ||
                    (k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0) ||
                    (k2_60_buffer[1]-d2_60_buffer[1]>=15 &&  k3_60_buffer[1]-d3_60_buffer[1]>=15)) ||

                   ((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||
                    (k1_240_buffer[0]-k1_240_buffer[1]>=3 &&  k2_240_buffer[0]-k2_240_buffer[1]>=1 && k3_240_buffer[0]-k3_240_buffer[1]>=0) ||
                    (k2_240_buffer[1]-d2_240_buffer[1]>=15 &&  k3_240_buffer[1]-d3_240_buffer[1]>=15)))
                    return;				
                    else				

                  longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-900*Point,"My order #LS1",4401,0,Green);
 //                 longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-900*Point,"My order #LS2",4402,0,Green);
  ...
  //***long Sell  2  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     {              
        //    m5 k1,k2,k3,50,[1]Μ [2]Μ堵 SELL
     if  (((k1_60_buffer[0]-k1_60_buffer[1]<=-3 &&  k2_60_buffer[0]-k2_60_buffer[1]<=-1 && k3_60_buffer[0]-k3_60_buffer[1]<=0 &&
            k1_60_buffer[1]>=50 &&   k2_60_buffer[1]>=50 && k3_60_buffer[1]>=50) ||
           (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0 &&
            k1_240_buffer[1]>=40 &&   k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50))) 
            if   (k1_15_buffer[0]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50)                               
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if ((OrdersTotal()<=1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                     ...
                     longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-25000*Point,"My order #LS2",4402,0,Green);
...
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
  ...
  //***long Sell  3  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     {              
        //    
      if   (((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.00010 && ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.00010 && close_15_buffer[1]-ma05_15_buffer[1]<=-0.00010) ||	
             (k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0)) ||	
            ...
            ((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
             ...
             (k1_15_buffer[1]-k1_15_buffer[2]<=-3 && k1_30_buffer[1]-k1_30_buffer[2]<=-3 && k1_60_buffer[1]-k1_60_buffer[2]<=-5 && k1_240_buffer[0]-k1_240_buffer[1]<=-10))
              if   (k1_15_buffer[0]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50)                               
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if ((OrdersTotal()<=1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                     ...
                     ((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||
                      ...
                      longsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-25000*Point,"My order #LS3",4403,0,Green);
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
     }      
 ...
 // Buy  1  ***************************************************************************************** 
  ...
  {  
    ...
    if (OrdersTotal()<=3)   
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0  &&
           k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
           close_05_buffer[1]-open_05_buffer[1]<=-0.00010)  ||

         ((k1_05_buffer[1]-d1_05_buffer[1]>=3 &&   k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25) &&
         ((close_05_buffer[1]-close_05_buffer[2]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010 ) ||
          (close_05_buffer[1]-open_05_buffer[1]<=-0.00040 &&  close_05_buffer[2]-open_05_buffer[2]>=0.00010) ||
          (close_05_buffer[1]-open_05_buffer[1]<=-0.00040 &&  low_05_buffer[1]-close_05_buffer[2]<=-0.00040))))   
...
//                 shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+250*Point,"My order #B2",8802,0,Yellow );
 ...
 // Buy  2  ***************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=8 &&  k2_05_buffer[1]-k2_05_buffer[2]>=5 && k3_05_buffer[1]-k3_05_buffer[2]>=2  &&
           k1_05_buffer[1]-d1_05_buffer[1]>=5  &&  k2_05_buffer[1]-d2_05_buffer[1]>=2 && k3_05_buffer[1]-d3_05_buffer[1]>=1 &&  
           k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
           close_05_buffer[1]-close_05_buffer[2]>=0.00010 && close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010) ||  

          (k1_05_buffer[1]-k1_05_buffer[2]>=5 &&  k2_05_buffer[1]-k2_05_buffer[2]>=3 && k3_05_buffer[1]-k3_05_buffer[2]>=-2  &&
           k1_05_buffer[1]-d1_05_buffer[1]>=2 &&  k2_05_buffer[1]-d2_05_buffer[1]>=1 && k3_05_buffer[1]-d3_05_buffer[1]>=-3 &&  
           k1_05_buffer[1]<=35 &&   k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30 && close_05_buffer[1]-close_05_buffer[2]>=0.00010) ||  


          (k1_15_buffer[1]-k1_15_buffer[2]>=10 &&  k2_15_buffer[1]-k2_15_buffer[2]>=5 && k3_15_buffer[1]-k3_15_buffer[2]>=2  &&
           k1_15_buffer[1]-d1_15_buffer[1]>=5  &&  k2_15_buffer[1]-d2_15_buffer[1]>=3 && k3_15_buffer[1]-d3_15_buffer[1]>=1 &&  
           k1_15_buffer[1]<=50 &&   k2_15_buffer[1]<=50 && k3_15_buffer[1]<=50 &&
           close_15_buffer[1]-close_15_buffer[2]>=0.00010 && close_15_buffer[1]-close_15_buffer[3]>=0.00010 &&  close_15_buffer[1]-close_15_buffer[4]>=0.00010))   
           ...
           shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+500*Point,"My order #B2",8802,0,Yellow );
    }     
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
         ...
         ((k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=70 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75) &&
         ((close_05_buffer[1]-close_05_buffer[2]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[3]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[4]<=-0.00010 ) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  close_05_buffer[2]-open_05_buffer[2]<=-0.00010) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  low_05_buffer[1]-close_05_buffer[2]>=0.00040))))   
...
//                    (k2_240_buffer[1]-d2_240_buffer[1]>=15 &&  k3_240_buffer[1]-d3_240_buffer[1]>=15)))
 ...
 // sell  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=3)    
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]<=-8 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-5 && k3_05_buffer[1]-k3_05_buffer[2]<=-2  &&
           k1_05_buffer[1]-d1_05_buffer[1]<=-2 &&  k2_05_buffer[1]-d2_05_buffer[1]<=-2 && k3_05_buffer[1]-d3_05_buffer[1]<=-1 &&  
           k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50 &&
           close_05_buffer[1]-close_05_buffer[2]<=-0.00010 && close_05_buffer[1]-close_05_buffer[3]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[4]<=-0.00010) ||  
          ...
          if   ((OrdersTotal()<=1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
           ...
           shortsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-500*Point,"My order #S2",4402,0,Green);
    } 
  }

//**********     order modify       *************************************************        
  int    trade_buffer[60];
  int    pip,pip_60=ArraySize(trade_buffer);
  ArraySetAsSeries(trade_buffer,true);
  for(pip=0; pip<pip_60 ; pip++)
...
//                                        longbuy01==OrderTicket() || longbuy02==OrderTicket() ||
//                                        longbuy03==OrderTicket() || longbuy04==OrderTicket() ) && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
//          if   (OrderType()==OP_BUY && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
          if   (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket()) && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
                      OrderOpenPrice()-high_05_buffer[0]<=0.00100 && OrderOpenPrice()-high_05_buffer[1]<=0.00100 &&
                      OrderOpenPrice()-high_05_buffer[2]<=0.00100 && OrderOpenPrice()-high_05_buffer[3]<=0.00100 &&
                      OrderOpenPrice()-high_05_buffer[4]<=0.00100 )
     //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+20*Point,OrderTakeProfit(),0,Blue);
                      OrderClose(OrderTicket(),lots,Bid,1,Sienna);                                                                     
       
          if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket()) && high_05_buffer[0]-OrderOpenPrice()>=0.00120 && high_05_buffer[0]-OrderOpenPrice()<=0.00130) 
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+60*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket()) && high_05_buffer[0]-OrderOpenPrice()>=0.00250 && high_05_buffer[0]-OrderOpenPrice()<=0.00260) 
               OrderModify(OrderTicket(),Ask,OrderOpenPrice()+160*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00400 && high_05_buffer[0]-OrderOpenPrice()<=0.00410) 
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+270*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00700 && high_05_buffer[0]-OrderOpenPrice()<=0.00710)
              OrderModify(OrderTicket(),Ask,OrderOpenPrice()+420*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.00900 && high_05_buffer[0]-OrderOpenPrice()<=0.00910)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+520*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.01200 && high_05_buffer[0]-OrderOpenPrice()<=0.01210)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+720*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.01500 && high_05_buffer[0]-OrderOpenPrice()<=0.01510)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+920*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.02000 && high_05_buffer[0]-OrderOpenPrice()<=0.02010)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+1420*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.02500 && high_05_buffer[0]-OrderOpenPrice()<=0.02510)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+1720*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.03000 && high_05_buffer[0]-OrderOpenPrice()<=0.03010)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+2320*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.03500 && high_05_buffer[0]-OrderOpenPrice()<=0.03510)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+2820*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.04000 && high_05_buffer[0]-OrderOpenPrice()<=0.04010)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+3420*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.04500 && high_05_buffer[0]-OrderOpenPrice()<=0.04510)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+3920*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.05000 && high_05_buffer[0]-OrderOpenPrice()<=0.05010)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+4500*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_BUY  &&  high_05_buffer[0]-OrderOpenPrice()>=0.05500 && high_05_buffer[0]-OrderOpenPrice()<=0.05510)
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+5000*Point,OrderTakeProfit(),0,Blue);
...
//                                        longsell01==OrderTicket() || longsell02==OrderTicket() ||
//                                        longsell03==OrderTicket() || longsell04==OrderTicket() ) && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
//         if   (OrderType()==OP_SELL &&  TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505 &&
          if   (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket())  && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
                      OrderOpenPrice()-low_05_buffer[0]<=0.00100 && OrderOpenPrice()-low_05_buffer[1]<=0.00100 &&
                      OrderOpenPrice()-low_05_buffer[2]<=0.00100 && OrderOpenPrice()-low_05_buffer[3]<=0.00100 &&
                      OrderOpenPrice()-low_05_buffer[4]<=0.00100) 
//                     OrderModify(OrderTicket(),Bid,OrderOpenPrice()-20*Point,OrderTakeProfit(),0,Blue);
                      OrderClose(OrderTicket(),lots,Ask,1,Gold);    
         
         
           if   (OrderType()==OP_SELL &&   (shortsell01==OrderTicket() || shortsell02==OrderTicket())  && low_05_buffer[0]-OrderOpenPrice()<=-0.00120 && low_05_buffer[0]-OrderOpenPrice()>=-0.00130)
                     OrderModify(OrderTicket(),Bid,OrderOpenPrice()-60*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_SELL &&  (shortsell01==OrderTicket() || shortsell02==OrderTicket())  && low_05_buffer[0]-OrderOpenPrice()<=-0.00250 && low_05_buffer[0]-OrderOpenPrice()>=-0.00260)
                   OrderModify(OrderTicket(),Bid,OrderOpenPrice()-160*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00400 && low_05_buffer[0]-OrderOpenPrice()>=-0.00410)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-270*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00700 && low_05_buffer[0]-OrderOpenPrice()>=-0.00710)
                OrderModify(OrderTicket(),Bid,OrderOpenPrice()-420*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00900 && low_05_buffer[0]-OrderOpenPrice()>=-0.00910)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-520*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.01200 && low_05_buffer[0]-OrderOpenPrice()>=-0.01210)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-720*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.01500 && low_05_buffer[0]-OrderOpenPrice()>=-0.01510)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-920*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.02000 && low_05_buffer[0]-OrderOpenPrice()>=-0.02010)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-1420*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.02500 && low_05_buffer[0]-OrderOpenPrice()>=-0.02510)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-1720*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.03000 && low_05_buffer[0]-OrderOpenPrice()>=-0.03010)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-2320*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.03500 && low_05_buffer[0]-OrderOpenPrice()>=-0.03510)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-2820*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.04000 && low_05_buffer[0]-OrderOpenPrice()>=-0.04010)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-3420*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.04500 && low_05_buffer[0]-OrderOpenPrice()>=-0.04510)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-3920*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.05000 && low_05_buffer[0]-OrderOpenPrice()>=-0.05010)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-4500*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.05500 && low_05_buffer[0]-OrderOpenPrice()>=-0.05510)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-5000*Point,OrderTakeProfit(),0,Blue);
