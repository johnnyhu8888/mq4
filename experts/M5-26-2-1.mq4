...
// Comment ("7=",ma12_05_buffer[7]," 6=",ma12_05_buffer[6],"  5=",ma12_05_buffer[5],"   4=",ma12_05_buffer[4],
 ...
 m5highest20bar=High[iHighest(NULL,PERIOD_M5,MODE_HIGH,16,0)];   //20bar程蔼基
 m5highest1740bar=High[iHighest(NULL,PERIOD_M5,MODE_HIGH,40,17)];   //17-40bar程蔼基
 m5highest20bartime=High[iHighest(NULL,PERIOD_M5,MODE_TIME,16,0)];   //20bar程蔼基丁
 m5highest1740bartime=High[iHighest(NULL,PERIOD_M5,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 m5lowest20bar=Low[iLowest(NULL,PERIOD_M5,MODE_LOW,16,0)];     //20bar程基
 m5lowest1740bar=Low[iLowest(NULL,PERIOD_M5,MODE_LOW,40,17)];   //17-40bar程基
 m5lowest20bartime=Low[iLowest(NULL,PERIOD_M5,MODE_TIME,16,0)];    //20bar程基丁
 m5lowest1740bartime=Low[iLowest(NULL,PERIOD_M5,MODE_TIME,40,17)];    //17-40bar程基丁  
...
// Comment ("7=",ma12_15_buffer[7]," 6=",ma12_15_buffer[6],"  5=",ma12_15_buffer[5],"   4=",ma12_15_buffer[4],
 ...
 M15highest20bar=High[iHighest(NULL,PERIOD_M15,MODE_HIGH,16,0)];   //20bar程蔼基
 M15highest1740bar=High[iHighest(NULL,PERIOD_M15,MODE_HIGH,40,17)];   //17-40bar程蔼基
 M15highest20bartime=High[iHighest(NULL,PERIOD_M15,MODE_TIME,16,0)];   //20bar程蔼基丁
 M15highest1740bartime=High[iHighest(NULL,PERIOD_M15,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 M15lowest20bar=Low[iLowest(NULL,PERIOD_M15,MODE_LOW,16,0)];     //20bar程基
 M15lowest1740bar=Low[iLowest(NULL,PERIOD_M15,MODE_LOW,40,17)];   //17-40bar程基
 M15lowest20bartime=Low[iLowest(NULL,PERIOD_M15,MODE_TIME,16,0)];    //20bar程基丁
 M15lowest1740bartime=Low[iLowest(NULL,PERIOD_M15,MODE_TIME,40,17)];    //17-40bar程基丁  
 //Comment ("high0-16=",highest20bar,"  low0-16=",lowest20bar,"    high17-32=",highest1740bar,"   low17-40=",lowest1740bar);
...
//          "3=",ma05_30_buffer[3]," 2=",ma05_30_buffer[2],"  1=",ma05_30_buffer[1],"   0=",ma05_30_buffer[0]);
 ...
 M30highest20bar=High[iHighest(NULL,PERIOD_M30,MODE_HIGH,16,0)];   //20bar程蔼基
 M30highest1740bar=High[iHighest(NULL,PERIOD_M30,MODE_HIGH,40,17)];   //17-40bar程蔼基
 M30highest20bartime=High[iHighest(NULL,PERIOD_M30,MODE_TIME,16,0)];   //20bar程蔼基丁
 M30highest1740bartime=High[iHighest(NULL,PERIOD_M30,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 M30lowest20bar=Low[iLowest(NULL,PERIOD_M30,MODE_LOW,16,0)];     //20bar程基
 M30lowest1740bar=Low[iLowest(NULL,PERIOD_M30,MODE_LOW,40,17)];   //17-40bar程基
 M30lowest20bartime=Low[iLowest(NULL,PERIOD_M30,MODE_TIME,16,0)];    //20bar程基丁
 M30lowest1740bartime=Low[iLowest(NULL,PERIOD_M30,MODE_TIME,40,17)];    //17-40bar程基丁  
 //Comment ("high0-16=",highest20bar,"  low0-16=",lowest20bar,"    high17-32=",highest1740bar,"   low17-40=",lowest1740bar);
...
//          "3=",ma05_60_buffer[3]," 2=",ma05_60_buffer[2],"  1=",ma05_60_buffer[1],"   0=",ma05_60_buffer[0]);
 ...
 H1highest20bar=High[iHighest(NULL,PERIOD_H1,MODE_HIGH,16,0)];   //20bar程蔼基
 H1highest1740bar=High[iHighest(NULL,PERIOD_H1,MODE_HIGH,40,17)];   //17-40bar程蔼基
 H1highest20bartime=High[iHighest(NULL,PERIOD_H1,MODE_TIME,16,0)];   //20bar程蔼基丁
 H1highest1740bartime=High[iHighest(NULL,PERIOD_H1,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 H1lowest20bar=Low[iLowest(NULL,PERIOD_H1,MODE_LOW,16,0)];     //20bar程基
 H1lowest1740bar=Low[iLowest(NULL,PERIOD_H1,MODE_LOW,40,17)];   //17-40bar程基
 H1lowest20bartime=Low[iLowest(NULL,PERIOD_H1,MODE_TIME,16,0)];    //20bar程基丁
 H1lowest1740bartime=Low[iLowest(NULL,PERIOD_H1,MODE_TIME,40,17)];    //17-40bar程基丁  
 //Comment ("high0-16=",highest20bar,"  low0-16=",lowest20bar,"    high17-32=",highest1740bar,"   low17-40=",lowest1740bar);
...
//          "3=",ma05_60_buffer[3]," 2=",ma05_60_buffer[2],"  1=",ma05_60_buffer[1],"   0=",ma05_60_buffer[0]);
 ...
 //癘魁16-bar の17-32-barぇ程蔼程基
 H4highest20bar=High[iHighest(NULL,PERIOD_H4,MODE_HIGH,16,0)];   //20bar程蔼基
 H4highest1740bar=High[iHighest(NULL,PERIOD_H4,MODE_HIGH,40,17)];   //17-40bar程蔼基
 H4highest20bartime=High[iHighest(NULL,PERIOD_H4,MODE_TIME,16,0)];   //20bar程蔼基丁
 H4highest1740bartime=High[iHighest(NULL,PERIOD_H4,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 H4lowest20bar=Low[iLowest(NULL,PERIOD_H4,MODE_LOW,16,0)];     //20bar程基
 H4lowest1740bar=Low[iLowest(NULL,PERIOD_H4,MODE_LOW,40,17)];   //17-40bar程基
 H4lowest20bartime=Low[iLowest(NULL,PERIOD_H4,MODE_TIME,16,0)];    //20bar程基丁
 H4lowest1740bartime=Low[iLowest(NULL,PERIOD_H4,MODE_TIME,40,17)];    //17-40bar程基丁  
...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
     {              
                                     //[macd]-[signal]>=-0.0028 ma45 ma90 キ稬 丁筳<=0.0008  k1<=20 綼<=0.00003 ┪禬筁buy
       if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && 
           ma45_05_buffer[1]-ma45_05_buffer[40]>=0 && ma45_05_buffer[1]-ma45_05_buffer[40]<=0.0015 &&
           ma90_05_buffer[1]-ma90_05_buffer[6]>=0  &&
           close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 && 
           k1_05_buffer[1]<=20 && macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00028) 
        { 
            
                                                  //   m15 m30 kd2 kd3┕秨 ぃ禦
          if  ( k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                k2_30_buffer[1]-d2_30_buffer[1]<=-1 &&  k3_30_buffer[1]-d3_30_buffer[1]<=-1)
           {    
               ...
               if (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B1",8801,0,Red );
              }    
                               //     m15m30 ma05 ma08 ma12 
               if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                   ma05_30_buffer[1]-ma05_30_buffer[2]<=-1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-1 && ma12_30_buffer[1]-ma12_30_buffer[2]<=-1)

                   return;
    
                   else         
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B1-1",8801-1,0,Red );
   ...
   //***  buy 2  ********************************************************************************** 
                                                         ...
                                                         //[1]>=0.0003  k1<=30  [1]-[2][3]>=0.0001
           if  (close_05_buffer[1]-open_05_buffer[1]>=0.0003 && close_05_buffer[1]-close_05_buffer[2]>=0.0001 && 
                close_05_buffer[1]-close_05_buffer[3]>=0.0001  &&
                k1_05_buffer[1]<=35  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
                  ...
                  if  (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                   ...
                   {    
                       ...
                       if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                           ...
                           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B2-1",8802-1,0,Yellow );
             
            }
 
 //***  buy 3  ********************************************************************************** 

                                                                  // k1<=20 ma45弊 綼>=0.00003 ┪禬筁 close 芥虫
           if (close_05_buffer[1]-ma45_05_buffer[1]<=0.0003 && ma45_05_buffer[1]-ma45_05_buffer[2]>=0.0001 && 
               ma45_05_buffer[1]-ma45_05_buffer[6]>=0.0007 &&
               k1_05_buffer[1]<=35  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
            { 
                              //   m15 m30 kd2 kd3┕秨 ぃ禦
                 if  ( k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                  ...
                  {    
                      ...
                      if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                          ...
                          OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B3-1",8803-1,0,Blue );
 ...
 //***  buy 4  ********************************************************************************** 
          ...
          if (close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 && ma90_05_buffer[1]-ma90_05_buffer[2]>=0.0001 && 
              ma90_05_buffer[1]-ma90_05_buffer[6]>=0.0004 && 
              k1_05_buffer[1]<=35  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
           { 
                              //   m15 m30 kd2 kd3┕秨 ぃ禦
                  if  (k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                   ...
                   {    
                       ...
                       if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                           ...
                           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B4-1",8804-1,0,Brown );
            
         }
         
  //***  buy 5  ********************************************************************************** 

          if (close_05_buffer[2]-open_05_buffer[2]<=-0.0003 && close_05_buffer[1]-open_05_buffer[1]>=0.0007 &&
              k1_05_buffer[1]<=35  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30)
           {                            
                           //   m15 m30 kd2 kd3┕秨 ぃ禦
               if  ( k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                ...
                {    
                    ...
                    if (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B5",8805,0,Purple );
                }    
                                    //     m15m30 ma05 ma08 ma12 
                    if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                        ma05_30_buffer[1]-ma05_30_buffer[2]<=-1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-1 && ma12_30_buffer[1]-ma12_30_buffer[2]<=-1)
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B5-1",8805-1,0,Purple );
             
            }

  //***  buy 6  ********************************************************************************** 

                                                      //k1k2k3<=30  k1k2k3  [main1]-[signal1]>=-0.00040
         if  (k1_05_buffer[1]-k1_05_buffer[2]>=1 && k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=1 && 
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00040 &&
              k1_05_buffer[1]<=35  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
         {    
                           //   m15 m30 kd2 kd3┕秨 ぃ禦
               if  ( k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                ...
                {    
                    ...
                    if (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B6",8806,0,Gold );
                    ...
                    if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B6-1",8806-1,0,Gold );
          
          } 
          
   //***  buy 7  ********************************************************************************** 

                                                              //[1]程基琌20bar程基 痙紇絬>=0.0006 kd1>=-5
         if  (low_05_buffer[1]== m5lowest20bar &&  close_05_buffer[1]-low_05_buffer[1]>=0.0006  &&
              k1_05_buffer[1]-d1_05_buffer[1]>=-5 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00040)        
          {
                           //   m15 m30 kd2 kd3┕秨 ぃ禦
               if  ( k2_15_buffer[1]-d2_15_buffer[1]<=-1 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-1 &&
                ...
                {    
                    ...
                    if (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B7",8807,0,OrangeRed );
                 }
                                    //    m15m30 ma05 ma08 ma12 
                    if (ma05_15_buffer[1]-ma05_15_buffer[2]<=-1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-1 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-1 &&
                        ma05_30_buffer[1]-ma05_30_buffer[2]<=-1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-1 && ma12_30_buffer[1]-ma12_30_buffer[2]<=-1)
                        ...
                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B7-1",8807-1,0,OrangeRed );
          }  
    }
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
                                     // [macd]-[signal]<=0.0028 ma45 ma90 キ稬 丁筳>=-0.0008  k1>=80 綼>=-0.00003 ┪禬筁sell
       if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
           ma45_05_buffer[1]-ma45_05_buffer[40]<=0 && ma45_05_buffer[1]-ma45_05_buffer[40]>=-0.0015 &&
           ma90_05_buffer[1]-ma90_05_buffer[6]<=0 &&
           close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && 
           ...
           if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
            ...
            {  
               ...
               if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S1",4401,0,Green );
            }
                                       //     m15m30 ma05 ma08 ma12 
               if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                   ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S1-1",4401-1,0,Green );
 ...
 //***  sell   2  ********************************************************************************** 
         ...
         if (close_05_buffer[1]-open_05_buffer[1]<=-0.0003 && close_05_buffer[1]-close_05_buffer[2]<=-0.0001 && 
             close_05_buffer[1]-close_05_buffer[3]<=-0.0001 && 
             k1_05_buffer[1]>=65 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) // && close_05_buffer[0]-close_05_buffer[3]<=-0.0001)
          {                                             
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S2",4402,0,White );
                  }
                                             //      m15m30 ma05 ma08 ma12 
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S2-1",4402-1,0,White );
          }   

  
 //***  sell 3  ********************************************************************************** 

                                                 //k1>=80 ma45弊 綼>=-0.00003 ┪禬筁close禦虫
         if (close_05_buffer[1]-ma45_05_buffer[1]>=-0.0003 && ma45_05_buffer[1]-ma45_05_buffer[2]<=-0.0001 && 
             ma45_05_buffer[1]-ma45_05_buffer[6]<=-0.0007 &&
             k1_05_buffer[1]>=65 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) 
          {                                             
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S3",4403,0,Lime );
                 }
                                             //     m15m30 ma05 ma08 ma12 
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S3-1",4403-1,0,Lime );
           }   
   
     
  //***  sell 4  ********************************************************************************** 
 
                                                 //k1>=80 ma90弊 綼>=-0.00003 ┪禬筁sell
          if (close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && ma90_05_buffer[1]-ma90_05_buffer[2]<=-0.0001 && 
              ma90_05_buffer[1]-ma90_05_buffer[6]<=-0.0004 &&
              k1_05_buffer[1]>=65 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) 
           { 
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S4",44040,Gray );
                  } 
                                             //    m15m30 ma05 ma08 ma12 
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S4-1",4404-1,0,Gray );
 ...
 //***  sell 5  ********************************************************************************** 
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S5",4405,0,Aqua );
                  }
                                             //      m15m30 ma05 ma08 ma12 
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S5-1",4405-1,0,Aqua );
  ...
  //***  sell 6  ********************************************************************************** 
                                                ...
                                                //k1k2k3>=70  k1k2k3  [main1]-[signal1]<=0.00040
         if  (k1_05_buffer[1]-k1_05_buffer[2]<=-1 && k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=-1  && //&& macdmainline_05_buffer[1]-macdmainline_05_buffer[2]<=0.00003 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00040  &&
              k1_05_buffer[1]>=65 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) 
          { 
                                                          //     m15 m30 kd2 ld3┕秨 ぃ芥
               if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                ...
                {  
                                                       // m15 m30 k1k2k3[0]-[1]>=1
                   if (k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                       k1_30_buffer[1]-k1_30_buffer[2]>=1 && k2_30_buffer[1]-k2_30_buffer[2]>=1 && k3_30_buffer[1]-k3_30_buffer[2]>=1)

                       return;
          
                       else         
                       OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S6",4406,0,Teal );
                }
                                           //     m15m30 ma05 ma08 ma12 
              if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                  ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S6-1",4406-1,0,Teal );
               
         }
          
   //***  sell 7  ********************************************************************************** 
     
                                                                  //[1]程蔼基琌20bar程蔼基 痙紇絬<=-0.0006 kd1<=5 
      if  (high_05_buffer[1]== m5highest20bar &&  close_05_buffer[1]-high_05_buffer[1]<=-0.0006  &&
           k1_05_buffer[1]-d1_05_buffer[1]<=5  && 
           macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00040)       
       {
             ...
             if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
              ...
              {  
                 ...
                 if (k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S7",4407,0,Olive );
            ...
            if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                ...
                OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-300*Point,"My order #S7-1",4407-1,0,Olive );
      ...
      if  (OrderType()==OP_BUY)
       {  
           ...
           if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
            ...
            {  
                                                   // m15 m30 k1k2k3[0]-[1]>=1    
               if (k1_15_buffer[0]-k1_15_buffer[1]>=1 && k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=1 &&
                   k1_30_buffer[0]-k1_30_buffer[1]>=1 && k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=1)
                   ...
                   OrderClose(OrderTicket(),lots,Ask,1,Red); 
                                     ...
                                     //     m15m30 ma05 ma08 ma12 
               if (ma05_15_buffer[0]-ma05_15_buffer[1]>=1 &&   ma08_15_buffer[0]-ma08_15_buffer[1]>=1 && ma12_15_buffer[0]-ma12_15_buffer[1]>=1 &&
                   ma05_30_buffer[0]-ma05_30_buffer[1]>=1 &&   ma08_30_buffer[0]-ma08_30_buffer[1]>=1 && ma12_30_buffer[0]-ma12_30_buffer[1]>=1)
 ...
 //***  CLOSE Buy  2  ********************************************************************************** 
             ...
             if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
                 ma45_05_buffer[1]-ma45_05_buffer[40]<=0 && ma45_05_buffer[1]-ma45_05_buffer[40]>=-0.0015 &&
                 ma90_05_buffer[1]-ma90_05_buffer[6]<=0  &&
                 close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && k1_05_buffer[1]>=80 &&
                 macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00028) 
...
//***  CLOSE Sell  1  ********************************************************************************** 
             ...
             if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 &&  
                 ma45_05_buffer[1]-ma45_05_buffer[40]>=0 && ma45_05_buffer[1]-ma45_05_buffer[40]<=0.0015 &&
                 ma90_05_buffer[1]-ma90_05_buffer[6]>=0  &&
                 close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 && k1_05_buffer[1]<=20 &&
                 macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00028) 
              { 
 ...
 //***  CLOSE Sell  2  ********************************************************************************** 
                                                         ...
                                                         //[1]>=0.0003  k1k2k3<=30  [1]-[2][3]>=0.0001
           if  (close_05_buffer[1]-open_05_buffer[1]>=0.0003 && close_05_buffer[1]-close_05_buffer[2]>=0.0001 && 
                close_05_buffer[1]-close_05_buffer[3]>=0.0001 &&
                k1_05_buffer[1]<=35 && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
