...
if (OrdersTotal()<1 || (OrdersTotal()<2 && longbuy01!=OrderTicket()) ||   (OrdersTotal()<3 && longbuy01!=OrderTicket()) ||          
   (OrdersTotal()<4 && longbuy01!=OrderTicket()) ||  (OrdersTotal()<5 && longbuy01!=OrderTicket()))
...
//*** long Buy  2  ***************************************************************************************** 
if (OrdersTotal()<1 || (OrdersTotal()<2 && longbuy02!=OrderTicket()) ||   (OrdersTotal()<3 && longbuy02!=OrderTicket()) ||          
   (OrdersTotal()<4 && longbuy02!=OrderTicket()) ||  (OrdersTotal()<5 && longbuy02!=OrderTicket()))
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]>=0) ||
          ...
          (k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0))) 
           if    (k1_05_buffer[0]-d1_05_buffer[0]>=3 &&   k1_05_buffer[1]<=50)                               
                       ...
                       longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #LB2",8802,0,Yellow );
      
 //*** long Sell  1  ********************************************************************************************************************** 
           
if (OrdersTotal()<1 || (OrdersTotal()<2 && longsell01!=OrderTicket()) ||   (OrdersTotal()<3 && longsell01!=OrderTicket()) ||          
   (OrdersTotal()<4 && longsell01!=OrderTicket()) ||  (OrdersTotal()<5 && longsell01!=OrderTicket()))
     ...
     if   (k1_15_buffer[1]>=55 &&   k2_15_buffer[1]>=65 && k3_15_buffer[1]>=65 && 
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]<=0) ||
          ...
          if    (k1_05_buffer[0]-d1_05_buffer[0]<=-3 &&   k1_05_buffer[1]>=50)                               
             ...
             longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-7000*Point,"My order #LS2",4402,0,Green);
