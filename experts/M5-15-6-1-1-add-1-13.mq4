...
if  (OrdersTotal()<3) 
  {  
      if ( OrdersTotal()>=1 && OrderMagicNumber() == 8801 ) 
      return;
      else
 ...
 //*** long Buy  2  ***************************************************************************************** 
       if ( OrdersTotal()>=1 && OrderMagicNumber() == 8802 ) 
      return;
      else
...
//*** long Buy  3  ***************************************************************************************** 
 ...
 if (  OrdersTotal()>=1 && OrderMagicNumber() == 8803 ) 
      return;
      else
...
//*** long Buy  4  ***************************************************************************************** 
  if ( OrdersTotal()>=1 && OrderMagicNumber() == 8804 ) 
      return;
      else
 ...
 //*** Buy  5  ***************************************************************************************** 
  ...
  if ( OrdersTotal()>=1 && OrderMagicNumber() == 8805 ) 
      return;
      else
     //    m5 k1,k2,k3ど,50,[1]Μ堵 [2]Μ BUY
          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
                  ...
                  if   ((k2_60_buffer[1]<=55 && k3_60_buffer[1]<=55 &&
                     ...
                     (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                      ...
                      longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-8000*Point,"My order #LS1",4401,0,Blue);

 //*** long Sell  2  ********************************************************************************************************************** 
        if (  OrdersTotal()>=1 && OrderMagicNumber() == 4402 ) 
      return;
      else
  ...
  //***long Sell  3  ********************************************************************************************************************** 
        if (  OrdersTotal()>=1 && OrderMagicNumber() == 4403 ) 
      return;
      else
  ...
  if ( OrdersTotal()>=1 && OrderMagicNumber() == 4404 ) 
      return;
      else
   ...
   //***long Sell  5  ********************************************************************************************************************** 
   if ( OrdersTotal()>=1 && OrderMagicNumber() == 4405 ) 
      return;
      else
