    ...
    //+++++++++++++++++++++++++++++++++++++++++++   BUY   18   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if     (ma05_240_buffer[1]-ma05_240_buffer[10]<=0  &&  ma05_240_buffer[1]-ma05_240_buffer[10]>=-0.0010 &&
        ...
        //       k1_240_buffer[1]-k1_240_buffer[2]>=0 && (k2_240_buffer[1]-k2_240_buffer[2]>=0 || k3_240_buffer[1]-k3_240_buffer[2]>=0) &&
          //     k2_240_buffer[1]<=35 && k3_240_buffer[1]<=35 &&
                   // [1] 收正 >=15點
         //     ((close_240_buffer[1]-open_240_buffer[1]>=0.0005 &&  high_240_buffer[1]-close_240_buffer[1]<=-0.0015) || 
           //    close_240_buffer[1]-open_240_buffer[1]>=0.0015)) 
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+2000*Point,"My order #B19",8819,0,OrangeRed );
   //+++++++++++++++++++++++++++++++++++++++++++   BUY   20   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       
         //(m15-66)  ma650斜上    ma90 平上 ma45在ma650之下50點,且斜上較大    ma90在ma45之下50點 
        if     (ma650_240_buffer[1]-ma650_240_buffer[2]>=0.0002  &&
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if  ((((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0080) ||
            ...
            ((k1_240_buffer[1]>=60 && k2_240_buffer[1]>=60  &&  k3_240_buffer[1]>=60) || (close_240_buffer[2]-open_240_buffer[2]>=0.0250))) ||
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   SELL   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   SELL   17   ++++++++++++++++++++++++++++++++++++++++++++++++++          
   ...
   //+++++++++++++++++++++++++++++++++++++++++++   SELL   20   ++++++++++++++++++++++++++++++++++++++++++++++++++          
         ...
         //(m15-66)  ma650,斜下  ma90平下  ma45在ma650之上50點,且斜下較大    ma90在ma45之上50點 
        if     (ma650_240_buffer[1]-ma650_240_buffer[2]<=-0.0002  &&
