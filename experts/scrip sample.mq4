...
40  egt520 2007.04.04 13:01  
thank rosh
 

Moderator
34198  Rosh 2007.04.04 13:29  
You're welcome.
 

Moderator
34198  Rosh 2007.04.04 17:21  
a little modifyed...
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 4405) 
 ...
 //[1]收黑過6點,KD1交叉下,k1往下小於4點,k1在85上,收盤離MA05小於10點
     if    (close_240_buffer[1]-open_240_buffer[1]<=-0.00060  &&
            k1_240_buffer[1]-d1_240_buffer[1]<=-1 && k1_240_buffer[1]>=75 && 
            k1_240_buffer[1]-k1_240_buffer[2]<=-1 && 
            close_240_buffer[1]-ma05_240_buffer[1]<=0.00100 &&
 //上影過30點,macd範圍內,ma12,ma05間距不過60點           
          ((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001300 &&
            high_240_buffer[1]-open_240_buffer[1]>=0.00300 &&
            ma05_240_buffer[1]-ma12_240_buffer[1]<=0.00600) ||
 //或收盤低於前2bar,ma12,ma05間距不過35點           
...
//   if ( OrdersTotal()>0 && OrderMagicNumber() == 8805) 
 ...
 //[1]收紅過6點,KD1交叉上,k1往上大於4點,k1在25下,收盤離MA05小於10點
     if    (close_240_buffer[1]-open_240_buffer[1]>=0.00060  &&
            k1_240_buffer[1]-d1_240_buffer[1]>=1 && k1_240_buffer[1]<=25 && 
            k1_240_buffer[1]-k1_240_buffer[2]>=1 && 
            close_240_buffer[1]-ma05_240_buffer[1]>=-0.00100 &&
 //下影過30點,macd範圍內,ma12,ma05間距不過40點           
          ((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.001300 &&
            low_240_buffer[1]-open_240_buffer[1]<=-0.00300 &&
            ma05_240_buffer[1]-ma12_240_buffer[1]>=-0.00400) ||
 //或收盤高於前2bar,ma12,ma05間距不過35點           
           (ma05_240_buffer[1]-ma12_240_buffer[1]>=-0.00350 &&
            close_240_buffer[1]-close_240_buffer[2]>=0.00010 && close_240_buffer[1]-close_240_buffer[3]>=0.00010))) 
            OrderClose(OrderTicket(),lots,Ask,1,Gold);    
 ...
 //m240  k1大幅向上 [1]或[2]須有一為正
                  (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                    (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #B1",8801,0,Yellow );
 ...
 //m240  k1大幅向上 [1]或[2]須有一為正
                  (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                    (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #B2",8802,0,Yellow );
 ...
 //m240  k1大幅向上 [1]或[2]須有一為正
                  (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                    (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-250*Point,Ask+3900*Point,"My order #B3",8803,0,Yellow );
...
//用在轉折所以排除條件較少      
 ...
 //m240  k1大幅向上 [1]或[2]須有一為正
                  (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                    (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+3700*Point,"My order #B4",8804,0,Yellow );
 ...
 //或收盤高於前2bar,ma12,ma05間距不過35點           
           (ma05_240_buffer[1]-ma12_240_buffer[1]>=-0.00350 &&
            close_240_buffer[1]-close_240_buffer[2]>=0.00010 && close_240_buffer[1]-close_240_buffer[3]>=0.00010)) || 
 //k2,k3開口縮小
           (k2_240_buffer[1]-d2_240_buffer[1]>=-6 && k3_240_buffer[1]-d3_240_buffer[1]>=-6))
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-390*Point,Ask+6900*Point,"My order #B5",8805,0,Yellow );
 ...
 //ma12,ma05間距不過20點,K1,K2,K3,在50下且上升            
            ...
            k1_60_buffer[1]<=50 &&   k2_60_buffer[1]<=50 && k3_60_buffer[1]<=50 &&
            k1_60_buffer[1]-k1_60_buffer[2]>=1 &&  k2_60_buffer[1]-k2_60_buffer[2]>=1  &&  k3_60_buffer[1]-k3_60_buffer[2]>=1)
            OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+2890*Point,"My order #B6",8806,0,Yellow );
 ...
 //H4  k1大幅向上 [1]或[2]須有一為正
                 (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                   (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-5000*Point,"My order #S1",4401,0,Blue);
 ...
 //H4  k1大幅向上 [1]或[2]須有一為正
                 (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                   (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-5000*Point,"My order #S2",4402,0,Blue);
 ...
 //H4  k1大幅向上 [1]或[2]須有一為正
                 (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                   (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-3900*Point,"My order #S3",4403,0,Green);
...
//H1,H4 kd1,2,3值差全部>1
 ...
 //H4  k1大幅向上 [1]或[2]須有一為正
                 (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                   (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-3900*Point,"My order #S4",4404,0,Green);
 ...
 //[1]收黑過6點,KD1交叉下,k1往下小於4點,k1在85上,收盤離MA05小於10點
     if    (close_240_buffer[1]-open_240_buffer[1]<=-0.00060  &&
            ...
            k1_240_buffer[1]-k1_240_buffer[2]<=-1 && 
            close_240_buffer[1]-ma05_240_buffer[1]<=0.00100 &&
 //上影過30點,macd範圍內,ma12,ma05間距不過40點           
          ((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.001300 &&
            high_240_buffer[1]-open_240_buffer[1]>=0.00300 &&
            ma05_240_buffer[1]-ma12_240_buffer[1]<=0.00400) ||
 //或收盤低於前2bar,ma12,ma05間距不過35點           
           (ma05_240_buffer[1]-ma12_240_buffer[1]<=0.00350 &&
            close_240_buffer[1]-close_240_buffer[2]<=-0.00010 && close_240_buffer[1]-close_240_buffer[3]<=-0.00010))) 
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+390*Point,Bid-6900*Point,"My order #S5",4405,0,Green);
 ...
 //ma12,ma05間距不過20點,K1,K2,K3,在50上且下降            
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+290*Point,Bid-2890*Point,"My order #S6",4406,0,Green);
