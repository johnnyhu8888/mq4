...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (((close_15_buffer[1]-close_15_buffer[2]>=0.0001  &&
               ...
               k1_15_buffer[1]-k1_15_buffer[2]>=0  &&  k1_15_buffer[1]-d1_15_buffer[1]>=0) || 
              ...
              (close_30_buffer[1]-close_30_buffer[2]>=0.0001  &&
               ...
               k1_30_buffer[1]-k1_30_buffer[2]>=0  &&  k1_30_buffer[1]-d1_30_buffer[1]>=0) || 
              ...
              (close_60_buffer[1]-close_15_buffer[2]>=0.0001  &&
               ...
               k1_60_buffer[1]-k1_60_buffer[2]>=0  &&  k1_60_buffer[1]-d1_60_buffer[1]>=0) || 
...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if   ((close_60_buffer[1]-open_60_buffer[1]<=-0.0001 && low_60_buffer[1]-close_60_buffer[1]<=-0.0024) ||
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                                        //H4  留下影線>80點
       if   (low_240_buffer[2]-open_240_buffer[2]<=-0.0080 &&  close_240_buffer[1]-open_240_buffer[1]>=0.0001  && 
                                                         //H4 k1,k2,k3 <=30
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                                           //H4  留上影線>80點
       if  (high_240_buffer[2]-close_240_buffer[2]>=0.0080 && close_240_buffer[1]-open_240_buffer[1]<=-0.0001  && 
                                                         //H4 k1,k2,k3 >=70
