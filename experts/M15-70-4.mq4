...
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if    (ma45_240_buffer[1]-ma45_240_buffer[2]>0 && ma90_240_buffer[1]-ma90_240_buffer[2]>0 &&
              ...
              (close_240_buffer[1]-open_240_buffer[1]>=0.0010  && close_240_buffer[2]-open_240_buffer[2]<=-0.0001  &&
               ...
               if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                    ...
                    shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+200*Point,"My order shortbuy1",1101,0,Yellow);
  
  //+++++++++++++++++++++++++++++++++++++++++++   SHORT BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
  
                  //  m15   case-buy1   macd 差值小且在一定範圍內    
      if     ((macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00040 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00040 &&
                // m15  k1,k2,k3<30   k[1]-[2]=5   
               k1_15_buffer[1]-k1_15_buffer[2]>=5 &&  k1_15_buffer[1]<=30 && k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30 &&
                //[1]>=5  [1]>[2],[3],[4],[5]
               ...
               close_15_buffer[1]-close_15_buffer[4]>=0.0001 &&
                 // ma45 為持平狀態
               ma45_15_buffer[1]-ma45_15_buffer[10]>=0.0003 && ma45_15_buffer[1]-ma45_15_buffer[10]<=-0.0003) ||
               
                //  m30   case-buy2   macd 差值小且在一定範圍內    
              (macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00040 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00040 &&
                // m15  k1,k2,k3<30   k[1]-[2]=5   
               k1_30_buffer[1]-k1_30_buffer[2]>=5 &&  k1_30_buffer[1]<=30 && k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30 &&
                //[1]>=5  [1]>[2],[3],[4],[5]
               close_30_buffer[1]-open_30_buffer[1]>=0.0005  &&  close_30_buffer[1]-close_30_buffer[2]>=0.0001  &&
               close_30_buffer[1]-close_30_buffer[3]>=0.0001 && close_30_buffer[1]-close_30_buffer[3]>=0.0001 &&
               close_30_buffer[1]-close_30_buffer[4]>=0.0001 &&
                 // ma45 為持平狀態
               ma45_30_buffer[1]-ma45_30_buffer[10]>=0.0003 && ma45_30_buffer[1]-ma45_30_buffer[10]<=-0.0003) ||
              
                //  m60   case-buy3   macd 差值小且在一定範圍內    
              (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 &&
                // m15  k1,k2,k3<30   k[1]-[2]=5   
               k1_60_buffer[1]-k1_60_buffer[2]>=5 &&  k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30 &&
                //[1]>=5  [1]>[2],[3],[4],[5]
               close_60_buffer[1]-open_60_buffer[1]>=0.0005  &&  close_60_buffer[1]-close_60_buffer[2]>=0.0001  &&
               close_60_buffer[1]-close_60_buffer[3]>=0.0001 && close_60_buffer[1]-close_60_buffer[3]>=0.0001 &&
               close_60_buffer[1]-close_60_buffer[4]>=0.0001 &&
                 // ma45 為持平狀態
               ma45_60_buffer[1]-ma45_60_buffer[10]>=0.0003 && ma45_60_buffer[1]-ma45_60_buffer[10]<=-0.0003) ||
           
              //  h4   case-buy4   macd 差值小且在一定範圍內    
              (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.00040 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.00040 &&
                // m15  k1,k2,k3<30   k[1]-[2]=5   
               k1_240_buffer[1]-k1_240_buffer[2]>=5 &&  k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30 && k3_240_buffer[1]<=30 &&
                //[1]>=5  [1]>[2],[3],[4],[5]
               close_240_buffer[1]-open_240_buffer[1]>=0.0005  &&  close_240_buffer[1]-close_240_buffer[2]>=0.0001  &&
               close_240_buffer[1]-close_240_buffer[3]>=0.0001 && close_240_buffer[1]-close_240_buffer[3]>=0.0001 &&
               close_240_buffer[1]-close_240_buffer[4]>=0.0001 &&
                 // ma45 為持平狀態
               ma45_240_buffer[1]-ma45_240_buffer[10]>=0.0003 && ma45_240_buffer[1]-ma45_240_buffer[10]<=-0.0003))
               if     (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       ...
                       shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+100*Point,"My order shortbuy2",1102,0,Yellow);
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   SHORT BUY   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if  (((close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[4]-open_15_buffer[4]>=0.0006  && 
              ...
              macdmainline_30_buffer[1]<=0.00110   &&   
                                                         //m60 的45,90,180  皆是斜上
             (macdmainline_60_buffer[1]<=0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]>=0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]>=0.0003 && 
              ma180_60_buffer[1]-ma180_60_buffer[2]>=0)))       if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       shortbuy04==OrderTicket() || shortbuy05==OrderTicket() ||shortbuy06==OrderTicket() || shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
                       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket()))   
                       return;
                       else      
                       shortbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+100*Point,"My order shortbuy3",1103,0,Yellow);

  //+++++++++++++++++++++++++++++++++++++++++++   SHORT BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 
              //h1   case-buy1   [1]留下影線 >=24點  [1]>0.0001開-低  [1]<-0.0001收-低
       if  (((close_60_buffer[1]-open_60_buffer[1]<=-0.0001 && close_60_buffer[1]-open_60_buffer[1]>=-0.0003 && 
              low_60_buffer[1]-close_60_buffer[1]<=-0.0024) ||
             (close_60_buffer[1]-open_60_buffer[1]>=0  && close_60_buffer[1]-open_60_buffer[1]<=0.0006 && 
              low_60_buffer[1]-open_60_buffer[1]<=-0.0024) &&
              low_60_buffer[1]==H1lowest40bar &&
              k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0) ||
                  //h1     case-buy2    [1]收紅 [2]留下影線
             ((close_60_buffer[2]-open_60_buffer[2]<=-0.0001  &&  low_60_buffer[2]-close_60_buffer[2]<=-0.0024) ||
             (close_60_buffer[2]-open_60_buffer[2]>=0  &&  low_60_buffer[2]-open_60_buffer[2]<=-0.0024) &&
              low_60_buffer[2]==H1lowest40bar &&
              k1_60_buffer[1]-k1_60_buffer[2]>=5 && k1_60_buffer[1]-d1_60_buffer[1]>=5 &&  
              close_60_buffer[1]-open_60_buffer[1]>=10)  && 
              macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.0200 && 
              macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00010) 
             if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       shortbuy04==OrderTicket() || shortbuy05==OrderTicket() ||shortbuy06==OrderTicket() || shortsell01==OrderTicket() || shortsell02==OrderTicket() ||shortsell03==OrderTicket() ||
                       ...
                       shortbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+100*Point,"My order shortbuy4",1104,0,Yellow);
        ...
        if    (ma45_240_buffer[1]-ma45_240_buffer[2]<0 && ma90_240_buffer[1]-ma90_240_buffer[2]<0 &&
              ...
              (close_240_buffer[1]-open_240_buffer[1]<=-0.0010  && close_240_buffer[2]-open_240_buffer[2]>=0.0001  &&
               ...
               if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                    ...
                    shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-200*Point,"My order shortsell01",2201,0,MediumSeaGreen );

 //+++++++++++++++++++++++++++++++++++++++++++   SHORT SELL   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
  
                //m15  case-buy1   macd  差值小且在一定範圍內    
      if     ((macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00040 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00040 &&
                // m15  k1,k2,k3>70   k[1]-[2]<=5   
               k1_15_buffer[1]-d1_15_buffer[2]<=-5 &&  k1_15_buffer[1]>=70 && k2_15_buffer[1]>=70 && k3_15_buffer[1]>=70 &&
                //[1]<=-0.0005  [1]<[2],[3],[4],[5]
               close_15_buffer[1]-open_15_buffer[1]<=-0.0005  &&  close_15_buffer[1]-close_15_buffer[2]<=-0.0001  &&
               close_15_buffer[1]-close_15_buffer[3]<=-0.0001 && close_15_buffer[1]-close_15_buffer[4]<=-0.0001 &&
               close_15_buffer[1]-close_15_buffer[5]<=-0.0001 &&
                       // ma45 為持平狀態
               ma45_15_buffer[1]-ma45_15_buffer[6]<=-0.0003 && ma45_15_buffer[1]-ma45_15_buffer[6]>=0.0003) ||
         
                //  m30   case-buy2   macd 差值小且在一定範圍內    
              (macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=-0.00040 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00040 &&
                // m15  k1,k2,k3>70   k[1]-[2]<=-5   
               k1_30_buffer[1]-k1_30_buffer[2]<=-5 &&  k1_30_buffer[1]>=70 && k2_30_buffer[1]>=70 && k3_30_buffer[1]>=70 &&
                //[1]<=-0.0005  [1]<[2],[3],[4],[5]
               close_30_buffer[1]-open_30_buffer[1]<=-0.0005  &&  close_30_buffer[1]-close_30_buffer[2]<=-0.0001  &&
               close_30_buffer[1]-close_30_buffer[3]<=-0.0001 && close_30_buffer[1]-close_30_buffer[3]<=-0.0001 &&
               close_30_buffer[1]-close_30_buffer[4]<=-0.0001 &&
              ...
              (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 &&
                // m15  k1,k2,k3>70   k[1]-[2]<=-5   
               k1_60_buffer[1]-k1_60_buffer[2]<=-5 &&  k1_60_buffer[1]>=70 && k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70 &&
                //[1]<=-0.0005  [1]<[2],[3],[4],[5]
               close_60_buffer[1]-open_60_buffer[1]<=-0.0005  &&  close_60_buffer[1]-close_60_buffer[2]<=-0.0001  &&
               close_60_buffer[1]-close_60_buffer[3]<=-0.0001 && close_60_buffer[1]-close_60_buffer[3]<=-0.0001 &&
               close_60_buffer[1]-close_60_buffer[4]<=-0.0001 &&
              ...
              (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.00040 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.00040 &&
                // m15  k1,k2,k3>70   k[1]-[2]<=-5   
               k1_240_buffer[1]-k1_240_buffer[2]<=-5 &&  k1_240_buffer[1]>=70 && k2_240_buffer[1]>=70 && k3_240_buffer[1]>=70 &&
                //[1]<=-0.0005  [1]<[2],[3],[4],[5]
               close_240_buffer[1]-open_240_buffer[1]<=-0.0005  &&  close_240_buffer[1]-close_240_buffer[2]<=-0.0001  &&
               close_240_buffer[1]-close_240_buffer[3]<=-0.0001 && close_240_buffer[1]-close_240_buffer[3]<=-0.0001 &&
               close_240_buffer[1]-close_240_buffer[4]<=-0.0001 &&
               ...
               if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       ...
                       shortsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-100*Point,"My order shortsell02",2202,0,MediumSeaGreen );
        ...
        if  (((close_15_buffer[1]-open_15_buffer[1]<=-0.0006 && close_15_buffer[4]-open_15_buffer[4]<=-0.0006  && 
              ...
              (macdmainline_60_buffer[1]>=-0.00200 || (ma45_60_buffer[1]-ma45_60_buffer[2]<=-0.0003 && ma90_60_buffer[1]-ma90_60_buffer[2]<=-0.0003 && 
               ...
               if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       ...
                       shortsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-100*Point,"My order shortsell03",2203,0,MediumSeaGreen );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   SHORT SELL   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if (((close_60_buffer[1]-open_60_buffer[1]<=-0.0001 && close_60_buffer[1]-open_60_buffer[1]>=-0.0006  &&
            high_60_buffer[1]-open_60_buffer[1]>=0.0024) ||
           (close_60_buffer[1]-open_60_buffer[1]>=0 && close_60_buffer[1]-open_60_buffer[1]<=0.0003  && 
            high_60_buffer[1]-close_60_buffer[1]>=0.0024) &&
            high_60_buffer[1]==H1highest40bar  && 
            k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0) ||
                // h1    case-sell2    [1]<=0 [2] 留上影線
          ((close_60_buffer[1]-open_60_buffer[1]<=-0.0001  &&  high_60_buffer[1]-open_60_buffer[1]>=0.0024) ||
           (close_60_buffer[1]-open_60_buffer[1]>=0  &&  high_60_buffer[1]-close_60_buffer[1]>=0.0024) &&
            high_60_buffer[1]==H1highest40bar  && 
            k1_60_buffer[1]-k1_60_buffer[2]<=5 && k1_60_buffer[1]-d1_60_buffer[1]<=5 && 
            close_60_buffer[1]-open_60_buffer[1]<=-0.0010)   &&
            ...
            if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                       ...
                       shortsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-100*Point,"My order shortsell04",2204,0,MediumSeaGreen );
...
//***  Ordermodify   ********************************************************************************** 
  ...
  //          OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-50*Point,OrderTakeProfit(),0,Blue);
         ...
         //超過1.5h收盤都沒升過10點時 
     if  (TimeCurrent()-OrderOpenTime()>=5000 &&  OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() || 
          shortbuy03==OrderTicket() || shortbuy04==OrderTicket()) && 
          close_15_buffer[1]-OrderOpenPrice()<=0.0010  && close_15_buffer[2]-OrderOpenPrice()<=0.0010  &&
          close_15_buffer[3]-OrderOpenPrice()<=0.0010  && close_15_buffer[4]-OrderOpenPrice()<=0.0010  &&
          close_15_buffer[5]-OrderOpenPrice()<=0.0010  && close_15_buffer[6]-OrderOpenPrice()<=0.0010)
          OrderModify(OrderTicket(),Bid,OrderOpenPrice()-6*Point,OrderTakeProfit(),0,Blue);
 
       if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() || 
           shortbuy03==OrderTicket() || shortbuy04==OrderTicket()) && 
          high_15_buffer[0]-OrderOpenPrice()>=0.0015 && high_15_buffer[0]-OrderOpenPrice()<=0.0035 )
                       //stoploss=OrderOpenPrice()+7*Point可以賺5點
                 //曾到過0.0015價位就不在執行這條
         if  ((high_15_buffer[0]-OrderOpenPrice()>=0.0020) ||
              (high_30_buffer[0]-OrderOpenPrice()>=0.0020)  ||
              (high_60_buffer[0]-OrderOpenPrice()>=0.0020)  ||
              (high_240_buffer[0]-OrderOpenPrice()>=0.0020))            
              return;
              else
      ...
      if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||
          shortbuy03==OrderTicket() || shortbuy04==OrderTicket()) && 
          high_15_buffer[0]-OrderOpenPrice()>=0.0036 && high_15_buffer[0]-OrderOpenPrice()<=0.0069)
                       //stoploss=OrderOpenPrice()+7*Point可以賺25點
                   //曾到過0.0036價位就不在執行這條
         if  ((high_15_buffer[0]-OrderOpenPrice()>=0.0040) ||
              (high_30_buffer[0]-OrderOpenPrice()>=0.0040)  ||
              (high_60_buffer[0]-OrderOpenPrice()>=0.0040)  ||
              (high_240_buffer[0]-OrderOpenPrice()>=0.0040))            
              return;
              else
      ...
      if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||
          shortbuy03==OrderTicket() || shortbuy04==OrderTicket()) && 
          high_15_buffer[0]-OrderOpenPrice()>=0.0070)
                       //stoploss=OrderOpenPrice()+57*Point可以賺55點
                   //曾到過0.0070價位就不在執行這條
         if  ((high_15_buffer[0]-OrderOpenPrice()>=0.0075) ||
              (high_30_buffer[0]-OrderOpenPrice()>=0.0075)  ||
              (high_60_buffer[0]-OrderOpenPrice()>=0.0075)  ||
              (high_240_buffer[0]-OrderOpenPrice()>=0.0075))            
              return;
              else
              OrderModify(OrderTicket(),Ask,OrderOpenPrice()+57*Point,OrderTakeProfit(),0,Blue);
   ...
   //         OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+50*Point,OrderTakeProfit(),0,Blue);
              ...
              //超過1.5h收盤都沒跌過10點時 
     if  (TimeCurrent()-OrderOpenTime()>=5000 &&  OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket() ||
          shortsell03==OrderTicket() || shortsell04==OrderTicket()) &&
          close_15_buffer[1]-OrderOpenPrice()>=-0.0010  && close_15_buffer[2]-OrderOpenPrice()>=-0.0010  &&
          close_15_buffer[3]-OrderOpenPrice()>=-0.0010  && close_15_buffer[4]-OrderOpenPrice()>=-0.0010  &&
          close_15_buffer[5]-OrderOpenPrice()>=-0.0010  && close_15_buffer[6]-OrderOpenPrice()>=-0.0010)
          OrderModify(OrderTicket(),Bid,OrderOpenPrice()-6*Point,OrderTakeProfit(),0,Blue);
      ...
      if (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket() ||
          shortsell03==OrderTicket() || shortsell04==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0015 && low_15_buffer[0]-OrderOpenPrice()>=-0.0035)
                                  //stoploss=OrderOpenPrice()-7*Point可以賺5點
                 //曾到過0.0015價位就不在執行這條
         if  ((low_15_buffer[0]-OrderOpenPrice()<=-0.0020) ||
              (low_30_buffer[0]-OrderOpenPrice()<=-0.0020)  ||
              (low_60_buffer[0]-OrderOpenPrice()<=-0.0020)  ||
              (low_240_buffer[0]-OrderOpenPrice()<=-0.0020))            
              return;
              else
             OrderModify(OrderTicket(),Bid,OrderOpenPrice()-7*Point,OrderTakeProfit(),0,Blue);
            
      if (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket() ||
          shortsell01==OrderTicket() || shortsell02==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0036 && low_15_buffer[0]-OrderOpenPrice()>=-0.0069)
                                  //stoploss=OrderOpenPrice()-27*Point可以賺25點
                       //曾到過0.0015價位就不在執行這條
         if  ((low_15_buffer[0]-OrderOpenPrice()<=-0.0040) ||
              (low_30_buffer[0]-OrderOpenPrice()<=-0.0040)  ||
              (low_60_buffer[0]-OrderOpenPrice()<=-0.0040)  ||
              (low_240_buffer[0]-OrderOpenPrice()<=-0.0040))            
              return;
              else
       ...
       if (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket() ||
          shortsell01==OrderTicket() || shortsell02==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0070)
                                  //stoploss=OrderOpenPrice()-57*Point可以賺55點
                         //曾到過0.0015價位就不在執行這條
         if  ((low_15_buffer[0]-OrderOpenPrice()<=-0.0075) ||
              (low_30_buffer[0]-OrderOpenPrice()<=-0.0075)  ||
              (low_60_buffer[0]-OrderOpenPrice()<=-0.0075)  ||
              (low_240_buffer[0]-OrderOpenPrice()<=-0.0075))            
              return;
              else
      OrderModify(OrderTicket(),Bid,OrderOpenPrice()-57*Point,OrderTakeProfit(),0,Blue);
