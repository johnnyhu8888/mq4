 ...
 //**************************   oders modify  ***************************************************************88
           ...
           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8801 || OrderMagicNumber( )==88011) &&
                  ...
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+30*Point,OrderTakeProfit(),0,Blue);
                                                   //44011為反向單以安全為原則       
//           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==88011 || OrderMagicNumber( )==8806) &&
...
//**********************************************************************************************************
           ...
           if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4401 || OrderMagicNumber( )==44011) &&
                  ...
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-30*Point,OrderTakeProfit(),0,Blue);
                                                  //44011為反向單以安全為原則
//           if    (OrderType()==OP_SELL && (OrderMagicNumber( )==44011 || OrderMagicNumber( )==4406) &&
...
//*** long Buy  3  ***************************************************************************************** 
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 8807) 
     ...
     if  (k1_15_buffer[1]-k1_15_buffer[2]>=6 &&  k1_15_buffer[2]-k1_15_buffer[3]<=-3) 
         OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+500*Point,"My order #LB7",8807,0,Yellow );
 ...
 //*** long SELL  3  ***************************************************************************************** 
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 4407) 
      return;
         ...
         //     k1大幅轉折
     if  (k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) 
          OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-500*Point,"My order #S7",4407,0,Green);
