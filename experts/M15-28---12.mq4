...
//*** Buy  1  ***************************************************************************************** 
     ...
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
           if (ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && 
              ...
              if (macdmainline_15_buffer[1]>=-0.00060 || macdmainline_15_buffer[1]<=0.00060 &&
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+1000*Point,"My order #B1",8801,0,Red );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    2     +++++++++++++++++++++
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0) ||
               ...
               if (macdmainline_15_buffer[1]>=-0.00060 || macdmainline_15_buffer[1]<=0.00060 &&
                ...
                OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+1000*Point,"My order #B2",8802,0,Yellow );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    3     +++++++++++++++++++++
         ...
         if   ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  &&
              ...
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+1000*Point,"My order #B3",8803,0,Blue );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    4     +++++++++++++++++++++
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]>=0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 &&
                                 //上ma180,中ma360,下ma650 順序由為由上到下
                ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0015 && ma360_15_buffer[1]-ma650_15_buffer[1]>=0.0015 && 
                                        //k1,k2,k3 <=18 >=8
                k1_15_buffer[1]<=18 ||  k1_15_buffer[1]>=8 && k2_15_buffer[1]<=18  || k2_15_buffer[1]>=8 &&
                k3_15_buffer[1]<=18 ||  k3_15_buffer[1]>=8 &&
               ...
               ((ma180_15_buffer[1]-ma180_15_buffer[40]>=0.0030 && ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 &&
                ...
                ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0015 && ma360_15_buffer[1]-ma650_15_buffer[1]>=0.0015 && 
                                        //k1,k2,k3 <=30 >=8
                k1_15_buffer[1]<=30 ||  k1_15_buffer[1]>=8 && k2_15_buffer[1]<=30  || k2_15_buffer[1]>=8 &&
                k3_15_buffer[1]<=30 ||  k3_15_buffer[1]>=8 &&
                                        //[1]收黑 且<-=0.0006  [1]<= ma180,ma360,ma650 0.0006 
                close_15_buffer[1]-open_15_buffer[1]<=-0.0006 && close_15_buffer[1]-ma180_15_buffer[1]<=-0.0006) ||
     ...
     //              (ma45_15_buffer[1]-ma45_15_buffer[6]<=-0.0006 && ma90_15_buffer[1]-ma90_15_buffer[6]<=0 &&
     //               ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0001 && 
     //               ma180_15_buffer[1]-ma180_15_buffer[6]<=0 && ma360_15_buffer[1]-ma360_15_buffer[6]<=0))
                
                    return;
                   else   
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+1000*Point,"My order #B4",8804,0,Brown );
    ...
    if (OrdersTotal()<=1)   
     {                                               //m15 的ma45  ma90 為 ㄏ 上升末端型態
          if (ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-1000*Point,"My order #S1",4401,0,Green );
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  2  +++++++++++++++++++++++++++++++++++++
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0) || 
               (ma90_15_buffer[1]-ma90_15_buffer[2]<=0 && ma180_15_buffer[1]-ma180_15_buffer[2]<=0) &&
                                                    //用m15 m30 macd 控管買賣點                                                    
               ...
               OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-1000*Point,"My order #S2",4402,0,White );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  3  +++++++++++++++++++++++++++++++++++++
        ...
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 &&
               ...
               if (macdmainline_15_buffer[1]>=-0.00060 || macdmainline_15_buffer[1]<=0.00060 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-1000*Point,"My order #S3",4403,0,Lime );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    4     +++++++++++++++++++++
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]<=-0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0020 &&
                                   //下ma180,中ma360,上ma650 順序由為由下到上
                ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0015 && ma360_15_buffer[1]-ma650_15_buffer[1]<=-0.0015 && 
                                        //k1,k2,k3 >=82 <=92
                k1_15_buffer[1]>=82 ||  k1_15_buffer[1]<=92 && k2_15_buffer[1]>=82  || k2_15_buffer[1]<=92 &&
                k3_15_buffer[1]>=82 ||  k3_15_buffer[1]<=92 &&
                                        //[1]收紅 且>=0.0006  [1]>= ma180,ma360,ma650 0.0006 
                close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[1]-ma180_15_buffer[1]>=0.0006) ||
               ...
               ((ma180_15_buffer[1]-ma180_15_buffer[40]<=-0.0050 && ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0040 &&
                ...
                ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0015 && ma360_15_buffer[1]-ma650_15_buffer[1]<=-0.0015 && 
                                        //k1,k2,k3 >=82 <=92
                k1_15_buffer[1]>=70 ||  k1_15_buffer[1]<=92 && k2_15_buffer[1]>=70  || k2_15_buffer[1]<=92 &&
                k3_15_buffer[1]>=70 ||  k3_15_buffer[1]<=92 &&
                                             //[1]收紅 且>=0.0006  [1]>= ma180,ma360,ma650 0.0006 
                close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[1]-ma180_15_buffer[1]>=0.0006) ||
      ...
      //             ma180_15_buffer[1]-ma180_15_buffer[6]>=0 && ma360_15_buffer[1]-ma360_15_buffer[6]>=0))
                 ...
                 OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-1000*Point,"My order #S4",4404,0,Gray );
