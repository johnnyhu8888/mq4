           ...
           (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
            ...
            if   ((k2_60_buffer[1]>=45 && k3_60_buffer[1]>=45 &&
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[2])+(k2_240_buffer[1]-d2_240_buffer[2])+(k3_240_buffer[1]-d3_240_buffer[2]))<50) ||
                  ...
                  (((macdmainline_240_buffer[0]-macdsignalline_240_buffer[0])-(macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]))-
                   ((macdmainline_240_buffer[1]-macdsignalline_240_buffer[1])-(macdmainline_240_buffer[2]-macdsignalline_240_buffer[2]))<=-0.000050)) 
                  return;
                  else
