...
//*** long Buy  2  ***************************************************************************************** 
if (OrdersTotal()<1 || (OrdersTotal()<3 && longbuy02<2) ||          
     ...
     if   (k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 && 
         ...
         ((d3_05_buffer[1]-d3_05_buffer[2]>=0) ||
          ...
          (k2_05_buffer[1]-k2_05_buffer[2]>=0 && k3_05_buffer[1]-k3_05_buffer[2]>=0))) 
               ...
               longbuy02=OrderSend(Symbol(),OP_BUYLIMIT,lots,Ask-150*Point,1,Bid-150*Point-5000*Point,"My order #LB2",8802,500,Yellow );
...
if (OrdersTotal()<1 ||  (OrdersTotal()<3 && longsell02<2) ||          
     ...
     if   (k1_05_buffer[1]>=70 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>75 && 
         ...
         ((d3_05_buffer[1]-d3_05_buffer[2]<=0) ||
          ...
          (k2_05_buffer[1]-k2_05_buffer[2]<=0 && k3_05_buffer[1]-k3_05_buffer[2]<=0))) 
             ...
             longsell02=OrderSend(Symbol(),OP_SELLLIMIT,lots,Bid+150*Point,1,Ask+150*Point+7000*Point,"My order #LS2",4402,500,Green);
