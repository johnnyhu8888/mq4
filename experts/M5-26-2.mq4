  ...
  if (OrdersTotal()<=1)   
   ...
   //***  buy 2  ********************************************************************************** 
           ...
           if  (close_05_buffer[1]-open_05_buffer[1]>=0.0003 && close_05_buffer[1]-close_05_buffer[2]>=0.0001 && 
                ...
                k1_05_buffer[1]<=30  && k2_05_buffer[1]<=30 && k3_05_buffer[1]<=30) 
...
//*** Sell  1  ********************************************************************************************************************** 
           ...
           if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
            ...
            {  
               ...
               if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S1",4401,0,Green );
               ...
               if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S1-1",4401-1,0,Green );
            }
 ...
 //***  sell   2  ********************************************************************************** 
            ...
            if (close_05_buffer[1]-open_05_buffer[1]<=-0.0003 && close_05_buffer[1]-close_05_buffer[2]<=-0.0001 && 
                close_05_buffer[1]-close_05_buffer[3]<=-0.0001 && 
                k1_05_buffer[1]>=70 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) // && close_05_buffer[0]-close_05_buffer[3]<=-0.0001)
             {                                             
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2-1",4402-1,0,White );
 ...
 //***  sell 3  ********************************************************************************** 
            ...
            if (close_05_buffer[1]-ma45_05_buffer[1]>=-0.0003 && ma45_05_buffer[1]-ma45_05_buffer[2]<=-0.0001 && 
                ma45_05_buffer[1]-ma45_05_buffer[6]<=-0.0007 &&
                k1_05_buffer[1]>=70 && k2_05_buffer[1]>=70 && k3_05_buffer[1]>=70) 
             {                                             
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S3-1",4403-1,0,Lime );
                   }
             }   
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S4",44040,Gray );
                     ...
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S4-1",4404-1,0,Gray );
                 ...
                 if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
                  ...
                  {  
                     ...
                     if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S5",4405,0,Aqua );
                     ...
                     if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                         ...
                         OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S5-1",4405-1,0,Aqua );
             ...
             if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
              ...
              {  
                 ...
                 if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S6",4406,0,Teal );
                 ...
                 if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S6-1",4406-1,0,Teal );
             ...
             if (k2_15_buffer[1]-d2_15_buffer[1]>=1 &&  k3_15_buffer[1]-d3_15_buffer[1]>=1 &&
              ...
              {  
                 ...
                 if (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S7",4407,0,Olive );
                 ...
                 if (ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S7-1",4407-1,0,Olive );
