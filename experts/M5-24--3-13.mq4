...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
     {              
       ...
       if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && ma90_05_buffer[1]-ma90_05_buffer[6]>=0  &&
        ...
        { 
                                                  ...
                                                  // m15 or m30k2k3>=65 耞よΑ  m15 m30 kd2 kd3┕秨 ぃ禦
          if  ((k2_15_buffer[1]>=35 && k3_15_buffer[1]>=35) || (k2_30_buffer[1]>=35 && k3_30_buffer[1]>=35) &&
           ...
           {    
               ...
               if (k1_15_buffer[0]-k1_15_buffer[1]<=-1 && k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=-1 &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+120*Point,"My order #B1",8801,0,Red );
      
                               // m15 or m30k2k3<=35 耞よΑ     m15m30 ma05 ma08 ma12 
               if ((k2_15_buffer[1]<=35 && k3_15_buffer[1]<=35) || (k2_30_buffer[1]<=35 && k3_30_buffer[1]<=35) &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+120*Point,"My order #B1-1",8801-1,0,Red );
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
       ...
       if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 && ma45_05_buffer[1]-ma45_05_buffer[6]<=0 && 
           ma45_05_buffer[1]-ma45_05_buffer[40]<=0 && ma45_05_buffer[1]-ma45_05_buffer[40]>=-0.0015 &&
           ma45_05_buffer[1]-ma90_05_buffer[1]>=-0.0008 &&
           close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && 
        ...
        { 
                                       ...
                                       // m15 or m30k2k3<=65 耞よΑ     m15 m30 kd2 ld3┕秨 ぃ芥
           if ((k2_15_buffer[1]<=65 && k3_15_buffer[1]<=65) || (k2_30_buffer[1]<=65 && k3_30_buffer[1]<=65) &&
            ...
            {  
               ...
               if (k1_15_buffer[0]-k1_15_buffer[1]>=1 && k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=1 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-120*Point,"My order #S1",4401,0,Green );
       
                                       // m15 or m30k2k3>=65 耞よΑ     m15m30 ma05 ma08 ma12 
               if ((k2_15_buffer[1]>=65 && k3_15_buffer[1]>=65) || (k2_30_buffer[1]>=65 && k3_30_buffer[1]>=65) &&
                   ma05_15_buffer[1]-ma05_15_buffer[2]>=1 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=1 && ma12_15_buffer[1]-ma12_15_buffer[2]>=1 &&
                   ma05_30_buffer[1]-ma05_30_buffer[2]>=1 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=1 && ma12_30_buffer[1]-ma12_30_buffer[2]>=1)
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-120*Point,"My order #S1-1",4401-1,0,Green );
            }
 ...
 //***  CLOSE Buy  2  ********************************************************************************** 
                                          ...
                                          // [macd]-[signal]<=0.0028 ma45 ma180 キ稬 丁筳>=-0.0008  k1>=80 綼>=-0.00003 ┪禬筁sell
            if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
                ma180_05_buffer[1]-ma180_05_buffer[40]<=0 && ma180_05_buffer[1]-ma180_05_buffer[40]>=-0.0012 &&
                ma180_05_buffer[1]-ma45_05_buffer[1]>=-0.0008 &&
                close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && k1_05_buffer[1]>=80 &&
                macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00028) 
 ...
 //***  CLOSE Buy  3  ********************************************************************************** 
            ...
            if (close_05_buffer[1]-open_05_buffer[1]<=-0.0003 && close_05_buffer[1]-close_05_buffer[2]<=-0.0001 && 
                close_05_buffer[1]-close_05_buffer[3]<=-0.0001 && k1_05_buffer[1]>=70) // && close_05_buffer[0]-close_05_buffer[3]<=-0.0001)
             {                                             
 ...
 //***  CLOSE Buy  4  ********************************************************************************** 
            ...
            if (close_05_buffer[1]-ma45_05_buffer[1]>=-0.0003 && ma45_05_buffer[1]-ma45_05_buffer[2]<=-0.0001 && 
                ma45_05_buffer[1]-ma45_05_buffer[6]<=-0.0007 && k1_05_buffer[1]>=80) // && close_05_buffer[0]-close_05_buffer[3]<=-0.0001)
             {                                             
  ...
  //***  CLOSE Buy  5  ********************************************************************************** 
             ...
             if (close_05_buffer[1]-ma90_05_buffer[1]>=-0.0003 && ma90_05_buffer[1]-ma90_05_buffer[2]<=-0.0001 && 
                 ma90_05_buffer[1]-ma90_05_buffer[6]<=-0.0004 && k1_05_buffer[1]>=80) 
              { 
 ...
 //***  CLOSE Buy  6  ********************************************************************************** 
  ...
  //***  CLOSE Buy  7  ********************************************************************************** 
                                                   ...
                                                   //k1>=65  k1k2k3  [main1]-[main2]<=0.00003 [main1]-[signal1]<=0.00020
            if  (k1_05_buffer[1]>=65 &&  k1_05_buffer[1]-k1_05_buffer[2]<=-1 && k2_05_buffer[1]-k2_05_buffer[2]<=-1 &&
                 k3_05_buffer[1]-k3_05_buffer[2]<=-1  && //&& macdmainline_05_buffer[1]-macdmainline_05_buffer[2]<=0.00003 &&
...
//***  CLOSE Sell  2  ********************************************************************************** 
                                          ...
                                          // [macd]-[signal]>=-0.0028 ma45 ma180 キ稬 丁筳<=0.0008  k1<=20 綼<=0.00003 ┪禬筁buy
            if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 &&  
                ma180_05_buffer[1]-ma180_05_buffer[40]>=0 && ma180_05_buffer[1]-ma180_05_buffer[40]<=0.0012 &&
                ma180_05_buffer[1]-ma45_05_buffer[1]<=0.0008 &&
                close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 && k1_05_buffer[1]<=20 &&
 ...
 //***  CLOSE Sell  3  ********************************************************************************** 
           ...
           if  (close_05_buffer[1]-open_05_buffer[1]>=0.0003 && close_05_buffer[1]-close_05_buffer[2]>=0.0001 && 
                close_05_buffer[1]-close_05_buffer[3]>=0.0001 && k1_05_buffer[1]<=30  ) //  && close_05_buffer[0]-close_05_buffer[3]>=0.0001)
 ...
 //***  CLOSE Sell  4  ********************************************************************************** 
           ...
           if (close_05_buffer[1]-ma45_05_buffer[1]<=0.0003 && ma45_05_buffer[1]-ma45_05_buffer[2]>=0.0001 && 
               ma45_05_buffer[1]-ma45_05_buffer[6]>=0.0007 && k1_05_buffer[1]<=20) 
            { 
 ...
 //***  CLOSE Sell  5  ********************************************************************************** 
          ...
          if (close_05_buffer[1]-ma90_05_buffer[1]<=0.0003 && ma90_05_buffer[1]-ma90_05_buffer[2]>=0.0001 && 
              ma90_05_buffer[1]-ma90_05_buffer[6]>=0.0004 && k1_05_buffer[1]<=20) 
           { 
  ...
  //***  CLOSE Sell  7  ********************************************************************************** 
                                                      ...
                                                      //k1<=35  k1k2k3  [main1]-[main2]>=-0.00003 [main1]-[signal1]>=-0.00020
         if  (k1_05_buffer[1]<=35 &&  k1_05_buffer[1]-k1_05_buffer[2]>=1 && k2_05_buffer[1]-k2_05_buffer[2]>=1 &&
              k3_05_buffer[1]-k3_05_buffer[2]>=1 && // &&  macdmainline_05_buffer[1]-macdmainline_05_buffer[2]>=-0.00003 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00040 ) 
          {    
