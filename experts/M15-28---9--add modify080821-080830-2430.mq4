...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                         //m15 ma180,ma360 or ma360,ma650 or ma650 ど碩    禴瘆ma180 ,ma360,ma650 Μ堵禦虫
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]>=0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 &&
                ...
                k1_15_buffer[1]<=18 && k2_15_buffer[1]<=18  &&  k3_15_buffer[1]<=18 && 
                                        //[1]Μ堵 <-=0.0006  [1]<= ma180,ma360,ma650 0.0006 
               ...
               (ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0020 &&
                                        //k1,k2,k3 <=18
                k1_15_buffer[1]<=18 && k2_15_buffer[1]<=18  &&  k3_15_buffer[1]<=18 && 
                                        //[1]Μ <=-0.0006  [1]<= ma180,ma360,ma650 0.0006 
              ...
              //m15 ma180,ma360 or ma360,ma650 or ma650 ど碩
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                              ...
                              //m15 ma180,ma360 or ma360,ma650 or ma650 禴碩 ど筁ma180 ,ma360,ma650 Μ芥虫
          ...
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]<=-0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0020 &&
               ...
               (ma360_15_buffer[1]-ma360_15_buffer[40]<=-0.0020 && ma650_15_buffer[1]-ma650_15_buffer[40]<=-0.0020 &&
                ...
                close_15_buffer[1]-open_15_buffer[1]>=0.0006 && close_15_buffer[1]-ma360_15_buffer[1]>=0.0006)) ||
                                       ...
                                       //m15 ma180,ma360 or ma360,ma650 or ma650 禴碩
...
//+++++++++++++++++++++++++++++++++++++++++++  CLOSE  BUY   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                           ...
                           //m15 ma180,ma360 or ma360,ma650 or ma650 禴碩 ど筁ma180 ,ma360,ma650 Μclose芥虫
...
//+++++++++++++++++++++++++++++++++++++++++++  CLOSE  sell   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                                                        ...
                                                                        //    禴瘆ma180 ,ma360,ma650 Μ堵close 禦虫                        
          if   (((ma180_15_buffer[1]-ma180_15_buffer[40]>=0.0020 && ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0020 &&
                                        //k1,k2,k3 <=18
                k1_15_buffer[1]<=18 && k2_15_buffer[1]<=18  &&  k3_15_buffer[1]<=18 && 
                                        //[1]Μ堵 <-=0.0006  [1]<= ma180,ma360,ma650 0.0006 
