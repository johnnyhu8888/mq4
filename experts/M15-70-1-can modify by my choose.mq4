 ...
 //*** Buy  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]<=55 && k2_05_buffer[1]<=55 && k3_05_buffer[1]<=55 && 
           ...
           if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                ...
                shortbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-30*Point,Ask+50*Point,"My order #Shortbuy3",2,0,Red );
 ...
 //*** Buy  2  ***************************************************************************************** 
       ...
       if (k1_15_buffer[1]<=50 && k2_15_buffer[1]<=50 && k3_15_buffer[1]<=50 && 
           ...
           if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                ...
                shortbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-30*Point,Ask+50*Point,"My order #Shortbuy4",3,0,Yellow );
 ...
 //*** sell  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]>=45 && k2_05_buffer[1]>=45 && k3_05_buffer[1]>=45 && 
           ...
           if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                ...
                shortsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+30*Point,Bid-50*Point,"My order #Shortsell3",2,0,Aqua );
 //*** sell  2  ***************************************************************************************** 
       ...
       if (k1_15_buffer[1]>=50 && k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50 && 
           ...
           if  (OrdersTotal()==1 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
                ...
                shortsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+30*Point,Bid-50*Point,"My order #Shortsell4",3,0,Aqua );
                        // FOR TEST 
 //         if    (Day()>15)
...
//***  Ordermodify   ********************************************************************************** 
  ...
  //          OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-50*Point,OrderTakeProfit(),0,Blue);
      if (OrderType()==OP_BUY && (shortbuy03==OrderTicket() || shortbuy04==OrderTicket()) && 
          high_15_buffer[0]-OrderOpenPrice()>=0.0010)
   ...
   //         OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+50*Point,OrderTakeProfit(),0,Blue);
        ...
        if (OrderType()==OP_SELL && (shortsell03==OrderTicket() || shortsell04==OrderTicket()) && 
            low_15_buffer[0]-OrderOpenPrice()<=-0.0010)
                                  //stoploss=OrderOpenPrice()-7*Point可以賺5點
