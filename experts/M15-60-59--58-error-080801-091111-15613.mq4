...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if  (((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && low_240_buffer[2]-close_240_buffer[2]<=-0.0080) ||
            ...
            ((k1_240_buffer[1]-d1_240_buffer[1]>=1 && k1_240_buffer[2]-d1_240_buffer[2]>=0 && close_240_buffer[1]-open_240_buffer[1]<=-0.0030) ||
             ...
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001  && low_240_buffer[1]-open_240_buffer[1]<=-0.0060)) || 
                              ...
                              //(m15-59)  h4 [1][2]<=-0.0001 [1]+[2]下影>=0.0160   k1,k2,3<=20
             ...
             (low_240_buffer[1]-close_240_buffer[1])+(low_240_buffer[2]-close_240_buffer[2])<=-0.0160) ||        
                            //(m15-59)  h4 [1][2]>=0.0001 [1]+[2]下影>=0.0160    k1,k2,k3<=20
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]>=0.0001 && 
              k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20 &&
             (low_240_buffer[1]-open_240_buffer[1])+(low_240_buffer[2]-open_240_buffer[2])<=-0.0160 ) ||         
                             //(m15-59)  h4 [1]>=0.0001  [2]<=-0.0001 [1]+[2]下影>=0.0160          k1,k2,k3<=20
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
              k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20 &&
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if   ((close_240_buffer[1]-open_240_buffer[1]>=0.0030 && close_240_buffer[4]-open_240_buffer[4]>=0.0010  && 
               ...
               k1_240_buffer[1]-d1_240_buffer[2]>=-3  && (k2_240_buffer[1]-d2_240_buffer[2]>=-3 || k3_240_buffer[1]-d3_240_buffer[2]>=-3) &&
       ...
       if (((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0080) ||
           ...
           ((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0085) ||
            ...
            (close_240_buffer[1]-open_240_buffer[1]>=0.0001   && high_240_buffer[1]-close_240_buffer[1]>=0.0060)) ||
               ...
               //(m15-59)  h4 [1][2]<=-0.0001 [1]+[2]上影>=0.0160     k1,k2,k3>=80
           (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
           ...
           (high_240_buffer[1]-close_240_buffer[1])+(high_240_buffer[2]-close_240_buffer[2])>=0.0160) || 
                 //(m15-59)  h4 [1]>=0.0001  [2]<=-0.0001  [1]+[2]上影>=0.0160     k1,k2,k3>=80
           (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
            k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80 &&
