...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
                                   //已呈現反轉型態         
       if ((ma05_05_buffer[1]-ma12_05_buffer[1]<=0 && ma05_05_buffer[1]-ma12_05_buffer[1]>=-0.0013 &&
           k1_05_buffer[1]<=36 && k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 && k1_05_buffer[1]-d1_05_buffer[1]>=1 &&
            macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00015) &&
           (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]>=0.0001) ||
           (close_05_buffer[2]-open_05_buffer[2]>=0  &&  close_05_buffer[1]-open_05_buffer[1]>=0))
          {
                // 單純只用黑變紅 所以須要更多的條件排除不適合的短暫反轉   //m15 的k1,k2,k3 向下 m30 的 k1,k2 向下
          ...
          if    ((k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=-1 &&
                k1_30_buffer[1]-k1_30_buffer[2]<=-1 && k2_30_buffer[1]-k2_30_buffer[2]<=-1) ||
                                                        ...
                                                        //    m15 的05,08,12 向下 m30 的05,08向下
               (ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-0.0001)||
         
                       
                                                 
                                             //m15 的k1,k2,k3 向下 05,08,12  向下
               (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && k2_15_buffer[1]-k2_15_buffer[2]<=-1 && 
                k3_15_buffer[1]-k3_15_buffer[2]<=-1 && ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&
                ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 ) ||
                                                 
   
                       //m15,m30,m60的05向下 m15 k1向下
               (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&  ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&
                ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.0001 &&  k1_15_buffer[1]-k1_15_buffer[2]<=-1) || 

                                          //m15 ,m30 [1]收黑 [2][3]為紅  m15 k1向下  下跌初段
               (close_15_buffer[1]-open_15_buffer[1]<=-0.0001  &&  close_30_buffer[1]-open_30_buffer[1]<=-0.0001 &&
                close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[3]-open_15_buffer[3]>=0 &&
                close_30_buffer[2]-open_30_buffer[2]>=0  &&  close_30_buffer[3]-open_30_buffer[3]>=0))
 ...
 //***  sell 1  ********************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     {                                            
                                //已呈現反轉型態  
         if ((ma05_05_buffer[1]-ma12_05_buffer[1]>=0 && ma05_05_buffer[1]-ma12_05_buffer[1]<=0.0013 &&
              k1_05_buffer[1]>=64 && k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75 && k1_05_buffer[1]-d1_05_buffer[1]<=-1 &&
              macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00015) &&
              (close_05_buffer[2]-open_05_buffer[2]>=0  &&  close_05_buffer[1]-open_05_buffer[1]<=-0.0001) ||
              (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]<=0))
            {
                                        ...
                                        // 單純只用紅變黑 所以須要更多的條件排除不適合的短暫反轉  //m15 的k1,k2,k3 向上 m30 的 k1,k2 向上
                  if   ((k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                         k1_30_buffer[1]-k1_30_buffer[2]>=1 && k2_30_buffer[1]-k2_30_buffer[2]>=1) ||
                                             
                                                       //  m15 的05,08,12 向上 m30 的05,08向上
                        (ma08_15_buffer[1]-ma08_15_buffer[2]>=0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]>=0.0001 &&
                         ma05_30_buffer[1]-ma05_30_buffer[2]>=0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]>=0.0001 ) ||
                           
                                                               //m15 的k1,k2,k3 向上 05,08,12  向上
                       (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && 
                        k3_15_buffer[1]-k3_15_buffer[2]>=1 && ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001 &&
                        ma08_15_buffer[1]-ma08_15_buffer[2]>=0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]>=0.0001 ) ||
                  
              
                                                  //m15,m30,m60的05向上   m15  k1向上
                      (ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001 &&  ma05_30_buffer[1]-ma05_30_buffer[2]>=0.0001 &&
                       ma05_60_buffer[1]-ma05_60_buffer[2]>=0.0001 &&  k1_15_buffer[1]-k1_15_buffer[2]>=1) ||

                                                      //m15 ,m30 [1]收紅 [2][3]為黑  m15 k1向上  上漲初段
                      (close_15_buffer[1]-open_15_buffer[1]>=0.0001  &&  close_30_buffer[1]-open_30_buffer[1]>=0.0001 &&
                       close_15_buffer[2]-open_15_buffer[2]<=0  &&  close_15_buffer[3]-open_15_buffer[3]<=0 &&
                       close_30_buffer[2]-open_30_buffer[2]<=0  &&  close_30_buffer[3]-open_30_buffer[3]<=0))
    ...
    if (OrdersTotal()>0)
     {
        for (cnt=0;cnt<OrdersTotal();cnt++)
          ...
          if  (OrderType()==OP_BUY )
           {  
               if  (TimeCurrent()-OrderOpenTime()>=1500 || TimeCurrent()-OrderOpenTime()<=4000  && close_05_buffer[1]-open_05_buffer[1]<=-0.0005)
 ...
 //                                           OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2",4402,0,Lime );
               ...
               if  (TimeCurrent()-OrderOpenTime()<=1500  && close_05_buffer[1]-open_05_buffer[1]<=-0.0005 && close_05_buffer[2]-open_05_buffer[2]<=-0.0005 )
           
                    OrderClose(OrderTicket(),lots,Ask,1,Gold); 
  //                                          OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2",4402,0,Lime );
               
                if  (TimeCurrent()-OrderOpenTime()>=1900 || TimeCurrent()-OrderOpenTime()<=4000  &&
            
                    OrderOpenPrice()- close_05_buffer[1]<=0.0045  && 
             
                    k1_05_buffer[1]-k1_05_buffer[2]<=-1 && k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=-1 ) 
                           OrderClose(OrderTicket(),lots,Ask,1,Gold); 
//                                            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2",4402,0,Lime );
               ...
               if  ( TimeCurrent()-OrderOpenTime()>=1900 || TimeCurrent()-OrderOpenTime()<=4000  &&
                    ...
                    close_05_buffer[1]-open_05_buffer[1]<=-0.0008 && k1_05_buffer[1]-k1_05_buffer[2]<=-1 ) 
...
//                                             OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S2",4402,0,Lime );
               ...
               if ((ma05_05_buffer[1]-ma12_05_buffer[1]>=0 && ma05_05_buffer[1]-ma12_05_buffer[1]<=0.0013 &&
                    k1_05_buffer[1]>=64 && k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75 && k1_05_buffer[1]-d1_05_buffer[1]<=-1 &&
                    macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00035) &&   //因close單所以將macd值放寬
                    (close_05_buffer[2]-open_05_buffer[2]>=0  &&  close_05_buffer[1]-open_05_buffer[1]<=-0.0001) ||
                    (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]<=0))
                  {
  ...
  if (OrdersTotal()>0)
     {
        for (cnt=0;cnt<OrdersTotal();cnt++)
          ...
          //                           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B2",8802,0,Blue );

              if  (TimeCurrent()-OrderOpenTime()<=1500  && close_05_buffer[1]-open_05_buffer[1]>=0.0005 && close_05_buffer[2]-open_05_buffer[2]>=0.0005 )
           
                    OrderClose(OrderTicket(),lots,Bid,1,Green);
//                                         OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B2",8802,0,Blue );
                                                                       //時間區間必須用  ||   不可用 &&                                                                //時間區間必須用  ||   不可用 && 
               if  (TimeCurrent()-OrderOpenTime()>=1900 || TimeCurrent()-OrderOpenTime()<=4000  &&
  ...
  //                                        OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B2",8802,0,Blue );
               ...
               if  ( TimeCurrent()-OrderOpenTime()>=1900 || TimeCurrent()-OrderOpenTime()<=4000  &&
                    ...
                    OrderClose(OrderTicket(),lots,Bid,1,Blue);
    //                                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B2",8802,0,Blue );

      
                                             //已呈現反轉型態         
                if ((OrderType()==OP_SELL  && ma05_05_buffer[1]-ma12_05_buffer[1]<=0 && ma05_05_buffer[1]-ma12_05_buffer[1]>=-0.0013 &&
                    k1_05_buffer[1]<=36 && k2_05_buffer[1]<=25 && k3_05_buffer[1]<=15 && k1_05_buffer[1]-d1_05_buffer[1]>=1 &&
                     macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00035) &&   ////因close單所以將macd值放寬
                    (close_05_buffer[2]-open_05_buffer[2]<=0  &&  close_05_buffer[1]-open_05_buffer[1]>=0.0001) ||
                    (close_05_buffer[2]-open_05_buffer[2]>=0  &&  close_05_buffer[1]-open_05_buffer[1]>=0))
                   {
        ...
        for (cnt=0;cnt<OrdersTotal();cnt++)
          {
             OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
                                                               ...
                                                               //則將不會或獲利,直到停損為止
              if (OrderType()==OP_SELL && close_15_buffer[1]-OrderOpenPrice()>=-0.00150) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()+100*Point,OrderTakeProfit(),0,Blue);
                
              if (OrderType()==OP_BUY && close_15_buffer[1]-OrderOpenPrice()>=0.0070 &&  close_15_buffer[1]-OrderOpenPrice()<=0.0075) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()+50*Point,OrderTakeProfit(),0,Blue);
             
              if (OrderType()==OP_BUY && close_15_buffer[1]-OrderOpenPrice()>=0.0035 && close_15_buffer[1]-OrderOpenPrice()<=0.0040) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()+20*Point,OrderTakeProfit(),0,Blue);
          
             if (OrderType()==OP_BUY && close_15_buffer[1]-OrderOpenPrice()>=0.0010 && close_15_buffer[1]-OrderOpenPrice()<=0.0015) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()+4*Point,OrderTakeProfit(),0,Blue);
             ...
             if (OrderType()==OP_SELL && close_15_buffer[1]-OrderOpenPrice()<=-0.00150) 
              ...
              if (OrderType()==OP_SELL && close_15_buffer[1]-OrderOpenPrice()<=-0.0070 && close_15_buffer[1]-OrderOpenPrice()<=-0.0075) 
                OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-50*Point,OrderTakeProfit(),0,Blue);
             
              if (OrderType()==OP_SELL && close_15_buffer[1]-OrderOpenPrice()<=-0.0035 && close_15_buffer[1]-OrderOpenPrice()>=-0.0040) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-20*Point,OrderTakeProfit(),0,Blue);
            
              if (OrderType()==OP_SELL && close_15_buffer[1]-OrderOpenPrice()<=-0.0010 && close_15_buffer[1]-OrderOpenPrice()>=-0.0015) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-4*Point,OrderTakeProfit(),0,Blue);
