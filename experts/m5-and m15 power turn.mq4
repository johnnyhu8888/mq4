...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]<=25 && k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 && 
           ...
           close_05_buffer[1]-open_05_buffer[1]>=0  &&  close_05_buffer[1]-close_05_buffer[2]>=0.0001) 
          
                       OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+30*Point,"My order #B1",8801,0,Red );

 //*** Buy  2  ***************************************************************************************** 
                                            
       if (k1_15_buffer[1]<=30 && k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30 && 
           ...
           close_15_buffer[1]-open_15_buffer[1]>=0  &&  close_15_buffer[1]-close_15_buffer[2]>=0.0003) 
          
           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+30*Point,"My order #B2",8802,0,Yellow );
 ...
 //*** sell  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]>=75 && k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75 && 
           ...
           close_05_buffer[1]-open_05_buffer[1]<=0  &&  close_05_buffer[1]-close_05_buffer[2]<=-0.0001) 
                        ...
                        OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-30*Point,"My order #S1",4401,0,Green );
 //*** sell  2  ***************************************************************************************** 
                                            
       if (k1_15_buffer[1]>=70 && k2_15_buffer[1]>=70 && k3_15_buffer[1]>=70 && 
           k1_15_buffer[1]-k1_15_buffer[2]<=-3 && k2_15_buffer[1]-k2_15_buffer[2]<=0 &&
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&
           close_15_buffer[1]-open_15_buffer[1]<=0  &&  close_15_buffer[1]-close_15_buffer[2]<=-0.0003) 
          
                        OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-30*Point,"My order #S2",4402,0,Aqua );
     }
 //***  CLOSE Buy    ********************************************************************************** 
 //***  CLOSE Buy 1   ********************************************************************************** 
    if (OrdersTotal()>0)
