...
//     {              
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                  ...
                  return;
                   ...
                   longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+800*Point,"My order #LB1",8803,0,Yellow );
            longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1600*Point,"My order #LB2",8802,0,Yellow );
...
//*** long Buy  2  ***************************************************************************************** 
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
            ...
            longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1600*Point,"My order #LB3",8802,0,Yellow );
             
            longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1600*Point,"My order #LB4",8802,0,Yellow );
     }  
...
//┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if  (OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                  ...
                  longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-1600*Point,"My order #LS2",4402,0,Green);
     }      
   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
                              ...
                              //秨虫15だず⊿害挡虫
         if   (OrderType()==OP_BUY && OrderOpenPrice()-high_05_buffer[0]<=0.00060 && OrderOpenPrice()-high_05_buffer[1]<=0.00060 &&
         ...
         if (OrderType()==OP_BUY &&  (longbuy01==OrderTicket() || longbuy02==OrderTicket()|| longbuy03==OrderTicket() || longbuy04==OrderTicket()))
                  if (OrderOpenPrice()-high_15_buffer[0]<=0.00110 && OrderOpenPrice()-high_15_buffer[1]<=0.00110 &&
                      ...
                      OrderClose(OrderTicket(),lots,Bid,1,Yellow);                        
