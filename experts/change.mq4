...
//*********************************************************
 ...
 //盢m116-barА絬の秨Μ蔼皚い
  ...
  double open_01_buffer[68], close_01_buffer[68] ,high_01_buffer[68] , low_01_buffer[68] , time_01_buffer[68] ;
...
// Comment ("7=",ma12_01_buffer[7]," 6=",ma12_01_buffer[6],"  5=",ma12_01_buffer[5],"   4=",ma12_01_buffer[4],
 ...
 //盢m516-barА絬の秨Μ蔼皚い
  ...
  double open_05_buffer[68], close_05_buffer[68] ,high_05_buffer[68] , low_05_buffer[68] , time_05_buffer[68] ;
...
// Comment ("7=",ma12_05_buffer[7]," 6=",ma12_05_buffer[6],"  5=",ma12_05_buffer[5],"   4=",ma12_05_buffer[4],
 ...
 m5highest16bar=High[iHighest(NULL,PERIOD_M5,MODE_HIGH,16,0)];   //16bar程蔼基
 m5highest1740bar=High[iHighest(NULL,PERIOD_M5,MODE_HIGH,40,17)];   //17-40bar程蔼基
 m5highest16bartime=High[iHighest(NULL,PERIOD_M5,MODE_TIME,16,0)];   //16bar程蔼基丁
 m5highest1740bartime=High[iHighest(NULL,PERIOD_M5,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 m5lowest16bar=Low[iLowest(NULL,PERIOD_M5,MODE_LOW,16,0)];     //16bar程基
 m5lowest1740bar=Low[iLowest(NULL,PERIOD_M5,MODE_LOW,40,17)];   //17-40bar程基
 m5lowest16bartime=Low[iLowest(NULL,PERIOD_M5,MODE_TIME,16,0)];    //16bar程基丁
 m5lowest1740bartime=Low[iLowest(NULL,PERIOD_M5,MODE_TIME,40,17)];    //17-40bar程基丁  
  //Comment ("high0-16=",highest16bar,"  low0-16=",lowest16bar,"    high17-32=",highest1740bar,"   low17-40=",lowest1740bar);
 ...
 //盢M1568-barА絬の秨Μ蔼皚い
  ...
  double open_15_buffer[68], close_15_buffer[68] ,high_15_buffer[68] , low_15_buffer[68] , time_15_buffer[68] ;
...
// Comment ("7=",ma12_15_buffer[7]," 6=",ma12_15_buffer[6],"  5=",ma12_15_buffer[5],"   4=",ma12_15_buffer[4],
 ...
 M15highest16bar=High[iHighest(NULL,PERIOD_M15,MODE_HIGH,16,0)];   //16bar程蔼基
 M15highest1740bar=High[iHighest(NULL,PERIOD_M15,MODE_HIGH,40,17)];   //17-40bar程蔼基
 M15highest16bartime=High[iHighest(NULL,PERIOD_M15,MODE_TIME,16,0)];   //16bar程蔼基丁
 M15highest1740bartime=High[iHighest(NULL,PERIOD_M15,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 M15lowest16bar=Low[iLowest(NULL,PERIOD_M15,MODE_LOW,16,0)];     //16bar程基
 M15lowest1740bar=Low[iLowest(NULL,PERIOD_M15,MODE_LOW,40,17)];   //17-40bar程基
 M15lowest16bartime=Low[iLowest(NULL,PERIOD_M15,MODE_TIME,16,0)];    //16bar程基丁
...
//**********************************************************************
 //盢m3068-barА絬の秨Μ蔼皚い
  ...
  double open_30_buffer[68], close_30_buffer[68] ,high_30_buffer[68] , low_30_buffer[68] , time_30_buffer[68] ;
...
//          "3=",ma05_30_buffer[3]," 2=",ma05_30_buffer[2],"  1=",ma05_30_buffer[1],"   0=",ma05_30_buffer[0]);
 ...
 M30highest16bar=High[iHighest(NULL,PERIOD_M30,MODE_HIGH,16,0)];   //16bar程蔼基
 M30highest1740bar=High[iHighest(NULL,PERIOD_M30,MODE_HIGH,40,17)];   //17-40bar程蔼基
 M30highest16bartime=High[iHighest(NULL,PERIOD_M30,MODE_TIME,16,0)];   //16bar程蔼基丁
 M30highest1740bartime=High[iHighest(NULL,PERIOD_M30,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 M30lowest16bar=Low[iLowest(NULL,PERIOD_M30,MODE_LOW,16,0)];     //16bar程基
 M30lowest1740bar=Low[iLowest(NULL,PERIOD_M30,MODE_LOW,40,17)];   //17-40bar程基
 M30lowest16bartime=Low[iLowest(NULL,PERIOD_M30,MODE_TIME,16,0)];    //16bar程基丁
...
//**********************************************************************
 //盢m6068-barА絬の秨Μ蔼皚い
  ...
  double open_60_buffer[68], close_60_buffer[68] ,high_60_buffer[68] , low_60_buffer[68] , time_60_buffer[68] ;
...
//          "3=",ma05_60_buffer[3]," 2=",ma05_60_buffer[2],"  1=",ma05_60_buffer[1],"   0=",ma05_60_buffer[0]);
 ...
 H1highest16bar=High[iHighest(NULL,PERIOD_H1,MODE_HIGH,16,0)];   //16bar程蔼基
 H1highest1740bar=High[iHighest(NULL,PERIOD_H1,MODE_HIGH,40,17)];   //17-40bar程蔼基
 H1highest16bartime=High[iHighest(NULL,PERIOD_H1,MODE_TIME,16,0)];   //16bar程蔼基丁
 H1highest1740bartime=High[iHighest(NULL,PERIOD_H1,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 H1lowest16bar=Low[iLowest(NULL,PERIOD_H1,MODE_LOW,16,0)];     //16bar程基
 H1lowest1740bar=Low[iLowest(NULL,PERIOD_H1,MODE_LOW,40,17)];   //17-40bar程基
 H1lowest16bartime=Low[iLowest(NULL,PERIOD_H1,MODE_TIME,16,0)];    //16bar程基丁
...
//**********************************************************************
 //盢H468-barА絬の秨Μ蔼皚い
  ...
  double open_240_buffer[68], close_240_buffer[68] ,high_240_buffer[68] , low_240_buffer[68] , time_240_buffer[68] ;
...
//          "3=",ma05_60_buffer[3]," 2=",ma05_60_buffer[2],"  1=",ma05_60_buffer[1],"   0=",ma05_60_buffer[0]);
 ...
 //癘魁16-bar の17-32-barぇ程蔼程基
 H4highest16bar=High[iHighest(NULL,PERIOD_H4,MODE_HIGH,16,0)];   //16bar程蔼基
 H4highest1740bar=High[iHighest(NULL,PERIOD_H4,MODE_HIGH,40,17)];   //17-40bar程蔼基
 H4highest16bartime=High[iHighest(NULL,PERIOD_H4,MODE_TIME,16,0)];   //16bar程蔼基丁
 H4highest1740bartime=High[iHighest(NULL,PERIOD_H4,MODE_TIME,40,17)];  //17-40bar程蔼基丁

 H4lowest16bar=Low[iLowest(NULL,PERIOD_H4,MODE_LOW,16,0)];     //16bar程基
 H4lowest1740bar=Low[iLowest(NULL,PERIOD_H4,MODE_LOW,40,17)];   //17-40bar程基
 H4lowest16bartime=Low[iLowest(NULL,PERIOD_H4,MODE_TIME,16,0)];    //16bar程基丁
...
//*** Buy  1  ***************  ma45弊絬,ma05,ma08,ma12は锣,kd<15ユ,硈Μ2ma05 ***************************************************************** 
           
                                                                               //ma45ど [1]-[6]>=0.0006
    if (OrdersTotal()<=1  &&   ma45_01_buffer[1]-ma45_01_buffer[6]>=0.0006 )
     {              
                                                                              //ma05禴 [1]-[6]<=-0.0006          
        if (ma05_01_buffer[1]-ma05_01_buffer[6]<=-0.0006  &&  
                                                                              //ma08禴 [1]-[6]<=-0.0006          
            ma08_01_buffer[1]-ma08_01_buffer[6]<=-0.0006  && 
                                                                              //ma12禴 [1]-[6]<=-0.0006          
            ma12_01_buffer[1]-ma12_01_buffer[6]<=-0.0006)
         {
                                                                              //ma05- ma12丁禯<=-0.0006   
             if  (ma05_01_buffer[1]-ma12_01_buffer[1]>=0.0006)
              {
                                                                              //k1,d1<15 && k1-d1<=-2
                 if  (k1_01_buffer[1]<25 &&  d1_01_buffer[1]<30  &&  k1_01_buffer[1]-d1_01_buffer[1]<=-2) 
                  {           
                                                                              //硈尿2bar Μ>=0.0003 1barΜ絃蔼ma05
             //         if  (high_01_buffer[1]-low_01_buffer[1]>=0.0003 &&
               //            high_01_buffer[2]-low_01_buffer[2]>=0.0003 && close_01_buffer[1]-ma05_01_buffer[1]>=0.0003)
                 //      {          
                          
                           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-10*Point,Ask+30*Point,"My order #1",8801,0,Yellow );
                   //    }
                   } 
              } 
         } 
...
//*** Sell  1  ***************  ma45弊絬,ma05,ma08,ma12は紆,kd>85ユ,硈Μ2堵ma05 ***************************************************************** 
        ...
        if (ma05_01_buffer[1]-ma05_01_buffer[6]>=0.0006  &&  
            ...
            ma12_01_buffer[1]-ma12_01_buffer[6]>=0.0006)
         {
             ...
             if  (ma05_01_buffer[1]-ma12_01_buffer[1]>=0.0006)
              {
                                                                              //k1,d1>85 && k1-d1>2
                 if  (k1_01_buffer[1]>75 &&  d1_01_buffer[1]>70  &&  k1_01_buffer[1]-d1_01_buffer[1]>=2) 
                  {           
                                                                              //硈尿2bar Μ堵<=-0.0003 1barΜ絃ma05
                //      if  (high_01_buffer[1]-low_01_buffer[1]<=-0.0003 &&
                  //         high_01_buffer[2]-low_01_buffer[2]<=-0.0003 && close_01_buffer[1]-ma05_01_buffer[1]<=-0.0003)
                    //   {          
                          
                           OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+10*Point,Bid-30*Point,"My order #S1",4401,0,Green );
                    //   }
                   } 
              } 
         } 
...
51-50-------53-51
   ...
   buy 10----
   buy 10---- 
   (k1_60_buffer[1]-k1_60_buffer[1]>=20 &&
               k2_60_buffer[1]-k2_60_buffer[1]>=8 && k3_60_buffer[1]-k3_60_buffer[1]>=8 &&
               k1_60_buffer[1]<=55 && k2_60_buffer[1]<=55 && k3_60_buffer[1]<=55 )
      
  
 09/01/21/20  09/01/14/20 
  buy 9----line  6
   //ma05[1]-[2]>=0.0015, [1]Μ絃ぃ0.0060   ||   ma05[1]-[2]>=-0.0005 ,[1]Μ絃ma05丁禯<=0.0010
              (ma05_240_buffer[1]-ma05_240_buffer[2]>=0.0015  &&  close_240_buffer[1]-open_240_buffer[1]<=0.0060) || 
              (ma05_240_buffer[1]-ma05_240_buffer[2]>=-0.0005  &&  close_240_buffer[1]-ma05_240_buffer[1]<=0.0010)) || 
...
08/08/15/16
08/10/10/08
09/09/22/20                                    //kd2,kd3,ma05<=-0.0014
                    (k2_240_buffer[1]-d2_240_buffer[1]<=-0.0014 && k3_240_buffer[1]-d3_240_buffer[1]<=-0.0014 &&
                     ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.0014) ||
                                    //kd2,kd3,=-0.0010  ,ma05<=-0.0030
                    (k2_240_buffer[1]-d2_240_buffer[1]<=-0.0010 && k3_240_buffer[1]-d3_240_buffer[1]<=-0.0010 &&
...
08/10/30/08                 sell 8
                  ...
                  //m30 [1]紇絬禬筁50翴   [2]璽秨-蔼  [2]タΜ-秨  
    
      if  ((close_30_buffer[1]-open_30_buffer[1]<=-0.0001 && high_30_buffer[1]-open_30_buffer[1]>=0.0050) ||
          (close_30_buffer[1]-open_30_buffer[1]>=0.0001   && high_30_buffer[1]-close_30_buffer[1]>=0.0050) &&
           high_30_buffer[1]==M15highest80bar  && 
           k2_30_buffer[1]-k2_30_buffer[2]<=0 && k3_30_buffer[1]-k3_30_buffer[2]<=0   &&
           k1_30_buffer[1]>=80 && k2_30_buffer[1]>=80 && k3_30_buffer[1]>=80)
                                  //硂柑氨穕穦40翴15翴莉穦20┮120翴  
           OrderSend(Symbol(),OP_SELLLIMIT,lots,close_30_buffer[1]+40*Point,1,Bid+35*Point,Bid-2000*Point,"My order #1",8801,expiration,Yellow );
...
08/10/10/21        buy  12  
                        ...
                        //m30 [2]紇絬禬筁27翴   [2]璽秨-蔼  [2]タΜ-秨  
     if  (((close_30_buffer[2]-open_30_buffer[2]<=-0.0001 && high_30_buffer[2]-open_30_buffer[2]>=0.0027) ||
          (close_30_buffer[2]-open_30_buffer[2]>=0.0001   && high_30_buffer[2]-close_30_buffer[2]>=0.0027) &&
          (high_30_buffer[1]==M15highest80bar || high_30_buffer[2]==M15highest80bar) && 
                               //     [1]Μ璽  [1]-[2]<=-0.0001   k1,k2,k3<=0  k1,k2,k3>=80
           close_30_buffer[1]-open_30_buffer[1]<=-0.0010 && close_30_buffer[2]-close_30_buffer[2]<=-0.0001 &&
           ...
           k1_30_buffer[1]>=70 && k2_30_buffer[1]>=70 && k3_30_buffer[1]>=70) ||
                         //m30 [1][2]紇絬禬筁27翴   [2]璽秨-蔼  [2]タΜ-秨  
         ((close_30_buffer[1]-open_30_buffer[1]<=-0.0001 && high_30_buffer[1]-open_30_buffer[1]>=0.0027) ||
          (close_30_buffer[1]-open_30_buffer[1]>=0.0001   && high_30_buffer[1]-close_30_buffer[1]>=0.0027) &&
          (close_30_buffer[2]-open_30_buffer[2]<=-0.0001 && high_30_buffer[2]-open_30_buffer[2]>=0.0027) ||
          (close_30_buffer[2]-open_30_buffer[2]>=0.0001   && high_30_buffer[2]-close_30_buffer[2]>=0.0027) &&
          (high_30_buffer[1]==M15highest80bar || high_30_buffer[2]==M15highest80bar) && 
                               //     [1]Μ璽  [1]-[2]<=-0.0001   k1,k2,k3<=0  k1,k2,k3>=80
           close_30_buffer[1]-open_30_buffer[1]<=-0.0010 && close_30_buffer[2]-close_30_buffer[2]<=-0.0001 &&
           k1_30_buffer[1]-k1_30_buffer[2]<=0 && k2_30_buffer[1]-k2_30_buffer[2]<=0 && k3_30_buffer[1]-k3_30_buffer[2]<=0   &&
           k1_30_buffer[1]>=70 && k2_30_buffer[1]>=70 && k3_30_buffer[1]>=70) ||
                                 // [1]痙紇絬禬筁50翴   [2]璽秨-蔼  k1,k2,k3<=-1  ,k1,k2,k3>=80
         ((close_30_buffer[1]-open_30_buffer[1]>=0.0001  && high_30_buffer[1]-open_30_buffer[1]<=-0.0050) &&
          high_30_buffer[1]==M15highest80bar &&
   ...
   buy 13
                        ...
                        //h1 [2]紇絬禬筁27翴   [2]璽秨-蔼  [2]タΜ-秨  
     if  (((close_60_buffer[2]-open_60_buffer[2]<=-0.0001 && high_60_buffer[2]-open_60_buffer[2]>=0.0027) ||
          (close_60_buffer[2]-open_60_buffer[2]>=0.0001   && high_60_buffer[2]-close_60_buffer[2]>=0.0027) &&
          (high_60_buffer[1]==M15highest160bar || high_60_buffer[2]==M15highest160bar) && 
                               //     [1]Μ璽  [1]-[2]<=-0.0001   k1,k2,k3<=0  k1,k2,k3>=80
           close_60_buffer[1]-open_60_buffer[1]<=-0.0010 && close_60_buffer[2]-close_60_buffer[2]<=-0.0001 &&
           ...
           k1_60_buffer[1]>=70 && k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70) ||
                         //h1 [1]>=32翴,[2]紇絬禬筁22翴   [2]璽秨-蔼  [2]タΜ-秨  
         ((close_60_buffer[1]-open_60_buffer[1]<=-0.0001 && high_60_buffer[1]-open_60_buffer[1]>=0.0032) ||
          (close_60_buffer[1]-open_60_buffer[1]>=0.0001   && high_60_buffer[1]-close_60_buffer[1]>=0.0032) &&
          (close_60_buffer[2]-open_60_buffer[2]<=-0.0001 && high_60_buffer[2]-open_60_buffer[2]>=0.0022) ||
          (close_60_buffer[2]-open_60_buffer[2]>=0.0001   && high_60_buffer[2]-close_60_buffer[2]>=0.0022) &&
          (high_60_buffer[1]==M15highest160bar || high_60_buffer[2]==M15highest160bar) && 
                               //     [1]Μ璽  [1]-[2]<=-0.0001   k1,k2,k3<=0  k1,k2,k3>=80
           close_60_buffer[1]-open_60_buffer[1]<=-0.0010 && close_60_buffer[2]-close_60_buffer[2]<=-0.0001 &&
           k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0   &&
           k1_60_buffer[1]>=70 && k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70) ||
                                 // [1]痙紇絬禬筁50翴   [2]璽秨-蔼  k1,k2,k3<=-1  ,k1,k2,k3>=80
         ((close_60_buffer[1]-open_60_buffer[1]>=0.0001  && high_60_buffer[1]-open_60_buffer[1]<=-0.0050) &&
          high_60_buffer[1]==M15highest160bar &&
   ...
   buy 8
   //h4 [+3][-2][+1]    [3]>=[2] [3]>=[1]
   close_240_buffer[1]-open_240_buffer[1]>=0.0030  &&  close_240_buffer[3]-open_240_buffer[3]>=0.0010 && 
   close_240_buffer[2]-open_240_buffer[2]<=-0.0020 &&
                 //[2]璽┮搭open  [3]タ┮搭close
   close_240_buffer[1]-open_240_buffer[2]>=0  &&  close_240_buffer[1]-close_240_buffer[3]>=0 && 
                 //k1,2,3<=20   k1, k2||k3 >=0
   k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20 && k3_240_buffer[1]<=20 &&
  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && (k2_240_buffer[1]-k2_240_buffer[2]>=0 || k3_240_buffer[1]-k3_240_buffer[2]>=0)) &&
                  //ma45 >=0.0006  
  close_240_buffer[1]-ma45_240_buffer[1]>=0.0006 
  
  
 sell #
 
                 //k1,2,3>=80   k1, k2 ,k3 >=1
   k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80 && k3_240_buffer[1]>=80 &&
