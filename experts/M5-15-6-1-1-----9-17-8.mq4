          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                    ...
                    ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))>50) ||
                      ...
                      (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=0.001000) ||
                ...
                ((k2_60_buffer[1]-d2_60_buffer[1])+(k3_60_buffer[1]-d3_60_buffer[2])>=35) ||
                       //角度折反
                 (k1_240_buffer[1]-k1_240_buffer[2]>=4 &&  k1_240_buffer[2]-k1_240_buffer[3]<=-4) ||
...
//*** close Buy  2  ***************************************************************************************** 
 //   if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
    //4401,44011兩張單不要由短單close
       if ( OrdersTotal()>0 && (OrderMagicNumber() != 4401 || OrderMagicNumber() != 4407 || OrderMagicNumber() != 4408 ))    
      ...
      if  ((k1_15_buffer[1]-k1_15_buffer[2]<=-8 &&  k1_15_buffer[1]>=75 &&
            ...
            close_15_buffer[1]-close_15_buffer[4]<=0) ||
           (k1_30_buffer[1]-k1_30_buffer[2]<=-8 &&  k1_30_buffer[1]>=75 &&
            ...
            close_30_buffer[1]-close_30_buffer[4]<=-0.00010))
                        //m60,m240 kd值差全部>10
...
//     if ( OrdersTotal()>0 && OrderMagicNumber() == 4407) 
     ...
     if ((((k1_15_buffer[1]>=40 && k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
           (k1_15_buffer[1]>=40 && k1_15_buffer[1]-k1_15_buffer[2]<=-8 &&  k1_15_buffer[2]-k1_15_buffer[3]>=1)) && 
          ((k2_15_buffer[1]-d2_15_buffer[1]<=6 &&  k3_15_buffer[1]-d3_15_buffer[1]<=6) ||
           ...
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 &&  k2_15_buffer[1]-k2_15_buffer[2]<=-1 &&
            ...
            k3_15_buffer[1]>=80) ||
                  //角度折反
           (k1_15_buffer[1]-k1_15_buffer[2]<=-4 &&  k1_15_buffer[2]-k1_15_buffer[3]>=4) ||
           
                //k1 &&(k2||k3)向下,macd 在合理範圍內,收盤[1]<[2][3][4]  
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && (k2_15_buffer[1]-k2_15_buffer[2]<=-1 ||
            ...
            close_15_buffer[1]-close_15_buffer[3]<=-0.00010 && close_15_buffer[1]-close_15_buffer[4]<=-0.00010))  
...
//    if (  OrdersTotal()>0 && OrderMagicNumber() != 4406)     //長短單會一直close   加上此列一次會下3張單
         //     k1大幅轉折
     if ((((k1_60_buffer[1]>=40 && k1_60_buffer[1]-k1_60_buffer[2]<=-6 &&  k1_60_buffer[2]-k1_60_buffer[3]>=3) || 
           (k1_60_buffer[1]>=40 && k1_60_buffer[1]-k1_60_buffer[2]<=-8 &&  k1_60_buffer[2]-k1_60_buffer[3]>=1)) && 
          ((k2_60_buffer[1]-d2_60_buffer[1]<=6 &&  k3_60_buffer[1]-d3_60_buffer[1]<=6) ||
           ...
           (k1_60_buffer[1]-k1_60_buffer[2]<=-1 &&  k2_60_buffer[1]-k2_60_buffer[2]<=-1 &&
            ...
            k3_60_buffer[1]>=80) ||
                 //角度折反
           (k1_60_buffer[1]-k1_60_buffer[2]<=-4 &&  k1_60_buffer[2]-k1_60_buffer[3]>=4) ||
           ...
           (k1_60_buffer[1]-k1_60_buffer[2]<=-1 && (k2_60_buffer[1]-k2_60_buffer[2]<=-1 ||
            ...
            close_60_buffer[1]-close_60_buffer[3]<=-0.00010 && close_60_buffer[1]-close_60_buffer[4]<=-0.00010))  
...
//      if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
       if ( OrdersTotal()>0 && (OrderMagicNumber() != 8801 || OrderMagicNumber() != 8807 || OrderMagicNumber() != 8808 ))    
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() == 8807) 
     ...
     if ((((k1_15_buffer[1]<=60 && k1_15_buffer[1]-k1_15_buffer[2]>=6  &&  k1_15_buffer[2]-k1_15_buffer[3]<=-3) || 
           (k1_15_buffer[1]<=60 && k1_15_buffer[1]-k1_15_buffer[2]>=8  &&  k1_15_buffer[2]-k1_15_buffer[3]<=-1)) && 
          ((k2_15_buffer[1]-d2_15_buffer[1]>=-6 &&  k3_15_buffer[1]-d3_15_buffer[1]>=-6)||
           (k2_15_buffer[1]-k2_15_buffer[2]>=0  &&  k3_15_buffer[1]-k3_15_buffer[2]>=0))) ||
           ...
           (k1_15_buffer[1]-k1_15_buffer[2]>=1 &&  k2_15_buffer[1]-k2_15_buffer[2]>=1 &&
            ...
            k3_15_buffer[1]<=20) ||
                 //角度折反
           (k1_15_buffer[1]-k1_15_buffer[2]>=4 &&  k1_15_buffer[2]-k1_15_buffer[3]<=-4) ||
                               //k1 &&(k2||k3)向上,macd 在合理範圍內,收盤[1]>[2][3][4]            
           (k1_15_buffer[1]-k1_15_buffer[2]>=1 && (k2_15_buffer[1]-k2_15_buffer[2]>=1 ||
...
//    if ( OrdersTotal()>0 && OrderMagicNumber() != 8806)     //長短單會一直close   加上此列一次會下3張單
                    // k1大幅轉折 kd2,kd3 間距縮小 或k2,k3都向上
     if ((((k1_60_buffer[1]<=60 && k1_60_buffer[1]-k1_60_buffer[2]>=6  &&  k1_60_buffer[2]-k1_60_buffer[3]<=-3) || 
           (k1_60_buffer[1]<=60 && k1_60_buffer[1]-k1_60_buffer[2]>=8  &&  k1_60_buffer[2]-k1_60_buffer[3]<=-1)) && 
          ((k2_60_buffer[1]-d2_60_buffer[1]>=-6 &&  k3_60_buffer[1]-d3_60_buffer[1]>=-6)||
           (k2_60_buffer[1]-k2_60_buffer[2]>=0  &&  k3_60_buffer[1]-k3_60_buffer[2]>=0))) ||
            ...
            if  (((ma05_15_buffer[1]-ma05_15_buffer[6]>=-0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB1",8801,0,Yellow );
//*** long Buy  2  ***************************************************************************************** 
   if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      return;
      else
      ...
      if   ((k1_15_buffer[1]-k1_15_buffer[2]>=6 &&  k1_15_buffer[1]<=25 &&
           ...
           (k1_30_buffer[1]-k1_30_buffer[2]>=6 &&  k1_30_buffer[1]<=25 &&
            ...
            if  ((k2_60_buffer[1]-d2_60_buffer[1]<=-10 && k3_60_buffer[1]-d3_60_buffer[2]<=-10 &&
             ...
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-250*Point,Ask+1500*Point,"My order #LB6",8806,0,Yellow );
//*** long Buy  3  ***************************************************************************************** 
            ...
            if  (((ma05_15_buffer[1]-ma05_15_buffer[6]>=-0.00030 && ma05_15_buffer[1]-ma05_15_buffer[6]<=0.00030) || 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-280*Point,Ask+1500*Point,"My order #LB7",8807,0,Yellow );
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])<=-3) && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]<=-12 && (close_240_buffer[1]-open_240_buffer[1]<=-0.00030 || close_240_buffer[2]-open_240_buffer[2]<=-0.00030)))
                  return;
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-290*Point,Ask+1500*Point,"My order #LB8",8808,0,Yellow );
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  return;
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS1",4401,0,Blue);
            ...
            if  ((k2_60_buffer[1]-d2_60_buffer[1]>=10 && k3_60_buffer[1]-d3_60_buffer[2]>=10 &&
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-1500*Point,"My order #S6",4406,0,Green);
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  return;
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+280*Point,Bid-1500*Point,"My order #S7",4407,0,Green);
 //*** long SELL  4  ***************************************************************************************** 
               ...
               (((k1_240_buffer[1]-k1_240_buffer[2])-(k1_240_buffer[2]-k1_240_buffer[3])>=3) && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)) ||
                 (k1_240_buffer[1]-k1_240_buffer[2]>=12 && (close_240_buffer[1]-open_240_buffer[1]>=0.00030 || close_240_buffer[2]-open_240_buffer[2]>=0.00030)))
                  return;
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+290*Point,Bid-1500*Point,"My order #S8",4408,0,Green);
