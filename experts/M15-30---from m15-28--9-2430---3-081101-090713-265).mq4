  ...
  if (OrdersTotal()<=1)   
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
                                             //用m15 m30 macd 控管買賣點 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00025 &&
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00050 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00025 &&
                                             //k1 (k2||k3)已上升
    ...
    if (OrdersTotal()<=1)   
     {                                               //m15 的ma45  ma90 為 ㄏ 上升末端型態
        ...
        //      close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
                                                 //用m15 m30 macd 控管買賣點 
               macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00025 &&
               macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00050 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00025 &&
                                                   //k1 (k2||k3)已下跌
              k1_15_buffer[1]-k1_15_buffer[2]<=-1  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
              k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0)
              if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
