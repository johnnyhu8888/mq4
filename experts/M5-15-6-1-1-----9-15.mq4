 ...
 //   if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
    ...
    if    ( OrdersTotal()>0 && (OrderMagicNumber()!=4401 || OrderMagicNumber()!=44011 || OrderMagicNumber()!=4407)) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k1_05_buffer[1]>=75 &&
            ...
            k1_240_buffer[0]-k1_240_buffer[1]<=-1 && k1_60_buffer[1]-k1_60_buffer[2]<=-1 &&     
...
//     if ( OrdersTotal()>0 && OrderMagicNumber() == 4407) 
         //     k1大幅轉折
     if ((((k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
           (k1_15_buffer[1]-k1_15_buffer[2]<=-8 &&  k1_15_buffer[2]-k1_15_buffer[3]>=1)) && 
...
//*** long Buy  3  ***************************************************************************************** 
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 8807) 
     ...
     if ((((k1_15_buffer[1]-k1_15_buffer[2]>=6  &&  k1_15_buffer[2]-k1_15_buffer[3]<=-3) || 
         ...
         OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1500*Point,"My order #LB7",8807,0,Yellow );
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 4407) 
     ...
     if ((((k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
           ...
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 && (k2_15_buffer[1]-k2_15_buffer[2]<=-1 ||
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-1500*Point,"My order #S7",4407,0,Green);
