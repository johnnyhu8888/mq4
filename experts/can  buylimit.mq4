...
//*** Buy  1  ***************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
                                                                              //ma05禴 [1]-[6]<=-0.0002   && [1]-[2]<=0       
        if (ma05_05_buffer[1]-ma05_05_buffer[6]<=-0.0002  &&  ma05_05_buffer[1]-ma05_05_buffer[2]>=0 &&
                                                                              //ma08禴 [1]-[6]<=-0.0002          
            ma08_05_buffer[1]-ma08_05_buffer[6]<=-0.0002  && 
                                                                              //ma12禴 [1]-[6]<=-0.0002          
            ma12_05_buffer[1]-ma12_05_buffer[6]<=-0.0002)
         {
                                                                              //ma05- ma08丁禯 ([1]-[2])-([2]-[3])>=0.0002   
             if  (((ma05_05_buffer[1]-ma08_05_buffer[1])- (ma05_05_buffer[2]-ma08_05_buffer[2]))  -
                  ((ma05_05_buffer[2]-ma08_05_buffer[2])- (ma05_05_buffer[3]-ma08_05_buffer[3])) >=0.0002)
              {
                                                                              //bar1-bar2>=0.0002 && bar1-bar3>=0.0002 ,bar2堵bar1Μ>=0.0003 
                      if  (( close_05_buffer[1]-open_05_buffer[1]>=0.0006 && close_05_buffer[2]-open_05_buffer[2]<=0.0002)  && 
                           (close_05_buffer[1]-close_05_buffer[2]>=0.0002 && close_05_buffer[1]-close_05_buffer[3]>=0.0002)) 
                       {    
                                                                              // (kd1>=3 && k1-d1<55) && ((kd2 && k1-d1<30) || (kd3)>= 1   k3-d3<30))
                            if  ((k1_05_buffer[1]<=55 &&  d1_05_buffer[1]<=55  &&  k1_05_buffer[1]-d1_05_buffer[1]>=3)  &&
                                (k2_05_buffer[1]<=30 &&  d2_05_buffer[1]<=30  &&  k2_05_buffer[1]-d2_05_buffer[1]>=1 ||
                                 k3_05_buffer[1]<=30 &&  d3_05_buffer[1]<=30  &&  k3_05_buffer[1]-d3_05_buffer[1]>=1)) 
                                                              //硂柑氨穕穦Ι奔20翴15翴莉穦20┮120翴  
                                 OrderSend(Symbol(),OP_BUYLIMIT,lots,close_05_buffer[1]-20*Point,1,Ask-35*Point,Ask+100*Point,"My order #1",8801,expiration,Yellow );
                       }
              } 
         } 
    }           
        ...
        if (ma05_05_buffer[1]-ma05_05_buffer[6]>=0.0002  &&  ma05_05_buffer[1]-ma05_05_buffer[2]<=0 &&
            ...
            ma12_05_buffer[1]-ma12_05_buffer[6]>=0.0002)
         {
             ...
             if  (((ma05_05_buffer[1]-ma08_05_buffer[1])- (ma05_05_buffer[2]-ma08_05_buffer[2]))  -
                  ((ma05_05_buffer[2]-ma08_05_buffer[2])- (ma05_05_buffer[3]-ma08_05_buffer[3])) <=-0.0002)
              {
                                                                              //bar1-bar2<=-0.0002 && bar1-bar3<=-0.0002 ,bar2bar1Μ堵<=-0.0003 
                      if  (( close_05_buffer[1]-open_05_buffer[1]<=-0.0006 && close_05_buffer[2]-open_05_buffer[2]>=-0.0002)  && 
                           (close_05_buffer[1]-close_05_buffer[2]<=-0.0002 && close_05_buffer[1]-close_05_buffer[3]<=-0.0002)) 
                       {    
                                                                              // (kd1<=-3 && k1-d1>45) && ((kd2<=-1 && k1-d1>70) || (kd3)<=-1  &&  k3-d3>70))
                            if  ((k1_05_buffer[1]>=45 &&  d1_05_buffer[1]>=45  &&  k1_05_buffer[1]-d1_05_buffer[1]<=-3)  &&
                                (k2_05_buffer[1]>=70 &&  d2_05_buffer[1]>=70  &&  k2_05_buffer[1]-d2_05_buffer[1]<=-1 ||
                                 k3_05_buffer[1]>=70 &&  d3_05_buffer[1]>=70  &&  k3_05_buffer[1]-d3_05_buffer[1]<=-1)) 
                   
                           OrderSend(Symbol(),OP_SELLLIMIT,lots,close_05_buffer[1]+20*Point,1,Bid+35*Point,Bid-100*Point,"My order #S1",4401,expiration,Green );
                      }
              } 
         } 
    }           
