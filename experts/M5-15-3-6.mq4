    ...
    if (OrdersTotal()<=1)   
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
      ...
      if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.01300 &&  k1_240_buffer[1]-k1_240_buffer[2]>=3 &&  k2_240_buffer[1]-k2_240_buffer[2]>=1 && k3_240_buffer[1]-k3_240_buffer[2]>=0)
            ...
            if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00220) // && TimeCurrent()-OrderOpenTime()>=2000)
                             //stoploss=OrderOpenPrice()+40*Point寥4翴
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+80*Point,OrderTakeProfit(),0,Blue);
         else
            if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00100) // && TimeCurrent()-OrderOpenTime()>=2000)
                             //stoploss=OrderOpenPrice()-40*Point莲3翴
      ...
      if (OrderType()==OP_SELL && low_05_buffer[0]-OrderOpenPrice()<=-0.01300 &&  k1_240_buffer[1]-k1_240_buffer[2]<=-3 &&  k2_240_buffer[1]-k2_240_buffer[2]<=-1 && k3_240_buffer[1]-k3_240_buffer[2]<=0)
            ...
            if (OrderType()==OP_SELL && low_05_buffer[0]-OrderOpenPrice()<=-0.00220) // && TimeCurrent()-OrderOpenTime()>=2000)
                  OrderModify(OrderTicket(),Bid,OrderOpenPrice()-80*Point,OrderTakeProfit(),0,Blue);
         else
            if (OrderType()==OP_SELL && low_05_buffer[0]-OrderOpenPrice()<=-0.00100) // && TimeCurrent()-OrderOpenTime()>=2000)
