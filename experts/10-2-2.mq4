...
//*** close Buy  6  ***************************************************************************************** 
 ...
 //K1,k2,k3 在高點 kd1交叉下            
            ...
            k1_15_buffer[1]-d1_15_buffer[1]<=-2)
            OrderClose(OrderTicket(),lots,Bid,1,LimeGreen); 
...
//H1,H4 kd1,2,3值差全部>1
 ...
 //m30,m60,m240全部在70上且開始下降
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-6900*Point,"My order #S7",4407,0,Blue);
 ...
 //[1][2]為負[3]或[4]為正
            close_240_buffer[1]-open_240_buffer[1]<=-0.00060 && close_240_buffer[2]-open_240_buffer[2]<=-0.00060 &&
            close_240_buffer[3]-open_240_buffer[3]>=0.00060 && close_240_buffer[4]-open_240_buffer[4]>=0.00060 &&
