...
//            OrderClose(OrderTicket(),lots,Ask,1,Gold);    
                     OrderCloseBy(OrderTicket(),LimeGreen); 
      ...
      return;
         ...
         ((close_05_buffer[1]-close_05_buffer[2]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010 ) ||
          ...
          if ((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0) ||
              ...
              shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+2500*Point,"My order #1",8802,0,Yellow );
 //*** close Buy  2  ***************************************************************************************** 
  else
    if    (OrdersTotal()>0 && OrderType()==OP_BUY  )
       if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
                  ...
                  if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                     ...
                     (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                      ...
                      longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-9000*Point,"My order #LS1",4401,0,Blue);
  else
        ...
        if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
         ...
         ((close_05_buffer[1]-close_05_buffer[2]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[3]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[4]<=-0.00010 ) ||
          ...
          if ((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
           ...
           shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-2500*Point,"My order #S1",4402,0,Green);
  //***long Sell  2  ********************************************************************************************************************** 
   else
    if    (OrdersTotal()>0 && OrderType()==OP_SELL  )
