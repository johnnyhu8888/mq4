      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                   macdsignalline_30_buffer[1]>=-0.00099 && macdsignalline_30_buffer[1]<=0.00099) ||
                                            //m15,m30 k1,k2,k3 全部向下 
                  (k1_15_buffer[1]-k1_15_buffer[2]<=0  && k2_15_buffer[1]-k2_15_buffer[2]<=0  &&
                   k3_15_buffer[1]-k3_15_buffer[2]<=0  && k1_30_buffer[1]-k1_30_buffer[2]<=0  &&
               ...
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-27*Point,Ask+450*Point,"My order #B2",8802,0,Yellow );
         ...
         if   ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  && close_15_buffer[1]-open_15_buffer[1]>=0.0002 &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-26*Point,Ask+450*Point,"My order #B3",8803,0,Blue );
             ...
             (((ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0040) ||
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_15_buffer[1]<=8 && k2_15_buffer[1]<=8 &&  k3_15_buffer[1]<=8))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-25*Point,Ask+450*Point,"My order #B4",8804,0,Brown );
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0024) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && low_15_buffer[1]-open_15_buffer[1]<=-0.0024) &&
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-24*Point,Ask+450*Point,"My order #B5",8805,0,Purple );
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
                 ...
                 (open_15_buffer[2]-open_15_buffer[1]<=0.0003 && open_15_buffer[3]-open_15_buffer[1]<=0.0003) ||     
                  ...
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+450*Point,"My order #B6",8806,0,Gold );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0080) ||
             ...
             //     (k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-22*Point,Ask+450*Point,"My order #B7",8807,0,OrangeRed );
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   BUY   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                 ...
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-21*Point,Ask+450*Point,"My order #B8",8808,0,Tomato);
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0) || 
               ...
               (k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0))         
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+27*Point,Bid-450*Point,"My order #S2",4402,0,White );
        ...
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 && close_15_buffer[1]-open_15_buffer[1]<=-0.0002 &&
             ...
             if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+26*Point,Bid-450*Point,"My order #S3",4403,0,Lime );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        //        (ma45_15_buffer[1]-ma45_15_buffer[6]>=-0.0013 && ma90_15_buffer[1]-ma90_15_buffer[6]>=-0.0013) || 
                ...
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                 ...
                 OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+25*Point,Bid-450*Point,"My order #S4",4404,0,Gray );
      ...
      if  ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && high_15_buffer[1]-open_15_buffer[1]>=0.0024) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001   && high_15_buffer[1]-close_15_buffer[1]>=0.0024) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+24*Point,Bid-450*Point,"My order #S5",4405,0,Aqua );
          ...
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && high_15_buffer[1]-close_15_buffer[1]>=0.0040) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (open_15_buffer[2]-open_15_buffer[1]>=-0.0003 && open_15_buffer[3]-open_15_buffer[1]>=-0.0003) ||     
                ...
                OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-450*Point,"My order #S6",4406,0,Teal );
     ...
     //           (k1_240_buffer[1]>=85 && k2_240_buffer[1]>=90  &&  k3_240_buffer[1]>=90) ||
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+22*Point,Bid-450*Point,"My order #S7",4407,0,Olive );
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+22*Point,Bid-450*Point,"My order #S8",4408,0,SeaGreen );
