...
//           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8801 || OrderMagicNumber( )==88011))
            if    (OrderType()==OP_BUY && OrderMagicNumber( )==8801) // || OrderMagicNumber( )==88011))
                                //單位為秒,約1.5小型
              if  (TimeCurrent()- OrderOpenTime()>=4000 &&// TimeCurrent()- OrderOpenTime()<=5000 &&
                  (close_15_buffer[1]-OrderOpenPrice()<=0.00010 && close_15_buffer[2]-OrderOpenPrice()<=0.00010) ||
                          //[0]的判斷避免反轉
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k1_05_buffer[1]<=15 &&
          ...
          ((k2_05_buffer[1]-k2_05_buffer[2]>=1) || (k3_05_buffer[1]-k3_05_buffer[2]>=1) || (d3_05_buffer[1]-d3_05_buffer[2]>=1))) 
             ...
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-100*Point,Ask+500*Point,"y order #LB6",8806,0,Yellow );
    ...
    if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k1_05_buffer[1]>=85 &&
          ...
          ((k2_05_buffer[1]-k2_05_buffer[2]<=-1) || (k3_05_buffer[1]-k3_05_buffer[2]<=-1) || (d3_05_buffer[1]-d3_05_buffer[2]<=-1))) 
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-500*Point,"My order #S6",4406,0,Green);
