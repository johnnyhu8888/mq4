...
if    (OrdersTotal()<1 || (OrdersTotal()<3 && shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket())) 
 {
     ...
     if   (k1_15_buffer[1]<=45 &&   k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30 && 
           d1_15_buffer[1]<=45 &&   d2_15_buffer[1]<=30 && d3_15_buffer[1]<=30 && 
           k1_30_buffer[1]<=45 &&   k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30 && 
           d1_30_buffer[1]<=45 &&   d2_30_buffer[1]<=30 && d3_30_buffer[1]<=30 && 
                       //m15,m30兩者收盤與ma05間距要小
...
//           k3_15_buffer[1]-d3_15_buffer[1]>=-5 &&
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]>=0) ||
          ...
          (k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0))) 
           if    (k1_05_buffer[0]-d1_05_buffer[0]>=-3 &&   k1_05_buffer[1]<=70)                               
  
                    //已有1張buy1單,不再買             
              if     ((OrdersTotal()==1 && longbuy01==OrderTicket()) ||                      

                              //ma05大幅往下且macd差值未縮小
                      (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.00040 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=-0.001000) ||
                           //ma05往下力道增加
//                     ((ma05_15_buffer[1]-ma05_15_buffer[2])-(ma05_15_buffer[2]-ma05_15_buffer[3])<=-0.00010) ||  
                      (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.00070 &&  k2_15_buffer[1]-d2_15_buffer[1]<=-15 &&  k3_15_buffer[1]-d3_15_buffer[1]<=-15) ||	


                              //ma05大幅往下且macd差值未縮小
                      (ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00040 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=-0.001000) ||
                           //ma05往下力道增加
//                     ((ma05_30_buffer[1]-ma05_30_buffer[2])-(ma05_30_buffer[2]-ma05_30_buffer[3])<=-0.00010) ||  
                      (ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.00070 &&  k2_30_buffer[1]-d2_30_buffer[1]<=-15 &&  k3_30_buffer[1]-d3_30_buffer[1]<=-15) ||	

                              //ma05大幅往下且macd差值未縮小
                      (ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=-0.001500) ||
                           //ma05往下力道增加
//                     ((ma05_60_buffer[1]-ma05_60_buffer[2])-(ma05_60_buffer[2]-ma05_60_buffer[3])<=-0.00010) ||  
                      (ma05_60_buffer[1]-ma05_60_buffer[2]<=-0.00120 &&  k2_60_buffer[1]-d2_60_buffer[1]<=-20 &&  k3_60_buffer[1]-d3_60_buffer[1]<=-20) ||	

                              //ma05大幅往下且macd差值未縮小
                      (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00050 && macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.002500) ||
                           //ma05往下力道增加
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) ||  
                      (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00250 &&  k2_240_buffer[1]-d2_240_buffer[1]<=-20 &&  k3_240_buffer[1]-d3_240_buffer[1]<=-20)) 	
                       return;	
                       else	
                       longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+4000*Point,"My order #LB1",8801,0,Yellow );
 //                       longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+900*Point,"My order #LB2",8802,0,Yellow );

//*** long Buy  2  ***************************************************************************************** 
           

     if   (k1_30_buffer[1]<=45 &&   k2_30_buffer[1]<=30 && k3_30_buffer[1]<=30 && 
           d1_30_buffer[1]<=45 &&   d2_30_buffer[1]<=30 && d3_30_buffer[1]<=30 && 
           k1_60_buffer[1]<=45 &&   k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30 && 
           d1_60_buffer[1]<=45 &&   d2_60_buffer[1]<=30 && d3_60_buffer[1]<=30 && 
           
                       //m30,m60兩者收盤與ma05間距要小
...
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) ||  
                      (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00250 &&  k2_240_buffer[1]-d2_240_buffer[1]<=-20 &&  k3_240_buffer[1]-d3_240_buffer[1]<=-20)) 	
                       ...
                       longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+5000*Point,"My order #LB2",8802,0,Red );
 ...
 //*** long Buy  3  ***************************************************************************************** 
     ...
     if   (k1_60_buffer[1]<=45 &&   k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30 && 
           d1_60_buffer[1]<=45 &&   d2_60_buffer[1]<=30 && d3_60_buffer[1]<=30 && 
           k1_240_buffer[1]<=45 &&   k2_240_buffer[1]<=30 && k3_240_buffer[1]<=30 && 
           d1_240_buffer[1]<=45 &&   d2_240_buffer[1]<=30 && d3_240_buffer[1]<=30 && 
           
                       //m60,m240兩者收盤與ma05間距要小
...
//           k3_60_buffer[1]-d3_60_buffer[1]>=-9 &&
         ...
         ((d3_60_buffer[1]-d3_60_buffer[2]>=0) ||
          ...
          (k2_60_buffer[1]-k2_60_buffer[2]>=0 && k3_60_buffer[1]-k3_60_buffer[2]>=0))) 
           if    (k1_15_buffer[0]-d1_15_buffer[0]>=-3 &&   k1_15_buffer[1]<=70)                               
...
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) ||  
                      (ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00250 &&  k2_240_buffer[1]-d2_240_buffer[1]<=-20 &&  k3_240_buffer[1]-d3_240_buffer[1]<=-20)) 	
                       ...
                       longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+9000*Point,"My order #LB3",8803,0,Purple );
 //                     longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2000*Point,"My order #LB4",8804,0,Yellow );
...
//           k3_15_buffer[1]-d3_15_buffer[1]<=5 &&
         ...
         ((d3_15_buffer[1]-d3_15_buffer[2]<=0) ||
          (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0) || 
          (k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0))) 
          if    (k1_05_buffer[0]-d1_05_buffer[0]<=3 &&   k1_05_buffer[1]>=30)                               
...
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) ||  
                      (ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00250 &&  k2_240_buffer[1]-d2_240_buffer[1]>=20 &&  k3_240_buffer[1]-d3_240_buffer[1]>=20)) 	
                       ...
                       longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-4000*Point,"My order #LS1",4401,0,Green);
...
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) ||  
                    ...
                    longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-5000*Point,"My order #LS2",4402,0,White);
...
//           k3_60_buffer[1]-d3_60_buffer[1]<=9 &&
         ...
         ((d3_60_buffer[1]-d3_60_buffer[2]<=0) ||
          (k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0) || 
          (k2_60_buffer[1]-k2_60_buffer[2]<=0 && k3_60_buffer[1]-k3_60_buffer[2]<=0))) 
           if    (k1_15_buffer[0]-d1_15_buffer[0]<=3 &&   k1_05_buffer[1]>=70)                               
...
//                     ((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) ||  
                      ...
                      longsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-9000*Point,"My order #LS3",4403,0,Blue);
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if   (k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 && 
           ...
           d1_15_buffer[1]<=30 &&   d2_15_buffer[1]<=25 && d3_15_buffer[1]<=25 && 
                       ...
                       //m15,m30兩者收盤與ma05間距要小
           ma05_05_buffer[1]-close_05_buffer[1]<=0.00100 && ma05_15_buffer[1]-close_15_buffer[1]<=0.00100 && 
...
//              if    ((OrdersTotal()==1 && longsell01==OrderTicket()) || 
                              ...
                              //ma05大幅往上且macd差值未縮小
              if     ((ma05_15_buffer[1]-ma05_15_buffer[2]>=0.00040 && macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=0.001000) ||
                           //ma05往下力道增加
//                     ((ma05_15_buffer[1]-ma05_15_buffer[2])-(ma05_15_buffer[2]-ma05_15_buffer[3])>=0.00010) ||  
                      (ma05_15_buffer[1]-ma05_15_buffer[2]>=0.00070 &&  k2_15_buffer[1]-d2_15_buffer[1]>=15 &&  k3_15_buffer[1]-d3_15_buffer[1]>=15) ||	
...
//              if    ((OrdersTotal()==1 && longsell02==OrderTicket()) || 
                              ...
                              //ma05大幅往下且macd差值未縮小
               if    ((ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00040 && macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=0.001000) ||
                           //ma05往下力道增加
//                     ((ma05_30_buffer[1]-ma05_30_buffer[2])-(ma05_30_buffer[2]-ma05_30_buffer[3])>=0.00010) ||  
                      (ma05_30_buffer[1]-ma05_30_buffer[2]>=0.00070 &&  k2_30_buffer[1]-d2_30_buffer[1]>=15 &&  k3_30_buffer[1]-d3_30_buffer[1]>=15) ||	
...
//           k3_60_buffer[1]-d3_60_buffer[1]<=9 &&
 ...
 //             if    ((OrdersTotal()==1 && longsell03==OrderTicket()) || 
                              //ma05大幅往下且macd差值未縮小
               if    ((ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.001500) ||
                           //ma05往下力道增加
//                     ((ma05_60_buffer[1]-ma05_60_buffer[2])-(ma05_60_buffer[2]-ma05_60_buffer[3])>=0.00010) ||  
                      (ma05_60_buffer[1]-ma05_60_buffer[2]>=0.00120 &&  k2_60_buffer[1]-d2_60_buffer[1]>=20 &&  k3_60_buffer[1]-d3_60_buffer[1]>=20) ||	
   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
         ...
         if   (OrderType()==OP_BUY && shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00120 && high_05_buffer[0]-OrderOpenPrice()<=0.00130) 
                     OrderModify(OrderTicket(),Ask,OrderOpenPrice()+60*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_BUY &&  shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00300 && high_05_buffer[0]-OrderOpenPrice()<=0.00310) 
                     OrderModify(OrderTicket(),Ask,OrderOpenPrice()+170*Point,OrderTakeProfit(),0,Blue);
         ...
         if   (OrderType()==OP_SELL && shortsell01==OrderTicket() &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00300 && low_05_buffer[0]-OrderOpenPrice()>=-0.00310)
                     OrderModify(OrderTicket(),Bid,OrderOpenPrice()-170*Point,OrderTakeProfit(),0,Blue);
   }
 }  
