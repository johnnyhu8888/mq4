...
//*** Buy  1  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     {              
        // M15    ど臱墩い,Μ,kd郎,kd1ユ,k2┪k3アど  BUY

        if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.00010 && //ma90_15_buffer[1]-ma90_15_buffer[2]>=0.00010 &&
             k1_15_buffer[1]-d1_15_buffer[1]>=1 &&  (k2_15_buffer[1]-k2_15_buffer[2]>=1 || k3_15_buffer[1]-k3_15_buffer[2]>=1) &&
...
//             shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+900*Point,"My order #1",8801,0,Yellow );
...
//*** Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
      // M15    臱墩い,Μ堵,kd蔼郎,kd1ユ,k2┪k3  SELL

//        if  ((k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&  (k2_15_buffer[1]-k2_15_buffer[2]<=-1 || k3_15_buffer[1]-k3_15_buffer[2]<=-1) && 
  ...
  //            shortsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-900*Point,"My order #S1",4401,0,Green);
