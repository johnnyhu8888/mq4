...
//*** Buy  1  ***************************************************************************************** 
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  buy  5     +++++++++++++++++++++
                                        ...
                                        //紇絬 >=25翴  [1]>0.0001秨-  [1]<-0.0001Μ-
         
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0025) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0025) &&
              low_15_buffer[1]==M15lowest40bar &&
             (k1_15_buffer[1]<=20 && k2_15_buffer[2]<=20 && k3_15_buffer[1]<=20) ||
             (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010 && 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00015))
              OrderSend(Symbol(),OP_BUYLIMIT,lots,Ask-15*Point,1,Ask-33*Point,Ask+100*Point,"My order #B5",8805,10000,Gold );
  
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  buy  6     +++++++++++++++++++++

                                                //紇絬 >=15翴  [1]>0.0001秨-  [1]<-0.0001Μ-
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0015) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0015) &&
              low_15_buffer[1]==M15lowest40bar && 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010 && 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00015)
              OrderSend(Symbol(),OP_BUYLIMIT,lots,Ask-25*Point,1,Ask-33*Point,Ask+100*Point,"My order #B6",8806,10000,Gold );
   
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  buy  7     +++++++++++++++++++++
                                                                 
                                        //紇絬 >=40翴  [1]>0.0001秨-  [1]<-0.0001Μ-
         
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0040) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0040) &&
              low_15_buffer[1]==M15lowest40bar &&
              k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0)  

             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-38*Point,Ask+100*Point,"My order #B7",8807,0,Purple );
   ...
   if (OrdersTotal()<=1)   
     {                                            
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   sell  5     +++++++++++++++++++++
                                     ...
                                     //紇絬禬筁25翴   [1]璽秨-蔼  [1]タΜ-秨
      if ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0025) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0025) &&
           high_15_buffer[1]==M15highest40bar && 
          (k1_15_buffer[1]>=80 && k2_15_buffer[2]>=80 && k3_15_buffer[1]>=80) ||
          (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00015))
           OrderSend(Symbol(),OP_SELLLIMIT,lots,Bid+15*Point,1,Bid+33*Point,Bid-100*Point,"My order #S5",4405,10000,Aqua );

     //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   sell  6     +++++++++++++++++++++

      if ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0015) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0015) && 
           high_15_buffer[1]==M15highest40bar && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00015)
           OrderSend(Symbol(),OP_SELLLIMIT,lots,Bid+25*Point,1,Bid+33*Point,Bid-100*Point,"My order #S6",4406,10000,Aqua );
         //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   sell  7     +++++++++++++++++++++
                                     
                                     //紇絬禬筁40翴   [1]璽秨-蔼  [1]タΜ-秨
      if ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0040) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0040) &&
           high_15_buffer[1]==M15highest40bar && 
           k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0)  
           OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+38*Point,Bid-100*Point,"My order #S7",4407,0,Aqua );
