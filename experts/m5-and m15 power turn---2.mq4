...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
       ...
       if (
           k1_05_buffer[1]-k1_05_buffer[2]>=3 && k2_05_buffer[1]-k2_05_buffer[2]>=0 &&
 ...
 //*** sell  2  ***************************************************************************************** 
       ...
       if (
           k1_15_buffer[1]-k1_15_buffer[2]<=-3 && k2_15_buffer[1]-k2_15_buffer[2]<=0 &&
        ...
        for (cnt=0;cnt<OrdersTotal();cnt++)
          {
             OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
              ...
              if (OrderType()==OP_SELL && close_05_buffer[1]-OrderOpenPrice()<=-0.0015) 
                                                                                 ...
                                                                                 //玥盢ぃ穦┪莉,氨穕ゎ
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-8*Point,OrderTakeProfit(),0,Blue);
