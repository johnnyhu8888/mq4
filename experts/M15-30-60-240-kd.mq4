...
//*** long Buy  2  ***************************************************************************************** 
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     ...
     if   (k1_15_buffer[1]>=75 &&   k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && 
           d1_15_buffer[1]>=75 &&   d2_15_buffer[1]>=75 && d3_15_buffer[1]>=75 && 
 ...
 //                 longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-900*Point,"My order #LS2",4402,0,Green);
  ...
  //***long Sell  2  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     {              
        //    m5 k1,k2,k3皆下降,且在50上,[1]收紅 [2]收黑 SELL
     if   (k1_30_buffer[1]>=75 &&   k2_30_buffer[1]>=75 && k3_30_buffer[1]>=75 && 
           d1_30_buffer[1]>=75 &&   d2_30_buffer[1]>=75 && d3_30_buffer[1]>=75 && 
...
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
  ...
  //***long Sell  3  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=3)   
     {              
        //    
     if   (k1_60_buffer[1]>=75 &&   k2_60_buffer[1]>=75 && k3_60_buffer[1]>=75 && 
           d1_60_buffer[1]>=75 &&   d2_60_buffer[1]>=75 && d3_60_buffer[1]>=75 && 
