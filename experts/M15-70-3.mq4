     ...
     if  (TimeCurrent()-OrderOpenTime()>=5000 &&  OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() || 
       ...
       if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() || 
          ...
          high_15_buffer[0]-OrderOpenPrice()>=0.0015 && high_15_buffer[0]-OrderOpenPrice()<=0.0035 )
                 ...
                 //曾到過0.0015價位就不在執行這條
         if  ((TimeCurrent()-OrderOpenTime()>=100  &&  high_15_buffer[0]-OrderOpenPrice()>=0.0020) ||
              (TimeCurrent()-OrderOpenTime()>=1900  &&  high_30_buffer[0]-OrderOpenPrice()>=0.0020)  ||
              (TimeCurrent()-OrderOpenTime()>=3800  &&  high_60_buffer[0]-OrderOpenPrice()>=0.0020)  ||
              (TimeCurrent()-OrderOpenTime()>=16000  &&  high_240_buffer[0]-OrderOpenPrice()>=0.0020))            
              return;
              else
      ...
      if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||
          ...
          high_15_buffer[0]-OrderOpenPrice()>=0.0036 && high_15_buffer[0]-OrderOpenPrice()<=0.0069)
                   ...
                   //曾到過0.0036價位就不在執行這條
         if  ((TimeCurrent()-OrderOpenTime()>=100  &&  high_15_buffer[0]-OrderOpenPrice()>=0.0040) ||
              (TimeCurrent()-OrderOpenTime()>=1900  &&  high_30_buffer[0]-OrderOpenPrice()>=0.0040)  ||
              (TimeCurrent()-OrderOpenTime()>=3800  &&  high_60_buffer[0]-OrderOpenPrice()>=0.0040)  ||
              (TimeCurrent()-OrderOpenTime()>=16000  &&  high_240_buffer[0]-OrderOpenPrice()>=0.0040))            
              return;
              else
      ...
      if (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||
          ...
          high_15_buffer[0]-OrderOpenPrice()>=0.0070)
                   ...
                   //曾到過0.0070價位就不在執行這條
         if  ((TimeCurrent()-OrderOpenTime()>=100  &&  high_15_buffer[0]-OrderOpenPrice()>=0.0075) ||
              (TimeCurrent()-OrderOpenTime()>=1900  &&  high_30_buffer[0]-OrderOpenPrice()>=0.0075)  ||
              (TimeCurrent()-OrderOpenTime()>=3800  &&  high_60_buffer[0]-OrderOpenPrice()>=0.0075)  ||
              (TimeCurrent()-OrderOpenTime()>=16000  &&  high_240_buffer[0]-OrderOpenPrice()>=0.0075))            
              return;
              else
