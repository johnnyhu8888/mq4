   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
        ...
        if ( OrderType() == OP_BUY) // && (OrderMagicNumber() == 8801 || OrderMagicNumber() == 8806))
        {
 Comment("qqqqqqqqq     =",OrderMagicNumber());
        //    m5 k1,k2,k3,50,[1]Μ [2]Μ堵 SELL
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
            k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50) ||
           (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0 &&
...
Comment("wwwwwwwww     =",OrderMagicNumber());
...
//*** close Buy  2  ***************************************************************************************** 
 ...
 //*** close Sell  1  ********************************************************************************************************************** 
        if ( OrderType()==OP_SELL) // && (OrderMagicNumber() == 4401 || OrderMagicNumber() == 4406)) 
 //     return(0);
//      else
Comment("yyyyyy     =",OrderMagicNumber());
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                   ...
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.002000) ||
                    ...
                    (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]<=-0.000050)))
                      ...
                      OrderClose(OrderTicket(),lots,Ask,1,Aqua);    

 Comment("xxxxxxxx     =",OrderMagicNumber());
 
  //***CLOSE Sell  2  ********************************************************************************************************************** 
//    if ( OrdersTotal()<=1 && OrderMagicNumber() == 4401 ) 
