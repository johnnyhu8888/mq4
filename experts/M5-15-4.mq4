     ...
     if  ( (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0  &&
          ...
          close_05_buffer[1]-close_05_buffer[2]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010 ))
            if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0) ||
              ...
              shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+1000*Point,"My order #1",8801,0,Yellow );
     }           
    ...
    if (OrdersTotal()<=1)   
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
          ...
          if (((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
           ...
           shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-1000*Point,"My order #S1",4401,0,Green);
     }        
                                                                        //秨虫30だぃ笆
  //*** Sell  2  ********************************************************************************************************************** 
