 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if ((OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                     ...
                     ((ma05_240_buffer[1]-ma05_240_buffer[2]<=-0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]<=-0.00010 && close_240_buffer[1]-ma05_240_buffer[1]<=-0.00010) ||	
                      ...
                      longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2000*Point,"My order #LB2",8802,0,Yellow );
 ...
 //┮Τ–眎虫冈灿orderticket北恨ぃ璶Τ虫猵祇ネ                   
                 if ((OrdersTotal()==1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                    ...
                    ((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||				
                     ...
                     longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS2",4402,0,Green);
...
//                      OrderModify(OrderTicket(),Ask,OrderOpenPrice()-50*Point,OrderOpenPrice()+100*Point,0,Blue);
         ...
         if   (OrderType()==OP_BUY && TimeCurrent()-OrderOpenTime()<=2500 && shortbuy01==OrderTicket() &&
...
//                      OrderModify(OrderTicket(),Bid,OrderOpenPrice()+50*Point,OrderOpenPrice()-100*Point,0,Blue);
         ...
         if   (OrderType()==OP_SELL && TimeCurrent()-OrderOpenTime()<=2500 && shortsell01==OrderTicket() &&
