...
//trade=1;
 ...
 //**************************   oders modify  ***************************************************************88
           ...
           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8805 || OrderMagicNumber( )==8806) &&
          ...
          if    (OrderType()==OP_BUY && OrderMagicNumber( )==8806 &&// || OrderMagicNumber( )==8802) &&
...
//**********************************************************************************************************
           ...
           if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4405 || OrderMagicNumber( )==4406) &&
...
//本段已有作用 
//          if     (OrderType()==OP_BUY && OrderMagicNumber( )==8801) // || OrderMagicNumber( )==8802) &&
//             if ((high_05_buffer[0]-OrderOpenPrice()<=-0.00130 && high_05_buffer[0]-OrderOpenPrice()>=-0.00140) ||
//                 (TimeCurrent()- OrderOpenTime()>=350 &&
//                  high_05_buffer[1]-OrderOpenPrice()<=-0.00130 && high_05_buffer[1]-OrderOpenPrice()>=-0.00140) ||
//                 (TimeCurrent()- OrderOpenTime()>=700 &&
//                  high_05_buffer[2]-OrderOpenPrice()<=-0.00130 && high_05_buffer[2]-OrderOpenPrice()>=-0.00140))
//                 OrderClose(OrderTicket(),lots,Bid,1,LimeGreen); 

 
//           if    (OrderType()==OP_SELL &&  OrderMagicNumber( )==4401)  // || OrderMagicNumber( )==4402) &&
//             if  ((low_05_buffer[0]-OrderOpenPrice()>=0.00130 && low_05_buffer[0]-OrderOpenPrice()<=0.00140) ||
//                 (TimeCurrent()- OrderOpenTime()>=350 &&
//                  low_05_buffer[1]-OrderOpenPrice()>=0.00130 && low_05_buffer[1]-OrderOpenPrice()<=0.00140) || 
//                 (TimeCurrent()- OrderOpenTime()>=700 &&
//                  low_05_buffer[2]-OrderOpenPrice()>=0.00130 && low_05_buffer[2]-OrderOpenPrice()<=0.00140)) 
          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                    ...
                    ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))>50) ||
                         ...
                         //ma05上升中
                 (((ma05_30_buffer[1]-ma05_30_buffer[2])-(ma05_30_buffer[2]-ma05_30_buffer[3])>=0.00010) &&
                        //k2,d2在極上方,d2呈水平狀   
                   (k2_30_buffer[1]>=80 && d2_30_buffer[1]>=80  &&  
                    k2_30_buffer[1]-k2_30_buffer[2]>=2 && k2_30_buffer[1]-k2_30_buffer[2]<=-2  &&
                    k2_30_buffer[2]-k2_30_buffer[3]>=2 && k2_30_buffer[2]-k2_30_buffer[3]<=-2  &&
                    d2_30_buffer[1]-d2_30_buffer[2]>=2 && d2_30_buffer[1]-d2_30_buffer[2]<=-2  &&
                    d2_30_buffer[2]-d2_30_buffer[3]>=2 && d2_30_buffer[2]-d2_30_buffer[3]<=-2) ||           
                        //k3,d3在極上方,d3呈水平狀  
                   (k3_30_buffer[1]>=80 && d2_30_buffer[1]>=80  &&  
                    k3_30_buffer[1]-k3_30_buffer[2]>=2 && k3_30_buffer[1]-k3_30_buffer[2]<=-2  &&
                    k3_30_buffer[2]-k3_30_buffer[3]>=2 && k3_30_buffer[2]-k3_30_buffer[3]<=-2  &&
                    d3_30_buffer[1]-d3_30_buffer[2]>=2 && d3_30_buffer[1]-d3_30_buffer[2]<=-2  &&
                    d3_30_buffer[2]-d3_30_buffer[3]>=2 && d3_30_buffer[2]-d3_30_buffer[3]<=-2)) ||     

                         //ma05上升中
                 (((ma05_60_buffer[1]-ma05_60_buffer[2])-(ma05_60_buffer[2]-ma05_60_buffer[3])>=0.00010) &&
                        //k2,d2在極上方,d2呈水平狀   
                   (k2_60_buffer[1]>=80 && d2_60_buffer[1]>=80  &&  
                    k2_60_buffer[1]-k2_60_buffer[2]>=2 && k2_60_buffer[1]-k2_60_buffer[2]<=-2  &&
                    k2_60_buffer[2]-k2_60_buffer[3]>=2 && k2_60_buffer[2]-k2_60_buffer[3]<=-2  &&
                    d2_60_buffer[1]-d2_60_buffer[2]>=2 && d2_60_buffer[1]-d2_60_buffer[2]<=-2  &&
                    d2_60_buffer[2]-d2_60_buffer[3]>=2 && d2_60_buffer[2]-d2_60_buffer[3]<=-2) ||           
                        //k3,d3在極上方,d3呈水平狀  
                   (k3_60_buffer[1]>=80 && d2_60_buffer[1]>=80  &&  
                    k3_60_buffer[1]-k3_60_buffer[2]>=2 && k3_60_buffer[1]-k3_60_buffer[2]<=-2  &&
                    k3_60_buffer[2]-k3_60_buffer[3]>=2 && k3_60_buffer[2]-k3_60_buffer[3]<=-2  &&
                    d3_60_buffer[1]-d3_60_buffer[2]>=2 && d3_60_buffer[1]-d3_60_buffer[2]<=-2  &&
                    d3_60_buffer[2]-d3_60_buffer[3]>=2 && d3_60_buffer[2]-d3_60_buffer[3]<=-2)) ||     

                         //ma05上升中
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) &&
                        //k2,d2在極上方,d2呈水平狀   
                   (k1_240_buffer[1]>=80 && d2_240_buffer[1]>=80  &&  
                    k1_240_buffer[1]-k1_240_buffer[2]>=2 && k1_240_buffer[1]-k1_240_buffer[2]<=-2  &&
                    k1_240_buffer[2]-k1_240_buffer[3]>=2 && k1_240_buffer[2]-k1_240_buffer[3]<=-2  &&
                    d1_240_buffer[1]-d1_240_buffer[2]>=2 && d1_240_buffer[1]-d1_240_buffer[2]<=-2  &&
                    d1_240_buffer[2]-d1_240_buffer[3]>=2 && d1_240_buffer[2]-d1_240_buffer[3]<=-2) ||           

                   (k2_240_buffer[1]>=80 && d2_240_buffer[1]>=80  &&  
                    k2_240_buffer[1]-k2_240_buffer[2]>=2 && k2_240_buffer[1]-k2_240_buffer[2]<=-2  &&
                    k2_240_buffer[2]-k2_240_buffer[3]>=2 && k2_240_buffer[2]-k2_240_buffer[3]<=-2  &&
                    d2_240_buffer[1]-d2_240_buffer[2]>=2 && d2_240_buffer[1]-d2_240_buffer[2]<=-2  &&
                    d2_240_buffer[2]-d2_240_buffer[3]>=2 && d2_240_buffer[2]-d2_240_buffer[3]<=-2) ||           
                        //k3,d3在極上方,d3呈水平狀  
                   (k3_240_buffer[1]>=80 && d2_240_buffer[1]>=80  &&  
                    k3_240_buffer[1]-k3_240_buffer[2]>=2 && k3_240_buffer[1]-k3_240_buffer[2]<=-2  &&
                    k3_240_buffer[2]-k3_240_buffer[3]>=2 && k3_240_buffer[2]-k3_240_buffer[3]<=-2  &&
                    d3_240_buffer[1]-d3_240_buffer[2]>=2 && d3_240_buffer[1]-d3_240_buffer[2]<=-2  &&
                    d3_240_buffer[2]-d3_240_buffer[3]>=2 && d3_240_buffer[2]-d3_240_buffer[3]<=-2)) ||     
...
//   if ( OrdersTotal()>0 && OrderMagicNumber() == 4405 ) 
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                         ...
                         //ma05下降中
                 (((ma05_60_buffer[1]-ma05_60_buffer[2])-(ma05_60_buffer[2]-ma05_60_buffer[3])<=-0.00010) &&
                        //k2,d2在極上方,d2呈水平狀   //kd2間距不大 
                   (k2_60_buffer[1]<=20 && d2_60_buffer[1]<=20  &&  
                    k2_60_buffer[1]-d2_60_buffer[1]<=-2 && k2_60_buffer[1]-d2_60_buffer[1]>=2  &&
                    k2_60_buffer[2]-d2_60_buffer[2]<=-2 && k2_60_buffer[2]-d2_60_buffer[2]>=2  &&
                    k2_60_buffer[3]-d2_60_buffer[3]<=-2 && k2_60_buffer[3]-d2_60_buffer[3]>=2  &&
                    d2_60_buffer[1]-d2_60_buffer[2]<=-2 && d2_60_buffer[2]-d2_60_buffer[3]>=2) ||
                        //k3,d2在極上方,d3呈水平狀   //kd3間距不大 
                   (k3_60_buffer[1]<=20 && d2_60_buffer[1]<=20  &&  
                    k3_60_buffer[1]-d3_60_buffer[1]<=-2 && k3_60_buffer[1]-d3_60_buffer[1]>=2  &&
                    k3_60_buffer[2]-d3_60_buffer[2]<=-2 && k3_60_buffer[2]-d3_60_buffer[2]>=2  &&
                    k3_60_buffer[3]-d3_60_buffer[3]<=-2 && k3_60_buffer[3]-d3_60_buffer[3]>=2  &&
                    d3_60_buffer[1]-d3_60_buffer[2]<=-2 && d3_60_buffer[2]-d3_60_buffer[3]>=2)) ||

                         //ma05下降中
                  (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) &&
                        //k1,d1在極下方,d2呈水平狀   //kd2間距不大 
                   (k1_240_buffer[1]<=20 && d2_240_buffer[1]<=20 &&   
                    k1_240_buffer[1]-d1_240_buffer[1]<=-2 && k1_240_buffer[1]-d1_240_buffer[1]>=2  &&
                    k1_240_buffer[2]-d1_240_buffer[2]<=-2 && k1_240_buffer[2]-d1_240_buffer[2]>=2  &&
                    k1_240_buffer[3]-d1_240_buffer[3]<=-2 && k1_240_buffer[3]-d1_240_buffer[3]>=2  &&
                    d1_240_buffer[1]-d1_240_buffer[2]<=-2 && d1_240_buffer[2]-d1_240_buffer[3]>=2) ||
                        //k2,d2在極下方,d2呈水平狀   //kd2間距不大 
                   (k2_240_buffer[1]<=20 && d2_240_buffer[1]<=20  &&  
                    k2_240_buffer[1]-d2_240_buffer[1]<=-2 && k2_240_buffer[1]-d2_240_buffer[1]>=2  &&
                    k2_240_buffer[2]-d2_240_buffer[2]<=-2 && k2_240_buffer[2]-d2_240_buffer[2]>=2  &&
                    k2_240_buffer[3]-d2_240_buffer[3]<=-2 && k2_240_buffer[3]-d2_240_buffer[3]>=2  &&
                    d2_240_buffer[1]-d2_240_buffer[2]<=-2 && d2_240_buffer[2]-d2_240_buffer[3]>=2) ||
                        //k3,d3在極下方,d3呈水平狀   //kd3間距不大 
                   (k3_240_buffer[1]<=20 && d2_240_buffer[1]<=20  &&  
                    k3_240_buffer[1]-d3_240_buffer[1]<=-2 && k3_240_buffer[1]-d3_240_buffer[1]>=2  &&
                    k3_240_buffer[2]-d3_240_buffer[2]<=-2 && k3_240_buffer[2]-d3_240_buffer[2]>=2  &&
                    k3_240_buffer[3]-d3_240_buffer[3]<=-2 && k3_240_buffer[3]-d3_240_buffer[3]>=2  &&
                    d3_240_buffer[1]-d3_240_buffer[2]<=-2 && d3_240_buffer[2]-d3_240_buffer[3]>=2)) ||
...
//   if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k1_05_buffer[1]>=85 &&
            k2_05_buffer[1]>=80 && k3_05_buffer[1]>=80 &&
            macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.000200 &&
          ((k2_05_buffer[1]-k2_05_buffer[2]<=-1) || (k3_05_buffer[1]-k3_05_buffer[2]<=-1) || (d3_05_buffer[1]-d3_05_buffer[2]<=-1))) 
            OrderClose(OrderTicket(),lots,Bid,1,LimeGreen); 
     ...
     if  (((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0 &&
           ...
           (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 (((ma05_30_buffer[1]-ma05_30_buffer[2])-(ma05_30_buffer[2]-ma05_30_buffer[3])<=-0.00010) &&
                        //k2,d2在極下方,d2呈水平狀   
                   (k2_30_buffer[1]<=20 && d2_30_buffer[1]<=20  &&  
                    k2_30_buffer[1]-k2_30_buffer[2]<=-2 && k2_30_buffer[1]-k2_30_buffer[2]>=2  &&
                    k2_30_buffer[2]-k2_30_buffer[3]<=-2 && k2_30_buffer[2]-k2_30_buffer[3]>=2  &&
                    d2_30_buffer[1]-d2_30_buffer[2]<=-2 && d2_30_buffer[1]-d2_30_buffer[2]>=2  &&
                    d2_30_buffer[2]-d2_30_buffer[3]<=-2 && d2_30_buffer[2]-d2_30_buffer[3]>=2) ||           
                         //k3,d3在極上方,d3呈水平狀  
                   (k3_30_buffer[1]<=20 && d2_30_buffer[1]<=20  &&  
                    k3_30_buffer[1]-k3_30_buffer[2]<=-2 && k3_30_buffer[1]-k3_30_buffer[2]>=2  &&
                    k3_30_buffer[2]-k3_30_buffer[3]<=-2 && k3_30_buffer[2]-k3_30_buffer[3]>=2  &&
                    d3_30_buffer[1]-d3_30_buffer[2]<=-2 && d3_30_buffer[1]-d3_30_buffer[2]>=2  &&
                    d3_30_buffer[2]-d3_30_buffer[3]<=-2 && d3_30_buffer[2]-d3_30_buffer[3]>=2)) ||           
...
//  if ( OrdersTotal()>0 && OrderMagicNumber() == 8805 ) 
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                  ...
                  (((ma05_30_buffer[1]-ma05_30_buffer[2])-(ma05_30_buffer[2]-ma05_30_buffer[3])>=0.00010) &&
                        //k2,d2在極上方,d2呈水平狀   //kd2間距不大 
                   (k2_30_buffer[1]>=80 && d2_30_buffer[1]>=80 &&    
                    k2_30_buffer[1]-d2_30_buffer[1]>=2 && k2_30_buffer[1]-d2_30_buffer[1]<=-2  &&
                    k2_30_buffer[2]-d2_30_buffer[2]>=2 && k2_30_buffer[2]-d2_30_buffer[2]<=-2  &&
                    k2_30_buffer[3]-d2_30_buffer[3]>=2 && k2_30_buffer[3]-d2_30_buffer[3]<=-2  &&
                    d2_30_buffer[1]-d2_30_buffer[2]>=2 && d2_30_buffer[2]-d2_30_buffer[3]<=-2) ||
                        //k3,d3在極上方,d3呈水平狀   //kd3間距不大 
                   (k3_30_buffer[1]>=80 && d3_30_buffer[1]>=80 &&   
                    k3_30_buffer[1]-d3_30_buffer[1]>=2 && k3_30_buffer[1]-d3_30_buffer[1]<=-2  &&
                    k3_30_buffer[2]-d3_30_buffer[2]>=2 && k3_30_buffer[2]-d3_30_buffer[2]<=-2  &&
                    k3_30_buffer[3]-d3_30_buffer[3]>=2 && k3_30_buffer[3]-d3_30_buffer[3]<=-2  &&
                    d3_30_buffer[1]-d3_30_buffer[2]>=2 && d3_30_buffer[2]-d3_30_buffer[3]<=-2)) ||
...
//      if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k1_05_buffer[1]<=15 &&
            k2_05_buffer[1]<=20 && k3_05_buffer[1]<=20 &&
            macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.000200 &&
          ((k2_05_buffer[1]-k2_05_buffer[2]>=1) || (k3_05_buffer[1]-k3_05_buffer[2]>=1) || (d3_05_buffer[1]-d3_05_buffer[2]>=1))) 
...
//                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+1500*Point,"My order #LB11",8811,0,Yellow );
 //*** long Buy  2  ***************************************************************************************** 
       if ( OrdersTotal()>0 && OrderMagicNumber() == 8802 ) 
      return;
      else
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB2",8802,0,Yellow );
//*** long Buy  3  ***************************************************************************************** 
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB3",8803,0,Yellow );
...
//*** long Buy  4  ***************************************************************************************** 
  if ( OrdersTotal()>0 && OrderMagicNumber() == 8804 ) 
     ...
     if   ((k1_60_buffer[1]<=15 &&   k2_60_buffer[1]<=15 && k3_60_buffer[1]<=15 &&  
         ...
         OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB4",8804,0,Yellow );
      ...
      return;
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) &&
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+500*Point,"My order #LB5",8805,0,Yellow );
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k1_05_buffer[1]<=15 &&
          ...
          ((k2_05_buffer[1]-k2_05_buffer[2]>=1) || (k3_05_buffer[1]-k3_05_buffer[2]>=1) || (d3_05_buffer[1]-d3_05_buffer[2]>=1))) 
             ...
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+500*Point,"y order #LB6",8806,0,Yellow );
 ...
 //*** long Sell  2  ********************************************************************************************************************** 
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) &&
                  ...
                  (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                   return;
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS2",4402,0,Blue);
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])>=0.00010) &&
                  ...
                  (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                   return;
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS3",4403,0,Blue);
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 4404 ) 
     ...
     if   ((k1_60_buffer[1]>=85 &&   k2_60_buffer[1]>=85 && k3_60_buffer[1]>=85 &&  
          ...
          ((macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])-(macdmainline_240_buffer[3]-macdsignalline_240_buffer[3]))<=-0.000500 &&  
            close_240_buffer[1]-open_240_buffer[1]>=0.00001))
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS4",4404,0,Blue);
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 (((ma05_240_buffer[1]-ma05_240_buffer[2])-(ma05_240_buffer[2]-ma05_240_buffer[3])<=-0.00010) &&
                   ...
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.001000) ||
                    ...
                    (macdmainline_240_buffer[1]-macdmainline_240_buffer[2]<=-0.000050) && (macdmainline_240_buffer[2]-macdmainline_240_buffer[3]<=-0.000050) &&
                    (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]<=-0.000050)))
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-500*Point,"My order #S5",4405,0,Green);
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k1_05_buffer[1]>=85 &&
          ...
          ((k2_05_buffer[1]-k2_05_buffer[2]<=-1) || (k3_05_buffer[1]-k3_05_buffer[2]<=-1) || (d3_05_buffer[1]-d3_05_buffer[2]<=-1))) 
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-500*Point,"My order #S6",4406,0,Green);
