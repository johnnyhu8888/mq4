              ...
              if  (TimeCurrent()- OrderOpenTime()>=700 && TimeCurrent()- OrderOpenTime()<=2000 &&
                  ...
                  (close_05_buffer[0]-OrderOpenPrice()<=0.00050)) 
                   OrderClose(OrderTicket(),lots,Bid,1,Gold);    
                                  //不判斷反向所下單
//           if    (OrderType()==OP_BUY && (OrderMagicNumber( )==8801 || OrderMagicNumber( )==8807))
       //     if    (OrderType()==OP_BUY && OrderMagicNumber( )==8801) // || OrderMagicNumber( )==88011))
                                //單位為秒,約1.5小型
...
//            if   (TimeCurrent()- OrderOpenTime()>=1 &&  TimeCurrent()- OrderOpenTime()<=3999 && 
//                 (close_15_buffer[0]-OrderOpenPrice()<=-0.00120)||(close_15_buffer[1]-OrderOpenPrice()<=-0.00120))
//                  OrderClose(OrderTicket(),lots,Bid,1,Gold); 
              ...
              if  (TimeCurrent()- OrderOpenTime()>=700 && TimeCurrent()- OrderOpenTime()<=2000 &&
                  ...
                  (close_05_buffer[0]-OrderOpenPrice()>=-0.00050))
                   OrderClose(OrderTicket(),lots,Ask,1,Gold);    
                                 //不判斷反向所下單
//            if    (OrderType()==OP_SELL && (OrderMagicNumber( )==4401 || OrderMagicNumber( )==4407))
     //       if    (OrderType()==OP_SELL && OrderMagicNumber( )==4401)// || OrderMagicNumber( )==44011))
//                                //單位為秒,約半小型
     //         if (TimeCurrent()- OrderOpenTime()>=7000 && //TimeCurrent()- OrderOpenTime()<=5000 &&
     //            (close_15_buffer[1]-OrderOpenPrice()>=-0.00050 && close_15_buffer[2]-OrderOpenPrice()>=-0.00050))
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                 ...
                 ((ma05_30_buffer[1]-ma05_30_buffer[6]<=0.00040 && ma05_30_buffer[1]-ma05_30_buffer[6]<=0.00040) || 
                  (ma05_30_buffer[1]-ma05_30_buffer[6]>=0.00100) &&                      
                             //k1,k2,k3  任一持平
                 ((k1_30_buffer[1]-k1_30_buffer[6]<=2 && k1_30_buffer[1]-k1_30_buffer[6]>=-2 ||
                   k2_30_buffer[1]-k2_30_buffer[6]<=2 && k2_30_buffer[1]-k2_30_buffer[6]>=-2 ||          
                   k3_30_buffer[1]-k3_30_buffer[6]<=2 && k3_30_buffer[1]-k3_30_buffer[6]>=-2) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
                 ...
                 ((ma05_60_buffer[1]-ma05_60_buffer[6]<=0.000060 && ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060) || 
                  (ma05_60_buffer[1]-ma05_60_buffer[6]>=0.00150) &&                     
                             //k1,k2,k3  任一持平
                 ((k1_60_buffer[1]-k1_60_buffer[6]<=2 && k1_60_buffer[1]-k1_60_buffer[6]>=-2 ||
                   k2_60_buffer[1]-k2_60_buffer[6]<=2 && k2_60_buffer[1]-k2_60_buffer[6]>=-2 ||          
                   k3_60_buffer[1]-k3_60_buffer[6]<=2 && k3_60_buffer[1]-k3_60_buffer[6]>=-2) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
...
//*** close Buy  2  ***************************************************************************************** 
 //   if ( OrdersTotal()>0 && OrderMagicNumber() == 4406 ) 
    ...
    if    ( OrdersTotal()>0 && (OrderMagicNumber()!=4401 || OrderMagicNumber()!=44011 || OrderMagicNumber()!=4407)) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k1_05_buffer[1]>=75 &&
            k2_05_buffer[1]>=80 && k3_05_buffer[1]>=80 &&
            k2_15_buffer[1]>=60 && k3_15_buffer[1]>=60 &&  k2_30_buffer[1]>=60 && k3_30_buffer[1]>=60 &&
            k1_240_buffer[0]-k1_240_buffer[1]<=-1 &&      
            ...
            if  (((ma05_60_buffer[1]-ma05_60_buffer[6]<=0.000060 && ma05_60_buffer[1]-ma05_60_buffer[6]>=-0.00060) || 
                 ...
                 ((ma05_240_buffer[1]-ma05_240_buffer[6]<=0.000100 && ma05_240_buffer[1]-ma05_240_buffer[6]>=-0.00100) || 
                  (ma05_240_buffer[1]-ma05_240_buffer[6]>=0.00300) &&  
                             //k1,k2,k3  任一持平
                 ((k1_240_buffer[1]-k1_240_buffer[6]<=2 && k1_240_buffer[1]-k1_240_buffer[6]>=-2 ||
                   k2_240_buffer[1]-k2_240_buffer[6]<=2 && k2_240_buffer[1]-k2_240_buffer[6]>=-2 ||          
                   k3_240_buffer[1]-k3_240_buffer[6]<=2 && k3_240_buffer[1]-k3_240_buffer[6]>=-2) ||
                                   //k2,k3 或 d2,d3呈下降狀態,但ma05是持平所以不買賣  
...
if ( OrdersTotal()>0 && (OrderMagicNumber() != 8801 || OrderMagicNumber() != 88011 || OrderMagicNumber() != 8807 ))    
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k1_05_buffer[1]<=25 &&
            k2_05_buffer[1]<=20 && k3_05_buffer[1]<=20 &&
            k2_15_buffer[1]<=40 && k3_15_buffer[1]<=40 &&  k2_30_buffer[1]<=40 && k3_30_buffer[1]<=40 &&
            k1_240_buffer[0]-k1_240_buffer[1]>=1 &&  
            macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.000200 &&
          ((k2_05_buffer[1]-k2_05_buffer[2]>=1) || (k3_05_buffer[1]-k3_05_buffer[2]>=1) || (d3_05_buffer[1]-d3_05_buffer[2]>=1))) 
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      ...
      if   (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k1_05_buffer[1]<=25 &&
          ...
          ((k2_05_buffer[1]-k2_05_buffer[2]>=1) || (k3_05_buffer[1]-k3_05_buffer[2]>=1) || (d3_05_buffer[1]-d3_05_buffer[2]>=1))) 
             ...
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+500*Point,"My order #LB6",8806,0,Yellow );
//*** long Buy  3  ***************************************************************************************** 
