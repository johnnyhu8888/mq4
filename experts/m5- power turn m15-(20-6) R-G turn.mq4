...
//*** Buy  1  ***************************************************************************************** 
  ...
  //*** Buy  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]-k1_05_buffer[2]>=3 && k2_05_buffer[1]-k2_05_buffer[2]>=0 &&
           k1_05_buffer[1]<=30 && k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 &&
           macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00015 &&
           macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00005) 
           if ((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001  &&  ma08_15_buffer[1]-ma08_15_buffer[1]<=-0.0001 &&
               ma12_15_buffer[1]-ma12_15_buffer[1]<=-0.0001) ||
              (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0  &&
               k1_15_buffer[1]-d1_15_buffer[1]<=0 &&  k2_15_buffer[1]-d2_15_buffer[1]<=0 && k3_15_buffer[1]-d3_15_buffer[1]<=0)) 
               return;
               else  
        
          OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+80*Point,"My order #B1",8801,0,Red );

 //*** Buy  2  ***************************************************************************************** 
                                            
       if ((k1_15_buffer[1]-k1_15_buffer[2]>=3 && (k2_15_buffer[1]-k2_15_buffer[2]>=0 || k3_15_buffer[1]-k3_15_buffer[2]>=0) &&
           k1_15_buffer[1]<=30  &&
           close_15_buffer[2]-open_15_buffer[2]<=-0.0020  &&  close_15_buffer[1]-open_15_buffer[1]>=0.0006 &&
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00035 && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010) ||
           (k1_15_buffer[1]-k1_15_buffer[2]>=6 && (k2_15_buffer[1]-k2_15_buffer[2]>=0 || k3_15_buffer[1]-k3_15_buffer[2]>=0) &&
           k1_15_buffer[1]<=30  &&
           close_15_buffer[2]-open_15_buffer[2]<=-0.0020  &&  close_15_buffer[1]-open_15_buffer[1]>=0.0006))
       
           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+80*Point,"My order #B2",8802,0,Yellow );
 ...
 //*** Buy  3  ***************************************************************************************** 
       ...
       if (k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0 &&
           ...
           OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+80*Point,"My order #B3",8803,0,Blue );
 ...
 //*** sell  1  ***************************************************************************************** 
       ...
       if (k1_05_buffer[1]-k1_05_buffer[2]<=-3 && k2_05_buffer[1]-k2_05_buffer[2]<=0 && 
           k1_05_buffer[1]>=70 && k2_05_buffer[1]>=75 && k3_05_buffer[1]>=75 &&
           macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]<=0.00015 &&
           macdmainline_05_buffer[1]-macdsignalline_05_buffer[1]>=-0.00005) 
           if ((ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001  &&  ma08_15_buffer[1]-ma08_15_buffer[1]>=0.0001 &&
               ma12_15_buffer[1]-ma12_15_buffer[1]>=0.0001) ||
              (k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0  &&
               ...
               return;
                        ...
                        OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-80*Point,"My order #S1",4401,0,Green );
 //*** sell  2  ***************************************************************************************** 
                                            
         if ((k1_15_buffer[1]-k1_15_buffer[2]<=13 && (k2_15_buffer[1]-k2_15_buffer[2]<=0 || k3_15_buffer[1]-k3_15_buffer[2]<=0) &&
            k1_15_buffer[1]>=70  &&
            close_15_buffer[2]-open_15_buffer[2]>=0.0020  &&  close_15_buffer[1]-open_15_buffer[1]<=-0.0006 &&
            macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00035 && 
            macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010) ||
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-80*Point,"My order #S2",4402,0,Aqua );
 ...
 //*** sell  3  ***************************************************************************************** 
        ...
        if (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0 &&
           ...
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010) 
            ...
            OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-80*Point,"My order #S3",4403,0,Lime );
     } 
 //***  Ordermodify   ********************************************************************************** 
        ...
        for (cnt=0;cnt<OrdersTotal();cnt++)
          {
             OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
              ...
              if (OrderType()==OP_SELL && close_05_buffer[1]-OrderOpenPrice()<=-0.0025) 
                                                                                 //狦OrderTakeProfit()竚块Τぇ莉翴(Bid-80*Point)
                                                                                 //玥盢ぃ穦┪莉,氨穕ゎ
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()-17*Point,OrderTakeProfit(),0,Blue);
             
              if (OrderType()==OP_BUY && close_05_buffer[1]-OrderOpenPrice()>=0.0025) 
                 OrderModify(OrderTicket(),OrderOpenPrice(),OrderOpenPrice()+17*Point,OrderTakeProfit(),0,Blue);
