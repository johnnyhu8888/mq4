...
//     {              
     ...
     if   ((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0 &&
            k1_15_buffer[1]<=50 &&   k2_15_buffer[1]<=50 && k3_15_buffer[1]<=50  && k1_05_buffer[0]-d1_05_buffer[1]>=3 && k1_05_buffer[1]<=50) ||
           (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
            ...
            k1_05_buffer[0]-d1_05_buffer[1]>=3 &&   k1_05_buffer[1]<=50)) 
...
//*** long Buy  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     ...
     if  (((k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0 &&
            k1_60_buffer[1]<=50 &&   k2_60_buffer[1]<=50 && k3_60_buffer[1]<=50 && k1_15_buffer[0]-d1_15_buffer[1]>=3 &&   k1_15_buffer[1]<=50) ||
           (k1_240_buffer[0]-k1_240_buffer[1]>=3 &&  k2_240_buffer[0]-k2_240_buffer[1]>=1 && k3_240_buffer[0]-k3_240_buffer[1]>=0 &&
            k1_240_buffer[1]<=60 &&   k2_240_buffer[1]<=50 && k3_240_buffer[1]<=50 &&
            k1_15_buffer[0]-d1_15_buffer[1]>=3 &&   k1_15_buffer[1]<=50))) 
    ...
    if (OrdersTotal()<=1)   
     {              
      ...
      if  (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
            k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=50 && k3_15_buffer[1]>=50 && k1_05_buffer[0]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50) ||
           (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0 &&
            k1_30_buffer[1]>=50 &&   k2_30_buffer[1]>=50 && k3_30_buffer[1]>=50 && k1_05_buffer[0]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50))) 
  ...
  //***long Sell  2  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     ...
     if  (((k1_60_buffer[0]-k1_60_buffer[1]<=-3 &&  k2_60_buffer[0]-k2_60_buffer[1]<=-1 && k3_60_buffer[0]-k3_60_buffer[1]<=0 &&
            k1_60_buffer[1]>=50 &&   k2_60_buffer[1]>=50 && k3_60_buffer[1]>=50 && k1_15_buffer[0]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50) ||
           (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0 &&
            k1_240_buffer[1]>=40 &&   k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50 && k1_15_buffer[0]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50))) 
...
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
 ...
 //    {              
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0  &&
         ...
         ((k1_05_buffer[1]-d1_05_buffer[2]>=3 &&   k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25) &&
...
//                 shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+250*Point,"My order #B2",8802,0,Yellow );
 ...
 // Buy  2  ***************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=10 &&  k2_05_buffer[1]-k2_05_buffer[2]>=5 && k3_05_buffer[1]-k3_05_buffer[2]>=2  &&
           k1_05_buffer[1]-d1_05_buffer[1]>=5 &&  k2_05_buffer[1]-d2_05_buffer[1]>=3 && k3_05_buffer[1]-d3_05_buffer[1]>=1 &&  
           k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
           close_05_buffer[1]-close_05_buffer[2]>=0.00010 && close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010) ||  
...
//                      OrderClose(OrderTicket(),lots,Bid,1,Sienna);                                                                     
          ...
          if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00120 && high_05_buffer[0]-OrderOpenPrice()<=0.00130) 
                  OrderModify(OrderTicket(),Ask,OrderOpenPrice()+60*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_BUY &&  shortbuy01==OrderTicket() && high_05_buffer[0]-OrderOpenPrice()>=0.00250 && high_05_buffer[0]-OrderOpenPrice()<=0.00260) 
               OrderModify(OrderTicket(),Ask,OrderOpenPrice()+160*Point,OrderTakeProfit(),0,Blue);
          if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00480 && high_05_buffer[0]-OrderOpenPrice()<=0.00490) 
...
//                      OrderClose(OrderTicket(),lots,Ask,1,Gold);    
           ...
           if   (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00120 && low_05_buffer[0]-OrderOpenPrice()>=-0.00130)
                     OrderModify(OrderTicket(),Bid,OrderOpenPrice()-60*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_SELL &&  shortsell01==OrderTicket() && low_05_buffer[0]-OrderOpenPrice()<=-0.00250 && low_05_buffer[0]-OrderOpenPrice()>=-0.00260)
                   OrderModify(OrderTicket(),Bid,OrderOpenPrice()-160*Point,OrderTakeProfit(),0,Blue);
         if   (OrderType()==OP_SELL &&  low_05_buffer[0]-OrderOpenPrice()<=-0.00480 && low_05_buffer[0]-OrderOpenPrice()>=-0.00490)
                    OrderModify(OrderTicket(),Bid,OrderOpenPrice()-320*Point,OrderTakeProfit(),0,Blue);
