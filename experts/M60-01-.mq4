    ...
    if (OrdersTotal()<=orderno)   
     {
        ...
        if    (ma45_60_buffer[1]-ma45_60_buffer[2]>-0.0001 && ma90_60_buffer[1]-ma90_60_buffer[2]>-0.0001 &&
              ...
              (close_60_buffer[1]-open_60_buffer[1]<=-0.0001  && low_240_buffer[1]-close_240_buffer[1]<=-0.0020)) &&
               ...
               //   [8],[9],[10],[11],[12],[13]的任一個收盤價在[1]收盤價之下  或  ma05[8]~~[13]在0.0003,-0.0003間          
             ((close_240_buffer[8]-close_240_buffer[1]<=-0.0001 || close_240_buffer[9]-close_240_buffer[1]<=-0.0001 ||
              ...
              (ma05_60_buffer[8]-ma05_60_buffer[13]>=-0.0003 && ma05_60_buffer[8]-ma05_60_buffer[13]<=0.0003)))                  
     ...
     if (OrdersTotal()<=orderno)   
      {
        ...
        if    (ma45_60_buffer[1]-ma45_60_buffer[2]<0.0001 && ma90_60_buffer[1]-ma90_60_buffer[2]<0.0001 &&
              ...
              (close_60_buffer[1]-open_60_buffer[1]>=0.0001  && high_60_buffer[1]-open_60_buffer[1]>=0.0020))  &&
               close_60_buffer[2]-open_60_buffer[2]>=0.0001 &&
               //   [8],[9],[10],[11],[12],[13]的任一個收盤價在[1]收盤價之上  或  ma05[8]~~[13]在0.0003,-0.0003間          
             ((close_240_buffer[8]-close_240_buffer[1]>=0.0001 || close_240_buffer[9]-close_240_buffer[1]>=0.0001 ||
               close_240_buffer[10]-close_240_buffer[1]>=0.0001 || close_240_buffer[11]-close_240_buffer[1]>=0.0001 ||
               close_240_buffer[12]-close_240_buffer[1]>=0.0001 || close_240_buffer[13]-close_240_buffer[1]>=0.0001) ||
              (ma05_60_buffer[8]-ma05_60_buffer[13]<=0.0003 && ma05_60_buffer[8]-ma05_60_buffer[13]>=-0.0003)))                  
