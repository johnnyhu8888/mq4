...
//                (k2_240_buffer[1]-d2_240_buffer[1]<=-15 &&  k3_240_buffer[1]-d3_240_buffer[1]<=-15)))	
                 ...
                 shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-80*Point,Ask+500*Point,"My order #B1",8801,0,Yellow );
    ...
    if (OrdersTotal()<=3)   
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=8 &&  k2_05_buffer[1]-k2_05_buffer[2]>=5 && k3_05_buffer[1]-k3_05_buffer[2]>=2  &&
          ...
          (k1_15_buffer[1]-k1_15_buffer[2]>=10 &&  k2_15_buffer[1]-k2_15_buffer[2]>=5 && k3_15_buffer[1]-k3_15_buffer[2]>=2  &&
           ...
           shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-80*Point,Ask+500*Point,"My order #B2",8802,0,Yellow );
    }     
//*** Sell  1  ********************************************************************************************************************** 
...
//          if   (OrderType()==OP_BUY && TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505  &&
          if   (OrderType()==OP_BUY && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket()) && TimeCurrent()-OrderOpenTime()>=500) //&&  TimeCurrent()-OrderOpenTime()<=1505) //  &&
                if  ( OrderOpenPrice()-high_05_buffer[0]<=0.00100 && OrderOpenPrice()-high_05_buffer[1]<=0.00100 &&
...
//         if   (OrderType()==OP_SELL &&  TimeCurrent()-OrderOpenTime()>=1500 && TimeCurrent()-OrderOpenTime()<=1505 &&
          if   (OrderType()==OP_SELL && (shortsell01==OrderTicket() || shortsell02==OrderTicket())  && TimeCurrent()-OrderOpenTime()>=1000 && TimeCurrent()-OrderOpenTime()<=1505  &&
