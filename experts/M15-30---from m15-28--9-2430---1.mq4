  ...
  if (OrdersTotal()<=1)   
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
              ...
              if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   macdsignalline_30_buffer[1]>=-0.00160 && macdsignalline_30_buffer[1]<=0.00160)
                   return;
                   else                        
             ...
             (((ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0040) ||
                ...
                if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   (k1_15_buffer[1]<=8 && k2_15_buffer[1]<=8 &&  k3_15_buffer[1]<=8))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-20*Point,Ask+450*Point,"My order #B4",8804,0,Brown );
        ...
        //        (ma45_15_buffer[1]-ma45_15_buffer[6]>=-0.0013 && ma90_15_buffer[1]-ma90_15_buffer[6]>=-0.0013) || 
               ...
               if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                  ...
                  (k1_15_buffer[1]>=92 && k2_15_buffer[1]>=92 &&  k3_15_buffer[1]>=92))
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+20*Point,Bid-450*Point,"My order #S4",4404,0,Gray );
      ...
      if  ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && high_15_buffer[1]-open_15_buffer[1]>=0.0024) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001   && high_15_buffer[1]-close_15_buffer[1]>=0.0024) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (open_15_buffer[3]-open_15_buffer[2]>=-0.0003 && open_15_buffer[4]-open_15_buffer[2]>=-0.0003) ||    
              (open_15_buffer[2]-open_15_buffer[1]>=-0.0003 && open_15_buffer[3]-open_15_buffer[1]>=-0.0003) ||     
              (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.0060 &&
               macdsignalline_30_buffer[1]>=-0.00060 && macdsignalline_30_buffer[1]<=0.0060))
               return;
               else                               
...
//***  Ordermodify   ********************************************************************************** 
        ...
        if (OrderType()==OP_BUY && high_15_buffer[0]-OrderOpenPrice()>=0.0101  && high_15_buffer[0]-OrderOpenPrice()<=0.0200)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15highest16bar-40*Point,OrderTakeProfit(),0,Blue);
        ...
        if (OrderType()==OP_SELL && low_15_buffer[0]-OrderOpenPrice()<=-0.0101  && low_15_buffer[0]-OrderOpenPrice()>=-0.0200)
            OrderModify(OrderTicket(),OrderOpenPrice(),M15lowest16bar+40*Point,OrderTakeProfit(),0,Blue);
