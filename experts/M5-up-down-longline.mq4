...
//*** Buy  1  ***************************************************************************************** 
  ...
  if (OrdersTotal()<=1)   
     {              
       ...
       if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 &&  ma90_05_buffer[1]-ma90_05_buffer[6]>=-0.0001 &&
        ...
        { 
                                                   ...
                                                   // m15 m30 kd2 ld3┕秨 ぃ禦
            
          if  (k2_15_buffer[0]-d2_15_buffer[0]<=-5 &&  k3_15_buffer[0]-d3_15_buffer[0]<=-5 &&
               k2_30_buffer[0]-d2_30_buffer[0]<=-5 &&  k3_30_buffer[0]-d3_30_buffer[0]<=-5)

              return;
          else      
             OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+120*Point,"My order #1",8801,0,Red );
        }
     }           
