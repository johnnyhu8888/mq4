    ...
    if  ( (k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0  &&
           ...
           (k1_05_buffer[1]-d1_05_buffer[2]>=3 &&   k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 &&
            ...
            if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0) ||
                 ...
                 shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+320*Point,"My order #1",8801,0,Yellow );
     }           
...
//*** Buy  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     {              
        ...
        if  (k1_05_buffer[1]-k1_05_buffer[2]>=1 && k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0)

             if  (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  close_05_buffer[2]-open_05_buffer[2]<=-0.00040 &&
                  close_05_buffer[1]-open_05_buffer[2]>=0.00010)  
               if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0) ||
                   (k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0) || 
                   (k1_60_buffer[0]-k1_60_buffer[1]<=-3 &&  k2_60_buffer[0]-k2_60_buffer[1]<=-1 && k3_60_buffer[0]-k3_60_buffer[1]<=0) ||
                   (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0)))
                   ...
                   shortbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+250*Point,"My order #2",8802,0,Yellow );
     }           
           ...
           (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
            ...
            if   ((k1_60_buffer[0]-k1_60_buffer[1]<=-3 &&  k2_60_buffer[0]-k2_60_buffer[1]<=-1 && k3_60_buffer[0]-k3_60_buffer[1]<=0) ||
                  (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0))
                   ...
                   longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+900*Point,"My order #3",8803,0,Yellow );
     }           
//*** Buy  4  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=1)   
     ...
     if  (((k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0 &&
           ...
           if    (k1_15_buffer[0]-d1_15_buffer[1]>=3 &&   k1_15_buffer[1]<=50)                               
            ...
            longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+2000*Point,"My order #4",8804,0,Yellow );
     }       
//*** Sell  1  ********************************************************************************************************************** 
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
          ...
          if (((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
              ...
              (k1_240_buffer[0]-k1_240_buffer[1]>=3 &&  k2_240_buffer[0]-k2_240_buffer[1]>=1 && k3_240_buffer[0]-k3_240_buffer[1]>=0)))
               ...
               shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-320*Point,"My order #S1",4401,0,Green);
     }        
                                                                        //秨虫30だぃ笆
  //*** Sell  2  ********************************************************************************************************************** 
      ...
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
          ...
          if (((k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0) ||
              ...
              return;
               ...
               shortsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-900*Point,"My order #S3",4403,0,Green);
     }
 //*** Sell  3  ********************************************************************************************************************** 
     ...
     {              
      ...
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
          ...
          if ((k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0) ||
              ...
              longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-900*Point,"My order #S3",4403,0,Green);
     }
  //*** Sell  4  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=1)   
     {              
        //    m5 k1,k2,k3,50,[1]Μ [2]Μ堵 SELL
      if (((k1_60_buffer[1]>=50 &&   k2_60_buffer[1]>=50 && k3_60_buffer[1]>=50) ||
           (k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0 &&
            k1_240_buffer[1]>=40 &&   k2_240_buffer[1]>=50 && k3_240_buffer[1]>=50))) 
            if   (k1_15_buffer[0]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50)                               
     
              longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #S4",4404,0,Green);
     }
   
//    if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00015) //&& TimeCurrent()-OrderOpenTime()>=8000)
                       //stoploss=OrderOpenPrice()+40*Point寥4翴
 //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+50*Point,OrderTakeProfit(),0,Blue);
 //     if (OrderType()==OP_BUY && k1_15_buffer[0]-k1_15_buffer[1]>=3 &&  k2_15_buffer[0]-k2_15_buffer[1]>=1 && k3_15_buffer[0]-k3_15_buffer[1]>=0)
 //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+100*Point,OrderOpenPrice()+450*Point,0,Blue);
 //     if (OrderType()==OP_BUY && k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[0]>=0)
 //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+250*Point,OrderOpenPrice()+700*Point,0,Blue);
 //     if (OrderType()==OP_BUY && k1_60_buffer[0]-k1_60_buffer[1]>=3 &&  k2_60_buffer[0]-k2_60_buffer[1]>=1 && k3_60_buffer[0]-k3_60_buffer[1]>=0)
 //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+400*Point,OrderOpenPrice()+1000*Point,0,Blue);
 //     if (OrderType()==OP_BUY && k1_240_buffer[0]-k1_240_buffer[1]>=3 &&  k2_240_buffer[0]-k2_240_buffer[1]>=1 && k3_240_buffer[0]-k3_240_buffer[1]>=0)
 //           OrderModify(OrderTicket(),Ask,OrderOpenPrice()+800*Point,OrderOpenPrice()+1500*Point,0,Blue);
      if (OrderType()==OP_BUY && OrderTicket()==shortbuy04 && high_240_buffer[0]-OrderOpenPrice()>=0.00100)
             OrderModify(OrderTicket(),Ask,OrderOpenPrice()+350*Point,OrderTakeProfit(),0,Blue);
      if (OrderType()==OP_BUY && OrderTicket()==shortbuy04 && high_240_buffer[0]-OrderOpenPrice()>=0.00200)
             OrderModify(OrderTicket(),Ask,OrderOpenPrice()+1200*Point,OrderTakeProfit(),0,Blue);

 //     if (OrderType()==OP_SELL && low_05_buffer[0]-OrderOpenPrice()<=-0.00015) //  && TimeCurrent()-OrderOpenTime()>=8000)
 //           OrderModify(OrderTicket(),Bid,OrderOpenPrice()-50*Point,OrderTakeProfit(),0,Blue);
 //     if (OrderType()==OP_SELL && k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0)
 //           OrderModify(OrderTicket(),Bid,OrderOpenPrice()-100*Point,OrderOpenPrice()-450*Point,0,Blue);
 //     if (OrderType()==OP_SELL && k1_30_buffer[0]-k1_30_buffer[1]<=-3 &&  k2_30_buffer[0]-k2_30_buffer[1]<=-1 && k3_30_buffer[0]-k3_30_buffer[1]<=0)
 //           OrderModify(OrderTicket(),Bid,OrderOpenPrice()-250*Point,OrderOpenPrice()-700*Point,0,Blue);
 //     if (OrderType()==OP_SELL && k1_60_buffer[0]-k1_60_buffer[1]<=-3 &&  k2_60_buffer[0]-k2_60_buffer[1]<=-1 && k3_60_buffer[0]-k3_60_buffer[1]<=0)
 //           OrderModify(OrderTicket(),Bid,OrderOpenPrice()-400*Point,OrderOpenPrice()-1000*Point,0,Blue);
 //      if (OrderType()==OP_SELL && k1_240_buffer[0]-k1_240_buffer[1]<=-3 &&  k2_240_buffer[0]-k2_240_buffer[1]<=-1 && k3_240_buffer[0]-k3_240_buffer[1]<=0)
 //           OrderModify(OrderTicket(),Bid,OrderOpenPrice()-800*Point,OrderOpenPrice()-1500*Point,0,Blue);
         if (OrderType()==OP_SELL && OrderTicket()==shortsell04 && low_240_buffer[0]-OrderOpenPrice()<=-0.00100)
             OrderModify(OrderTicket(),Bid,OrderOpenPrice()+350*Point,OrderTakeProfit(),0,Blue);
         if (OrderType()==OP_SELL && OrderTicket()==shortsell04 && high_240_buffer[0]-OrderOpenPrice()<=-0.00200)
             OrderModify(OrderTicket(),Bid,OrderOpenPrice()+1200*Point,OrderTakeProfit(),0,Blue);
