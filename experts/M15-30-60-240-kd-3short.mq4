...
//                (k2_240_buffer[1]-d2_240_buffer[1]<=-15 &&  k3_240_buffer[1]-d3_240_buffer[1]<=-15)))	
                 ...
                 shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-120*Point,Ask+500*Point,"My order #B1",8801,0,Yellow );
...
//                    (k2_240_buffer[1]-d2_240_buffer[1]>=15 &&  k3_240_buffer[1]-d3_240_buffer[1]>=15)))
               ...
               shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+120*Point,Bid-500*Point,"My order #S1",4401,0,Green);
   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
         ...
         if   (OrderType()==OP_BUY && shortbuy01==OrderTicket() && close_05_buffer[1]-open_05_buffer[1]<=-0.00020 &&
                  close_05_buffer[0]-OrderOpenPrice()<=0.00060 && close_05_buffer[1]-OrderOpenPrice()<=0.00060 && 
                  close_05_buffer[2]-OrderOpenPrice()<=0.00060 )
