     ...
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                   macdsignalline_30_buffer[1]>=-0.00099 && macdsignalline_30_buffer[1]<=0.00099) ||
                    // h4 k1下 k1>=70 m60 k1,k2,k3 全部向下 k2,k3>=65  macd 沒在-0.00070,0.00020之內 
                  (k1_60_buffer[1]-k1_60_buffer[2]<=0  && k2_60_buffer[1]-k2_60_buffer[2]<=0  &&
                   k3_60_buffer[1]-k3_60_buffer[2]<=0  && k2_60_buffer[1]>=65 && k3_60_buffer[1]>=65 &&
                   k1_240_buffer[1]-k1_240_buffer[2]<=0  &&  k1_240_buffer[1]>=70  && 
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=-0.00070 || 
                   macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.00020) ||
                                          //m30,m60 k1,k2,k3 全部向下 
                  (k1_30_buffer[1]-k1_30_buffer[2]<=0  && k2_30_buffer[1]-k2_30_buffer[2]<=0  &&
                   k3_30_buffer[1]-k3_30_buffer[2]<=0  && k1_60_buffer[1]-k1_60_buffer[2]<=0  &&
                   k2_60_buffer[1]-k2_60_buffer[2]<=0  && k3_60_buffer[1]-k3_60_buffer[2]<=0) ||
                                       //H4 k1,k2,k3全向下,或 kd2,kd3向下開口大 或 k1,k,2,k3在極低
                  (k2_240_buffer[1]-d2_240_buffer[1]<=-18  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-18) ||
                  (k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                                       //h4 超高時不做買單 
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80) ||
                                        // h4 macd 差值大小於00360不做
                   macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=0.00360 ||
                   macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.00360 ||
                  (k1_240_buffer[1]-k1_240_buffer[2]<=0  && k2_240_buffer[1]-k2_240_buffer[2]<=0  &&
                   k3_240_buffer[1]-k3_240_buffer[2]<=0 ) ||
                                        //在低點但h4[1][0]都在 ma05的10點以下
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                   close_240_buffer[1]-ma05_240_buffer[1]<=-0.0010  && close_240_buffer[0]-ma05_240_buffer[0]<=-0.0010))
                   return;
                   else                        
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-32*Point,Ask+540*Point,"My order #B1",8801,0,Red );
              ...
              (k2_15_buffer[1]-k2_15_buffer[2]>=0  ||  k3_15_buffer[1]-k3_15_buffer[2]>=0)) 
               if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80) ||
                   ...
                   macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.00360 ||
                  (k1_240_buffer[1]-k1_240_buffer[2]<=0  && k2_240_buffer[1]-k2_240_buffer[2]<=0  &&
                   k3_240_buffer[1]-k3_240_buffer[2]<=0 && k1_240_buffer[1]<=80) ||
                                        //在低點但h4[1][0]都在 ma05的10點以下
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                   close_240_buffer[1]-ma05_240_buffer[1]<=-0.0010  && close_240_buffer[0]-ma05_240_buffer[0]<=-0.0010))
                   return;
                   else                        
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-33*Point,Ask+540*Point,"My order #B2",8802,0,Yellow );
               ...
               (ma90_15_buffer[1]-ma90_15_buffer[2]>=0 && ma180_15_buffer[1]-ma180_15_buffer[2]>=0) &&                                  //下跌末端上升要一次升過前3bar
                ...
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                    ...
                    (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-34*Point,Ask+540*Point,"My order #B3",8803,0,Blue );
 
//+++++++++++++++++++++++++++++++++++++++++++   BUY   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                                                                                       
                                       //m30 k1,k2,k3 <=30  k2,k3向上
         if    (k1_30_buffer[1]<=30 && k2_30_buffer[1]<=30  &&  k3_30_buffer[1]<=30 && 
                k2_30_buffer[1]-k2_30_buffer[2]>=0  &&   k3_30_buffer[1]-k3_30_buffer[2]>=0  &&                       
                                     //m60 k1,k2,k3 <=30  k1向上
                k1_60_buffer[0]<=30 && k2_60_buffer[0]<=30  &&  k3_60_buffer[0]<=30 && 
                k1_60_buffer[0]-k1_60_buffer[1]>=8  &&   k1_60_buffer[0]-d1_60_buffer[1]>=3  && 
                                                      //m15 m30 macd 控管買賣點 
                macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 && 
                macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00050 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00020 &&
                macdmainline_30_buffer[1]<=0.00110)
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                    ...
                    (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-48*Point,Ask+540*Point,"My order #B4",8804,0,Brown );
...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   5   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0024) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001  && low_15_buffer[1]-open_15_buffer[1]<=-0.0024) &&
              ...
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010 && macdmainline_30_buffer[1]<=0.00110)
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-36*Point,Ask+540*Point,"My order #B5",8805,0,Purple );
  
//+++++++++++++++++++++++++++++++++++++++++++   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          

                      // h4 k1 上 k1<30  m60 k1,k2,k3 全部向上 k2,k3<=35  macd 在-0.00070,0.00020之內 
      if   ((k1_60_buffer[1]-k1_60_buffer[2]>=0  && k2_60_buffer[1]-k2_60_buffer[2]>=0  &&
             k3_60_buffer[1]-k3_60_buffer[2]>=0  && k2_60_buffer[1]<=35 && k3_60_buffer[1]<=35 &&
             k1_240_buffer[1]-k1_240_buffer[2]>=0  &&  k1_240_buffer[1]<=30  && 
      //       macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00070 && 
      //     macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00020 &&
             macdmainline_30_buffer[1]<=0.00110) ||
                                       //m30,m60 k1,k2,k3 全部向上 
            (k1_30_buffer[1]-k1_30_buffer[2]>=0  && k2_30_buffer[1]-k2_30_buffer[2]>=0  &&
             k3_30_buffer[1]-k3_30_buffer[2]>=0  && k1_60_buffer[1]-k1_60_buffer[2]>=0  &&
             k2_60_buffer[1]-k2_60_buffer[2]>=0  && k3_60_buffer[1]-k3_60_buffer[2]>=0  &&
             k1_30_buffer[1]<=40 && k2_30_buffer[1]<=40 && k3_30_buffer[1]<=40  &&
             k1_60_buffer[1]<=40 && k2_60_buffer[1]<=40 && k3_60_buffer[1]<=40 &&
             macdmainline_30_buffer[1]<=0.00110 ))
                       //H4 k1,k2,k3全向下,或 kd2,kd3向下開口大 或 k1,k,2,k3在極低
                if  ((k2_240_buffer[1]-d2_240_buffer[1]<=-18  &&  k3_240_buffer[1]-d3_240_buffer[1]<=-18) ||
                     (k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                                          //h4 超高時不做買單 
                     (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80) ||
                                           // h4 macd 差值大小於00360不做
                     ...
                     (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20  &&
                      ...
                      OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-37*Point,Ask+540*Point,"My order #B6",8806,0,Gold );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && low_15_buffer[1]-close_15_buffer[1]<=-0.0080) ||
             ...
             close_240_buffer[1]-open_240_buffer[1]>=0.0001  && macdmainline_30_buffer[1]<=0.00110 &&
             ...
             //     (k1_240_buffer[1]<=15 && k2_240_buffer[1]<=10  &&  k3_240_buffer[1]<=10) ||
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-38*Point,Ask+540*Point,"My order #B7",8807,0,OrangeRed );
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   BUY   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]>=0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0.0001 && 
               ...
               k1_15_buffer[1]<=30 && k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30  && macdmainline_30_buffer[1]<=0.00110 &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                 ...
                 OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-31*Point,Ask+540*Point,"My order #B8",8808,0,Tomato);
        ...
        //      close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_30_buffer[1]-k1_30_buffer[2]>=0  && k2_30_buffer[1]-k2_30_buffer[2]>=0  &&
                   k3_30_buffer[1]-k3_30_buffer[2]>=0  && k1_60_buffer[1]-k1_60_buffer[2]>=0  &&
                   k2_60_buffer[1]-k2_60_buffer[2]>=0  && k3_60_buffer[1]-k3_60_buffer[2]>=0) ||
                               //H4 k1,k2,k3全向上,或 kd2,kd3向上開口大 或 k1,k,2,k3在極高
                  (k2_240_buffer[1]-d2_240_buffer[1]>=18  &&  k3_240_buffer[1]-d3_240_buffer[1]>=18) ||
                  ...
                  (k1_240_buffer[1]<=20 && k2_240_buffer[1]<=20  &&  k3_240_buffer[1]<=20) ||
                   ...
                   macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.00360 ||
                  (k1_240_buffer[1]-k1_240_buffer[2]>=0  && k2_240_buffer[1]-k2_240_buffer[2]>=0  &&
                   k3_240_buffer[1]-k3_240_buffer[2]>=0  && k1_240_buffer[1]>=20) ||
                                        //在高點但h4[1][0]都在 ma05的10點以上
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   close_240_buffer[1]-ma05_240_buffer[1]>=0.0010  && close_240_buffer[0]-ma05_240_buffer[0]>=0.0010))
                   return;
                   else                        
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+32*Point,Bid-540*Point,"My order #S1",4401,0,Green );
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0) || 
               ...
               (k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0))         
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+33*Point,Bid-540*Point,"My order #S2",4402,0,White );
        ...
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 && close_15_buffer[1]-open_15_buffer[1]<=-0.0002 &&
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+34*Point,Bid-540*Point,"My order #S3",4403,0,Lime );
 
//+++++++++++++++++++++++++++++++++++++++++++   SELL   4   ++++++++++++++++++++++++++++++++++++++++++++++++++          
         
                                          //m30 k1,k2,k3 >=70  k2,k3向下
         if    (k1_30_buffer[1]>=70 && k2_30_buffer[1]>=70  &&  k3_30_buffer[1]>=70 && 
                k2_30_buffer[1]-k2_30_buffer[2]<=0  &&   k3_30_buffer[1]-k3_30_buffer[2]<=0  &&                       
                                     //m60 k1,k2,k3 >=70  k1向下
                k1_60_buffer[0]>=70 && k2_60_buffer[0]>=70  &&  k3_60_buffer[0]>=70 && 
                k1_60_buffer[0]-k1_60_buffer[1]<=-8  &&   k1_60_buffer[0]-d1_60_buffer[1]<=-3  && 
                                                   //用m15 m30 macd 控管買賣點 
                 macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010 &&
                 macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00050 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&
                ...
                if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+48*Point,Bid-540*Point,"My order #S4",4404,0,Gray );
      ...
      if  ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && high_15_buffer[1]-open_15_buffer[1]>=0.0024) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001   && high_15_buffer[1]-close_15_buffer[1]>=0.0024) &&
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+36*Point,Bid-540*Point,"My order #S5",4405,0,Aqua );

//+++++++++++++++++++++++++++++++++++++++++++   SELL   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          

                //h4 k1 下 k1<=70   m60 k1,k2,k3 全部向下 k2,k3>=65  macd 在-0.00070,0.00020之內 
      if   ((k1_60_buffer[1]-k1_60_buffer[2]<=0  && k2_60_buffer[1]-k2_60_buffer[2]<=0  &&
             k3_60_buffer[1]-k3_60_buffer[2]<=0  && k2_60_buffer[1]>=65 && k3_60_buffer[1]>=65 &&
             k1_240_buffer[1]-k1_240_buffer[2]<=0  &&  k1_240_buffer[1]>=70  && 
     //        macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=-0.00070 && 
     //      macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.00020  &&
            ...
            (k1_30_buffer[1]-k1_30_buffer[2]<=0  && k2_30_buffer[1]-k2_30_buffer[2]<=0  &&
             k3_30_buffer[1]-k3_30_buffer[2]<=0  && k1_60_buffer[1]-k1_60_buffer[2]<=0  &&
             k2_60_buffer[1]-k2_60_buffer[2]<=0  && k3_60_buffer[1]-k3_60_buffer[2]<=0  &&
             k1_30_buffer[1]>=60 && k2_30_buffer[1]>=60  &&  k3_30_buffer[1]>=60  &&
             k1_60_buffer[1]>=60 && k2_60_buffer[1]>=60  &&  k3_60_buffer[1]>=60))                                            //避開超過100點 
                     //H4 k1,k2,k3全向上,或 kd2,kd3向上開口大 或 k1,k,2,k3在極高
             if     ((k2_240_buffer[1]-d2_240_buffer[1]>=18  &&  k3_240_buffer[1]-d3_240_buffer[1]>=18) ||
                     (k1_240_buffer[1]>=85 && k2_240_buffer[1]>=90  &&  k3_240_buffer[1]>=90) ||
                                           //h4 超低時不做賣單 
                     ...
                     (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                      ...
                      OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+37*Point,Bid-540*Point,"My order #S6",4406,0,Teal );
     ...
     //           (k1_240_buffer[1]>=85 && k2_240_buffer[1]>=90  &&  k3_240_buffer[1]>=90) ||
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   return;
                    ...
                    OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+38*Point,Bid-540*Point,"My order #S7",4407,0,Olive );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  (ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && 
               ...
               k1_15_buffer[1]>=70 && k2_15_buffer[1]>=70 && k3_15_buffer[1]>=70  && macdmainline_30_buffer[1]>=-0.00110 &&
               close_15_buffer[1]-open_15_buffer[1]<=-0.0005  &&  close_15_buffer[1]-close_15_buffer[2]<=-0.0001 && 
              ...
              if ((macdmainline_15_buffer[1]>=-0.00099 && macdmainline_15_buffer[1]<=0.00099 &&
                  ...
                  (k1_240_buffer[1]>=80 && k2_240_buffer[1]>=80  &&  k3_240_buffer[1]>=80  &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+31*Point,Bid-540*Point,"My order #S8",4408,0,SeaGreen );
...
//+++++++++++++++++++++++++++++++++++++++++++CLOSE   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      //      macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=0.00020 &&
            ...
            (k1_30_buffer[1]-k1_30_buffer[2]<=0  && k2_30_buffer[1]-k2_30_buffer[2]<=0  &&
             ...
             k2_60_buffer[1]-k2_60_buffer[2]<=0  && k3_60_buffer[1]-k3_60_buffer[2]<=0  &&
             k1_30_buffer[1]>=60 && k2_30_buffer[1]>=60  &&  k3_30_buffer[1]>=60  &&
             k1_60_buffer[1]>=60 && k2_60_buffer[1]>=60  &&  k3_60_buffer[1]>=60  &&
             macdmainline_30_buffer[1]>=-0.00110))                                            //避開超過100點 
                     //H4 k1,k2,k3全向上,或 kd2,kd3向上開口大 或 k1,k,2,k3在極高
             if     ((k2_240_buffer[1]-d2_240_buffer[1]>=18  &&  k3_240_buffer[1]-d3_240_buffer[1]>=18) ||
                     (k1_240_buffer[1]>=85 && k2_240_buffer[1]>=90  &&  k3_240_buffer[1]>=90) ||
                                           //h4 超低時不做賣單 
