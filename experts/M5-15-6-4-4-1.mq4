...
//trade=1;
 ...
 //*** long Buy  1  ***************************************************************************************** 
  if  (OrdersTotal()<=4)
   {
                       //⊿虫┪Τㄢ眎祏虫虫
     if(OrderSelect(longbuy01, SELECT_BY_TICKET)==true && longbuy01==OrderTicket())
        return;
        else
...
//*** long Buy  2  ***************************************************************************************** 
     if(OrderSelect(longbuy02, SELECT_BY_TICKET)==true && longbuy02==OrderTicket())
        return;
        else
 ...
 //*** long Buy  3  ***************************************************************************************** 
     if(OrderSelect(longbuy03, SELECT_BY_TICKET)==true && longbuy03==OrderTicket())
        return;
        else
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell01, SELECT_BY_TICKET)==true && longsell01==OrderTicket())
        return;
        else
  ...
  //***long Sell  2  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell02, SELECT_BY_TICKET)==true && longsell02==OrderTicket())
        return;
        else
  ...
  //***long Sell  3  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell03, SELECT_BY_TICKET)==true && longsell03==OrderTicket())
        return;
        else
...
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  SELL   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     if(OrderSelect(longbuy24, SELECT_BY_TICKET)==true && longbuy24==OrderTicket())
        return;
        else
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  SELL  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if(OrderSelect(longsell24, SELECT_BY_TICKET)==true && longsell24==OrderTicket())
        return;
        else
