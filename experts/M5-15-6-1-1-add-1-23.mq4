           ...
           (k1_30_buffer[0]-k1_30_buffer[1]>=3 &&  k2_30_buffer[0]-k2_30_buffer[1]>=1 && k3_30_buffer[0]-k3_30_buffer[1]>=0 &&
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                   ...
                   longbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB1",8801,0,Yellow );
 //*** long Buy  2  ***************************************************************************************** 
            ...
            if   ((d2_30_buffer[1]>=45 && d3_30_buffer[1]>=45 &&
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                   ...
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.002000) ||
                    ...
                    longbuy02=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB2",8802,0,Yellow );
//*** long Buy  3  ***************************************************************************************** 
            ...
            if   ((d2_60_buffer[1]>=45 && d3_60_buffer[1]>=45 &&
                 ...
                 ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1]))<50) ||
                   ...
                   (macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=-0.002000) ||
                    ...
                    longbuy03=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB3",8803,0,Yellow );
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 8804 ) 
     ...
     if   ((k1_60_buffer[1]<=15 &&   k2_60_buffer[1]<=15 && k3_60_buffer[1]<=15 &&  
          ...
          ((macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])-(macdmainline_240_buffer[3]-macdsignalline_240_buffer[3]))>=0.000500 &&  
            ...
            longbuy04=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-300*Point,Ask+19000*Point,"My order #LB4",8804,0,Yellow );
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 8805 ) 
     ...
     if   (((k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50 &&
         ...
         (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
           ...
           shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-200*Point,Ask+500*Point,"My order #short",8805,0,Yellow );
 ...
 //*** Buy  6  ***************************************************************************************** 
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 8806 ) 
      return(0);
       ...
       if   (k1_05_buffer[1]-k1_05_buffer[2]>=2 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=-1 &&
        
          (close_05_buffer[1]-open_05_buffer[1]<=-0.00010 && close_05_buffer[2]-open_05_buffer[2]>=0.00010) ||
      
         ((close_05_buffer[1]-open_05_buffer[1]>=0.00020 && low_05_buffer[1]-open_05_buffer[1]>=0.00040) && 
          (low_05_buffer[1]==m05lowest40bar ||  low_05_buffer[2]==m05lowest40bar)) &&
       
         ((k1_05_buffer[1]<=50 &&   k2_05_buffer[1]<=50 && k3_05_buffer[1]<=50) || 
          (k2_05_buffer[1]-d2_05_buffer[1]>=15 && k3_05_buffer[1]-d3_05_buffer[1]>=15)))   

           shortbuy01=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-250*Point,Ask+450*Point,"My order #1",8806,0,Yellow );
 ...
 //*** long Sell  2  ********************************************************************************************************************** 
          ...
          if  (k1_15_buffer[1]-d1_15_buffer[1]<=-3 &&   k1_15_buffer[1]>=50)                               
                  ...
                  if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                     ...
                     (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                      ...
                      longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS2",4402,0,Blue);
            ...
            close_30_buffer[1]-open_30_buffer[1]>=0.00001))
                  ...
                  if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                     ...
                     (macdsignalline_240_buffer[1]-macdsignalline_240_buffer[2]<=-0.000050) && (macdsignalline_240_buffer[2]-macdsignalline_240_buffer[3]>=0.000050)))
                      ...
                      longsell03=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS3",4403,0,Blue);
  ...
  if ( OrdersTotal()>0 && OrderMagicNumber() == 4404 ) 
     ...
     if   ((k1_60_buffer[1]>=85 &&   k2_60_buffer[1]>=85 && k3_60_buffer[1]>=85 &&  
          ...
          ((macdmainline_240_buffer[2]-macdsignalline_240_buffer[2])-(macdmainline_240_buffer[3]-macdsignalline_240_buffer[3]))<=-0.000500 &&  
            close_240_buffer[1]-open_240_buffer[1]>=0.00001))
            longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-19000*Point,"My order #LS4",4404,0,Blue);
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 4405 ) 
     ...
     if   (((k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50 &&
           ...
           shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+200*Point,Bid-500*Point,"My order #S1",4405,0,Green);
   ...
   if ( OrdersTotal()>0 && OrderMagicNumber() == 4405 ) 
     ...
     if   (k1_05_buffer[1]-k1_05_buffer[2]<=-2 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=1 &&
         ...
         ((close_05_buffer[1]-open_05_buffer[1]<=-0.00020 && high_05_buffer[1]-close_05_buffer[1]<=-0.00040) && 
          (high_05_buffer[1]==m05highest40bar ||  high_05_buffer[2]==m05highest40bar)) &&
    
         ((k1_05_buffer[1]>=50 &&   k2_05_buffer[1]>=50 && k3_05_buffer[1]>=50) ||
          (k2_05_buffer[1]-d2_05_buffer[1]<=-15 && k3_05_buffer[1]-d3_05_buffer[1]<=-15)))   
   
           shortsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+250*Point,Bid-450*Point,"My order #S1",4406,0,Green);
