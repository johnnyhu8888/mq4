...
//       if (OrderSymbol()==Symbol())  trade=0 ;
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
   ...
   //+++++++++++++++++++++++++++++++++++++++++++   BUY   14   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                ...
                //(m15-62) h1    macd<=-0.00870   畉-50,+50丁         祇ネ诀瞯ぃ┮ぃㄏノ猵逼埃猭
        if    (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 &&
               macdmainline_60_buffer[1]<=-0.00870 &&
                    //k1,k2,k3  [1]-[2]>=0   k1,k2,k3<=30 || ma180 ,ma360弊
             ...
             ((k1_60_buffer[1]<=30 && k2_60_buffer[1]<=30 && k3_60_buffer[1]<=30) || (ma180_60_buffer[1]-ma180_60_buffer[2]>=0.0001 &&
               ...
               if   (ma45_240_buffer[1]-ma45_240_buffer[2]<=-0.0010 && ma90_240_buffer[1]-ma90_240_buffer[2]<=-0.0008 &&
                     ...
                     OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+200*Point,"My order #B14",8814,0,LimeGreen );
  
    //+++++++++++++++++++++++++++++++++++++++++++   BUY   15   ++++++++++++++++++++++++++++++++++++++++++++++++++          
  
  
                  //(m15-63)  H4     [2][3]Μ堵<20翴     [1]Μ>=10翴  痙紇絬>30翴   
      if     (close_240_buffer[1]-open_240_buffer[1]>=0.0010  && low_240_buffer[1]-open_240_buffer[1]<=-0.0030 &&
              ...
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-28*Point,Ask+200*Point,"My order #B15",8815,0,FireBrick );
   ...
   //+++++++++++++++++++++++++++++++++++++++++++   SELL   14   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if    (macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]<=0.00040 && macdmainline_60_buffer[1]-macdsignalline_60_buffer[1]>=-0.00040 &&
               macdmainline_60_buffer[1]>=0.00870 &&
                    //k1,k2,k3  [1]-[2]<=0   k1,k2,k3>=70 || ma180 ,ma360弊
               k1_60_buffer[1]-k1_60_buffer[2]<=0 && k2_60_buffer[1]-k2_60_buffer[2]<=0 && 
               k3_60_buffer[1]-k3_60_buffer[2]<=0 && 
             ((k1_60_buffer[1]>=70 && k2_60_buffer[1]>=70 && k3_60_buffer[1]>=70) || (ma180_60_buffer[1]-ma180_60_buffer[2]<=-0.0001 &&
               ma360_60_buffer[1]-ma360_60_buffer[2]<=-0.0001)))
                          //ma45  ,ma90,ma180,ma360  弊
               if   (ma45_240_buffer[1]-ma45_240_buffer[2]>=0.0010 && ma90_240_buffer[1]-ma90_240_buffer[2]>=0.0010 &&
                     ma180_240_buffer[1]-ma180_240_buffer[2]>=0.0004 && ma360_240_buffer[1]-ma360_240_buffer[2]>=0.0002)
                     return;
                     else 
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-200*Point,"My order #S14",4414,0,FireBrick );
 
     //+++++++++++++++++++++++++++++++++++++++++++   SELL   15   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 
                 //(m15-63)  H4     [2][3]Μ<20翴     [1]Μ堵  痙紇絬>30翴   
       if    (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && high_240_buffer[1]-open_240_buffer[1]>=0.0030 &&
              ...
              OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+28*Point,Bid-200*Point,"My order #S15",4415,0,SpringGreen );
 }

//***  Ordermodify   ********************************************************************************** 
                                                         //狦OrderTakeProfit()竚块Τぇ莉翴(Bid-80*Point)
                                                         //玥盢ぃ穦┪莉,氨穕ゎ
                                 //ノ  high[1] 粇畉ぃ穦び  斗﹚Μ玥はΜ堵穦э
