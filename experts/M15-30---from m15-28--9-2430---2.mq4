     ...
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
              ...
              if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-38*Point,Ask+450*Point,"My order #B1",8801,0,Red );
     ...
     {                                               //m15 的ma45  ma90 為 ㄏ 上升末端型態
        ...
        //      close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
              ...
              if (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                  ...
                  OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+38*Point,Bid-450*Point,"My order #S1",4401,0,Green );
