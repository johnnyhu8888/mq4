      ...
      if (((k1_15_buffer[0]-k1_15_buffer[1]<=-3 &&  k2_15_buffer[0]-k2_15_buffer[1]<=-1 && k3_15_buffer[0]-k3_15_buffer[1]<=0 &&
          ...
          if  (k1_05_buffer[1]-d1_05_buffer[1]<=-3 &&   k1_05_buffer[1]>=50)                               
               ...
               if   ((d2_30_buffer[1]<=55 && d3_30_buffer[1]<=55 &&
                    ...
                    (k1_60_buffer[1]-k1_60_buffer[2]>=0 && k2_60_buffer[1]-k2_60_buffer[2]>=0 && k1_60_buffer[1]-k1_60_buffer[2]>=0) ||
                      //ma05 持平狀態 
...
//    if    ( OrdersTotal()>0 && (OrderMagicNumber()!=4401 || OrderMagicNumber()!=44011 || OrderMagicNumber()!=4407)) 
     ...
     if ((((k1_15_buffer[1]>=40 && k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=3) || 
          ...
          ((k2_15_buffer[1]-d2_15_buffer[1]<=6 &&  k3_15_buffer[1]-d3_15_buffer[1]<=6) ||
           ...
           (k1_15_buffer[1]-k1_15_buffer[2]<=-1 &&  k2_15_buffer[1]-k2_15_buffer[2]<=-1 &&
            ...
            k3_15_buffer[1]>=80) ||
                  //角度折反
           (k1_15_buffer[1]-k1_15_buffer[2]<=-6 &&  k1_15_buffer[2]-k1_15_buffer[3]>=5) ||
     ...
     if ((((k1_60_buffer[1]>=40 && k1_60_buffer[1]-k1_60_buffer[2]<=-6 &&  k1_60_buffer[2]-k1_60_buffer[3]>=3) || 
          ...
          ((k2_60_buffer[1]-d2_60_buffer[1]<=6 &&  k3_60_buffer[1]-d3_60_buffer[1]<=6) ||
           ...
           (k1_60_buffer[1]-k1_60_buffer[2]<=-1 &&  k2_60_buffer[1]-k2_60_buffer[2]<=-1 &&
            ...
            k3_60_buffer[1]>=80) ||
                 //角度折反
           (k1_60_buffer[1]-k1_60_buffer[2]<=-3 &&  k1_60_buffer[2]-k1_60_buffer[3]>=3) ||
...
//if ( OrdersTotal()>0 && (OrderMagicNumber() != 8801 || OrderMagicNumber() != 88011 || OrderMagicNumber() != 8807 ))    
   
      if   ((k1_15_buffer[1]-k1_15_buffer[2]>=8 &&  k1_15_buffer[1]<=25 &&
            k1_15_buffer[1]-d1_15_buffer[1]>=5 &&
            close_15_buffer[1]-close_15_buffer[2]>=0.00010 && close_15_buffer[1]-close_15_buffer[3]>=0.00010 &&
            close_15_buffer[1]-close_15_buffer[4]>=0) ||
           (k1_30_buffer[1]-k1_30_buffer[2]>=8 &&  k1_30_buffer[1]<=25 &&
            k1_30_buffer[1]-d1_30_buffer[1]>=5 &&
            close_30_buffer[1]-close_30_buffer[2]>=0.00010 && close_30_buffer[1]-close_30_buffer[3]>=0.00010 &&
            close_30_buffer[1]-close_30_buffer[4]>=0.00010))
     ...
     if ((((k1_60_buffer[1]<=60 && k1_60_buffer[1]-k1_60_buffer[2]>=6  &&  k1_60_buffer[2]-k1_60_buffer[3]<=-3) || 
          ...
          ((k2_60_buffer[1]-d2_60_buffer[1]>=-6 &&  k3_60_buffer[1]-d3_60_buffer[1]>=-6)||
           ...
           (k1_60_buffer[1]-k1_60_buffer[2]>=1 &&  k2_60_buffer[1]-k2_60_buffer[2]>=1 &&
            ...
            k3_60_buffer[1]<=20) ||
                 //角度折反
           (k1_60_buffer[1]-k1_60_buffer[2]>=6 &&  k1_60_buffer[2]-k1_60_buffer[3]<=-5) ||
                               //k1 &&(k2||k3)向上,macd 在合理範圍內,收盤[1]>[2][3][4]            
           (k1_60_buffer[1]-k1_60_buffer[2]>=1 && (k2_60_buffer[1]-k2_60_buffer[2]>=1 ||
