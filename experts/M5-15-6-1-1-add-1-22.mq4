...
//   {
   for ( int y = OrdersTotal() - 1; y >= 0; y -- )
       ...
       //---- 如果在???位中生成??，?到下一步
        ...
        {
         int  _GetLastError1 = GetLastError();
            Print( "OrderSelect( ", z, ", SELECT_BY_POS ) - Error #", _GetLastError1 );
            continue;
        }
...
//   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
       OrderSelect(cnt,SELECT_BY_POS,MODE_TRADES);
           ...
           if    (OrderType()==OP_BUY && OrderMagicNumber( )==8805 &&
           ...
           if    (OrderType()==OP_SELL && OrderMagicNumber( )==4405 && 
