...
//*** Buy  1  ***************************************************************************************** 
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    4     +++++++++++++++++++++
                                                      //kd1,kd2,kd3交叉上 k1<40 k2,k3<20
         if   (k1_15_buffer[1]-d1_15_buffer[1]>=0  &&  k2_15_buffer[1]-d2_15_buffer[1]>=0  && k3_15_buffer[1]-d3_15_buffer[1]>=0  &&
                k1_15_buffer[1]<=40 && k2_15_buffer[1]<=20  &&  k3_15_buffer[1]<=20 &&
                                                  
                                                   //m15 的ma45  ma90 為斜L下跌型態 
               (ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.0001 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001) || 
               (ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.0001 && ma180_15_buffer[1]-ma180_15_buffer[2]<=-0.0001) &&                                  //下跌末端上升要一次升過前3bar
                                            //m15  macd <=-0.00260  <=-0.00280  
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=0 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00035 &&
              macdmainline_15_buffer[1]<=-0.00260 &&  macdsignalline_30_buffer[1]<=-0.00280)
              if (macdmainline_15_buffer[1]>=-0.00060 && macdmainline_15_buffer[1]<=0.00060 &&
                   macdsignalline_30_buffer[1]>=-0.00060 && macdsignalline_30_buffer[1]<=0.00060)
                   return;
                   else   
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  2  +++++++++++++++++++++++++++++++++++++
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    4     +++++++++++++++++++++
                                                      //kd1,kd2,kd3交叉下 k1>=60 k2,k3>=80
         if   (k1_15_buffer[1]-d1_15_buffer[1]<=0  &&  k2_15_buffer[1]-d2_15_buffer[1]<=0  && k3_15_buffer[1]-d3_15_buffer[1]<=0  &&
                k1_15_buffer[1]>=60 && k2_15_buffer[1]>=80  &&  k3_15_buffer[1]>=80 &&
