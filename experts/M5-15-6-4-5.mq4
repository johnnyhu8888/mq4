...
//trade=1;
   for (cnt=0;cnt<OrdersTotal();cnt++)
     {
              //璶璹虫腹絏暗矪瞶ゲ斗эΘ SELECT_BY_TICKET,ぃノSELECT_BY_POS
 ...
 //*** long Buy  1  ***************************************************************************************** 
                       //⊿虫┪Τㄢ眎祏虫虫
     if(OrderSelect(longbuy01, SELECT_BY_TICKET)==true)
        break;
        else
 if (OrdersTotal()<1 || (OrdersTotal()<2 && longbuy01<2) ||   (OrdersTotal()<3 && longbuy01<2) ||          
   (OrdersTotal()<4 && longbuy01<2) ||  (OrdersTotal()<5 && longbuy01<=2))
...
//*** long Buy  2  ***************************************************************************************** 
     if(OrderSelect(longbuy02, SELECT_BY_TICKET)==true)
        return;
        else
 if (OrdersTotal()<1 || (OrdersTotal()<2 && longbuy02<2) ||   (OrdersTotal()<3 && longbuy02<2) ||          
   (OrdersTotal()<4 && longbuy02<2) ||  (OrdersTotal()<5 && longbuy02<=2))
 ...
 //*** long Buy  3  ***************************************************************************************** 
     if(OrderSelect(longbuy03, SELECT_BY_TICKET)==true)
        return;
        else
 if (OrdersTotal()<1 || (OrdersTotal()<2 && longbuy03<2) ||   (OrdersTotal()<3 && longbuy03<2) ||          
   (OrdersTotal()<4 && longbuy03<2) ||  (OrdersTotal()<5 && longbuy03<=2))
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell01, SELECT_BY_TICKET)==true)
        return;
        else
if (OrdersTotal()<1 || (OrdersTotal()<2 && longsell01<2) ||   (OrdersTotal()<3 && longsell01<2) ||          
   (OrdersTotal()<4 && longsell01<2) ||  (OrdersTotal()<5 && longsell01<2))
  ...
  //***long Sell  2  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell02, SELECT_BY_TICKET)==true)
        return;
        else
if (OrdersTotal()<1 || (OrdersTotal()<2 && longsell02<2) ||   (OrdersTotal()<3 && longsell02<2) ||          
   (OrdersTotal()<4 && longsell02<2) ||  (OrdersTotal()<5 && longsell02<2))
  ...
  //***long Sell  3  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell03, SELECT_BY_TICKET)==true)
        return;
        else
if (OrdersTotal()<1 || (OrdersTotal()<2 && longsell03<2) ||   (OrdersTotal()<3 && longsell03<2) ||          
   (OrdersTotal()<4 && longsell03<2) ||  (OrdersTotal()<5 && longsell03<2))
...
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  SELL   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     if(OrderSelect(longbuy24, SELECT_BY_TICKET)==true)
        return;
        else
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  SELL  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if(OrderSelect(longsell24, SELECT_BY_TICKET)==true)
        return;
        else
