...
//trade=1;
 ...
 //*** long Buy  1  ***************************************************************************************** 
                    //沒單或有兩張短單可下長單
if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && (longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
...
//*** long Buy  2  ***************************************************************************************** 
  if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && (longbuy01==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
 ...
 //*** long Buy  3  ***************************************************************************************** 
   if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy04==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
   ...
   if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && ( longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
...
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  SELL   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && ( longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
                      longbuy21==OrderTicket() || longbuy22==OrderTicket() || longbuy23==OrderTicket() || 
     ...
     if   (k1_05_buffer[1]<=30 &&   k2_05_buffer[1]<=25 && k3_05_buffer[1]<=25 && 
         ...
         ((d3_05_buffer[1]-d3_05_buffer[2]>=0) ||
          ...
          (k2_05_buffer[1]-k2_05_buffer[2]>=0 && k3_05_buffer[1]-k3_05_buffer[2]>=0))) 
           ...
           longbuy24=OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-150*Point,Ask+500*Point,"My order #B1",8801,0,Yellow );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  SELL  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if (OrdersTotal()<1 || ((OrdersTotal()<2 ||  OrdersTotal()<3 ||  OrdersTotal()<4 ||  OrdersTotal()<5) && ( longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      ...
                      longsell13==OrderTicket() || longsell14==OrderTicket() || longsell15==OrderTicket() || longsell16==OrderTicket() ||
                      longsell17==OrderTicket() || longsell18==OrderTicket() || longsell19==OrderTicket() || longsell20==OrderTicket() ||
                      longsell21==OrderTicket() || longsell22==OrderTicket() || longsell23==OrderTicket())))
     ...
     if   (k1_05_buffer[1]>=70 &&   k2_05_buffer[1]>=75 && k3_05_buffer[1]>75 && 
         ...
         ((d3_05_buffer[1]-d3_05_buffer[2]<=0) ||
          ...
          (k2_05_buffer[1]-k2_05_buffer[2]<=0 && k3_05_buffer[1]-k3_05_buffer[2]<=0))) 
                    ...
                    longsell24=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-500*Point,"My order #S1",4401,0,Green);
  ...
  if (OrdersTotal()>0)
   ...
   for (cnt=0;cnt<OrdersTotal();cnt++)
     ...
     if    (OrderType()==OP_BUY  && (longbuy01==OrderTicket()))
...
//+++++++++++++++++++++++++++++++++++++++++++  CLOSE  BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        if    (OrderType()==OP_BUY  && (longbuy02==OrderTicket()))
...
//+++++++++++++++++++++++++++++++++++++++++++  CLOSE  BUY   3   ++++++++++++++++++++++++++++++++++++++++++++++++++          
      ...
      if    (OrderType()==OP_BUY  && (longbuy03==OrderTicket()))
