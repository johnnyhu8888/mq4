...
//*** Buy  1  ***************************************************************************************** 
 ...
 //*** Buy  2  ***************************************************************************************** 
       ...
       if ((k1_15_buffer[1]-k1_15_buffer[2]>=3 && (k2_15_buffer[1]-k2_15_buffer[2]>=0 || k3_15_buffer[1]-k3_15_buffer[2]>=0) &&
           ...
           k1_15_buffer[1]<=30  &&
           close_15_buffer[2]-open_15_buffer[2]<=-0.0020  &&  close_15_buffer[1]-open_15_buffer[1]>=0.0006))
          if (ma45_15_buffer[1]-ma45_15_buffer[6]<=-0.0006)
               return;
               else
 ...
 //*** Buy  3  ***************************************************************************************** 
       ...
       if (k1_15_buffer[1]-k1_15_buffer[2]>=0 && k2_15_buffer[1]-k2_15_buffer[2]>=0 && k3_15_buffer[1]-k3_15_buffer[2]>=0 &&
           k2_15_buffer[1]<=30  &&  k3_15_buffer[1]<=30  &&
           k1_15_buffer[1]-d1_15_buffer[1]>=0 && ma45_15_buffer[1]-ma45_15_buffer[6]>=0.0003 &&
           ma90_15_buffer[1]-ma90_15_buffer[6]>=0.0001 )      //&&  (k2_15_buffer[1]-d2_15_buffer[1]>=0 || k3_15_buffer[1]-d3_15_buffer[1]>=0)) 
 ...
 //*** sell  3  ***************************************************************************************** 
        ...
        if (k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0 &&
           k2_15_buffer[1]>=70  &&  k3_15_buffer[1]>=70  &&
           k1_15_buffer[1]-d1_15_buffer[1]<=0 && ma45_15_buffer[1]-ma45_15_buffer[6]<=-0.0003 &&
           ma90_15_buffer[1]-ma90_15_buffer[6]<=-0.0001)   // &&  (k2_15_buffer[1]-d2_15_buffer[1]<=0 || k3_15_buffer[1]-d3_15_buffer[1]<=0))
