...
//+++++++++++++++++++++++++++++++++++++++++++   BUY   6   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                                                //H4     [2]留下影線>85點 k1,k2,k3<=30  [1]>=0.0001 ||kd[1]>=1,kd2>=0 
       if  (((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && low_240_buffer[2]-close_240_buffer[2]<=-0.0085) ||
             (close_240_buffer[2]-open_240_buffer[2]>=0.0001  && low_240_buffer[2]-open_240_buffer[2]<=-0.0085) &&
                                                          //H4 k1,k2,k3 <=30
              k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30  &&  k3_240_buffer[1]<=30 &&
                 //(m15-59) h4  kd1[1]>=1  kd1[2]>=0
            ((k1_240_buffer[1]-d1_240_buffer[1]>=1 && k1_240_buffer[2]-d1_240_buffer[2]>=0) ||
              close_240_buffer[1]-open_240_buffer[1]>=0.0001)) || 
            
                    //H4     [2]留下影線<=-0.0085  k1,k2,k3<=30  [1]下影線<=-0.0060  
             ((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && low_240_buffer[2]-close_240_buffer[2]<=-0.0085) ||
              (close_240_buffer[2]-open_240_buffer[2]>=0.0001  && low_240_buffer[2]-open_240_buffer[2]<=-0.0085) &&
                        //H4 k1,k2,k3 <=30
              k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30  &&  k3_240_buffer[1]<=30 &&
                //(m15-59)   h4  [12下影>=80 [1]下影>=60
             (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && low_240_buffer[1]-close_240_buffer[1]<=-0.0060) ||
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001  && low_240_buffer[1]-open_240_buffer[1]<=-0.0060)) || 
                            
                              //(m15-59)  h4 [1][2]<=-0.0001 [1]+[2]下影>=0.0160
             (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 &&
             (low_240_buffer[1]-close_240_buffer[1])+(low_240_buffer[2]-close_240_buffer[2])<=-0.0160) ||        
                            //(m15-59)  h4 [1][2]>=0.0001 [1]+[2]下影>=0.0160
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]>=0.0001 && 
             (low_240_buffer[1]-open_240_buffer[1])+(low_240_buffer[2]-open_240_buffer[2])<=-0.0160 ) ||         
                             //(m15-59)  h4 [1]>=0.0001  [2]<=-0.0001 [1]+[2]下影>=0.0160
             (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
             (low_240_buffer[1]-open_240_buffer[1])+(low_240_buffer[2]-close_240_buffer[2])<=-0.0160) ||          
                            //(m15-59)  h4 [1]<=-0.0001  [2]>=0.0001 [1]+[2]下影>=0.0160
             (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && close_240_buffer[2]-open_240_buffer[2]>=0.0001 && 
             (low_240_buffer[1]-close_240_buffer[1])+(low_240_buffer[2]-open_240_buffer[2])<=-0.0160) ||          
           
              //(m15-59) (m15-58)h4  [2]下影線超過50點   [1]>=-0.0040  kd1>=3  
             ((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && low_240_buffer[2]-close_240_buffer[2]<=-0.0050) ||
              (close_240_buffer[2]-open_240_buffer[2]>=0.0001  && low_240_buffer[2]-close_240_buffer[2]<=-0.0050) &&
               close_240_buffer[1]-open_240_buffer[1]>=-0.0040  && k1_240_buffer[1]-d1_240_buffer[1]>=3 &&
  ...
  //+++++++++++++++++++++++++++++++++++++++++++   BUY   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if     ((close_240_buffer[4]-open_240_buffer[4]<=-0.0050 && close_240_buffer[3]-open_240_buffer[3]<=-0.0050  && 
              ...
              (close_240_buffer[1]-open_240_buffer[1]>=0.0030 && close_240_buffer[5]-open_240_buffer[5]>=0.0010  && 
               ...
               k1_240_buffer[1]<=30 && k2_240_buffer[1]<=30 && k3_240_buffer[1]<=30  &&
                             // h4  [2]>=-0.0100  || [3]>=-0.0170  || macd差值>=-0.00300
              (close_240_buffer[2]-open_240_buffer[2]>=-0.0100 || close_240_buffer[3]-open_240_buffer[3]>=-0.0170 ||
               macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]>=-0.00300) &&
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if   ((close_240_buffer[1]-open_240_buffer[1]>=0.0030 && close_240_buffer[4]-open_240_buffer[4]>=0.0010  && 
               close_240_buffer[2]-open_240_buffer[2]<=-0.0010 && close_240_buffer[3]-open_240_buffer[3]<=-0.0010 &&
                 //(m15-59) kd1,(kd2||kd3)>=-2 開口必須縮小
               k1_240_buffer[1]-d1_240_buffer[2]>=-2  && (k2_240_buffer[1]-d2_240_buffer[2]>=-2 || k3_240_buffer[1]-d3_240_buffer[2]>=-2) &&
               k2_240_buffer[1]<=30 && k3_240_buffer[1]<=30  &&
                  //(m15=58)  h4 收盤必須離ma05在10點內   h1   k1,k2,k3必須在45下以免已漲過高
               close_240_buffer[1]-ma05_240_buffer[1]>=-0.0010 &&
               k1_60_buffer[1]<=45 && k2_60_buffer[1]<=45 && k3_60_buffer[1]<=45 && 
              (low_240_buffer[1]==H4lowest40bar ||  low_240_buffer[2]==H4lowest40bar)) ||
                   //h4 的 [+5][-4][-3][-2][+1]  && [+1]or[-2]為最低 bar實體為0.0010   [1]>=0.0030  
              (close_240_buffer[1]-open_240_buffer[1]>=0.0030 && close_240_buffer[5]-open_240_buffer[5]>=0.0010  && 
               close_240_buffer[2]-open_240_buffer[2]<=-0.0010 && close_240_buffer[3]-open_240_buffer[3]<=-0.0010 &&
                  ...
                  ((ma45_240_buffer[1]-ma45_240_buffer[2])-(ma45_240_buffer[2]-ma45_240_buffer[3])<=-0.0001  ||
                   ...
                   ((k1_240_buffer[1]-d1_240_buffer[1])+(k2_240_buffer[1]-d2_240_buffer[1])+(k3_240_buffer[1]-d3_240_buffer[1])<=-40 &&
                     k1_240_buffer[1]-d1_240_buffer[1]<=-12 && k2_240_buffer[1]-d2_240_buffer[1]<=-12 && k3_240_buffer[1]-d3_240_buffer[1]<=-12) ||
                           ...
                           //(m15-57)h4  [1]跌過100點  ma45<=-0.0015
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
                     ...
                     //H4     [2]留上影線<=85點 k1,k2,k3>=70  [1]<=-0.0001 ||kd[1]<=-1,kd2<=0 
       if (((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0085) ||
            (close_240_buffer[2]-open_240_buffer[2]>=0.0001   && high_240_buffer[2]-close_240_buffer[2]>=0.0085) &&
                                                       //H4 k1,k2,k3 >=70
            ...
            ((k1_240_buffer[1]-d1_240_buffer[1]<=-1 && k1_240_buffer[2]-d1_240_buffer[2]<=0) ||
             close_240_buffer[1]-open_240_buffer[1]<=-0.0001)) || 
                          ...
                          //H4     [2]留上影線>=0.0085  k1,k2,k3>=70  [1]上影線>=0.0060  
           ((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0085) ||
            (close_240_buffer[2]-open_240_buffer[2]>=0.0001   && high_240_buffer[2]-close_240_buffer[2]>=0.0085) &&
                                                        //H4 k1,k2,k3 >=70
             k1_240_buffer[1]>=70 && k2_240_buffer[1]>=70  &&  k3_240_buffer[1]>=70 &&
                    //(m15-59)   h4  [2]上影>=80 [1]上影>=60
            (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && high_240_buffer[1]-open_240_buffer[1]>=0.0060) ||
            (close_240_buffer[1]-open_240_buffer[1]>=0.0001   && high_240_buffer[1]-close_240_buffer[1]>=0.0060)) ||
             
               //(m15-59)  h4 [1][2]<=-0.0001 [1]+[2]上影>=0.0160
           (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
           (high_240_buffer[1]-open_240_buffer[1])+(high_240_buffer[2]-open_240_buffer[2])>=0.0160) || 
                 //(m15-59)  h4 [1][2]>=0.0001 [1]+[2]上影>=0.0160
           (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]>=0.0001 && 
           (high_240_buffer[1]-close_240_buffer[1])+(high_240_buffer[2]-close_240_buffer[2])>=0.0160) || 
                 //(m15-59)  h4 [1]>=0.0001  [2]<=-0.0001  [1]+[2]上影>=0.0160
           (close_240_buffer[1]-open_240_buffer[1]>=0.0001 && close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && 
           (high_240_buffer[1]-close_240_buffer[1])+(high_240_buffer[2]-open_240_buffer[2])>=0.0160) || 
                //(m15-59)  h4 [1]<=-0.0001  [2]>=0.0001  [1]+[2]上影>=0.0160
           (close_240_buffer[1]-open_240_buffer[1]<=-0.0001 && close_240_buffer[2]-open_240_buffer[2]>=0.0001 && 
           (high_240_buffer[1]-open_240_buffer[1])+(high_240_buffer[2]-close_240_buffer[2])>=0.0160) ||
           
              //(m15-59) (m15-58)h4  [2]上影線超過50點   [1]<=0.0040  kd1<=-3  
             ((close_240_buffer[2]-open_240_buffer[2]<=-0.0001 && high_240_buffer[2]-open_240_buffer[2]>=0.0050) ||
              (close_240_buffer[2]-open_240_buffer[2]>=0.0001  && high_240_buffer[2]-close_240_buffer[2]>=0.0050) &&
               close_240_buffer[1]-open_240_buffer[1]<=0.0040  && k1_240_buffer[1]-d1_240_buffer[1]<=-3 &&
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   8   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if   ((close_240_buffer[4]-open_240_buffer[4]>=0.0050 && close_240_buffer[3]-open_240_buffer[3]>=0.0050  && 
              ...
              (close_240_buffer[1]-open_240_buffer[1]<=-0.0030 && close_240_buffer[5]-open_240_buffer[5]<=-0.0010  && 
               ...
               close_240_buffer[4]-open_240_buffer[4]>=0.0010 && 
               k1_240_buffer[1]>=70 && k2_240_buffer[1]>=70 && k3_240_buffer[1]>=70  &&
                          // h4  [2]<=0.0100 || [3]<=0.00170  || macd差值<0.00300
              (close_240_buffer[2]-open_240_buffer[2]<=0.0100 ||  close_240_buffer[3]-open_240_buffer[3]<=0.0170 ||
               macdmainline_240_buffer[1]-macdsignalline_240_buffer[1]<=0.00300)  &&
               close_240_buffer[1]-close_240_buffer[2]<=0 && close_240_buffer[1]-close_240_buffer[3]<=0  && 
              (high_240_buffer[1]==H4highest40bar ||  high_240_buffer[2]==H4highest40bar)))
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   SELL   9   ++++++++++++++++++++++++++++++++++++++++++++++++++          
        ...
        if   ((close_240_buffer[1]-open_240_buffer[1]<=-0.0030 && close_240_buffer[4]-open_240_buffer[4]<=-0.0010  && 
               close_240_buffer[2]-open_240_buffer[2]>=0.0010 && close_240_buffer[3]-open_240_buffer[3]>=0.0010 &&
                               //(m15-59) kd1,(kd2||kd3)<=2 開口必須縮小
               k1_240_buffer[1]-k1_240_buffer[2]<=2  && (k2_240_buffer[1]-k2_240_buffer[2]<=2 || k3_240_buffer[1]-k3_240_buffer[2]<=2) &&
               k2_240_buffer[1]>=70 && k3_240_buffer[1]>=70  &&
                   //(m15=58)  h4 收盤必須離ma05在10點內   h1   k1,k2,k3必須在55上以免已跌過頭
               close_240_buffer[1]-ma05_240_buffer[1]<=0.0010 &&
