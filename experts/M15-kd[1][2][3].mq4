...
//*** Buy  1  ***************************************************************************************** 
 ...
 //     if  (  k1_15_buffer[1]<=25 &&   k2_15_buffer[1]<=30 && k3_15_buffer[1]<=30 ) // &&
...
//*** Sell  1  ********************************************************************************************************************** 
  ...
  //      if   (ma45_15_buffer[1]-ma45_15_buffer[2]<=-0.00010 && ma90_15_buffer[1]-ma90_15_buffer[2]<=-0.00010 &&
  //            close_15_buffer[1]-open_15_buffer[1]<=-0.00010 &&
     //   if (      k1_15_buffer[1]>=75 &&   k2_15_buffer[1]>=70 && k3_15_buffer[1]>=70)//  &&
         //     k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&  (k2_15_buffer[1]-k2_15_buffer[2]<=-1 || k3_15_buffer[1]-k3_15_buffer[2]<=-1))  
   Comment( "K1=", k1_15_buffer[1],"K2=",k2_15_buffer[1]);     
