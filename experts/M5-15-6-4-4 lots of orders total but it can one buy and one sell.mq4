...
//trade=1;
 ...
 //*** long Buy  1  ***************************************************************************************** 
  if  (OrdersTotal()<=4)
   {
                       //⊿虫┪Τㄢ眎祏虫虫
     if(OrderSelect(longbuy01, SELECT_BY_POS)==true)
        return;
        else
...
//*** long Buy  2  ***************************************************************************************** 
     if(OrderSelect(longbuy02, SELECT_BY_POS)==true)
        return;
        else
 ...
 //*** long Buy  3  ***************************************************************************************** 
     if(OrderSelect(longbuy03, SELECT_BY_POS)==true)
        return;
        else
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell01, SELECT_BY_POS)==true)
        return;
        else
  ...
  //***long Sell  2  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell02, SELECT_BY_POS)==true)
        return;
        else
  ...
  //***long Sell  3  ********************************************************************************************************************** 
     ...
     if(OrderSelect(longsell03, SELECT_BY_POS)==true)
        return;
        else
...
//+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  SELL   ++++++++++++++++++++++++++++++++++++++++++++++++++          
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
if (OrdersTotal()<1 || (OrdersTotal()<3 && longbuy24<2) ||          
   (OrdersTotal()<4 && longbuy24<2) ||  (OrdersTotal()<5 && longbuy24<2))
...
if (OrdersTotal()<1 || (OrdersTotal()<3 && longsell24<2) ||          
   (OrdersTotal()<4 && longsell24<2) ||  (OrdersTotal()<5 && longsell24<2))
