  ...
  if (OrdersTotal()<=1)   
     {                                           //m15 的ma45  ma90 為斜L下跌末端型態 
      ...
      //        close_15_buffer[1]-close_15_buffer[4]>=0.0001  &&
                                             //用m15 m30 macd 控管買賣點 
              macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00040 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00020 &&
                                             //k1 (k2||k3)已上升
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]<=-0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0005 && 
                   ...
                   (close_15_buffer[1]-open_15_buffer[1]<=0.0080 || close_15_buffer[1]-high_15_buffer[1]<=0.0080) &&
                    ...
                    open_240_buffer[2]-low_240_buffer[2]<=0.0090 && open_240_buffer[1]-low_240_buffer[1]<=0.0100) || 
                                              //在macd正負160內不交易
                   (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                    macdmainline_30_buffer[1]>=-0.00160 && macdmainline_30_buffer[1]<=0.00160))
                    return;
                    else                               
                    
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-20*Point,Ask+2000*Point,"My order #B1",8801,0,Red );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]>=0 && ma90_15_buffer[1]-ma90_15_buffer[2]>=0) ||
               (ma90_15_buffer[1]-ma90_15_buffer[2]>=0 && ma180_15_buffer[1]-ma180_15_buffer[2]>=0) &&
                                                    //用m15 m30 macd 控管買賣點 順勢所以放寬值
               macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00040 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00030 && 
               macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00070 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00030 &&
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]<=-0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0005 && 
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-21*Point,Ask+2000*Point,"My order #B2",8802,0,Yellow );
         ...
         if   ((k1_15_buffer[1]-k1_15_buffer[2]>=10  &&  k1_15_buffer[1]-d1_15_buffer[1]>=5  && 
              ...
              macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]>=-0.00040 &&  macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00020))
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]<=-0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0005 && 
                   ...
                   OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-22*Point,Ask+2000*Point,"My order #B3",8803,0,Blue );
             ...
             (((ma360_15_buffer[1]-ma360_15_buffer[40]>=0.0040 && ma650_15_buffer[1]-ma650_15_buffer[40]>=0.0040) ||
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]<=-0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]<=-0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]<=-0.0005 && 
                   ...
                   (k1_15_buffer[1]<=8 && k2_15_buffer[1]<=8 &&  k3_15_buffer[1]<=8))
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+2000*Point,"My order #B4",8804,0,Brown );
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  (open_15_buffer[2]-open_15_buffer[1]<=0.0003 && open_15_buffer[3]-open_15_buffer[1]<=0.0003) ||     
                   ...
                   (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-24*Point,Ask+2000*Point,"My order #B5",8805,0,Purple );
              ...
              if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
                 ...
                 (open_15_buffer[2]-open_15_buffer[1]<=0.0003 && open_15_buffer[3]-open_15_buffer[1]<=0.0003) ||     
                   ...
                   (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                    ...
                    OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-25*Point,Ask+2000*Point,"My order #B6",8806,0,Gold );
 ...
 //+++++++++++++++++++++++++++++++++++++++++++   BUY   7   ++++++++++++++++++++++++++++++++++++++++++++++++++          
       ...
       if    (close_30_buffer[1]-open_30_buffer[1]>=0.0010 && ma05_30_buffer[1]-ma12_30_buffer[1]>=-0.0012 && 
             ...
             (macdsignalline_30_buffer[1]-macdsignalline_30_buffer[2])-(macdsignalline_30_buffer[2]-macdsignalline_30_buffer[3])>=0.00002  && 
              ...
              OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-26*Point,Ask+2000*Point,"My order #B7",8807,0,OrangeRed );
    ...
    if (OrdersTotal()<=1)   
     {                                               //m15 的ma45  ma90 為 ㄏ 上升末端型態
        ...
        //      close_15_buffer[1]-close_15_buffer[4]<=-0.0001  &&
                                                 //用m15 m30 macd 控管買賣點 
               macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00020 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&
               macdmainline_30_buffer[1]-macdsignalline_30_buffer[1]<=0.00040 &&  macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020 &&
                                                   //k1 (k2||k3)已下跌
              k1_15_buffer[1]-k1_15_buffer[2]<=-1  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
              k2_15_buffer[1]-k2_15_buffer[2]<=0  ||  k3_15_buffer[1]-k3_15_buffer[2]<=0)
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]>=0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]>=0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0005 && 
                  ...
                  (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+20*Point,Bid-2000*Point,"My order #S1",4401,0,Green );
...
//+++++++++++++++++++++++++++++++++++++++++++   SELL   2   ++++++++++++++++++++++++++++++++++++++++++++++++++          
          ...
          if  ((ma45_15_buffer[1]-ma45_15_buffer[2]<=0 && ma90_15_buffer[1]-ma90_15_buffer[2]<=0) || 
               ...
               OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+21*Point,Bid-2000*Point,"My order #S2",4402,0,White );
        ...
        if     ((k1_15_buffer[1]-k1_15_buffer[2]<=-10  &&  k1_15_buffer[1]-d1_15_buffer[1]<=-5 &&
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]>=0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]>=0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0005 && 
                  ...
                  (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+22*Point,Bid-2000*Point,"My order #S3",4403,0,Lime );
        ...
        //        (ma45_15_buffer[1]-ma45_15_buffer[6]>=-0.0013 && ma90_15_buffer[1]-ma90_15_buffer[6]>=-0.0013) || 
              ...
              if ((ma45_15_buffer[1]-ma90_15_buffer[1]>=0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]>=0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0005 && 
                  ...
                  (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-2000*Point,"My order #S4",4404,0,Gray );
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (open_15_buffer[2]-open_15_buffer[1]>=-0.0003 && open_15_buffer[3]-open_15_buffer[1]>=-0.0003) ||     
                  ...
                  (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+24*Point,Bid-2000*Point,"My order #S5",4405,0,Aqua );
           ...
           if ((close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
              ...
              (open_15_buffer[2]-open_15_buffer[1]>=-0.0003 && open_15_buffer[3]-open_15_buffer[1]>=-0.0003) ||     
                  ...
                  (macdmainline_15_buffer[1]>=-0.00160 && macdmainline_15_buffer[1]<=0.00160 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+25*Point,Bid-2000*Point,"My order #S6",4406,0,Teal );
             ...
             (k2_30_buffer[1]-k2_30_buffer[2]<=0 && k3_30_buffer[1]-k3_30_buffer[2]<=0))                                           
               ...
               if ((ma45_15_buffer[1]-ma90_15_buffer[1]>=0.0005 && ma90_15_buffer[1]-ma180_15_buffer[1]>=0.0005 && ma180_15_buffer[1]-ma360_15_buffer[1]>=0.0005 && 
                  ...
                  (macdmainline_15_buffer[1]>=-0.00199 && macdmainline_15_buffer[1]<=0.00199 &&
                   ...
                   OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+26*Point,Bid-2000*Point,"My order #S7",4407,0,Olive );
