...
if    (OrdersTotal()<=1 || (OrdersTotal()<3 && (shortbuy01==OrderTicket() || shortbuy02==OrderTicket() ||shortbuy03==OrderTicket() ||
       ...
       shortsell04==OrderTicket() || shortsell05==OrderTicket() ||shortsell06==OrderTicket()))) 
 {
    ...
    if (OrdersTotal()<=6)   
     ...
     if   (k1_15_buffer[1]<=50 &&   k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && 
           d1_15_buffer[1]<=50 &&   d2_15_buffer[1]<=25 && d3_15_buffer[1]<=25 && 
...
//           k1_15_buffer[1]-d1_15_buffer[1]>=-3 &&  k2_15_buffer[1]-d2_15_buffer[1]>=-3 && 
         ...
         //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生   有2張長單不下單                
...
//*** long Buy  2  ***************************************************************************************** 
   ...
   if (OrdersTotal()<=6)   
     ...
     if   (k1_30_buffer[1]<=40 &&   k2_30_buffer[1]<=25 && k3_30_buffer[1]<=25 && 
           d1_30_buffer[1]<=40 &&   d2_30_buffer[1]<=25 && d3_30_buffer[1]<=25 && 
...
//           k1_240_buffer[1]-d1_240_buffer[1]>=-3 &&  k2_240_buffer[1]-d2_240_buffer[1]>=-3 && 
 ...
 //*** long Sell  1  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=6)   
     ...
     if   (k1_15_buffer[1]>=50 &&   k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && 
           d1_15_buffer[1]>=50 &&   d2_15_buffer[1]>=75 && d3_15_buffer[1]>=75 && 
...
//以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
            if   ((OrdersTotal()<=1 && longbuy01==OrderTicket()) || 
                  ...
                  longsell01=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-25000*Point,"My order #LS1",4401,0,Green);
 //                 longsell02=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+150*Point,Bid-900*Point,"My order #LS2",4402,0,Green);
  ...
  //***long Sell  2  ********************************************************************************************************************** 
    ...
    if (OrdersTotal()<=6)   
     {              
        //    m5 k1,k2,k3皆下降,且在50上,[1]收紅 [2]收黑 SELL
     if   (k1_30_buffer[1]>=60 &&   k2_30_buffer[1]>=75 && k3_30_buffer[1]>=75 && 
           d1_30_buffer[1]>=60 &&   d2_30_buffer[1]>=75 && d3_30_buffer[1]>=75 && 
 ...
 //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
            if   ((OrdersTotal()<=1 && longsell04==OrderTicket()) ||          
                     ...
                     ((ma05_240_buffer[1]-ma05_240_buffer[2]>=0.00010 && ma05_240_buffer[1]-ma12_240_buffer[1]>=0.00010 && close_240_buffer[1]-ma05_240_buffer[1]>=0.00010) ||
                      ...
                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-25000*Point,"My order #LS4",4404,0,Green);
//                      longsell04=OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+300*Point,Bid-2000*Point,"My order #LS4",4404,0,Green);
     }          
   }        
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BUY  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if  ((k1_05_buffer[1]-k1_05_buffer[2]>=3 &&  k2_05_buffer[1]-k2_05_buffer[2]>=1 && k3_05_buffer[1]-k3_05_buffer[2]>=0  &&
         ...
         ((close_05_buffer[1]-close_05_buffer[2]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[3]>=0.00010 &&  close_05_buffer[1]-close_05_buffer[4]>=0.00010 ) ||
          ...
          if   (k1_15_buffer[1]<=30 &&   k2_15_buffer[1]<=40 )
 ...
 //+++++++++++++++++++++++++++++++++++++++++++ SHORT  BSELL  01   ++++++++++++++++++++++++++++++++++++++++++++++++++          
     ...
     if   ((k1_05_buffer[1]-k1_05_buffer[2]<=-3 &&  k2_05_buffer[1]-k2_05_buffer[2]<=-1 && k3_05_buffer[1]-k3_05_buffer[2]<=0  &&
         ...
         ((close_05_buffer[1]-close_05_buffer[2]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[3]<=-0.00010 &&  close_05_buffer[1]-close_05_buffer[4]<=-0.00010 ) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  close_05_buffer[2]-open_05_buffer[2]<=-0.00010) ||
          (close_05_buffer[1]-open_05_buffer[1]>=0.00040 &&  low_05_buffer[1]-close_05_buffer[2]>=0.00040))))   
          if   (k1_15_buffer[1]>=70 &&   k2_15_buffer[1]>=60) 
...
//以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
            if   ((OrdersTotal()<=1 && (longbuy02==OrderTicket() || longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                   longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                   longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                   longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                   longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
...
//           k1_30_buffer[1]-d1_30_buffer[1]<=3 &&  k2_30_buffer[1]-d2_30_buffer[1]<=3 && 
 ...
 //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
                 if ((OrdersTotal()<=1 && (longbuy01==OrderTicket() ||  longbuy03==OrderTicket() || longbuy04==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
...
//           k1_60_buffer[1]-d1_60_buffer[1]<=3 &&  k2_60_buffer[1]-d2_60_buffer[1]<=3 && 
 ...
 //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
                 if ((OrdersTotal()<=1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket()  || longbuy04==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
...
//           k1_240_buffer[1]-d1_240_buffer[1]<=3 &&  k2_240_buffer[1]-d2_240_buffer[1]<=3 && 
 ...
 //以下所有每張單詳細的orderticket只為控管不要有下多單的狀況發生                   
                 if ((OrdersTotal()<=1 && (longbuy01==OrderTicket() || longbuy02==OrderTicket() || longbuy03==OrderTicket() ||
                      longbuy05==OrderTicket() || longbuy06==OrderTicket() || longbuy07==OrderTicket() || longbuy08==OrderTicket() ||
                      longbuy09==OrderTicket() || longbuy10==OrderTicket() || longbuy11==OrderTicket() || longbuy12==OrderTicket() ||
                      longbuy13==OrderTicket() || longbuy14==OrderTicket() || longbuy15==OrderTicket() || longbuy16==OrderTicket() ||
                      longbuy17==OrderTicket() || longbuy18==OrderTicket() || longbuy19==OrderTicket() || longbuy20==OrderTicket() ||
