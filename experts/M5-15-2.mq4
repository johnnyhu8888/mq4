...
//*** Sell  1  ********************************************************************************************************************** 
  ...
  //*** Sell  2  ********************************************************************************************************************** 
    ...
    if (OrderType()==OP_BUY && high_05_buffer[0]-OrderOpenPrice()>=0.00010) // && TimeCurrent()-OrderOpenTime()>=2000)
      ...
      if (OrderType()==OP_BUY && k1_15_buffer[1]-k1_15_buffer[2]>=3 &&  k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=0)
            OrderModify(OrderTicket(),Ask,OrderOpenPrice()+100*Point,OrderOpenPrice()+450*Point,0,Blue);
      if (OrderType()==OP_BUY && k1_30_buffer[1]-k1_30_buffer[2]>=3 &&  k2_30_buffer[1]-k2_30_buffer[2]>=1 && k3_30_buffer[1]-k3_30_buffer[2]>=0)
            OrderModify(OrderTicket(),Ask,OrderOpenPrice()+250*Point,OrderOpenPrice()+700*Point,0,Blue);
      if (OrderType()==OP_BUY && k1_60_buffer[1]-k1_60_buffer[2]>=3 &&  k2_60_buffer[1]-k2_60_buffer[2]>=1 && k3_60_buffer[1]-k3_60_buffer[2]>=0)
      ...
      if (OrderType()==OP_SELL && k1_15_buffer[1]-k1_15_buffer[2]<=-3 &&  k2_15_buffer[1]-k2_15_buffer[2]<=-1 && k3_15_buffer[1]-k3_15_buffer[2]<=0)
            OrderModify(OrderTicket(),Bid,OrderOpenPrice()-100*Point,OrderOpenPrice()-450*Point,0,Blue);
      if (OrderType()==OP_SELL && k1_30_buffer[1]-k1_30_buffer[2]<=-3 &&  k2_30_buffer[1]-k2_30_buffer[2]<=-1 && k3_30_buffer[1]-k3_30_buffer[2]<=0)
            OrderModify(OrderTicket(),Bid,OrderOpenPrice()-250*Point,OrderOpenPrice()-700*Point,0,Blue);
      if (OrderType()==OP_SELL && k1_60_buffer[1]-k1_60_buffer[2]<=-3 &&  k2_60_buffer[1]-k2_60_buffer[2]<=-1 && k3_60_buffer[1]-k3_60_buffer[2]<=0)
