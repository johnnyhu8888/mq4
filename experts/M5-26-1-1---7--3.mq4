     ...
     {              
       ...
       if (ma45_05_buffer[1]-ma45_05_buffer[6]>=0 && 
        ...
        { 
          ...
          if ((ma05_15_buffer[1]-ma12_15_buffer[1]<=-0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]>=-0.0012 &&
              k1_15_buffer[1]<=35 && k2_15_buffer[1]<=25 && k3_15_buffer[1]<=25 && k1_15_buffer[1]-d1_15_buffer[1]>=3) &&
              
              (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00020) || 
              (close_15_buffer[1]-open_15_buffer[1]>=0  &&  close_15_buffer[1]-close_15_buffer[2]>=0  && 
               close_15_buffer[1]-close_15_buffer[3]>=0 &&  close_15_buffer[1]-close_15_buffer[4]>=0) &&
              ...
              (close_15_buffer[2]-open_15_buffer[2]>=0  &&  close_15_buffer[1]-open_15_buffer[1]>=0))
            {
               //  if  (ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                 //     ma05_30_buffer[1]-ma05_30_buffer[2]<=-0.0001 &&   ma08_30_buffer[1]-ma08_30_buffer[2]<=-0.0001 &&
                   //   ma05_15_buffer[1]-ma12_15_buffer[2]<=-0.0011)
          ...
          if (close_05_buffer[2]-open_05_buffer[2]<=-0.0003 && close_05_buffer[1]-open_05_buffer[1]>=0.0007 &&
           ...
           {                            
              ...
              if ((ma05_15_buffer[1]-ma05_15_buffer[2]<=-0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]<=-0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]<=-0.0001 &&
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-18*Point,Ask+300*Point,"My order #B3",8803,0,Purple );
     ...
     {              
       ...
       if (ma45_05_buffer[1]-ma45_05_buffer[6]<=0 &&  
        ...
        { 
         ...
         if ((ma05_15_buffer[1]-ma12_15_buffer[1]>=0.0001 && ma05_15_buffer[1]-ma12_15_buffer[1]<=0.0012 &&
              k1_15_buffer[1]>=65 && k2_15_buffer[1]>=75 && k3_15_buffer[1]>=75 && k1_15_buffer[1]-d1_15_buffer[1]<=-3) &&
            ...
            {                  
               ...
               if (( ma05_15_buffer[1]-ma05_15_buffer[2]>=0.0001 &&   ma08_15_buffer[1]-ma08_15_buffer[2]>=0.0001 && ma12_15_buffer[1]-ma12_15_buffer[2]>=0.0001 &&
                    ...
                    (k1_15_buffer[1]-k1_15_buffer[2]>=1 && k2_15_buffer[1]-k2_15_buffer[2]>=1 && k3_15_buffer[1]-k3_15_buffer[2]>=1 &&
                     ...
                     OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+18*Point,Bid-300*Point,"My order #S3",4403,0,Aqua );
