...
//*** Buy  1  ***************************************************************************************** 
 ...
 //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  buy  5     +++++++++++++++++++++
        ...
        //  (((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0015) ||
          //   (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0015) &&
          //    low_15_buffer[1]==M15lowest40bar &&
          //    k1_15_buffer[1]<=20 && k2_15_buffer[2]<=20 && k3_15_buffer[1]<=20 && k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
          //    macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00050 && 
          //    macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00010) ||
            
       if     ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0024) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0024) &&
              low_15_buffer[1]==M15lowest40bar &&
    ...
    //          OrderSend(Symbol(),OP_BUYLIMIT,lots,Ask-15*Point,1,Ask-33*Point,Ask+100*Point,"My order #B5",8805,10000,Gold );
            if (close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                ...
                OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+100*Point,"My order #B5",8805,0,Purple );
       ...
       if   ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && close_15_buffer[1]-low_15_buffer[1]>=0.0040) ||
             (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && open_15_buffer[1]-low_15_buffer[1]>=0.0040) &&
              ...
              if (close_15_buffer[2]-open_15_buffer[2]<=-0.0100 || close_15_buffer[1]-open_15_buffer[1]<=-0.0100 ||
                  ...
                  OrderSend(Symbol(),OP_BUY,lots,Ask,1,Ask-23*Point,Ask+100*Point,"My order #B6",8806,0,Gold );
   ...
   if (OrdersTotal()<=1)   
     {                                            
      ...
      if (((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0015) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0015) &&
           ...
           k1_15_buffer[1]>=80 && k2_15_buffer[2]>=80 && k3_15_buffer[1]>=80 &&  k1_15_buffer[1]-d1_15_buffer[1]<=-1 &&
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.00050 && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010) ||
                                            //紇絬禬筁25翴   [1]璽秨-蔼  [1]タΜ-秨
         ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0015) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0015) &&
           high_15_buffer[1]==M15highest40bar  && 
           k1_15_buffer[1]-k1_15_buffer[2]<=0 && k2_15_buffer[1]-k2_15_buffer[2]<=0 && k3_15_buffer[1]-k3_15_buffer[2]<=0   &&
          (macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]<=0.000120 && 
           macdmainline_15_buffer[1]-macdsignalline_15_buffer[1]>=-0.00010)))
     ...
     //      OrderSend(Symbol(),OP_SELLLIMIT,lots,Bid+15*Point,1,Bid+33*Point,Bid-100*Point,"My order #S5",4405,10000,Aqua );
           if (close_15_buffer[2]-open_15_buffer[2]>=0.0100 || close_15_buffer[1]-open_15_buffer[1]>=0.0100 ||
               ...
               OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-100*Point,"My order #S5",4405,0,Aqua );
     ...
     //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++   sell  6     +++++++++++++++++++++
      ...
      if ((close_15_buffer[1]-open_15_buffer[1]<=-0.0001 && open_15_buffer[1]-high_15_buffer[1]<=-0.0040) ||
          (close_15_buffer[1]-open_15_buffer[1]>=0.0001 && close_15_buffer[1]-high_15_buffer[1]<=-0.0040) &&
           ...
           OrderSend(Symbol(),OP_SELL,lots,Bid,1,Bid+23*Point,Bid-100*Point,"My order #S6",4406,0,Teal );
